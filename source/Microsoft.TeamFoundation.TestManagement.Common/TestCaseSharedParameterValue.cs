...
// Type: Microsoft.TeamFoundation.TestManagement.Common.TestCaseSharedParameterValue
...
namespace Microsoft.TeamFoundation.TestManagement.Common
{
  ...
  public class TestCaseSharedParameterValue : TestCaseParameterValue
  {
    private TestCaseSharedParameterValue(int rowId) => this.RowId = rowId;

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private int RowId { get; set; }

    public override string ToString() => string.Format("RowId : {0}", (object) this.RowId);
  }
}
