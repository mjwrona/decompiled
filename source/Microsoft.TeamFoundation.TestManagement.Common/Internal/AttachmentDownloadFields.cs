...
// Type: Microsoft.TeamFoundation.TestManagement.Common.Internal.AttachmentDownloadFields
...
namespace Microsoft.TeamFoundation.TestManagement.Common.Internal
{
  ...
  {
    public static readonly string AttachmentId = "id";
    public static readonly string TestRunId = "run";
    public static readonly string TestResultId = "res";
    public static readonly string SessionId = "ses";
    public static readonly string Length = "len";
  }
}
