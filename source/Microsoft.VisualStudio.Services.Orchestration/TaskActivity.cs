...
// Type: Microsoft.VisualStudio.Services.Orchestration.TaskActivity
...
namespace Microsoft.VisualStudio.Services.Orchestration
{
  public abstract class TaskActivity
  {
    ...
    public virtual Task<string> RunAsync(TaskContext context, string input) => Task.FromResult<string>(this.Run(context, input));
  }
}
