...
// Type: Microsoft.VisualStudio.Services.Orchestration.TaskActivityDispatcherSharding.IActivityShardLocator
...
{
  public interface IActivityShardLocator
  {
    bool TryGetShardValue(IActivityShardKey key, out string shardValue, string dispatcherType = null);
  }
}
