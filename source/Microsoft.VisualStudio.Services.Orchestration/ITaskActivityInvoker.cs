...
// Type: Microsoft.VisualStudio.Services.Orchestration.ITaskActivityInvoker
...
{
  public interface ITaskActivityInvoker
  {
    Task<object> Invoke(TaskContext context, string methodName, Func<object, Task<object>> invoke);
  }
}
