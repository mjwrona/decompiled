...
// Type: Microsoft.VisualStudio.Services.Orchestration.TaskOrchestration`2
...
{
  public abstract class TaskOrchestration<TResult, TInput> : 
    TaskOrchestration<TResult, TInput, string, string>
  {
  }
}
