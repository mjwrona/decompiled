...
// Type: Microsoft.VisualStudio.Services.Orchestration.History.TimerFiredEvent
...
namespace Microsoft.VisualStudio.Services.Orchestration.History
{
  ...
  {
    internal TimerFiredEvent()
    {
    }

    public TimerFiredEvent(int eventId, DateTime timestamp)
