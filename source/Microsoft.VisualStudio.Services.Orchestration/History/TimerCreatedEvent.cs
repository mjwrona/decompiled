...
// Type: Microsoft.VisualStudio.Services.Orchestration.History.TimerCreatedEvent
...
namespace Microsoft.VisualStudio.Services.Orchestration.History
{
  ...
  {
    internal TimerCreatedEvent()
    {
    }

    public TimerCreatedEvent(int eventId, DateTime timestamp)
