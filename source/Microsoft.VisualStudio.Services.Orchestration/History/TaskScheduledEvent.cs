...
// Type: Microsoft.VisualStudio.Services.Orchestration.History.TaskScheduledEvent
...
namespace Microsoft.VisualStudio.Services.Orchestration.History
{
  ...
  {
    internal TaskScheduledEvent()
    {
    }

    public TaskScheduledEvent(int eventId, DateTime timestamp)
