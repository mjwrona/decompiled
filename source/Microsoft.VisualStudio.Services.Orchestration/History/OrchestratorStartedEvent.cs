...
// Type: Microsoft.VisualStudio.Services.Orchestration.History.OrchestratorStartedEvent
...
{
  [DataContract]
  public sealed class OrchestratorStartedEvent : HistoryEvent
  {
    internal OrchestratorStartedEvent()
    {
    }

    public OrchestratorStartedEvent(int eventId, DateTime timestamp)
