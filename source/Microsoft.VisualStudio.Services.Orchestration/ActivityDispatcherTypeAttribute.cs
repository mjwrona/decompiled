...
// Type: Microsoft.VisualStudio.Services.Orchestration.ActivityDispatcherTypeAttribute
...
namespace Microsoft.VisualStudio.Services.Orchestration
{
  ...
  public class ActivityDispatcherTypeAttribute : Attribute
  {
    public ActivityDispatcherTypeAttribute(string dispatcherType)
    {
      ArgumentUtility.CheckStringForNullOrEmpty(dispatcherType, nameof (dispatcherType));
