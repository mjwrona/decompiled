...
// Type: Microsoft.TeamFoundation.DistributedTask.Elastic.IAzureVirtualMachineScaleSetResourceService
...
namespace Microsoft.TeamFoundation.DistributedTask.Elastic
{
  ...
  public interface IAzureVirtualMachineScaleSetResourceService : IVssFrameworkService
  {
    Task<IReadOnlyList<VirtualMachineScaleSet>> ListScaleSetsInSubscriptionAsync(
      IVssRequestContext requestContext,
      Guid serviceEndpointId,
      Guid serviceEndpointScope);

    Task<VirtualMachineScaleSet> GetScaleSetAsync(
      IVssRequestContext requestContext,
