...
// Type: Microsoft.VisualStudio.Services.Common.PropertyTypeNotSupportedException
...
namespace Microsoft.VisualStudio.Services.Common
{
  ...
  public class PropertyTypeNotSupportedException : VssPropertyValidationException
  {
    public PropertyTypeNotSupportedException(string propertyName, Type type)
      : base(propertyName, CommonResources.VssUnsupportedPropertyValueType((object) propertyName, (object) type.FullName))
    {
    }
