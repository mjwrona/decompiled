...
// Type: Microsoft.TeamFoundation.Coverage.WebApi.CoverageChangeSummary
...
{
  [DataContract]
  public class CoverageChangeSummary
  {
    [DataMember(Name = "deltaPipelineRun", IsRequired = false, EmitDefaultValue = false)]
    public PipelineInstanceReference DeltaPipelineRun;
    [DataMember(Name = "scope", IsRequired = true, EmitDefaultValue = false)]
    public string Scope;
    [DataMember(Name = "fileCoverageChanges", IsRequired = false, EmitDefaultValue = false)]
    public List<FileCoverageChange> FileCoverageChanges;
  }
}
