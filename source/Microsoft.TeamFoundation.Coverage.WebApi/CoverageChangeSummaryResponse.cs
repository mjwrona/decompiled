...
// Type: Microsoft.TeamFoundation.Coverage.WebApi.CoverageChangeSummaryResponse
...
{
  [DataContract]
  public class CoverageChangeSummaryResponse
  {
    [ClientResponseContent]
    [DataMember(IsRequired = false, EmitDefaultValue = false)]
    public CoverageChangeSummary CoverageChangeSummary { get; set; }
