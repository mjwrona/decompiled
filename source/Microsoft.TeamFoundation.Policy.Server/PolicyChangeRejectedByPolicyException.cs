...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyChangeRejectedByPolicyException
...
{
  [Serializable]
  public class PolicyChangeRejectedByPolicyException : TeamFoundationServiceException
  {
    public PolicyChangeRejectedByPolicyException(ActionDeniedBySubscriberException e)
      : base(PolicyResources.Get("PolicyConfigurationUpdateRejectedByPolicy"), (Exception) e)
    {
    }
  }
}
