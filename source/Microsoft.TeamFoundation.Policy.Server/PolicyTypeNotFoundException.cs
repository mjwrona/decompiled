...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyTypeNotFoundException
...
{
  [Serializable]
  public class PolicyTypeNotFoundException : TeamFoundationServiceException
  {
    public PolicyTypeNotFoundException(Guid typeId)
      : base(PolicyResources.Format("PolicyTypeNotFound", (object) typeId))
    {
    }
  }
}
