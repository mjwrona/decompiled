...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyOperationFailedException
...
{
  [Serializable]
  public class PolicyOperationFailedException : TeamFoundationServiceException
  {
    public PolicyOperationFailedException(
    ...
    public PolicyOperationFailedException()
      : base(PolicyResources.Get("PolicyOperationFailed"))
    {
    }
  }
}
