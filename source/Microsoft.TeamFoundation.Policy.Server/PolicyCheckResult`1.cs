...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyCheckResult`1
...
{
  public sealed class PolicyCheckResult<TContext> : PolicyCheckResult where TContext : TeamFoundationPolicyEvaluationRecordContext
  {
    ...
    internal PolicyCheckResult(
      ...
      TContext context)
      : base(newStatus, rejectionReason, (TeamFoundationPolicyEvaluationRecordContext) context)
    {
    }
  }
}
