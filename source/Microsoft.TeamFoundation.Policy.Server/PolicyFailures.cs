...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyFailures
...
{
  public class PolicyFailures
  {
    public PolicyFailures(PolicyConfigurationRecord configuration, string errorMessage)
    {
