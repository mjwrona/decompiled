...
// Type: Microsoft.TeamFoundation.Policy.Server.CannotCreateUnknownScopeException
...
{
  [Serializable]
  public class CannotCreateUnknownScopeException : TeamFoundationServiceException
  {
    public CannotCreateUnknownScopeException()
      : base(PolicyResources.Get("CannotCreateUnknownScope"))
    {
    }
  }
}
