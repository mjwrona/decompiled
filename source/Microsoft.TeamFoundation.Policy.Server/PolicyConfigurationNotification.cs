...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyConfigurationNotification
...
{
  public class PolicyConfigurationNotification : PolicyNotification
  {
    public PolicyConfigurationNotification(Guid projectId, PolicyConfigurationRecord configuration)
      : base(projectId)
    {
