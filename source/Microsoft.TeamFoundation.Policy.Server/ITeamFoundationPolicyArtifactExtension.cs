...
// Type: Microsoft.TeamFoundation.Policy.Server.ITeamFoundationPolicyArtifactExtension
...
{
  [InheritedExport]
  public interface ITeamFoundationPolicyArtifactExtension
  {
    ITeamFoundationPolicyTarget TryGetArtifactTarget(
