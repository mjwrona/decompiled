...
// Type: Microsoft.TeamFoundation.Policy.Server.CannotCreateNewDeprecatedScopeException
...
{
  [Serializable]
  public class CannotCreateNewDeprecatedScopeException : TeamFoundationServiceException
  {
    public CannotCreateNewDeprecatedScopeException()
      : base(PolicyResources.Get("CannotCreateNewDeprecatedScope"))
    {
    }
  }
}
