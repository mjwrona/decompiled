...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyEvaluationNotFoundException
...
{
  [Serializable]
  public class PolicyEvaluationNotFoundException : TeamFoundationServiceException
  {
    public PolicyEvaluationNotFoundException(Guid evaluationId)
      : base(PolicyResources.Format("PolicyEvaluationNotFound", (object) evaluationId))
    {
    }
  }
}
