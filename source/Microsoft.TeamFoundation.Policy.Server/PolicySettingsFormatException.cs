...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicySettingsFormatException
...
{
  [Serializable]
  public class PolicySettingsFormatException : TeamFoundationServiceException
  {
    public PolicySettingsFormatException(string error)
      : base(PolicyResources.Format(nameof (PolicySettingsFormatException), (object) error))
    {
    }
  }
}
