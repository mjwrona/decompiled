...
// Type: Microsoft.TeamFoundation.Policy.Server.ArtifactNotFoundException
...
{
  [Serializable]
  public class ArtifactNotFoundException : TeamFoundationServiceException
  {
    public ArtifactNotFoundException(ArtifactId artifactId)
      : base(PolicyResources.Format("ArtifactIdNotFound", (object) LinkingUtilities.EncodeUri(artifactId)))
    {
    }
  }
}
