...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyEvaluationUpdateNotification
...
{
  public class PolicyEvaluationUpdateNotification : PolicyNotification
  {
    public PolicyEvaluationUpdateNotification(Guid projectId, string artifactId)
      : base(projectId)
    {
