...
// Type: Microsoft.TeamFoundation.Policy.Server.FeatureAvailabilityFlags
...
namespace Microsoft.TeamFoundation.Policy.Server
{
  ...
  {
    public const string PolicyEnterpriseManagedPolicies = "Policy.EnterpriseManagedPolicies";
