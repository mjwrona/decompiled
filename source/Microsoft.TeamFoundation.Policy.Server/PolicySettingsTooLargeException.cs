...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicySettingsTooLargeException
...
{
  [Serializable]
  public class PolicySettingsTooLargeException : TeamFoundationServiceException
  {
    public PolicySettingsTooLargeException(int length)
      : base(PolicyResources.Format(nameof (PolicySettingsTooLargeException), (object) 50000, (object) length))
    {
    }
  }
}
