...
// Type: Microsoft.TeamFoundation.Policy.Server.PolicyNeedsPermissionException
...
{
  [Serializable]
  public class PolicyNeedsPermissionException : TeamFoundationServiceException
  {
    public PolicyNeedsPermissionException(string message)
      : base(message)
    {
    }
  }
