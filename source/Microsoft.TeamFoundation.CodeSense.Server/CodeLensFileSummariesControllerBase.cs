...
// Type: Microsoft.TeamFoundation.CodeSense.Server.WebAPI.CodeLensFileSummariesControllerBase
...
{
  public class CodeLensFileSummariesControllerBase : CodeLensFilesController
  {
    public VersionedContent ReadFileSummaries(CodeSenseResourceVersion targetResourceVersion = CodeSenseResourceVersion.Dev12Update3)
    {
      ...
      try
      {
        ...
        versionedContent = service.GetSummary(this.TfsRequestContext, path, targetResourceVersion);
      }
