...
// Type: Microsoft.TeamFoundation.CodeSense.Server.WebAPI.CodeLensFileDetails2Controller
...
{
  public sealed class CodeLensFileDetails2Controller : CodeLensFileDetailsControllerBase
  {
    [ValidateCodeLensInput]
    [TraceFilter(1023030, 1023040)]
    public HttpResponseMessage GetFileDetails(string pathVersion) => this.CreateResponseFromResult(this.ReadFileDetails(CodeSenseResourceVersion.Dev12Update1));
  }
}
