...
// Type: Microsoft.TeamFoundation.CodeSense.Server.WebAPI.CodeLensFileSummaries2Controller
...
{
  public sealed class CodeLensFileSummaries2Controller : CodeLensFileSummariesControllerBase
  {
    [ValidateCodeLensInput]
    [TraceFilter(1023035, 1023045)]
    public HttpResponseMessage GetFileSummaries(string pathVersion) => this.CreateResponseFromResult(this.ReadFileSummaries(CodeSenseResourceVersion.Dev12Update1));
  }
}
