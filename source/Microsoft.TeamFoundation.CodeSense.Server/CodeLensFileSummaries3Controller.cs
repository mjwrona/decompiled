...
// Type: Microsoft.TeamFoundation.CodeSense.Server.WebAPI.CodeLensFileSummaries3Controller
...
{
  public sealed class CodeLensFileSummaries3Controller : CodeLensFileSummariesControllerBase
  {
    [ValidateCodeLensInput]
    [TraceFilter(1023035, 1023045)]
    public HttpResponseMessage GetFileSummaries(string pathVersion, string timeStamp = "") => this.CreateResponseFromResult(this.ReadFileSummaries(), true);
  }
}
