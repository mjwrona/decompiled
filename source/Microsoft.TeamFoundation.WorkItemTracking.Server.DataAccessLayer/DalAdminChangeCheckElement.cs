...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.DalAdminChangeCheckElement
...
{
  internal class DalAdminChangeCheckElement : DalSqlElement
  {
    public void JoinBatch(ElementGroup group, string changeStoredProcedure, bool verbose)
    {
      ...
      this.AppendSql(changeStoredProcedure);
      this.AppendSql(" ");
