...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.DalDeleteLinkTypeElement
...
{
  internal class DalDeleteLinkTypeElement : DalSqlElement
  {
    public void JoinBatch(ElementGroup group, string referenceName)
    {
      this.m_elementGroup = group;
      this.m_outputs = 1;
      this.m_index = group.AddElementToGroup(this.m_outputs);
      this.AppendSql("exec dbo.[");
      this.AppendSql("DeleteLinkType");
      this.AppendSql("] ");
