...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.DalDeleteQueryItemElement
...
{
  internal class DalDeleteQueryItemElement : DalSqlElement
  {
    public void JoinBatch(ElementGroup group, ServerQueryItem item)
    {
      ...
      this.AppendSql("DeleteQueryItem");
      this.AppendSql("] ");
