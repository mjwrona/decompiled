...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.DalSqlResourceComponent24
...
{
  internal class DalSqlResourceComponent24 : DalSqlResourceComponent23
  {
      ...
      out ResultCollection rc)
    {
      ...
      this.BindInt("@uncommittedChangesLookbackWindowInSeconds", uncommittedChangesLookbackWindowInSeconds);
