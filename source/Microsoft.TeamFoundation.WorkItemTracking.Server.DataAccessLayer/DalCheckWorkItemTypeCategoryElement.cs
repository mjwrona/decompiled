...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.DalCheckWorkItemTypeCategoryElement
...
{
  internal class DalCheckWorkItemTypeCategoryElement : DalSqlElement
  {
    public void JoinBatch(ElementGroup group)
    {
      ...
      this.AppendSql("CheckWorkItemTypeCategory");
      this.AppendSql(" ");
