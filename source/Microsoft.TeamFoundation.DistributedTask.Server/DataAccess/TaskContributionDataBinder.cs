...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskContributionDataBinder
...
{
  internal class TaskContributionDataBinder : ObjectBinder<TaskDefinitionData>
  {
    ...
    internal TaskContributionDataBinder()
    {
    }
