...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentRequestBinder10
...
{
  internal sealed class TaskAgentRequestBinder10 : ObjectBinder<TaskAgentJobRequest>
  {
    ...
    private readonly int targetPoolId;

    internal TaskAgentRequestBinder10(int poolId) => this.targetPoolId = poolId;

    internal TaskAgentRequestBinder10()
    {
    }
    ...
    protected override TaskAgentJobRequest Bind()
    {
      ...
      result.PoolId = this.targetPoolId;
