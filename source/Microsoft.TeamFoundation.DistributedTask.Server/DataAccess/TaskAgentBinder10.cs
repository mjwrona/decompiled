...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentBinder10
...
{
  internal sealed class TaskAgentBinder10 : ObjectBinder<TaskAgent>
  {
    ...
    private SqlColumnBinder m_statusChangedOn = new SqlColumnBinder("StatusChangedOn");
    ...
    protected override TaskAgent Bind()
    {
      ...
      taskAgent.OSDescription = this.m_osDescription.GetString((IDataReader) this.Reader, true);
      taskAgent.AccessPoint = this.m_accessPoint.GetString((IDataReader) this.Reader, true);
      ...
      taskAgent.ProvisioningState = this.m_provisioningState.GetString((IDataReader) this.Reader, false);
      taskAgent.StatusChangedOn = this.m_statusChangedOn.GetNullableDateTime((IDataReader) this.Reader);
