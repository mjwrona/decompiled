...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentRequestBinder16
...
{
  internal sealed class TaskAgentRequestBinder16 : ObjectBinder<TaskAgentJobRequest>
  {
    ...
    internal TaskAgentRequestBinder16()
    {
    }
    ...
    protected override TaskAgentJobRequest Bind()
    {
      ...
      result.Priority = new int?(this.m_priority.GetInt32((IDataReader) this.Reader, 0, 0));
