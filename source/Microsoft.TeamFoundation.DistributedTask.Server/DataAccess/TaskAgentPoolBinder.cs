...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentPoolBinder
...
{
  internal sealed class TaskAgentPoolBinder : ObjectBinder<TaskAgentPoolData>
  {
    ...
    public TaskAgentPoolBinder(IVssRequestContext requestContext) => this.m_scopeId = requestContext.ServiceHost.InstanceId;
    ...
    protected override TaskAgentPoolData Bind()
    {
      ...
      Guid? nullableGuid1 = this.m_administratorsGroupId.GetNullableGuid((IDataReader) this.Reader);
      Guid guid;
      if (nullableGuid1.HasValue)
      {
        ...
        taskAgentPool2.AdministratorsGroup = identityRef;
      }
      Guid? nullableGuid2 = this.m_serviceAccountsGroupId.GetNullableGuid((IDataReader) this.Reader);
      if (nullableGuid2.HasValue)
      {
        ...
        identityRef.Id = guid.ToString("D");
        taskAgentPool3.ServiceAccountsGroup = identityRef;
      }
