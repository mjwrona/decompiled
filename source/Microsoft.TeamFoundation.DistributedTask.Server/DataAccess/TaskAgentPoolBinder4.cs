...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentPoolBinder4
...
{
  internal sealed class TaskAgentPoolBinder4 : ObjectBinder<TaskAgentPoolData>
  {
    ...
    public TaskAgentPoolBinder4(IVssRequestContext requestContext) => this.m_scopeId = requestContext.ServiceHost.InstanceId;
