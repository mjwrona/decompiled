...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskResourceComponent11
...
{
  internal class TaskResourceComponent11 : TaskResourceComponent10
  {
      ...
      string description = null)
    {
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) this, nameof (AddAgentQueue)))
      {
        ...
        {
          resultCollection.AddBinder<TaskAgentQueue>((ObjectBinder<TaskAgentQueue>) new TaskAgentQueueBinder2());
