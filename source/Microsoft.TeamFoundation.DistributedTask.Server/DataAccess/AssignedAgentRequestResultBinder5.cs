...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.AssignedAgentRequestResultBinder5
...
{
  internal sealed class AssignedAgentRequestResultBinder5 : ObjectBinder<AssignedAgentRequestResult>
  {
    ...
    private SqlColumnBinder m_userDelayed = new SqlColumnBinder("UserDelayed");
    ...
    private SqlColumnBinder m_previousAgentCloudGuid = new SqlColumnBinder("PreviousAgentCloudGuid");
    ...
    private SqlColumnBinder m_previousGetAccountParallelism = new SqlColumnBinder("PreviousAgentCloudGetAccountParallelismEndpoint");
    private SqlColumnBinder m_previousMaxParallelism = new SqlColumnBinder("PreviousAgentCloudMaxParallelism");
    private SqlColumnBinder m_previousAcquisitionTimeout = new SqlColumnBinder("PreviousAgentCloudAcquisitionTimeout");
    private SqlColumnBinder m_currentAgentCloudGuid = new SqlColumnBinder("CurrentAgentCloudGuid");
    ...
    private SqlColumnBinder m_currentGetAccountParallelism = new SqlColumnBinder("CurrentAgentCloudGetAccountParallelismEndpoint");
    private SqlColumnBinder m_currentMaxParallelism = new SqlColumnBinder("CurrentAgentCloudMaxParallelism");
    ...
    protected override AssignedAgentRequestResult Bind()
    {
      ...
      taskAgentJobRequest1.UserDelayed = this.m_userDelayed.GetBoolean((IDataReader) this.Reader);
      ...
      if (int32_1 > 0)
      {
        ...
        previousAgentCloud.Id = this.m_previousAgentCloudGuid.GetGuid((IDataReader) this.Reader, false);
        ...
        previousAgentCloud.GetAccountParallelismEndpoint = this.m_previousGetAccountParallelism.GetString((IDataReader) this.Reader, true);
        previousAgentCloud.MaxParallelism = new int?(this.m_previousMaxParallelism.GetInt32((IDataReader) this.Reader, 0));
      ...
      if (int32_2 > 0)
      {
        ...
        currentAgentCloud.Id = this.m_currentAgentCloudGuid.GetGuid((IDataReader) this.Reader, false);
        ...
        currentAgentCloud.GetAccountParallelismEndpoint = this.m_currentGetAccountParallelism.GetString((IDataReader) this.Reader, true);
        currentAgentCloud.MaxParallelism = new int?(this.m_currentMaxParallelism.GetInt32((IDataReader) this.Reader, 0));
