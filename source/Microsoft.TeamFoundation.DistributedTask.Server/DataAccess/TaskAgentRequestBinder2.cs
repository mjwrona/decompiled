...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentRequestBinder2
...
{
  internal sealed class TaskAgentRequestBinder2 : ObjectBinder<TaskAgentJobRequest>
  {
    ...
    protected override TaskAgentJobRequest Bind()
    {
      ...
      taskAgentJobRequest1.ServiceOwner = ServiceInstanceTypes.TFS;
