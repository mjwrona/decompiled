...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.MetaTaskDefinitionComponent10
...
{
  internal class MetaTaskDefinitionComponent10 : MetaTaskDefinitionComponent9
  {
      ...
      bool enablePriorVersionEdit)
    {
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) this, nameof (UpdateMetaTaskDefinition)))
      {
        ...
        this.BindBoolean("@enablePriorVersionEdit", enablePriorVersionEdit);
