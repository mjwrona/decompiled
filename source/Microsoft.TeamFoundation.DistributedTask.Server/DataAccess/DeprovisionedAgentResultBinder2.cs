...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.DeprovisionedAgentResultBinder2
...
{
  internal sealed class DeprovisionedAgentResultBinder2 : ObjectBinder<DeprovisioningAgentResult>
  {
    ...
    private SqlColumnBinder m_agentCloudGuid = new SqlColumnBinder("Id");
    ...
    private SqlColumnBinder m_agentCloudMaxParallelism = new SqlColumnBinder("AgentCloudMaxParallelism");
    ...
    protected override DeprovisioningAgentResult Bind()
    {
      ...
      if (!this.m_targetVersion.IsNull((IDataReader) this.Reader))
      {
        ...
        switch (this.m_reason.GetByte((IDataReader) this.Reader))
        {
          case 1:
          ...
          case 2:
            ...
            break;
          case 3:
            agent.PendingUpdate.Reason = (TaskAgentUpdateReason) new TaskAgentDowngrade();
            break;
        }
      }
      ...
      if (this.m_agentCloudId.GetInt32((IDataReader) this.Reader, 0) > 0)
      {
        ...
        agentCloud.Id = this.m_agentCloudGuid.GetGuid((IDataReader) this.Reader, false);
        ...
        agentCloud.AcquisitionTimeout = this.m_acquisitionTimeout.GetNullableInt32((IDataReader) this.Reader);
        agentCloud.GetAccountParallelismEndpoint = this.m_getAccountParallelism.GetString((IDataReader) this.Reader, true);
        agentCloud.MaxParallelism = this.m_agentCloudMaxParallelism.GetNullableInt32((IDataReader) this.Reader);
      }
