...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentPoolBinder3
...
{
  internal sealed class TaskAgentPoolBinder3 : ObjectBinder<TaskAgentPoolData>
  {
    ...
    public TaskAgentPoolBinder3(IVssRequestContext requestContext) => this.m_scopeId = requestContext.ServiceHost.InstanceId;
    ...
    protected override TaskAgentPoolData Bind()
    {
      ...
      taskAgentPool1.IsHosted = this.m_isHosted.ColumnExists((IDataReader) this.Reader) && this.m_isHosted.GetBoolean((IDataReader) this.Reader, false);
