...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskResourceComponent18
...
{
  internal class TaskResourceComponent18 : TaskResourceComponent17
  {
    ...
    {
      TaskResourceComponent18 component = this;
      ...
      string requestResourceType)
    {
      ...
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) component, nameof (QueueAgentRequestAsync)))
      {
        ...
        TaskResourceComponent18 resourceComponent18_1 = component;
        TaskOrchestrationOwner definition = request.Definition;
        int? parameterValue1 = new int?(definition != null ? definition.Id : 0);
        resourceComponent18_1.BindNullableInt("@definitionId", parameterValue1);
        ...
        TaskResourceComponent18 resourceComponent18_2 = component;
        TaskOrchestrationOwner owner = request.Owner;
        int? parameterValue2 = new int?(owner != null ? owner.Id : 0);
        resourceComponent18_2.BindNullableInt("@ownerId", parameterValue2);
