...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.EnvironmentResourceBinder
...
{
  internal sealed class EnvironmentResourceBinder : ObjectBinder<EnvironmentResourceReference>
  {
    ...
    protected override EnvironmentResourceReference Bind() => new EnvironmentResourceReference()
    {
