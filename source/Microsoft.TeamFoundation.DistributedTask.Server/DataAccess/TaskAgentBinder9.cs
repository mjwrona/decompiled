...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentBinder9
...
{
  internal sealed class TaskAgentBinder9 : ObjectBinder<TaskAgent>
  {
      ...
      if (!this.m_targetVersion.IsNull((IDataReader) this.Reader))
      {
        ...
        switch (this.m_reason.GetByte((IDataReader) this.Reader))
        {
          ...
          case 2:
            ...
            break;
          case 3:
            taskAgent.PendingUpdate.Reason = (TaskAgentUpdateReason) new TaskAgentDowngrade();
            break;
        }
      }
      return taskAgent;
