...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentPoolBinder5
...
{
  internal sealed class TaskAgentPoolBinder5 : ObjectBinder<TaskAgentPoolData>
  {
    ...
    public TaskAgentPoolBinder5(IVssRequestContext requestContext) => this.m_scopeId = requestContext.ServiceHost.InstanceId;
    ...
    protected override TaskAgentPoolData Bind()
    {
      ...
      taskAgentPool1.Provisioned = this.m_provisioned.GetBoolean((IDataReader) this.Reader, false);
