...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentPoolBinder14
...
{
  internal sealed class TaskAgentPoolBinder14 : ObjectBinder<TaskAgentPoolData>
  {
    ...
    public TaskAgentPoolBinder14(IVssRequestContext requestContext) => this.m_scopeId = requestContext.ServiceHost.InstanceId;
    ...
    protected override TaskAgentPoolData Bind()
    {
      ...
      taskAgentPool1.Options = new TaskAgentPoolOptions?((TaskAgentPoolOptions) this.m_options.GetInt32((IDataReader) this.Reader));
