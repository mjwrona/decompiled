...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.KubernetesResourceComponent4
...
{
  internal class KubernetesResourceComponent4 : KubernetesResourceComponent3
  {
      ...
      IEnumerable<int> resourceIds)
    {
      ...
      using (ResultCollection resultCollection = new ResultCollection((IDataReader) this.ExecuteReader(), this.ProcedureName, this.RequestContext))
      {
        ...
        return (IList<KubernetesResource>) resultCollection.GetCurrent<KubernetesResource>().ToArray<KubernetesResource>();
      }
    }
  }
}
