...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.DeploymentExecutionRecordObjectBinder
...
{
  internal sealed class DeploymentExecutionRecordObjectBinder : 
    ObjectBinder<DeploymentExecutionRecordObject>
  {
    ...
    public DeploymentExecutionRecordObjectBinder(EnvironmentComponent sqlComponent) => this.SqlComponent = (TaskSqlComponentBase) sqlComponent;
