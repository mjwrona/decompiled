...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.VariableGroupComponent4
...
{
  internal class VariableGroupComponent4 : VariableGroupComponent3
  {
      ...
      VariableGroupQueryOrder queryOrder = VariableGroupQueryOrder.IdDescending)
    {
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) this, nameof (GetVariableGroups)))
      {
        ...
        this.BindNullableInt("@continuationToken", continuationToken);
