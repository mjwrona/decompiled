...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentPoolBinder8
...
{
  internal sealed class TaskAgentPoolBinder8 : ObjectBinder<TaskAgentPoolData>
  {
    ...
    public TaskAgentPoolBinder8(IVssRequestContext requestContext) => this.m_scopeId = requestContext.ServiceHost.InstanceId;
