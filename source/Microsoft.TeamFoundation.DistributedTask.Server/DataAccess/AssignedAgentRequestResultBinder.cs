...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.AssignedAgentRequestResultBinder
...
{
  internal sealed class AssignedAgentRequestResultBinder : ObjectBinder<AssignedAgentRequestResult>
  {
    ...
    protected override AssignedAgentRequestResult Bind()
    {
      ...
      if (int32_1 > 0)
      {
        ...
        previousAgentCloud.AcquireAgentEndpoint = this.m_previousAcquireAgent.GetString((IDataReader) this.Reader, false);
        ...
        previousAgentCloud.ReleaseAgentEndpoint = this.m_previousReleaseAgent.GetString((IDataReader) this.Reader, false);
      ...
      if (int32_2 > 0)
      {
        ...
        currentAgentCloud.AcquireAgentEndpoint = this.m_currentAcquireAgent.GetString((IDataReader) this.Reader, false);
        ...
        currentAgentCloud.ReleaseAgentEndpoint = this.m_currentReleaseAgent.GetString((IDataReader) this.Reader, false);
