...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskDefinitionDataBinder
...
{
  internal class TaskDefinitionDataBinder : ObjectBinder<TaskDefinitionData>
  {
    ...
    internal TaskDefinitionDataBinder()
    {
    }
