...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.DataAccess.TaskAgentCloudRequestBinder2
...
{
  internal sealed class TaskAgentCloudRequestBinder2 : ObjectBinder<TaskAgentCloudRequest>
  {
    ...
    private SqlColumnBinder m_poolName = new SqlColumnBinder("PoolName");
    ...
    protected override TaskAgentCloudRequest Bind()
    {
      TaskAgentCloudRequest agentCloudRequest = new TaskAgentCloudRequest()
      {
        ...
        ProvisionRequestTime = new DateTime?(this.m_provisionRequestTime.GetDateTime((IDataReader) this.Reader)),
      ...
      agentCloudRequest.Pool.Name = this.m_poolName.GetString((IDataReader) this.Reader, true);
      agentCloudRequest.Agent = new TaskAgentReference();
      agentCloudRequest.Agent.Id = this.m_agentId.GetInt32((IDataReader) this.Reader);
      agentCloudRequest.Agent.Name = this.m_agentName.GetString((IDataReader) this.Reader, true);
