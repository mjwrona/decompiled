...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.VMRollingStrategyExecutor
...
{
  internal sealed class VMRollingStrategyExecutor : VMStrategyExecutorBase
  {
    private RollingDeploymentStrategy m_strategy;
    private int m_maxUnhealthyVMs;

    public VMRollingStrategyExecutor(
      VirtualMachineGroupState virtualMachineGroupState,
      RollingDeploymentStrategy strategy,
