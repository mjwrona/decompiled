...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.Extensions.RunDefaultDeploymentPhase
...
{
  internal sealed class RunDefaultDeploymentPhase : RunDeploymentPhaseBase
  {
    ...
    {
      this.m_strategyExecutor = DefaultStrategyExecutorFactory.GetDeploymentStrategyExecutor(input.Strategy, input.ProviderPhase);
