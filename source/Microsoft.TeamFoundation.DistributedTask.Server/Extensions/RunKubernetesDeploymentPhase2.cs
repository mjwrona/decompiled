...
// Type: Microsoft.TeamFoundation.DistributedTask.Server.Extensions.RunKubernetesDeploymentPhase2
...
{
  internal sealed class RunKubernetesDeploymentPhase2 : RunDeploymentPhaseBase2
  {
      ...
      RunDeploymentPhaseInput2 input)
    {
      ...
      context.Trace(0, TraceLevel.Info, "Started deployment phase orchestration for target type Kubernetes and strategy " + strategyName + ".");
      this.m_strategyExecutor = KubernetesStrategyExecutorFactory2.GetDeploymentStrategyExecutor(input.Strategy, input.ProviderPhase);
