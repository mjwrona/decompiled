...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.VirtualMachineScaleSetOSDiskManagedDisk
...
{
  [DataContract]
  public class VirtualMachineScaleSetOSDiskManagedDisk
  {
    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "id")]
    public string Id { get; set; }

    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "storageAccountType")]
