...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.VirtualMachineScaleSetStorageProfile
...
namespace Microsoft.TeamFoundation.DistributedTask.Azure.Models
{
  ...
  {
    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "osDisk")]
    public VirtualMachineScaleSetOSDisk OSDisk { get; set; }

    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "imageReference")]
    public VirtualMachineScaleSetStorageProfileImageReference ImageReference { get; set; }
  }
}
