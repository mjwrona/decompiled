...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.AutoscaleSettingResource
...
{
  [DataContract]
  public class AutoscaleSettingResource : AutoscaleSettingResourceReference
  {
    [DataMember(IsRequired = false, EmitDefaultValue = false)]
    public string Name { get; set; }

    [DataMember(IsRequired = false, EmitDefaultValue = false)]
    public AutoscaleSettingResourceProperties Properties { get; set; }
  }
}
