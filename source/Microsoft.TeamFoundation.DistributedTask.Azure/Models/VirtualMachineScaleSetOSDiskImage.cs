...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.VirtualMachineScaleSetOSDiskImage
...
{
  [DataContract]
  public class VirtualMachineScaleSetOSDiskImage
  {
    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "uri")]
