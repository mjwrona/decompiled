...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.VirtualMachineScaleSetStorageProfileDiffDiskSettings
...
{
  [DataContract]
  public class VirtualMachineScaleSetStorageProfileDiffDiskSettings
  {
    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "option")]
    public string Option { get; set; }

    [DataMember(IsRequired = false, EmitDefaultValue = false, Name = "placement")]
