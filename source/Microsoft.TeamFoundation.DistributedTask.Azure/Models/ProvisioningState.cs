...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.ProvisioningState
...
namespace Microsoft.TeamFoundation.DistributedTask.Azure.Models
{
  ...
  public enum ProvisioningState
  {
    ...
    [EnumMember] Updating,
    [EnumMember] Deleting,
    [EnumMember(Value = "OS Provisioning In progress")] OSProvisioningInProgress,
    [EnumMember(Value = "OS Provisioning Complete")] OSProvisioningComplete,
