...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.VirtualMachineReimageRequestBody
...
{
  public class VirtualMachineReimageRequestBody
  {
    public bool TempDisk { get; set; }

    public string ExactVersion { get; set; }

    public VirtualMachineReimageOsProfile osProfile { get; set; }
  }
}
