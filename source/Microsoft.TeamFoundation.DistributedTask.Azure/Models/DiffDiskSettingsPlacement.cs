...
// Type: Microsoft.TeamFoundation.DistributedTask.Azure.Models.DiffDiskSettingsPlacement
...
{
  public class DiffDiskSettingsPlacement
  {
    public static string CacheDisk => nameof (CacheDisk);

    public static string ResourceDisk => nameof (ResourceDisk);
  }
}
