...
// Type: Microsoft.VisualStudio.Services.SocialServer.Server.ISocialSdkSocialActivityProvider
...
{
  [InheritedExport]
  public interface ISocialSdkSocialActivityProvider
  {
    string GetSupportedActivityType();
  }
}
