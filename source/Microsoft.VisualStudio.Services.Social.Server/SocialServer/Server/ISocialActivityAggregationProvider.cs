...
// Type: Microsoft.VisualStudio.Services.SocialServer.Server.ISocialActivityAggregationProvider
...
{
  [InheritedExport]
  public interface ISocialActivityAggregationProvider
  {
    Guid GetProviderId();

    IList<string> GetRequiredSocialActivityTypeList();

    IList<SocialActivityAggregatedMetric> Aggregate(
      DateTime startTime,
      DateTime endTime,
