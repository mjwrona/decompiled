...
// Type: Microsoft.VisualStudio.Services.SocialServer.Server.SocialActivityAggregatedArtifact
...
{
  public class SocialActivityAggregatedArtifact
  {
    public const int ArtifactIdMaxLength = 100;
