...
// Type: Microsoft.VisualStudio.Services.SocialServer.Server.SocialActivityAggregationGetActivityException
...
{
  public class SocialActivityAggregationGetActivityException : VssServiceException
  {
    public SocialActivityAggregationGetActivityException(string msg)
      : base(msg)
    {
    }
  }
