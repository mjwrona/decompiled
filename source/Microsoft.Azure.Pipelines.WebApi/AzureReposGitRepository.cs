...
// Type: Microsoft.Azure.Pipelines.WebApi.AzureReposGitRepository
...
{
  [DataContract]
  public class AzureReposGitRepository : Repository
  {
    public AzureReposGitRepository()
      : this((ISecuredObject) null)
    {
    }

    internal AzureReposGitRepository(ISecuredObject securedObject)
      : base(securedObject, RepositoryType.AzureReposGit)
    {
    }
