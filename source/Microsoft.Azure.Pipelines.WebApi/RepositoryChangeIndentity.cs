...
// Type: Microsoft.Azure.Pipelines.WebApi.RepositoryChangeIndentity
...
{
  [DataContract]
  public class RepositoryChangeIndentity : BaseSecuredObject
  {
    [JsonConstructor]
    public RepositoryChangeIndentity()
    {
    }

    internal RepositoryChangeIndentity(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
