...
// Type: Microsoft.Azure.Pipelines.WebApi.RunReference
...
{
  [DataContract]
  public class RunReference : BaseSecuredObject
  {
    [JsonConstructor]
    protected RunReference()
    {
    }

    internal RunReference(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
