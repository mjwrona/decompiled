...
// Type: Microsoft.Azure.Pipelines.WebApi.ContainerResource
...
{
  [DataContract]
  public sealed class ContainerResource : BaseSecuredObject
  {
    [JsonConstructor]
    ...
    internal ContainerResource(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
