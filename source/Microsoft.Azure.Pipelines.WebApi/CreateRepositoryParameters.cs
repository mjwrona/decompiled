...
// Type: Microsoft.Azure.Pipelines.WebApi.CreateRepositoryParameters
...
{
  [DataContract]
  [KnownType(typeof (CreateAzureReposGitRepositoryParameters))]
  [KnownType(typeof (CreateGitHubRepositoryParameters))]
  [JsonConverter(typeof (CreateRepositoryParametersJsonConverter))]
  public class CreateRepositoryParameters
  {
    protected CreateRepositoryParameters(RepositoryType type) => this.Type = type;
