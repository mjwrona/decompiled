...
// Type: Microsoft.Azure.Pipelines.WebApi.PipelineNotFoundException
...
{
  [Serializable]
  public class PipelineNotFoundException : VssServiceException
  {
    ...
    public PipelineNotFoundException(string message, Exception ex)
      : base(message, ex)
    {
    }

    protected PipelineNotFoundException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
