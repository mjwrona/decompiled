...
// Type: Microsoft.Azure.Pipelines.WebApi.RunNotFoundException
...
{
  [Serializable]
  public class RunNotFoundException : VssServiceException
  {
    ...
    public RunNotFoundException(string message, Exception ex)
      : base(message, ex)
    {
    }

    protected RunNotFoundException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
