...
// Type: Microsoft.Azure.Pipelines.WebApi.ServiceConnection
...
{
  [DataContract]
  public class ServiceConnection : BaseSecuredObject
  {
    ...
    internal ServiceConnection(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
