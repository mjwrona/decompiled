...
// Type: Microsoft.Azure.Pipelines.WebApi.BuildResourceParameters
...
{
  [DataContract]
  public class BuildResourceParameters : BaseSecuredObject
  {
    [JsonConstructor]
    ...
    internal BuildResourceParameters(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
