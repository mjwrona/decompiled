...
// Type: Microsoft.Azure.Pipelines.WebApi.UnknownCreateRepositoryParameters
...
{
  public class UnknownCreateRepositoryParameters : CreateRepositoryParameters
  {
    public UnknownCreateRepositoryParameters(RepositoryType type)
      : base(type)
    {
    }
  }
