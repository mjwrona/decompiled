...
// Type: Microsoft.Azure.Pipelines.WebApi.PipelineBase
...
{
  [DataContract]
  public abstract class PipelineBase : BaseSecuredObject
  {
    internal PipelineBase(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
