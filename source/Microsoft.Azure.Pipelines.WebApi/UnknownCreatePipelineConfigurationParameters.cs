...
// Type: Microsoft.Azure.Pipelines.WebApi.UnknownCreatePipelineConfigurationParameters
...
{
  public class UnknownCreatePipelineConfigurationParameters : CreatePipelineConfigurationParameters
  {
    public UnknownCreatePipelineConfigurationParameters(ConfigurationType type)
      : base(type)
    {
    }
  }
