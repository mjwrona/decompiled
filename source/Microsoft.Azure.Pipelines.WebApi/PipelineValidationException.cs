...
// Type: Microsoft.Azure.Pipelines.WebApi.PipelineValidationException
...
{
  [Serializable]
  public class PipelineValidationException : VssServiceException
  {
    ...
    public PipelineValidationException(string message, Exception ex)
      : base(message, ex)
    {
    }
