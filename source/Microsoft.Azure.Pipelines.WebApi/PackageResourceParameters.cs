...
// Type: Microsoft.Azure.Pipelines.WebApi.PackageResourceParameters
...
{
  [DataContract]
  public class PackageResourceParameters : BaseSecuredObject
  {
    [JsonConstructor]
    ...
    internal PackageResourceParameters(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
