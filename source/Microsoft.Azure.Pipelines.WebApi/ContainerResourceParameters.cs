...
// Type: Microsoft.Azure.Pipelines.WebApi.ContainerResourceParameters
...
{
  [DataContract]
  public class ContainerResourceParameters : BaseSecuredObject
  {
    [JsonConstructor]
    public ContainerResourceParameters()
    {
    }

    internal ContainerResourceParameters(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
