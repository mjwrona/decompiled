...
// Type: Microsoft.Azure.Pipelines.WebApi.LogNotFoundException
...
{
  [Serializable]
  public class LogNotFoundException : VssServiceException
  {
    ...
    public LogNotFoundException(string message, Exception ex)
      : base(message, ex)
    {
    }
