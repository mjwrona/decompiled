...
// Type: Microsoft.Azure.Pipelines.WebApi.RepositoryResourceParameters
...
{
  [DataContract]
  public class RepositoryResourceParameters : BaseSecuredObject
  {
    [JsonConstructor]
    ...
    internal RepositoryResourceParameters(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
