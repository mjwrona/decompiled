...
// Type: Microsoft.Azure.Pipelines.WebApi.CreatePipelineConfigurationParameters
...
{
  [DataContract]
  [KnownType(typeof (CreateYamlPipelineConfigurationParameters))]
  [JsonConverter(typeof (CreatePipelineConfigurationParametersJsonConverter))]
  public class CreatePipelineConfigurationParameters
  {
    protected CreatePipelineConfigurationParameters(ConfigurationType type) => this.Type = type;
