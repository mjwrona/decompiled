...
// Type: Microsoft.Azure.Pipelines.WebApi.PipelineResourceParameters
...
{
  [DataContract]
  public class PipelineResourceParameters : BaseSecuredObject
  {
    [JsonConstructor]
    ...
    internal PipelineResourceParameters(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
