...
// Type: Microsoft.Azure.Pipelines.WebApi.RepositoryType
...
namespace Microsoft.Azure.Pipelines.WebApi
{
  ...
  public enum RepositoryType
  {
    ...
    GitHub = 1,
    AzureReposGit = 2,
    [EditorBrowsable(EditorBrowsableState.Never), EnumMember(Value = "azure-repos-git")] AzureReposGitHyphenated = 2,
    GitHubEnterprise = 3,
  }
}
