...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManagerAPI.IAction
...
namespace Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManagerAPI
{
  public interface IAction
  {
    ...
    bool IsCompleted(IVssRequestContext requestContext);

    void Invoke(IVssRequestContext requestContext, out string resultMessage);
  }
}
