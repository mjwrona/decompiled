...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManagerAPI.AbstractDataProviderFactory
...
namespace Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManagerAPI
{
  ...
  {
    public abstract List<IDataProvider> GetDataProviders(HashSet<DataType> dataTypes);

    public abstract IDataProvider GetDataProvider(DataType dataType);
  }
}
