...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManagerAPI.DataType
...
namespace Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManagerAPI
{
  ...
  {
    CollectionIndexingUnitData,
    ProjectIndexingUnitData,
    RepoIndexingUnitData,
    ESTermQuerydata,
    IndexingUnitChangeEventsData,
    FailedFilesCountData,
    JobQueueData,
    ReindexingStatusData,
    IndexingUnitChangeEventStateData,
    ShardSizeData,
    SearchIndexDocumentCountData,
    ScopedIndexingUnitData,
    GitRepoBranchLevelDocCount,
  }
}
