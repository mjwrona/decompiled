...
// Type: Microsoft.Azure.Cosmos.Scripts.StoredProcedureExecuteResponse`1
...
namespace Microsoft.Azure.Cosmos.Scripts
{
  public class StoredProcedureExecuteResponse<T> : Response<T>
  {
    ...
    public virtual string ScriptLog
    {
      get
      {
        string headerValue = this.Headers?.GetHeaderValue<string>("x-ms-documentdb-script-log-results");
