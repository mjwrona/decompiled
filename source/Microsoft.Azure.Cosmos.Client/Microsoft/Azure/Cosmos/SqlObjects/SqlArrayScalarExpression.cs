...
// Type: Microsoft.Azure.Cosmos.SqlObjects.SqlArrayScalarExpression
...
namespace Microsoft.Azure.Cosmos.SqlObjects
{
  internal sealed class SqlArrayScalarExpression : SqlScalarExpression
  {
    ...
    private SqlArrayScalarExpression(SqlQuery sqlQuery) => this.SqlQuery = sqlQuery ?? throw new ArgumentNullException(nameof (sqlQuery));
