...
// Type: Microsoft.Azure.Cosmos.SqlObjects.SqlExistsScalarExpression
...
namespace Microsoft.Azure.Cosmos.SqlObjects
{
  ...
  {
    private SqlExistsScalarExpression(SqlQuery subquery) => this.Subquery = subquery ?? throw new ArgumentNullException(nameof (subquery));
