...
// Type: Microsoft.Azure.Cosmos.ChangeFeed.FeedManagement.PartitionSynchronizer
...
namespace Microsoft.Azure.Cosmos.ChangeFeed.FeedManagement
{
  internal abstract class PartitionSynchronizer
  {
    ...
    public abstract Task<(IEnumerable<DocumentServiceLease>, bool)> HandlePartitionGoneAsync(
