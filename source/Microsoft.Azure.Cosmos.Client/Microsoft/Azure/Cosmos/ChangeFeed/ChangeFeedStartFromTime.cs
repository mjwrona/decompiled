...
// Type: Microsoft.Azure.Cosmos.ChangeFeed.ChangeFeedStartFromTime
...
namespace Microsoft.Azure.Cosmos.ChangeFeed
{
  internal sealed class ChangeFeedStartFromTime : ChangeFeedStartFrom
  {
    ...
    {
      this.StartTime = time.Kind == DateTimeKind.Utc ? time : throw new ArgumentOutOfRangeException("time.Kind must be DateTimeKind.Utc");
    }
