...
// Type: Microsoft.Azure.Cosmos.ChangeFeed.LeaseManagement.DocumentServiceLeaseManager
...
namespace Microsoft.Azure.Cosmos.ChangeFeed.LeaseManagement
{
  ...
  {
    public abstract Task<DocumentServiceLease> CreateLeaseIfNotExistAsync(
    ...
    public abstract Task<DocumentServiceLease> UpdatePropertiesAsync(
      DocumentServiceLease leaseToUpdatePropertiesFrom);
  }
}
