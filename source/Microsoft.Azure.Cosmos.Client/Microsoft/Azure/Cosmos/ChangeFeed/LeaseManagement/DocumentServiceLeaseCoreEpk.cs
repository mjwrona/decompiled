...
// Type: Microsoft.Azure.Cosmos.ChangeFeed.LeaseManagement.DocumentServiceLeaseCoreEpk
...
namespace Microsoft.Azure.Cosmos.ChangeFeed.LeaseManagement
{
  ...
  internal sealed class DocumentServiceLeaseCoreEpk : DocumentServiceLease
  {
    ...
    {
      get => this.ExplicitTimestamp ?? DocumentServiceLeaseCoreEpk.UnixStartTime.AddSeconds((double) this.TS);
    ...
    public override string ToString()
    {
      ...
      DateTime dateTime = DocumentServiceLeaseCoreEpk.UnixStartTime;
