...
// Type: Microsoft.Azure.Cosmos.Number64
...
namespace Microsoft.Azure.Cosmos
{
  ...
  internal readonly struct Number64 : IComparable<Number64>, IEquatable<Number64>
  {
    ...
    public static Number64.DoubleEx ToDoubleEx(Number64 number64) => !number64.IsDouble ? (Number64.DoubleEx) number64.longValue.Value : (Number64.DoubleEx) number64.doubleValue.Value;
    ...
    public override int GetHashCode() => Number64.ToDoubleEx(this).GetHashCode();

    [StructLayout(LayoutKind.Sequential, Pack = 2)]
    public readonly struct DoubleEx : IEquatable<Number64.DoubleEx>, IComparable<Number64.DoubleEx>
    {
      ...
      public override int GetHashCode() => 0 ^ BitConverter.DoubleToInt64Bits(this.DoubleValue).GetHashCode() ^ this.ExtraBits.GetHashCode();
