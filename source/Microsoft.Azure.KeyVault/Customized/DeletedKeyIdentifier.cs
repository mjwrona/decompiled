...
// Type: Microsoft.Azure.KeyVault.DeletedKeyIdentifier
...
namespace Microsoft.Azure.KeyVault
{
  ...
  {
    public static bool IsDeletedKeyIdentifier(string identifier) => ObjectIdentifier.IsObjectIdentifier("deletedkeys", identifier);
