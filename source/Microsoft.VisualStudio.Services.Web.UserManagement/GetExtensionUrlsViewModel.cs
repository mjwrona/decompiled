...
// Type: Microsoft.VisualStudio.Services.Web.UserManagement.GetExtensionUrlsViewModel
...
{
  public class GetExtensionUrlsViewModel
  {
    ...
    public string MarketPlaceUrlWithServerKey { get; set; }
  }
}
