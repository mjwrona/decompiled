...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.DeletedBoardRowIsNotEmptyException
...
{
  [Serializable]
  public class DeletedBoardRowIsNotEmptyException : VssServiceException
  {
    public DeletedBoardRowIsNotEmptyException()
    {
    }

    public DeletedBoardRowIsNotEmptyException(string message)
      : base(message)
    {
    }
  }
