...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.TeamDaysOutOfRangeException
...
{
  [Serializable]
  public class TeamDaysOutOfRangeException : VssServiceException
  {
    public TeamDaysOutOfRangeException(string message)
      : base(message)
    {
    }
  }
