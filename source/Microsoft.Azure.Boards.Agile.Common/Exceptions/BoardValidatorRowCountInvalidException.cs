...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.BoardValidatorRowCountInvalidException
...
{
  [Serializable]
  public class BoardValidatorRowCountInvalidException : BoardValidatorExceptionBase
  {
    public BoardValidatorRowCountInvalidException(string message)
      : base(message)
    {
    }
  }
