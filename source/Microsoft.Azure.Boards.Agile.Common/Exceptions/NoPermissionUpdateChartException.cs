...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.NoPermissionUpdateChartException
...
{
  [Serializable]
  public class NoPermissionUpdateChartException : VssServiceException
  {
    public NoPermissionUpdateChartException(string message)
      : base(message)
    {
    }
  }
