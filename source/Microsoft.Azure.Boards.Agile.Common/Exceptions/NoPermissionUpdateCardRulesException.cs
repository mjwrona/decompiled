...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.NoPermissionUpdateCardRulesException
...
{
  [Serializable]
  public class NoPermissionUpdateCardRulesException : VssServiceException
  {
    public NoPermissionUpdateCardRulesException(string message)
      : base(message)
    {
    }
  }
