...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.NoPermissionUpdateCardSettingsException
...
{
  [Serializable]
  public class NoPermissionUpdateCardSettingsException : VssServiceException
  {
    public NoPermissionUpdateCardSettingsException(string message)
      : base(message)
    {
    }
  }
