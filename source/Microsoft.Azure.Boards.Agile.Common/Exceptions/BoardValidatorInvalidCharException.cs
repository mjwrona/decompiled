...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.BoardValidatorInvalidCharException
...
{
  [Serializable]
  public class BoardValidatorInvalidCharException : BoardValidatorExceptionBase
  {
    public BoardValidatorInvalidCharException(string message)
      : base(message)
    {
    }

    public BoardValidatorInvalidCharException(string message, string inputWithError)
