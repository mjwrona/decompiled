...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.FilterSettingsUpdateFailureException
...
{
  [Serializable]
  public class FilterSettingsUpdateFailureException : VssServiceException
  {
    public FilterSettingsUpdateFailureException(string message)
      : base(message)
    {
    }
  }
