...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.BoardUserSettingsUpdateFailureException
...
{
  [Serializable]
  public class BoardUserSettingsUpdateFailureException : VssServiceException
  {
    public BoardUserSettingsUpdateFailureException(string message)
    {
    }
  }
}
