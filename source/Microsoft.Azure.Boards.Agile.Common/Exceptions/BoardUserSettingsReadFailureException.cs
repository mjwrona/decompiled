...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.BoardUserSettingsReadFailureException
...
{
  [Serializable]
  public class BoardUserSettingsReadFailureException : VssServiceException
  {
    public BoardUserSettingsReadFailureException(string message)
    {
    }
  }
}
