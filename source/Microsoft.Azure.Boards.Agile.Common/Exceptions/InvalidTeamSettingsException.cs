...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.InvalidTeamSettingsException
...
{
  [Serializable]
  public class InvalidTeamSettingsException : VssServiceException
  {
    public InvalidTeamSettingsException(string message)
      : base(message)
    {
    }
  }
