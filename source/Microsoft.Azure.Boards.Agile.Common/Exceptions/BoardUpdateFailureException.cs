...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.BoardUpdateFailureException
...
{
  [Serializable]
  public class BoardUpdateFailureException : VssServiceException
  {
    public BoardUpdateFailureException(Exception ex)
      : base(ex.Message, ex)
    {
    }
  }
