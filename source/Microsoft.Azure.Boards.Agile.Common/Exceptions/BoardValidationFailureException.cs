...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.BoardValidationFailureException
...
{
  [Serializable]
  public class BoardValidationFailureException : VssServiceException
  {
    public BoardValidationFailureException(string message)
      : base(message)
    {
    }
  }
