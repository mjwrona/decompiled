...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.CardSettingsUpdateFailureException
...
{
  [Serializable]
  public class CardSettingsUpdateFailureException : VssServiceException
  {
    public CardSettingsUpdateFailureException(string message)
      : base(message)
    {
    }
  }
