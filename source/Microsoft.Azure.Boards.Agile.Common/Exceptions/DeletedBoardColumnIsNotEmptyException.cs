...
// Type: Microsoft.Azure.Boards.Agile.Common.Exceptions.DeletedBoardColumnIsNotEmptyException
...
{
  [Serializable]
  public class DeletedBoardColumnIsNotEmptyException : VssServiceException
  {
    public DeletedBoardColumnIsNotEmptyException()
    {
    }

    public DeletedBoardColumnIsNotEmptyException(string message)
      : base(message)
    {
    }
  }
