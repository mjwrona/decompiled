...
// Type: Microsoft.TeamFoundation.Git.Server.RepositoryDeletedNotification
...
{
  public class RepositoryDeletedNotification : GitNotification
  {
    internal RepositoryDeletedNotification(
