...
// Type: Microsoft.TeamFoundation.Git.Server.GitImportRequest
...
namespace Microsoft.TeamFoundation.Git.Server
{
  public class GitImportRequest : 
    GitAsyncOperation<InternalGitImportRequestParameters, GitImportStatusDetail>
  {
    public GitImportRequest()
    {
    }

    internal GitImportRequest(
      Guid repositoryId,
      int operationId,
