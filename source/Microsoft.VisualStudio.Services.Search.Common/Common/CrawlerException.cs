...
// Type: Microsoft.VisualStudio.Services.Search.Common.CrawlerException
...
{
  [Serializable]
  public class CrawlerException : SearchServiceException
  {
    ...
    public CrawlerException(SearchServiceErrorCode errorCode, string message)
