...
// Type: Microsoft.VisualStudio.Services.Search.Common.UnableToLoadParserException
...
{
  [Serializable]
  public class UnableToLoadParserException : SearchServiceException
  {
    public UnableToLoadParserException()
      : this(SearchServiceErrorCode.UnexpectedError, (string) null)
    {
    }

    public UnableToLoadParserException(string message)
      : base(message)
    {
    }

    public UnableToLoadParserException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public UnableToLoadParserException(SearchServiceErrorCode errorCode, string message)
    ...
    protected UnableToLoadParserException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.ErrorCode = (SearchServiceErrorCode) info.GetValue("ErrorCode", typeof (SearchServiceErrorCode));
    }

    protected override string DefaultMessage => ExceptionMessage.CrawlerException;
