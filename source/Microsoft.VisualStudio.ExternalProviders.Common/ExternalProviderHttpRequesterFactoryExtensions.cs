...
// Type: Microsoft.VisualStudio.ExternalProviders.Common.ExternalProviderHttpRequesterFactoryExtensions
...
namespace Microsoft.VisualStudio.ExternalProviders.Common
{
  ...
  {
    public static IExternalProviderHttpRequester GetRequester(
      this IExternalProviderHttpRequesterFactory factory)
    {
      return factory.GetRequester((HttpMessageHandler) new VssHttpMessageHandler());
    }
  }
}
