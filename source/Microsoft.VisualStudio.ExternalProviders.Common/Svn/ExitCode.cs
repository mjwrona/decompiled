...
// Type: Microsoft.VisualStudio.ExternalProviders.Common.Svn.ExitCode
...
namespace Microsoft.VisualStudio.ExternalProviders.Common.Svn
{
  internal enum ExitCode
  {
    ...
    Failure = 1,
    InvalidArguments = 2,
    SvnAuthenticationException = 3,
    SvnRepositoryIOException = 4,
    SvnSystemException = 5,
    SvnException = 6,
    UnknownError = 10, // 0x0000000A
  }
}
