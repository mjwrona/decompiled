...
// Type: Microsoft.Azure.DevOps.ServiceEndpoints.Server.AzureBoardsMarketplaceApp
...
{
  internal static class AzureBoardsMarketplaceApp
  {
    private const string PrimaryClientSecretKey = "GitHubAzureBoardsAppClientSecretPrimary";
    private const string SecondaryClientSecretKey = "GitHubAzureBoardsAppClientSecretSecondary";
    private const string DrawerName = "ConfigurationSecrets";
    private const string UsePrimarySecretKey = "/Configuration/GitHubAzureBoardsApp/UsePrimaryGitHubCredentials";

    public static AuthConfiguration Initialize(
      IVssRequestContext requestContext,
      bool secretsRequired = false)
    {
      if (!requestContext.IsFeatureEnabled("ServiceEndpoints.EnableAzureBoardsMarketplaceAppId"))
        return (AuthConfiguration) null;
      AuthConfiguration authConfiguration1 = new AuthConfiguration();
      authConfiguration1.Name = InternalAuthConfigurationConstants.AzureBoardsMarketplaceAppName;
      authConfiguration1.Id = InternalAuthConfigurationConstants.AzureBoardsMarketplaceAppId;
      ...
      try
      {
        ...
        int num = vssRequestContext1.GetService<CachedRegistryService>().GetValue<bool>(vssRequestContext1, (RegistryQuery) "/Configuration/GitHubAzureBoardsApp/UsePrimaryGitHubCredentials", true) ? 1 : 0;
        ...
        string lookupKey = num != 0 ? "GitHubAzureBoardsAppClientSecretPrimary" : "GitHubAzureBoardsAppClientSecretSecondary";
      ...
      {
        throw new ApplicationException("This deployment is not properly configured with a registered GitHub account. " + ex.Message);
      }
