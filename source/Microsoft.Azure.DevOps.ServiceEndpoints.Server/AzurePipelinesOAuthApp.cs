...
// Type: Microsoft.Azure.DevOps.ServiceEndpoints.Server.AzurePipelinesOAuthApp
...
{
  internal static class AzurePipelinesOAuthApp
  {
    private const string DrawerName = "ConfigurationSecrets";
    private const string UsePrimarySecretKey = "/Configuration/GitHub/UsePrimaryGitHubCredentials";
    private const string PrimaryClientSecretKey = "GitHubClientSecretPrimary";
    private const string SecondaryClientSecretKey = "GitHubClientSecretSecondary";
      ...
      bool secretsRequired = false)
    {
      ...
      authConfiguration1.Id = InternalAuthConfigurationConstants.AzurePipelinesOAuthAppId;
      authConfiguration1.Url = InternalAuthConfigurationConstants.GitHubUri;
      authConfiguration1.Name = InternalAuthConfigurationConstants.AzurePipelinesOAuthAppName;
      ...
      try
      {
        ...
        int num = vssRequestContext1.GetService<ICachedRegistryService>().GetValue<bool>(vssRequestContext1, (RegistryQuery) "/Configuration/GitHub/UsePrimaryGitHubCredentials", true) ? 1 : 0;
        ...
        string lookupKey = num != 0 ? "GitHubClientSecretPrimary" : "GitHubClientSecretSecondary";
