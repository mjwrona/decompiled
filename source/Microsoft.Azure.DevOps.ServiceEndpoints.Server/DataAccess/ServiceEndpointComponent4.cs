...
// Type: Microsoft.Azure.DevOps.ServiceEndpoints.Server.DataAccess.ServiceEndpointComponent4
...
{
  internal class ServiceEndpointComponent4 : ServiceEndpointComponent3
  {
    public ServiceEndpointComponent4() => this.SelectedFeatures |= SqlResourceComponentFeatures.BindPartitionIdByDefault;
      ...
      bool includeFailed)
    {
      using (new ServiceEndpointsSqlComponentBase.SqlMethodScope((ServiceEndpointsSqlComponentBase) this, nameof (GetServiceEndpoints)))
      {
        ...
        this.BindGuidTable("@endpointIdsTable", endpointIds == null ? (IEnumerable<Guid>) null : endpointIds.Distinct<Guid>());
    ...
    {
      this.AddServiceEndpoint(scopeId, serviceEndpoint, disallowDuplicateEndpointName);
    }
  }
}
