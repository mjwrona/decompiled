...
// Type: Microsoft.Azure.DevOps.ServiceEndpoints.Server.BitbucketOAuthApp
...
{
  internal static class BitbucketOAuthApp
  {
    private static readonly string SecretLookupKey = BitbucketConstants.StrongBox.PrimaryVstsRegistrationLookupKey;
      ...
      bool secretsRequired = false)
    {
      ...
      authConfiguration1.Id = InternalAuthConfigurationConstants.BitbucketVstsAppId;
      authConfiguration1.Url = InternalAuthConfigurationConstants.BitbucketUri;
      authConfiguration1.Name = InternalAuthConfigurationConstants.BitbucketVstsAppName;
      ...
      try
      {
        ...
        StrongBoxItemInfo itemInfo = vssRequestContext.GetService<ITeamFoundationStrongBoxService>().GetItemInfo(vssRequestContext, "ConfigurationSecrets", BitbucketOAuthApp.SecretLookupKey, true);
