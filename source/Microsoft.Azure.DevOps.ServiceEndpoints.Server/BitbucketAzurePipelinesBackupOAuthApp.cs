...
// Type: Microsoft.Azure.DevOps.ServiceEndpoints.Server.BitbucketAzurePipelinesBackupOAuthApp
...
{
  internal static class BitbucketAzurePipelinesBackupOAuthApp
  {
    private static readonly string SecretLookupKey = BitbucketConstants.StrongBox.BackupAzurePipelinesRegistrationLookupKey;
      ...
      bool secretsRequired = false)
    {
      ...
      authConfiguration1.Id = InternalAuthConfigurationConstants.BitbucketAzurePipelinesBackupOAuthAppId;
      authConfiguration1.Url = InternalAuthConfigurationConstants.BitbucketUri;
      authConfiguration1.Name = InternalAuthConfigurationConstants.BitbucketAzurePipelinesBackupOAuthAppName;
      ...
      try
      {
        ...
        StrongBoxItemInfo itemInfo = vssRequestContext.GetService<ITeamFoundationStrongBoxService>().GetItemInfo(vssRequestContext, "ConfigurationSecrets", BitbucketAzurePipelinesBackupOAuthApp.SecretLookupKey, true);
