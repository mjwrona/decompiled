...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManager.Data.ReindexingStatusContextBuilder
...
{
  public class ReindexingStatusContextBuilder : IProviderContextBuilder
  {
    ...
    {
      ReindexingStatusContext reindexingStatusContext = new ReindexingStatusContext();
      reindexingStatusContext.RequestContext = requestContext;
      reindexingStatusContext.DeploymentRequestContext = requestContext.To(TeamFoundationHostType.Deployment);
      reindexingStatusContext.EntityType = healthInputData.EntityType;
      return (ProviderContext) reindexingStatusContext;
    }
  }
}
