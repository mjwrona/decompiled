...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManager.Data.FailedFilesContextBuilder
...
{
  public class FailedFilesContextBuilder : IProviderContextBuilder
  {
    ...
    {
      FailedFilesContext failedFilesContext = new FailedFilesContext();
      failedFilesContext.RequestContext = requestContext;
      return (ProviderContext) failedFilesContext;
    }
  }
}
