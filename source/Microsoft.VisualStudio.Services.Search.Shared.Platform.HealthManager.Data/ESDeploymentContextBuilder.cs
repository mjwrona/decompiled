...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.HealthManager.Data.ESDeploymentContextBuilder
...
{
  public class ESDeploymentContextBuilder : IProviderContextBuilder
  {
    ...
    {
      return (ProviderContext) new ESDeploymentContext()
      {
        SearchPlatformConnectionString = requestContext.GetConfigValue("/Service/ALMSearch/Settings/JobAgentSearchPlatformConnectionString"),
        SearchPlatformSettings = requestContext.GetElasticsearchPlatformSettings("/Service/ALMSearch/Settings/JobAgentSearchPlatformSettings"),
        EntityType = healthInputData.EntityType,
        Indices = (IEnumerable<string>) healthInputData.Indices
      };
    }
  }
}
