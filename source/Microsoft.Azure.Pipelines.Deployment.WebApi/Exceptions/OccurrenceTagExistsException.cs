...
// Type: Microsoft.Azure.Pipelines.Deployment.WebApi.Exceptions.OccurrenceTagExistsException
...
namespace Microsoft.Azure.Pipelines.Deployment.WebApi.Exceptions
{
  ...
  [Serializable]
  public class OccurrenceTagExistsException : ArtifactMetadataException
  {
    public OccurrenceTagExistsException(string message)
      : base(message)
    {
    }

    public OccurrenceTagExistsException(string message, Exception innerException)
