...
// Type: Microsoft.Azure.Pipelines.Deployment.WebApi.Exceptions.NoteExistsException
...
namespace Microsoft.Azure.Pipelines.Deployment.WebApi.Exceptions
{
  ...
  [Serializable]
  public class NoteExistsException : ArtifactMetadataException
  {
    ...
    public NoteExistsException(string message, Exception innerException)
