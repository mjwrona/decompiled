...
// Type: Microsoft.Azure.Pipelines.Deployment.WebApi.Exceptions.ArtifactMetadataException
...
namespace Microsoft.Azure.Pipelines.Deployment.WebApi.Exceptions
{
  ...
  [Serializable]
  public class ArtifactMetadataException : DeploymentException
  {
    ...
    public ArtifactMetadataException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected ArtifactMetadataException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
