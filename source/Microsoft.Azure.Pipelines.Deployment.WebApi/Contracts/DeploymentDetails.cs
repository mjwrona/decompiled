...
// Type: Microsoft.Azure.Pipelines.Deployment.WebApi.Contracts.DeploymentDetails
...
{
  [DataContract]
  public class DeploymentDetails : BaseMetadataDetails
  {
    ...
    [DataMember(EmitDefaultValue = false)]
    public PipelineRunInfo PipelineRunInfo { get; set; }
  }
}
