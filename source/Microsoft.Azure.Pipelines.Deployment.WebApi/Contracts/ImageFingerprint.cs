...
// Type: Microsoft.Azure.Pipelines.Deployment.WebApi.Contracts.ImageFingerprint
...
namespace Microsoft.Azure.Pipelines.Deployment.WebApi.Contracts
{
  ...
  public class ImageFingerprint
  {
    ...
    [DataMember(Name = "v2Blobs", EmitDefaultValue = false)]
    public List<string> V2Blobs { get; set; }
