...
// Type: Microsoft.Azure.Boards.RecentActivity.InvalidRecentActivityException
...
{
  [Serializable]
  public class InvalidRecentActivityException : TeamFoundationServiceException
  {
    public InvalidRecentActivityException()
      : base(Resources.InvalidActivity())
    {
    }
  }
}
