...
// Type: Microsoft.Azure.Boards.RecentActivity.RecentActivityProviderNotFoundException
...
{
  [Serializable]
  public class RecentActivityProviderNotFoundException : TeamFoundationServiceException
  {
    public RecentActivityProviderNotFoundException(Guid artifactKind, string allProviders)
      : base(Resources.CouldNotFindArtifactProvider((object) artifactKind, (object) allProviders))
    {
    }
  }
}
