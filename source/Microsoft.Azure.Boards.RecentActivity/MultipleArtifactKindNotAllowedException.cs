...
// Type: Microsoft.Azure.Boards.RecentActivity.MultipleArtifactKindNotAllowedException
...
{
  [Serializable]
  public class MultipleArtifactKindNotAllowedException : TeamFoundationServiceException
  {
    public MultipleArtifactKindNotAllowedException()
      : base(Resources.AllActivitiesShouldBeOfSameKind())
    {
    }
  }
}
