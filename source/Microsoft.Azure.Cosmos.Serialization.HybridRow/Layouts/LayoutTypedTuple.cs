...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutTypedTuple
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutTypedTuple : LayoutIndexedScope
  {
    internal LayoutTypedTuple(bool immutable)
      : base(immutable ? LayoutCode.ImmutableTypedTupleScope : LayoutCode.TypedTupleScope, immutable, true, true, false, true)
    {
    }

    public override string Name => !this.Immutable ? "tuple_t" : "im_tuple_t";
