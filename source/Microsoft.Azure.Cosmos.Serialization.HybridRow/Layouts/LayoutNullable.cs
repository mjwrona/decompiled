...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutNullable
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutNullable : LayoutIndexedScope
  {
    internal LayoutNullable(bool immutable)
      : base(immutable ? LayoutCode.ImmutableNullableScope : LayoutCode.NullableScope, immutable, true, true, false, true)
    {
    }

    public override string Name => !this.Immutable ? "nullable" : "im_nullable";
      ...
      UpdateOptions options = UpdateOptions.Upsert)
    {
      ...
      b.WriteNullable(ref edit, (LayoutScope) this, typeArgs, options, hasValue, out value);
    ...
    public override Result WriteScope(
      ...
      UpdateOptions options = UpdateOptions.Upsert)
    {
      return this.WriteScope(ref b, ref edit, typeArgs, true, out value, options);
    }

    public static Result HasValue(ref RowBuffer b, ref RowCursor scope)
    {
      Contract.Requires(scope.scopeType is LayoutNullable);
      return b.ReadInt8(scope.start) == (sbyte) 0 ? Result.NotFound : Result.Success;
    }
