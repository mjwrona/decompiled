...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutTypedArray
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutTypedArray : LayoutIndexedScope
  {
    internal LayoutTypedArray(bool immutable)
      : base(immutable ? LayoutCode.ImmutableTypedArrayScope : LayoutCode.TypedArrayScope, immutable, true, false, false, true)
    {
    }

    public override string Name => !this.Immutable ? "array_t" : "im_array_t";
      ...
      UpdateOptions options = UpdateOptions.Upsert)
    {
      ...
      b.WriteTypedArray(ref edit, (LayoutScope) this, typeArgs, options, out value);
