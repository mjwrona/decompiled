...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutFloat32
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutFloat32 : LayoutType<float>
  {
      ...
      float value)
    {
      ...
      b.WriteFloat32(checked (scope.start + col.Offset), value);
      ...
      out float value)
    {
      ...
      value = b.ReadFloat32(checked (scope.start + col.Offset));
      return Result.Success;
    }
