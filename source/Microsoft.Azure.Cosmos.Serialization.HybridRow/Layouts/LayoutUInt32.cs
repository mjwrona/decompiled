...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutUInt32
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutUInt32 : LayoutType<uint>
  {
      ...
      uint value)
    {
      ...
      b.WriteUInt32(checked (scope.start + col.Offset), value);
      ...
      out uint value)
    {
      ...
      value = b.ReadUInt32(checked (scope.start + col.Offset));
      return Result.Success;
    }
