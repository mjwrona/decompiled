...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutInt32
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutInt32 : LayoutType<int>
  {
      ...
      int value)
    {
      ...
      b.WriteInt32(checked (scope.start + col.Offset), value);
      ...
      out int value)
    {
      ...
      value = b.ReadInt32(checked (scope.start + col.Offset));
      return Result.Success;
    }
