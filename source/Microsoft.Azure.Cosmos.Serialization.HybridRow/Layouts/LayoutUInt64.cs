...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutUInt64
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutUInt64 : LayoutType<ulong>
  {
      ...
      ulong value)
    {
      ...
      b.WriteUInt64(checked (scope.start + col.Offset), value);
      ...
      out ulong value)
    {
      ...
      value = b.ReadUInt64(checked (scope.start + col.Offset));
      return Result.Success;
    }
