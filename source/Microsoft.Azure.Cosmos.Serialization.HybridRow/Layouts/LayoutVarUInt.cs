...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutVarUInt
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutVarUInt : LayoutType<ulong>
  {
      ...
      ulong value)
    {
      ...
      int shift;
      b.WriteVariableUInt(variableValueOffset, value, exists, out shift);
      ...
      out ulong value)
    {
      ...
      int variableValueOffset = b.ComputeVariableValueOffset(scope.layout, scope.start, col.Offset);
      value = b.ReadVariableUInt(variableValueOffset);
      return Result.Success;
    }
