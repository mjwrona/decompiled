...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts.LayoutUInt16
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Layouts
{
  public sealed class LayoutUInt16 : LayoutType<ushort>
  {
      ...
      ushort value)
    {
      ...
      b.WriteUInt16(checked (scope.start + col.Offset), value);
      ...
      out ushort value)
    {
      ...
      value = b.ReadUInt16(checked (scope.start + col.Offset));
      return Result.Success;
    }
