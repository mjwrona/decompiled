...
// Type: Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas.TypedTupleHybridRowSerializer`6
...
namespace Microsoft.Azure.Cosmos.Serialization.HybridRow.Schemas
{
  ...
  public struct TypedTupleHybridRowSerializer<T1, T1Serializer, T2, T2Serializer, T3, T3Serializer> : 
  ...
  {
    public IEqualityComparer<(T1 Item1, T2 Item2, T3 Item3)> Comparer => (IEqualityComparer<(T1, T2, T3)>) TypedTupleHybridRowSerializer<T1, T1Serializer, T2, T2Serializer, T3, T3Serializer>.TypedTupleComparer.Default;
    ...
    {
      public static readonly TypedTupleHybridRowSerializer<T1, T1Serializer, T2, T2Serializer, T3, T3Serializer>.TypedTupleComparer Default = new TypedTupleHybridRowSerializer<T1, T1Serializer, T2, T2Serializer, T3, T3Serializer>.TypedTupleComparer();

      public override bool Equals(
        (T1 Item1, T2 Item2, T3 Item3) x,
        (T1 Item1, T2 Item2, T3 Item3) y)
      {
        return default (T1Serializer).Comparer.Equals(x.Item1, y.Item1) && default (T2Serializer).Comparer.Equals(x.Item2, y.Item2) && default (T3Serializer).Comparer.Equals(x.Item3, y.Item3);
      }
