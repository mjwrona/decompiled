...
// Type: Microsoft.VisualStudio.Services.Tcm.LegacyRuns5Controller
...
namespace Microsoft.VisualStudio.Services.Tcm
{
  ...
  public class LegacyRuns5Controller : TcmControllerBase
  {
    ...
    public IList<Microsoft.TeamFoundation.TestManagement.WebApi.TestRun> GetTestRunsByQuery(
      ...
      [FromUri(Name = "$top")] int top = 2147483647)
    {
      return (IList<Microsoft.TeamFoundation.TestManagement.WebApi.TestRun>) this.RunsHelper.GetTestRunsByQuery(this.ProjectId.ToString(), query, includeIdsOnly, includeRunDetails, skip, top);
    }
