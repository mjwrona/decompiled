...
// Type: Microsoft.TeamFoundation.VersionControl.Common.LabelUri
...
namespace Microsoft.TeamFoundation.VersionControl.Common
{
  public class LabelUri : VersionControlIntegrationUri
  {
    public LabelUri(string teamFoundationServerUrl, int labelId)
      : base(teamFoundationServerUrl, ArtifactType.Label, labelId.ToString((IFormatProvider) CultureInfo.InvariantCulture))
    {
    }

    public LabelUri(TfsTeamProjectCollection teamProjectCollection, int labelId)
      : base(teamProjectCollection, ArtifactType.Label, labelId.ToString((IFormatProvider) CultureInfo.InvariantCulture))
    {
    }
  }
}
