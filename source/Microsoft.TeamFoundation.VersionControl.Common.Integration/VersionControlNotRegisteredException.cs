...
// Type: Microsoft.TeamFoundation.VersionControl.Common.VersionControlNotRegisteredException
...
{
  [Serializable]
  public class VersionControlNotRegisteredException : TeamFoundationServerException
  {
    public VersionControlNotRegisteredException(string teamFoundationServerName)
      : base(VersionControlIntegrationResources.Format("VersionControlNotRegistered", (object) teamFoundationServerName))
    {
    }
  }
}
