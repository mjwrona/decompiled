...
// Type: Microsoft.Azure.Devops.Tags.Server.VersionedTagArtifact`1
...
{
  public class VersionedTagArtifact<T> : TagArtifact<T>
  {
    public VersionedTagArtifact(Guid dataspaceIdentifier, T artifactId, int version)
      : base(dataspaceIdentifier, artifactId)
    {
