...
// Type: Microsoft.Azure.Devops.Tags.Server.TagHistoryEntry`1
...
namespace Microsoft.Azure.Devops.Tags.Server
{
  ...
  public class TagHistoryEntry<T> : TagHistoryEntryBase<T, TagDefinition>
  {
    public TagHistoryEntry(
      VersionedTagArtifact<T> artifactVersion,
      IEnumerable<TagDefinition> tags,
      DateTime changedDate,
      Guid changedBy)
      : base(artifactVersion, tags, changedDate, changedBy)
    {
    }
  }
}
