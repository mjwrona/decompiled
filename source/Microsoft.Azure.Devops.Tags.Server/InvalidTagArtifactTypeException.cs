...
// Type: Microsoft.Azure.Devops.Tags.Server.InvalidTagArtifactTypeException
...
{
  [Serializable]
  public class InvalidTagArtifactTypeException : TeamFoundationServiceException
  {
    public InvalidTagArtifactTypeException(Type t)
      : base(t.ToString())
    {
    }
  }
