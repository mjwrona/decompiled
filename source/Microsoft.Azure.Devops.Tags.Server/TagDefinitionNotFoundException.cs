...
// Type: Microsoft.Azure.Devops.Tags.Server.TagDefinitionNotFoundException
...
{
  [Serializable]
  public class TagDefinitionNotFoundException : TeamFoundationServiceException
  {
    ...
    public TagDefinitionNotFoundException(string name)
      : base(name)
    {
    }

    public TagDefinitionNotFoundException(Guid id)
      : base(id.ToString())
    {
    }
  }
