...
// Type: Microsoft.Azure.Devops.Tags.Server.ArtifactTagIds`1
...
namespace Microsoft.Azure.Devops.Tags.Server
{
  ...
  public class ArtifactTagIds<T> : ArtifactTagBase<T, Guid>
  {
    public ArtifactTagIds(VersionedTagArtifact<T> artifactId, IEnumerable<Guid> tagIds)
      : base(artifactId, tagIds)
    {
    }
  }
}
