...
// Type: Microsoft.Azure.Devops.Tags.Server.InvalidTagArtifactKindException
...
{
  [Serializable]
  public class InvalidTagArtifactKindException : TeamFoundationServiceException
  {
    public InvalidTagArtifactKindException()
      : base(string.Empty)
    {
    }

    public InvalidTagArtifactKindException(string name)
      : base(name)
    {
    }

    public InvalidTagArtifactKindException(Guid id)
      : base(id.ToString())
    {
    }
  }
