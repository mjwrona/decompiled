...
// Type: Microsoft.Azure.Devops.Tags.Server.Components.TaggingComponent10
...
{
  internal class TaggingComponent10 : TaggingComponent9
  {
    internal override void CleanUnusedTagDefinitions(DateTime cutoffTime, bool deleteUnusedTags)
    {
      this.PrepareStoredProcedure("prc_CleanUnusedTagDefinitions", 3600);
      this.BindDateTime("@cutoffTime", cutoffTime);
      this.BindBoolean("@deleteUnusedTags", deleteUnusedTags);
