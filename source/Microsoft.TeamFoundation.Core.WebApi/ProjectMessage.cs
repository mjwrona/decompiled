...
// Type: Microsoft.TeamFoundation.Core.WebApi.ProjectMessage
...
namespace Microsoft.TeamFoundation.Core.WebApi
{
  ...
  public class ProjectMessage
  {
    public ProjectMessage(
      ...
      bool shouldInvalidateSystemStore)
    {
      this.Project = project;
      this.ProjectChangeType = changeType;
      this.ShouldInvalidateSystemStore = shouldInvalidateSystemStore;
    }

    public ProjectMessage(ProjectInfo project, ProjectChangeType changeType)
      : this(project, changeType, false)
    {
    }
