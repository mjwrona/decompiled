...
// Type: Microsoft.TeamFoundation.Core.WebApi.TfsRequestContextItemsKeys
...
namespace Microsoft.TeamFoundation.Core.WebApi
{
  ...
  {
    public const string RequestTeam = "RequestTeam";
    public const string RequestProject = "RequestProject";
  }
}
