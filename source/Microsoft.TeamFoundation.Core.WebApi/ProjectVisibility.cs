...
// Type: Microsoft.TeamFoundation.Core.WebApi.ProjectVisibility
...
namespace Microsoft.TeamFoundation.Core.WebApi
{
  ...
  {
    [ClientInternalUseOnly(true)] Unchanged = -1, // 0xFFFFFFFF
    Private = 0,
    [ClientInternalUseOnly(false)] Organization = 1,
    [EditorBrowsable(EditorBrowsableState.Never)] Public = 2,
    [ClientInternalUseOnly(true)] SystemPrivate = 3,
  }
}
