...
// Type: Microsoft.TeamFoundation.Core.WebApi.ProjectHttpHeaders
...
{
  internal static class ProjectHttpHeaders
  {
    public const string BypassProjectPropertyCache = "X-TFS-BypassProjectPropertyCache";
  }
}
