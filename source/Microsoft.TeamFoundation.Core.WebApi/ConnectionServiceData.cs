...
// Type: Microsoft.TeamFoundation.Core.WebApi.ConnectionServiceData
...
namespace Microsoft.TeamFoundation.Core.WebApi
{
  ...
  {
    public const string ConnectedServiceMetaData = "ConnectedServiceMetaData";
    public const string EndPoint = "EndPoint";
    public const string CredentialsXml = "CredentialsXml";
    public const string AuthorizationSuffix = "-CredentialsXml";
    public const string ConnectedServiceType = "ConnectedService";
