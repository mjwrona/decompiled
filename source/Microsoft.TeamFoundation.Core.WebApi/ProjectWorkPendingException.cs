...
// Type: Microsoft.TeamFoundation.Core.WebApi.ProjectWorkPendingException
...
{
  [ExceptionMapping("0.0", "3.0", "ProjectWorkPendingException", "Microsoft.TeamFoundation.Core.WebApi.ProjectWorkPendingException, Microsoft.TeamFoundation.Core.WebApi, Version=14.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class ProjectWorkPendingException : ProjectException
  {
    public ProjectWorkPendingException(string projectName)
      : base(WebApiResources.CSS_PROJECT_WORK_PENDING((object) projectName))
    {
    }
