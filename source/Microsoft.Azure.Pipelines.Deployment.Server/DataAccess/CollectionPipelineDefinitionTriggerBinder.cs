...
// Type: Microsoft.Azure.Pipelines.Deployment.DataAccess.CollectionPipelineDefinitionTriggerBinder
...
{
  public class CollectionPipelineDefinitionTriggerBinder : PipelineDefinitionTriggerBinder
  {
    private PipelineTriggerSqlComponent m_sqlComponent;
    private SqlColumnBinder m_dataspaceId = new SqlColumnBinder("DataspaceId");

    public CollectionPipelineDefinitionTriggerBinder(PipelineTriggerSqlComponent component) => this.m_sqlComponent = component;
