...
// Type: Microsoft.Azure.Pipelines.Deployment.DataAccess.PipelineDefinitionTriggerBinder
...
{
  public class PipelineDefinitionTriggerBinder : ObjectBinder<PipelineDefinitionTrigger>
  {
    ...
    protected override PipelineDefinitionTrigger Bind()
    {
      ...
      if (definitionTrigger.TriggerType == PipelineTriggerType.PipelineCompletion)
      ...
      definitionTrigger.ArtifactDefinition = new ArtifactDefinitionReference()
      {
        ...
        Connection = this.m_ConnectionId.GetGuid((IDataReader) this.Reader, true)
      };
