...
// Type: Microsoft.VisualStudio.Services.PyPi.Server.Upstreams.LimitedPyPiMetadata
...
{
  public record LimitedPyPiMetadata(
    PyPiPackageIdentity Identity,
    string? RequiresPython,
    ImmutableArray<IUnstoredPyPiPackageFile> PackageFiles)
  ;
}
