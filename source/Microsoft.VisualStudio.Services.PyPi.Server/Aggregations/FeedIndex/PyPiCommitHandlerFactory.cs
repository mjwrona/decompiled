...
// Type: Microsoft.VisualStudio.Services.PyPi.Server.Aggregations.FeedIndex.PyPiCommitHandlerFactory
...
{
  public class PyPiCommitHandlerFactory : IFeedIndexCommitHandlerFactory
  {
    private readonly IVssRequestContext requestContext;

    public PyPiCommitHandlerFactory(IVssRequestContext requestContext) => this.requestContext = requestContext;
