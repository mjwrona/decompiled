...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Server.InvalidArtifactDataException
...
{
  [Serializable]
  public class InvalidArtifactDataException : Exception
  {
    public InvalidArtifactDataException()
    {
    }
