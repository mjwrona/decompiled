...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Server.Security.MachineGroupPermissions
...
{
  public static class MachineGroupPermissions
  {
    ...
    public const int AllPermissions = 59;
  }
}
