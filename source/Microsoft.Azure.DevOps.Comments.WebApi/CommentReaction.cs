...
// Type: Microsoft.Azure.DevOps.Comments.WebApi.CommentReaction
...
{
  [DataContract]
  public class CommentReaction : CommentResourceReference
  {
    public CommentReaction()
    {
    }

    public CommentReaction(ISecuredObject securedObject) => this.SetSecuredObject(securedObject);
