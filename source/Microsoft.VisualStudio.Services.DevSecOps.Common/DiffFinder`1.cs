...
// Type: Microsoft.VisualStudio.Services.DevSecOps.Common.DiffFinder`1
...
namespace Microsoft.VisualStudio.Services.DevSecOps.Common
{
  public abstract class DiffFinder<T> : IDisposable
  {
    ...
    private Microsoft.VisualStudio.Services.DevSecOps.Common.ContinueDifferencePredicate<T> m_predicate;
    ...
    {
      return this.Diff(original, modified, elementComparer, (Microsoft.VisualStudio.Services.DevSecOps.Common.ContinueDifferencePredicate<T>) null);
    }
    ...
    public IDiffChange[] Diff(
      ...
      IList<T> modified,
      IEqualityComparer<T> elementComparer,
      Microsoft.VisualStudio.Services.DevSecOps.Common.ContinueDifferencePredicate<T> predicate)
    {
    ...
    public static DiffFinder<T> LcsDiff => (DiffFinder<T>) new Microsoft.VisualStudio.Services.DevSecOps.Common.LcsDiff<T>();

    protected Microsoft.VisualStudio.Services.DevSecOps.Common.ContinueDifferencePredicate<T> ContinueDifferencePredicate => this.m_predicate;
    ...
    public IDiffChange[] DiffEx(
      ...
      IEqualityComparer<T> secondaryElementComparer)
    {
      return this.DiffEx(original, modified, primaryElementComparer, secondaryElementComparer, (Microsoft.VisualStudio.Services.DevSecOps.Common.ContinueDifferencePredicate<T>) null);
    }
