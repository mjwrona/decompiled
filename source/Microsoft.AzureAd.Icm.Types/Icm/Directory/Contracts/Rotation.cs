...
// Type: Microsoft.Icm.Directory.Contracts.Rotation
...
{
  public class Rotation : ModifiableDocument
  {
    public Rotation() => this.SubCycles = (IList<RotationSubCycle>) new List<RotationSubCycle>();
