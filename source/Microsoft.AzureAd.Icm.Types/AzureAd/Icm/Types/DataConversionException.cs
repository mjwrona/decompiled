...
// Type: Microsoft.AzureAd.Icm.Types.DataConversionException
...
{
  [Serializable]
  public class DataConversionException : IcmException
  {
    ...
    public DataConversionException(string message, Exception exception)
    ...
    protected DataConversionException(
