...
// Type: Microsoft.TeamFoundation.Reporting.DataServices.DataAccess.ChartConfigurationSqlResourceComponent4
...
{
  internal class ChartConfigurationSqlResourceComponent4 : ChartConfigurationSqlResourceComponent3
  {
    private static readonly SqlMetaData[] typ_ChartConfigurationTable2 = new SqlMetaData[16]
    {
      ...
      IEnumerable<ChartConfigurationDataModel> rows)
    {
      ...
      System.Func<ChartConfigurationDataModel, SqlDataRecord> selector = (System.Func<ChartConfigurationDataModel, SqlDataRecord>) (chartConfiguration =>
      {
        ...
        SqlDataRecord sqlDataRecord = new SqlDataRecord(ChartConfigurationSqlResourceComponent4.typ_ChartConfigurationTable2);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
      ...
      return this.BindTable(parameterName, "typ_ChartConfigurationTable2", rows.Select<ChartConfigurationDataModel, SqlDataRecord>(selector));
    }
  }
}
