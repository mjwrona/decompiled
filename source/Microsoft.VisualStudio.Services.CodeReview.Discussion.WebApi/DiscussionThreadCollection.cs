...
// Type: Microsoft.VisualStudio.Services.CodeReview.Discussion.WebApi.DiscussionThreadCollection
...
namespace Microsoft.VisualStudio.Services.CodeReview.Discussion.WebApi
{
  ...
  public class DiscussionThreadCollection : List<DiscussionThread>
  {
    ...
    public DiscussionThreadCollection(IList<DiscussionThread> collection)
      : base((IEnumerable<DiscussionThread>) collection)
    {
    }
  }
}
