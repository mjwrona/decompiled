...
// Type: Microsoft.TeamFoundation.Agile.Server.Services.IAgileProjectPermissionService
...
{
  [DefaultServiceImplementation(typeof (AgileProjectPermissionService))]
  public interface IAgileProjectPermissionService : IVssFrameworkService
  {
    bool GetAdvanceBacklogManagementPermission(
      IVssRequestContext requestContext,
      Guid projectId,
      bool throwIfNoPermission = false);

    bool GetPlansPermission(
      IVssRequestContext requestContext,
      Guid projectId,
      bool throwIfNoPermission = false);
  }
