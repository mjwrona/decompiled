...
// Type: Microsoft.TeamFoundation.Agile.Server.Services.IProductBacklogWorkItemService
...
{
  [DefaultServiceImplementation(typeof (ProductBacklogWorkItemService))]
  public interface IProductBacklogWorkItemService : IVssFrameworkService
  {
    IEnumerable<int> GetBacklogLevelWorkItems(
