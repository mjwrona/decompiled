...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnUpdateUserIsNotTeamAdminException
...
{
  [Serializable]
  public class TaskboardColumnUpdateUserIsNotTeamAdminException : TeamFoundationServerException
  {
    public TaskboardColumnUpdateUserIsNotTeamAdminException()
      : base(AgileResources.TaskboardColumnUpdateUserIsNotTeamAdminException)
    {
    }
  }
}
