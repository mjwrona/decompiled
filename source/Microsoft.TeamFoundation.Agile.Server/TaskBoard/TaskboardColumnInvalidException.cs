...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnInvalidException
...
{
  [Serializable]
  public class TaskboardColumnInvalidException : ArgumentException
  {
    public TaskboardColumnInvalidException(string columnName)
      : base(string.Format(AgileResources.TaskboardColumnInvalidException, (object) columnName))
    {
    }
  }
}
