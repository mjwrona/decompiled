...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnMappingInvalidException
...
{
  [Serializable]
  public class TaskboardColumnMappingInvalidException : ArgumentException
  {
    public TaskboardColumnMappingInvalidException()
      : base(AgileResources.TaskboardColumnMappingInvalidException)
    {
    }
  }
}
