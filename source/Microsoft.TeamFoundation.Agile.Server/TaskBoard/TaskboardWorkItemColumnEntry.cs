...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardWorkItemColumnEntry
...
{
  internal class TaskboardWorkItemColumnEntry
  {
    public int WorkItemId { get; }

    public string Column { get; }

    public TaskboardWorkItemColumnEntry(int workItemId, string column)
    {
