...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardInvalidTeamIterationException
...
{
  [Serializable]
  public class TaskboardInvalidTeamIterationException : ArgumentException
  {
    public TaskboardInvalidTeamIterationException(Guid iterationId)
      : base(string.Format(AgileResources.TaskboardInvalidTeamIterationException, (object) iterationId))
    {
    }
  }
}
