...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnInvalidMappingException
...
{
  [Serializable]
  public class TaskboardColumnInvalidMappingException : ArgumentException
  {
    public TaskboardColumnInvalidMappingException(string message)
      : base(message)
    {
    }
  }
