...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnNotFoundException
...
{
  [Serializable]
  public class TaskboardColumnNotFoundException : TeamFoundationServiceException
  {
    public TaskboardColumnNotFoundException(string message)
      : base(string.Format(AgileResources.TaskboardColumnNotFoundException))
    {
    }
  }
}
