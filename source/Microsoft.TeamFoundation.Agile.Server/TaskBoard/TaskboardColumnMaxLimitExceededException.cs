...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnMaxLimitExceededException
...
{
  [Serializable]
  public class TaskboardColumnMaxLimitExceededException : ArgumentException
  {
    public TaskboardColumnMaxLimitExceededException(int columnCount, int max)
      : base(string.Format(AgileResources.TaskboardColumnMaxLimitExceededException, (object) columnCount, (object) max))
    {
    }
  }
}
