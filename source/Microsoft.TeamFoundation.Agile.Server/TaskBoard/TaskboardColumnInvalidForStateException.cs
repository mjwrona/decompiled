...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnInvalidForStateException
...
{
  [Serializable]
  public class TaskboardColumnInvalidForStateException : ArgumentException
  {
    public TaskboardColumnInvalidForStateException(string columnName, string wiState)
      : base(string.Format(AgileResources.TaskboardColumnInvalidForStateException, (object) columnName, (object) wiState))
    {
    }
  }
}
