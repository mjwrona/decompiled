...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnNotCustomizedException
...
{
  [Serializable]
  public class TaskboardColumnNotCustomizedException : ArgumentException
  {
    public TaskboardColumnNotCustomizedException()
      : base(AgileResources.TaskboardColumnNotCustomizedException)
    {
    }
  }
}
