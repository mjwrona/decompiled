...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnUpdateException
...
{
  [Serializable]
  public class TaskboardColumnUpdateException : TeamFoundationServiceException
  {
    public TaskboardColumnUpdateException(string message)
      : base(string.Format(AgileResources.TaskboardColumnUpdateException))
    {
    }
  }
}
