...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnMappingEmptyException
...
{
  [Serializable]
  public class TaskboardColumnMappingEmptyException : ArgumentException
  {
    public TaskboardColumnMappingEmptyException(string columnName)
      : base(string.Format(AgileResources.TaskboardColumnMappingEmptyException, (object) columnName))
    {
    }
  }
}
