...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.ITaskboardColumnService
...
{
  [DefaultServiceImplementation(typeof (TaskboardColumnService))]
  public interface ITaskboardColumnService : IVssFrameworkService
  {
    TaskboardColumns GetColumns(IVssRequestContext context, ProjectInfo project, WebApiTeam team);

    TaskboardColumns UpdateColumns(
