...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnNameDuplicateException
...
{
  [Serializable]
  public class TaskboardColumnNameDuplicateException : ArgumentException
  {
    public TaskboardColumnNameDuplicateException(string colName)
      : base(string.Format(AgileResources.Taskboard_ColumnNamesNotUnique, (object) colName))
    {
    }
  }
}
