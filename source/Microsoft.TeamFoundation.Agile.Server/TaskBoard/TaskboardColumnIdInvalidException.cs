...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnIdInvalidException
...
{
  [Serializable]
  public class TaskboardColumnIdInvalidException : ArgumentException
  {
    public TaskboardColumnIdInvalidException(Guid columnId)
      : base(string.Format(AgileResources.Taskboard_ColumnIdNotfound, (object) columnId))
    {
    }
  }
}
