...
// Type: Microsoft.TeamFoundation.Agile.Server.TaskBoard.TaskboardColumnMinColumnLimitException
...
{
  [Serializable]
  public class TaskboardColumnMinColumnLimitException : ArgumentException
  {
    public TaskboardColumnMinColumnLimitException(int minColumns, int columnsCount)
      : base(string.Format(AgileResources.TaskboardColumnMinColumnLimitException, (object) columnsCount, (object) minColumns))
    {
    }
  }
}
