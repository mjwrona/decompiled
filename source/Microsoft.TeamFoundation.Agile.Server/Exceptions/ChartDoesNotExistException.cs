...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.ChartDoesNotExistException
...
{
  [Serializable]
  public class ChartDoesNotExistException : TeamFoundationServiceException
  {
    ...
    public ChartDoesNotExistException()
      : base(AgileResources.ChartDoesNotExistExceptionMessage)
    {
    }
  }
}
