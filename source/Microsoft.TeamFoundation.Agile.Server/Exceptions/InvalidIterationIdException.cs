...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.InvalidIterationIdException
...
{
  [Serializable]
  public class InvalidIterationIdException : TeamFoundationServiceException
  {
    public InvalidIterationIdException(string message)
