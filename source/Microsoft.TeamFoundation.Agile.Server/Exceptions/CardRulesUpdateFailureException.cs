...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.CardRulesUpdateFailureException
...
{
  [Serializable]
  public class CardRulesUpdateFailureException : TeamFoundationServiceException
  {
    public CardRulesUpdateFailureException(Exception ex)
      : base(string.Format(AgileResources.UpdateBoardCardRules_UpdateBoardFailed, (object) ex.Message, (object) ex.StackTrace))
    {
    }
  }
}
