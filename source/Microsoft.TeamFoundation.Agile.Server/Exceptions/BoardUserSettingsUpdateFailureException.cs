...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.BoardUserSettingsUpdateFailureException
...
{
  [Serializable]
  public class BoardUserSettingsUpdateFailureException : TeamFoundationServiceException
  {
    public BoardUserSettingsUpdateFailureException(Exception ex)
      : base(string.Format(AgileResources.UpdateBoardUserSettings_UpdateFailed, (object) ex.Message))
    {
    }
  }
}
