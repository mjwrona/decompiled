...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.NoPermissionUpdateCardRulesException
...
{
  [Serializable]
  public class NoPermissionUpdateCardRulesException : TeamFoundationServiceException
  {
    public NoPermissionUpdateCardRulesException()
      : base(string.Format(AgileResources.UpdateBoardCardRules_UserIsNotTeamAdmin))
    {
    }
  }
}
