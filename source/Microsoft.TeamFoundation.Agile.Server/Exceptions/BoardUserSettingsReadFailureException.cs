...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.BoardUserSettingsReadFailureException
...
{
  [Serializable]
  public class BoardUserSettingsReadFailureException : TeamFoundationServiceException
  {
    public BoardUserSettingsReadFailureException(Exception ex)
      : base(string.Format(AgileResources.GetBoardUserSettings_GetFailed, (object) ex.Message))
    {
    }
  }
}
