...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.InvalidHierarchyException
...
{
  [Serializable]
  public class InvalidHierarchyException : InvalidReorderOperationException
  {
    public InvalidHierarchyException()
      : base(AgileResources.ProductBacklogReorderHelper_ParentIsInCompleteState)
    {
    }
  }
}
