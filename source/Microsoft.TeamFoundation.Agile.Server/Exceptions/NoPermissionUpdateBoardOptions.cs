...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.NoPermissionUpdateBoardOptions
...
{
  [Serializable]
  public class NoPermissionUpdateBoardOptions : TeamFoundationServiceException
  {
    public NoPermissionUpdateBoardOptions()
      : base(string.Format(AgileResources.UpdateBoardOptions_UserIsNotTeamAdmin))
    {
    }
  }
}
