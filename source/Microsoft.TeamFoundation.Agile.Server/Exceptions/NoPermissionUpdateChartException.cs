...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.NoPermissionUpdateChartException
...
{
  [Serializable]
  public class NoPermissionUpdateChartException : TeamFoundationServiceException
  {
    public NoPermissionUpdateChartException()
      : base(string.Format(AgileResources.UpdateChartSettings_UserIsNotTeamAdmin))
    {
    }
  }
}
