...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.CardSettingsUpdateFailureException
...
{
  [Serializable]
  public class CardSettingsUpdateFailureException : TeamFoundationServiceException
  {
    public CardSettingsUpdateFailureException()
      : base(string.Format(AgileResources.UpdateBoardCardSettings_UpdateBoardFailed))
    {
    }
  }
}
