...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.FilterSettingsUpdateFailureException
...
{
  [Serializable]
  public class FilterSettingsUpdateFailureException : TeamFoundationServiceException
  {
    public FilterSettingsUpdateFailureException(Exception ex)
      : base(AgileResources.UpdateBoardFilterSettings_UpdateBoardFailed)
    {
    }
  }
}
