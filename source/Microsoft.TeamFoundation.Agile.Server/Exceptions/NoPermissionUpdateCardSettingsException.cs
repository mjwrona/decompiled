...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.NoPermissionUpdateCardSettingsException
...
{
  [Serializable]
  public class NoPermissionUpdateCardSettingsException : TeamFoundationServiceException
  {
    public NoPermissionUpdateCardSettingsException()
      : base(string.Format(AgileResources.UpdateBoardCardSettings_UserIsNotTeamAdmin))
    {
    }
  }
}
