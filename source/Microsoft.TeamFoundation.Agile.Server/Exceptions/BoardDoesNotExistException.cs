...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.BoardDoesNotExistException
...
{
  [Serializable]
  public class BoardDoesNotExistException : TeamFoundationServiceException
  {
    public BoardDoesNotExistException(string boardIdorName)
      : base(string.Format(AgileResources.BoardIdOrNameDoesNotExist, (object) boardIdorName))
    {
    }

    public BoardDoesNotExistException()
      : base(AgileResources.BoardDoesNotExistExceptionMessage)
    {
    }
  }
}
