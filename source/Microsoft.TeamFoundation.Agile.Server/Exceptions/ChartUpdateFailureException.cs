...
// Type: Microsoft.TeamFoundation.Agile.Server.Exceptions.ChartUpdateFailureException
...
{
  [Serializable]
  public class ChartUpdateFailureException : TeamFoundationServiceException
  {
    public ChartUpdateFailureException(Exception ex)
      : base(string.Format(AgileResources.ChartUpdateFailureExceptionMessage, (object) ex.Message, (object) ex.StackTrace))
    {
    }
  }
}
