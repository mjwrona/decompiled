...
// Type: Microsoft.TeamFoundation.Agile.Server.FeatureFlags
...
namespace Microsoft.TeamFoundation.Agile.Server
{
  ...
  {
    public const string TaskboardColumnCustomizationDisabled = "WebAccess.Agile.Taskboard.DisableCustomColumn";
  }
}
