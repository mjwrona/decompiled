...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Server.SubscriptionBinder7
...
{
  internal class SubscriptionBinder7 : SubscriptionBinder4
  {
    private SqlColumnBinder Scope = new SqlColumnBinder(nameof (Scope));

    protected override Microsoft.VisualStudio.Services.ServiceHooks.WebApi.Subscription Bind() => base.Bind();
  }
}
