...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Server.ServiceHooksStats
...
{
  public class ServiceHooksStats
  {
    public int ConsumerCount { get; set; }

    public int ConsumerActionCount { get; set; }

    public int EnabledSubscriptionCount { get; set; }
