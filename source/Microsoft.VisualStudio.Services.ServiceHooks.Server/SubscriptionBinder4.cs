...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Server.SubscriptionBinder4
...
{
  internal class SubscriptionBinder4 : SubscriptionBinder3
  {
    ...
    protected override Microsoft.VisualStudio.Services.ServiceHooks.WebApi.Subscription Bind()
    {
      ...
      subscription.ResourceVersion = this.ResourceVersion.GetString((IDataReader) this.Reader, true);
      return subscription;
    }
  }
}
