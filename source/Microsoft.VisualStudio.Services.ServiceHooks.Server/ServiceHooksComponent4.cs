...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Server.ServiceHooksComponent4
...
{
  internal class ServiceHooksComponent4 : ServiceHooksComponent3
  {
    internal const int ResourceVersionLengthMax = 260;
    ...
    protected override SubscriptionBinder GetSubscriptionBinder() => (SubscriptionBinder) new SubscriptionBinder4();
  }
}
