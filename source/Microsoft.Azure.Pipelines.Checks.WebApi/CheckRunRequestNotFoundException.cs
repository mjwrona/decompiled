...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckRunRequestNotFoundException
...
{
  [Serializable]
  public sealed class CheckRunRequestNotFoundException : VssServiceException
  {
    public CheckRunRequestNotFoundException(string message)
      : base(message)
    {
    }
  }
