...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.DeleteCheckSuitesEvent
...
namespace Microsoft.Azure.Pipelines.Checks.WebApi
{
  ...
  public class DeleteCheckSuitesEvent
  {
    public DeleteCheckSuitesEvent(string eventType, Guid projectId, IList<Guid> checkSuiteIds)
    {
      ArgumentUtility.CheckStringForNullOrEmpty(eventType, nameof (eventType));
      ArgumentUtility.CheckForEmptyGuid(projectId, nameof (projectId));
      ArgumentUtility.CheckEnumerableForNullElement((IEnumerable) checkSuiteIds, nameof (checkSuiteIds));
      this.EventType = eventType;
      this.ProjectId = projectId;
      this.CheckSuiteIds = checkSuiteIds;
    }
    ...
    public IList<Guid> CheckSuiteIds { get; set; }
  }
}
