...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.EventConstants
...
namespace Microsoft.Azure.Pipelines.Checks.WebApi
{
  ...
  {
    public const string CheckSuiteUpdated = "MS.Azure.Pipelines.CheckSuiteUpdated";
    public const string DeleteCheckSuites = "MS.Azure.Pipelines.DeleteCheckSuites";
