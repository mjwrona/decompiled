...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.InvalidCheckRunUpdateException
...
{
  [Serializable]
  public sealed class InvalidCheckRunUpdateException : VssServiceException
  {
    public InvalidCheckRunUpdateException(string message)
      : base(message)
    {
    }
  }
