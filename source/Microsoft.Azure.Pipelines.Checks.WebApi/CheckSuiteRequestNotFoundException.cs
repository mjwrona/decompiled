...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckSuiteRequestNotFoundException
...
{
  [Serializable]
  public sealed class CheckSuiteRequestNotFoundException : VssServiceException
  {
    public CheckSuiteRequestNotFoundException(string message)
      : base(message)
    {
    }
  }
