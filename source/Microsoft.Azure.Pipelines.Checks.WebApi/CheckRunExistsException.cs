...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckRunExistsException
...
{
  [Serializable]
  public sealed class CheckRunExistsException : VssServiceException
  {
    public CheckRunExistsException(string message)
      : base(message)
    {
    }
  }
