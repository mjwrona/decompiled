...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.InvalidCheckRunContextException
...
{
  [Serializable]
  public sealed class InvalidCheckRunContextException : VssServiceException
  {
    public InvalidCheckRunContextException(string message)
      : base(message)
    {
    }
  }
