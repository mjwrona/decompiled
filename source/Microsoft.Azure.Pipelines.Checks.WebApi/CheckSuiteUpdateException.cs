...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckSuiteUpdateException
...
{
  [Serializable]
  public sealed class CheckSuiteUpdateException : VssServiceException
  {
    public CheckSuiteUpdateException(string message)
      : base(message)
    {
    }
  }
