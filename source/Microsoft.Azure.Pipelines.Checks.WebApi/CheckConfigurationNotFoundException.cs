...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckConfigurationNotFoundException
...
{
  [Serializable]
  public sealed class CheckConfigurationNotFoundException : VssServiceException
  {
    public CheckConfigurationNotFoundException()
    {
    }

    public CheckConfigurationNotFoundException(string message)
      : base(message)
    {
    }
  }
