...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckCannotBeRerunException
...
{
  [Serializable]
  public sealed class CheckCannotBeRerunException : VssServiceException
  {
    public CheckCannotBeRerunException(string message)
      : base(message)
    {
    }
  }
