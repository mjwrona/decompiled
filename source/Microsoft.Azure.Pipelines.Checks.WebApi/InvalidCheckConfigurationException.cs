...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.InvalidCheckConfigurationException
...
{
  [Serializable]
  public sealed class InvalidCheckConfigurationException : VssServiceException
  {
    public InvalidCheckConfigurationException(string message)
      : base(message)
    {
    }
  }
