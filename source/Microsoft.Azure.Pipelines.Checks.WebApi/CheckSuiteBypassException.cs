...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckSuiteBypassException
...
{
  [Serializable]
  public sealed class CheckSuiteBypassException : VssServiceException
  {
    public CheckSuiteBypassException(string message)
      : base(message)
    {
    }
  }
