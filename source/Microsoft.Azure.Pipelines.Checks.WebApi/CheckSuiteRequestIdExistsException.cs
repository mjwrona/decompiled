...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckSuiteRequestIdExistsException
...
{
  [Serializable]
  public sealed class CheckSuiteRequestIdExistsException : VssServiceException
  {
    public CheckSuiteRequestIdExistsException(string message)
      : base(message)
    {
    }
  }
