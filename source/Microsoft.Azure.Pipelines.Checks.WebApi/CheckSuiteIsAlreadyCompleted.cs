...
// Type: Microsoft.Azure.Pipelines.Checks.WebApi.CheckSuiteIsAlreadyCompleted
...
{
  [Serializable]
  public sealed class CheckSuiteIsAlreadyCompleted : VssServiceException
  {
    public CheckSuiteIsAlreadyCompleted(string message)
      : base(message)
    {
    }
  }
