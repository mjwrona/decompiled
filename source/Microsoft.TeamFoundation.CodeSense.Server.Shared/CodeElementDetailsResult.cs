...
// Type: Microsoft.TeamFoundation.CodeSense.Server.CodeElementDetailsResult
...
{
  public sealed class CodeElementDetailsResult : CodeElementResult
  {
    public CodeElementDetailsResult(
    ...
    [JsonConstructor]
    internal CodeElementDetailsResult()
    {
    }

    [JsonProperty(Order = 3)]
    public IEnumerable<CollectorResult> ElementDetails
    {
