...
// Type: Microsoft.TeamFoundation.Dashboards.Common.JQuerySelectors
...
namespace Microsoft.TeamFoundation.Dashboards.Common
{
  ...
  {
    public const string MenuFocus = ".menu-focus-receiver";
    public const string DataGridWidgetIdAttribute = "data-widget-id";
    public const string ManagerListID = "data-id";
  }
}
