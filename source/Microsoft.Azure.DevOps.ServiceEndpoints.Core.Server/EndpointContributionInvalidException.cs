...
// Type: Microsoft.Azure.DevOps.ServiceEndpoints.Core.Server.EndpointContributionInvalidException
...
{
  public class EndpointContributionInvalidException : Exception
  {
    public EndpointContributionInvalidException(string message)
      : base(message)
    {
    }

    public EndpointContributionInvalidException(string message, Exception innerException)
