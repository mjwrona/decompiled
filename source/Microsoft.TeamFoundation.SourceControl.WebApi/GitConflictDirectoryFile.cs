...
// Type: Microsoft.TeamFoundation.SourceControl.WebApi.GitConflictDirectoryFile
...
namespace Microsoft.TeamFoundation.SourceControl.WebApi
{
  ...
  public class GitConflictDirectoryFile : GitConflict
  {
    ...
    public override void SetSecuredObject(ISecuredObject securedObject)
    {
      ...
      this.SourceTree?.SetSecuredObject(securedObject);
