...
// Type: Microsoft.TeamFoundation.SourceControl.WebApi.GitConflictFileDirectory
...
namespace Microsoft.TeamFoundation.SourceControl.WebApi
{
  ...
  public class GitConflictFileDirectory : GitConflict
  {
    ...
    public override void SetSecuredObject(ISecuredObject securedObject)
    {
      ...
      this.TargetTree?.SetSecuredObject(securedObject);
