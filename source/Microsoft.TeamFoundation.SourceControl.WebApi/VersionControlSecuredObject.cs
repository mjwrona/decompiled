...
// Type: Microsoft.TeamFoundation.SourceControl.WebApi.VersionControlSecuredObject
...
namespace Microsoft.TeamFoundation.SourceControl.WebApi
{
  ...
  [DataContract]
  [KnownType(typeof (GitRepository))]
  [KnownType(typeof (GitPushRef))]
  public abstract class VersionControlSecuredObject : ISecuredObject
  {
    private ISecuredObject m_securedObject;

    public VersionControlSecuredObject()
    {
    }

    public VersionControlSecuredObject(ISecuredObject securedObject) => this.m_securedObject = securedObject;
