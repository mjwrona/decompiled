...
// Type: Microsoft.TeamFoundation.SourceControl.WebApi.Legacy.Change
...
namespace Microsoft.TeamFoundation.SourceControl.WebApi.Legacy
{
  ...
  public class Change : Entity
  {
    ...
    [DataMember(Name = "sourceServerItem", EmitDefaultValue = false)]
    ...
    public override void SetSecuredObject(ISecuredObject securedObject)
    {
      ...
      this.Item?.SetSecuredObject(securedObject);
    }
  }
}
