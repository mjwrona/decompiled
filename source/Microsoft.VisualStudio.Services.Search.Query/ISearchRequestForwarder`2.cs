...
// Type: Microsoft.VisualStudio.Services.Search.Query.ISearchRequestForwarder`2
...
{
  public interface ISearchRequestForwarder<TRequest, TResponse>
    ...
    where TResponse : EntitySearchResponse
  {
    ...
    TResponse GetZeroResultResponse(TRequest searchRequest, out IEnumerable<string> suggestions);
  }
}
