...
// Type: Microsoft.VisualStudio.Services.Search.Query.SecurityChecksCache.PackageSecurityChecksCache
...
{
  public class PackageSecurityChecksCache : SecurityChecksCacheBase<PackageSecuritySet>
  {
    public PackageSecurityChecksCache(
