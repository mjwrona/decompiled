...
// Type: Microsoft.VisualStudio.Services.Search.Query.Correctors.TermExpressionValueCorrector
...
{
  internal class TermExpressionValueCorrector : TermCorrector
  {
      ...
      TermExpression termExpression)
    {
      ...
      int? indexVersion;
      if (!requestContext.TryGetQueryIndexVersion((EntityType) WorkItemEntityType.GetInstance(), out indexVersion))
      ...
      termExpression.Value = termExpression.Value.NormalizeStringAndReplaceTurkishDottedI();
label_8:
