...
// Type: Microsoft.VisualStudio.Services.Search.Query.SettingSearchQueryTagger
...
namespace Microsoft.VisualStudio.Services.Search.Query
{
  internal class SettingSearchQueryTagger : EntitySearchQueryTagger
  {
    ...
    protected override string GetTaggerCIEntityTag() => "SettingSearchRequestTags";

    protected override IDictionary<string, string> GetSupportedFilterCategoriesWithTagsMapping() => (IDictionary<string, string>) SettingSearchQueryTagger.s_FilterCategoriesTagsMap;
    ...
    internal static class SettingSearchQueryTaggerConstants
    {
      public const string ScopeFilter = "ScopeFilter";
      public const string CITagSettingEntity = "SettingSearchRequestTags";
    }
  }
}
