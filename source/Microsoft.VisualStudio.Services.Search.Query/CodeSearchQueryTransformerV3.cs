...
// Type: Microsoft.VisualStudio.Services.Search.Query.CodeSearchQueryTransformerV3
...
{
  internal class CodeSearchQueryTransformerV3 : CodeSearchQueryTransformerV2
  {
    [StaticSafe]
    private static readonly CompositeTermCorrector s_compositeTermCorrector = new CompositeTermCorrector(new ICorrector[11]
    {
      ...
      (ICorrector) new CodeNormalizationTermCorrectorV3(),
      (ICorrector) new WildcardTermCorrector()
    });

    public CodeSearchQueryTransformerV3(IVssRequestContext requestContext)
      : base(requestContext)
    {
    }

    protected override CompositeTermCorrector GetCompositeTermCorrector() => CodeSearchQueryTransformerV3.s_compositeTermCorrector;
  }
}
