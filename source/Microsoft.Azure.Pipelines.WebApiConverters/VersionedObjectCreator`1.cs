...
// Type: Microsoft.Azure.Pipelines.WebApiConverters.VersionedObjectCreator`1
...
{
  public class VersionedObjectCreator<T> : IVersionedObjectCreator where T : new()
  {
    public VersionedObjectCreator(int resourceVersion) => this.Version = resourceVersion;

    public object Create() => (object) new T();
