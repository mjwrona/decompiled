...
// Type: Microsoft.TeamFoundation.Agile.Web.Controller.Capacity2ApiController
...
{
  [VersionedApiControllerCustomName(Area = "work", ResourceName = "capacities", ResourceVersion = 2)]
  [ControllerApiVersion(5.1)]
  public class Capacity2ApiController : CapacityApiControllerBase
  {
    [HttpGet]
    [ClientExample("GET__work_teamsettings_iterations__iterationId__capacities.json", "Get a team's capacity", null, null)]
    public IEnumerable<TeamMemberCapacityIdentityRef> GetCapacitiesWithIdentityRef(Guid iterationId)
    {
      this.TfsRequestContext.TraceEnter(290930, "AgileService", "AgileService", nameof (GetCapacitiesWithIdentityRef));
      try
      {
      ...
      {
        this.TfsRequestContext.TraceLeave(290931, "AgileService", "AgileService", nameof (GetCapacitiesWithIdentityRef));
      }
    }
