...
// Type: Microsoft.TeamFoundation.Agile.Web.Data.FullScaledAgileViewRecordBinder3
...
{
  internal class FullScaledAgileViewRecordBinder3 : ObjectBinder<FullScaledAgileViewRecord2>
  {
    ...
    protected override FullScaledAgileViewRecord2 Bind()
    {
      ...
      agileViewRecord2.LastAccessed = this.LastAccessedColumn.GetNullableDateTime((IDataReader) this.Reader);
