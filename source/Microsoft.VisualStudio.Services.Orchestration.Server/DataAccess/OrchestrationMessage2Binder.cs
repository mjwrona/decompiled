...
// Type: Microsoft.VisualStudio.Services.Orchestration.Server.DataAccess.OrchestrationMessage2Binder
...
{
  internal sealed class OrchestrationMessage2Binder : ObjectBinder<OrchestrationMessage>
  {
    ...
    protected override OrchestrationMessage Bind() => new OrchestrationMessage()
    {
      ...
      CompressionType = (CompressionType) this.m_compressionType.GetByte((IDataReader) this.Reader, (byte) 0),
      Content = this.m_content.GetBytes((IDataReader) this.Reader, true)
    };
  }
}
