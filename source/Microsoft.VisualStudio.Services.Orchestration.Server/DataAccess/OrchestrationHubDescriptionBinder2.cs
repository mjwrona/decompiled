...
// Type: Microsoft.VisualStudio.Services.Orchestration.Server.DataAccess.OrchestrationHubDescriptionBinder2
...
{
  internal sealed class OrchestrationHubDescriptionBinder2 : 
    ObjectBinder<OrchestrationHubDescription>
  {
    private SqlColumnBinder m_hubId = new SqlColumnBinder("HubId");
    ...
    protected override OrchestrationHubDescription Bind()
    {
      ...
      {
        HubId = this.m_hubId.GetInt32((IDataReader) this.Reader),
