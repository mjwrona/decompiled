...
// Type: Microsoft.TeamFoundation.Ssh.Server.External.Eldos.EldosSshSocketException
...
{
  [Serializable]
  public class EldosSshSocketException : VssServiceException
  {
    public EldosSshSocketException()
    {
    }

    public EldosSshSocketException(string message)
      : base(message)
    {
    }

    public EldosSshSocketException(string message, Exception inner)
      : base(message, inner)
    {
    }
  }
