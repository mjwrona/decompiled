...
// Type: Microsoft.VisualStudio.Services.DelegatedAuthorization.DataAccess.DelegatedAuthorizationComponent10
...
{
  internal class DelegatedAuthorizationComponent10 : DelegatedAuthorizationComponent9
  {
      ...
      bool isPublic = false)
    {
      try
      {
        ...
        {
          resultCollection.AddBinder<AccessTokenKey>((ObjectBinder<AccessTokenKey>) new AccessTokenKeyBinder5());
