...
// Type: Microsoft.VisualStudio.Services.DelegatedAuthorization.DataAccess.DelegatedAuthorizationComponent9
...
{
  internal class DelegatedAuthorizationComponent9 : DelegatedAuthorizationComponent8
  {
    ...
    public override Registration CreateRegistration(Registration registration)
    {
      try
      {
        ...
        this.BindDateTime("@ValidFrom", registration.ValidFrom.Value.DateTime);
