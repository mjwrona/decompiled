...
// Type: Microsoft.TeamFoundation.Wiki.WebApi.WikiCreateBaseParameters
...
{
  [DataContract]
  public class WikiCreateBaseParameters : WikiSecuredObject
  {
    ...
    [DataMember(Name = "mappedPath", EmitDefaultValue = false)]
