...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.PackageResourceStore
...
{
  public class PackageResourceStore : 
    InMemoryResourceStore<PackageResource>,
    IPackageResourceStore,
    IStepProvider
  {
    public PackageResourceStore(IEnumerable<PackageResource> packages, IArtifactResolver resolver = null)
      : base(packages)
    {
      this.Resolver = resolver;
    }

    public PackageResourceStore(params PackageResource[] packages)
      : base((IEnumerable<PackageResource>) packages)
    {
    }
