...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.Expressions.IsSHA1Node
...
namespace Microsoft.TeamFoundation.DistributedTask.Pipelines.Expressions
{
  ...
  public sealed class IsSHA1Node : FunctionNode
  {
    ...
    protected override sealed object EvaluateCore(EvaluationContext context) => (object) RegexUtility.IsMatch(this.Parameters[0].EvaluateString(context) ?? string.Empty, "SHA1");
  }
}
