...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.Expressions.IsUrlNode
...
namespace Microsoft.TeamFoundation.DistributedTask.Pipelines.Expressions
{
  ...
  public sealed class IsUrlNode : FunctionNode
  {
    ...
    protected override sealed object EvaluateCore(EvaluationContext context) => (object) RegexUtility.IsMatch(this.Parameters[0].EvaluateString(context) ?? string.Empty, "Url");
  }
}
