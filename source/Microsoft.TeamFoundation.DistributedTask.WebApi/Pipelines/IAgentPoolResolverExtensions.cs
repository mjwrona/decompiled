...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.IAgentPoolResolverExtensions
...
namespace Microsoft.TeamFoundation.DistributedTask.Pipelines
{
  ...
  public static class IAgentPoolResolverExtensions
  {
    ...
    {
      return resolver.Resolve((ICollection<AgentPoolReference>) new AgentPoolReference[1]
      {
        reference
