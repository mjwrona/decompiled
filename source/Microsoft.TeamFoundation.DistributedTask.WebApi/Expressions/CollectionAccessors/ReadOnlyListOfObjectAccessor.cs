...
// Type: Microsoft.TeamFoundation.DistributedTask.Expressions.CollectionAccessors.ReadOnlyListOfObjectAccessor
...
{
  internal sealed class ReadOnlyListOfObjectAccessor : 
    IReadOnlyArray,
    ...
    IEnumerable
  {
    ...
    public ReadOnlyListOfObjectAccessor(IReadOnlyList<object> list) => this.m_list = list;
