...
// Type: Microsoft.TeamFoundation.DistributedTask.WebApi.DeploymentStrategyBase
...
namespace Microsoft.TeamFoundation.DistributedTask.WebApi
{
  internal abstract class DeploymentStrategyBase
  {
    ...
    {
      this.Type = type;
      this.Actions = (IList<DeploymentStrategyBaseAction>) new List<DeploymentStrategyBaseAction>();
    }
