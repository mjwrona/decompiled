...
// Type: Microsoft.TeamFoundation.DistributedTask.WebApi.InvalidAuthorizationDetailsException
...
namespace Microsoft.TeamFoundation.DistributedTask.WebApi
{
  ...
  public class InvalidAuthorizationDetailsException : DistributedTaskException
  {
    ...
    public InvalidAuthorizationDetailsException(string message, Exception innerException)
