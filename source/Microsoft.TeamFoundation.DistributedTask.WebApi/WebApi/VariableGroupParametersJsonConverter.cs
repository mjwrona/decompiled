...
// Type: Microsoft.TeamFoundation.DistributedTask.WebApi.VariableGroupParametersJsonConverter
...
namespace Microsoft.TeamFoundation.DistributedTask.WebApi
{
  internal sealed class VariableGroupParametersJsonConverter : VssSecureJsonConverter
  {
    ...
    public override bool CanConvert(Type objectType) => typeof (VariableGroupParameters).GetTypeInfo().IsAssignableFrom(objectType.GetTypeInfo());
