...
// Type: Microsoft.VisualStudio.Services.TestResults.WebApi.CoverageSummaryStatusConflictException
...
{
  public class CoverageSummaryStatusConflictException : VssServiceException
  {
    public CoverageSummaryStatusConflictException()
    {
    }
