...
// Type: Microsoft.VisualStudio.Services.Feed.Server.ClientServices.PlatformFeedMetricsInternalClientService
...
{
  internal class PlatformFeedMetricsInternalClientService : 
    ...
    IVssFrameworkService
  {
    ...
    {
      requestContext.GetService<IFeedMetricsService>().IngestRawMetrics(requestContext, updates.ToList<PackageMetricsData>());
