...
// Type: Microsoft.VisualStudio.Services.DevSecOps.WebApi.SecretsScanTimeoutException
...
{
  [Serializable]
  public class SecretsScanTimeoutException : ScanServiceException
  {
    public SecretsScanTimeoutException()
      : base(DevSecOpsWebApiResources.SecretScanExpressionEvaluationTimeoutException())
    {
    }

    public SecretsScanTimeoutException(string message, Exception innerException)
