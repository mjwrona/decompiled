...
// Type: Microsoft.VisualStudio.Services.DevSecOps.WebApi.BatchScanResult
...
namespace Microsoft.VisualStudio.Services.DevSecOps.WebApi
{
  ...
  {
    public BatchScanResult(Guid? correlationId)
    {
      this.CorrelationId = correlationId;
      this.Results = (IList<ContainerResult>) new List<ContainerResult>();
    }
    ...
    [DataMember]
    public IList<ContainerResult> Results { get; }
  }
}
