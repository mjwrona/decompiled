...
// Type: Microsoft.VisualStudio.Services.Gallery.Server.Components.GalleryTagBinder
...
{
  internal class GalleryTagBinder : ObjectBinder<GalleryTag>
  {
    ...
    protected override GalleryTag Bind() => new GalleryTag()
    {
