...
// Type: Microsoft.VisualStudio.Services.Gallery.Server.Components.ExtensionDailyStatBinder
...
{
  internal class ExtensionDailyStatBinder : ObjectBinder<ExtensionDailyStat>
  {
    ...
    private SqlColumnBinder downloadCountColumn = new SqlColumnBinder("DownloadCount");
    ...
    protected override ExtensionDailyStat Bind() => new ExtensionDailyStat()
    {
      ...
      Counts = new EventCounts()
      {
        ...
        WebDownloadCount = this.downloadCountColumn.GetInt64((IDataReader) this.Reader, 0L),
