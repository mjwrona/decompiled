...
// Type: Microsoft.VisualStudio.Services.Gallery.Server.Components.PublisherComponent6
...
{
  internal class PublisherComponent6 : PublisherComponent5
  {
    ...
    protected override PublisherComponent5.PublisherDbModelBinder GetPublisherDbModelBinder() => (PublisherComponent5.PublisherDbModelBinder) new PublisherComponent6.PublisherDbModelBinder2();

    internal class PublisherDbModelBinder2 : PublisherComponent5.PublisherDbModelBinder
    {
      protected SqlColumnBinder publisherStateColumn = new SqlColumnBinder("PublisherState");
