...
// Type: Microsoft.TeamFoundation.Server.AuthorizationSubsystemException
...
{
  [Serializable]
  public class AuthorizationSubsystemException : TeamFoundationServerException
  {
    public AuthorizationSubsystemException()
    {
    }
