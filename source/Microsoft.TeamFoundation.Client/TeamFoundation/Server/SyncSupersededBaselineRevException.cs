...
// Type: Microsoft.TeamFoundation.Server.SyncSupersededBaselineRevException
...
{
  [Serializable]
  public class SyncSupersededBaselineRevException : SyncSubsystemException
  {
    public SyncSupersededBaselineRevException()
    {
    }
