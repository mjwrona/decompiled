...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Jobs.ChangeProcessing.PendingPduNotification
...
{
  public record PendingPduNotification(
    ICommitLogEntry Commit,
    TriggerCommitType CommitType,
    IPackageIdentity PackageIdentity,
    CommitAffectsViews CommitAffectsViews)
  ;
}
