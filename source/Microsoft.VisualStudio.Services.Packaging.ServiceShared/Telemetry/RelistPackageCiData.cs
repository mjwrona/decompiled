...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Telemetry.RelistPackageCiData
...
{
  public class RelistPackageCiData : PackagingCiData
  {
    public RelistPackageCiData(
      ...
      : base(requestContext, "RelistPackage", protocol, feed)
    {
