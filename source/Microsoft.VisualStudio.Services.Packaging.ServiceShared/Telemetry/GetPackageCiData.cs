...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Telemetry.GetPackageCiData
...
{
  public class GetPackageCiData : PackagingCiData
  {
    public GetPackageCiData(
      ...
      : base(requestContext, "GetPackage", protocol, feed)
    {
