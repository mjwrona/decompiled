...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Telemetry.UnlistPackageCiData
...
{
  public class UnlistPackageCiData : PackagingCiData
  {
    public UnlistPackageCiData(
      ...
      : base(requestContext, "UnlistPackage", protocol, feed)
    {
