...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Telemetry.RestoreToFeedPackageCiData
...
{
  public class RestoreToFeedPackageCiData : PackagingCiData
  {
    public RestoreToFeedPackageCiData(
      ...
      : base(requestContext, "RestorePackageToFeed", protocol, feed)
    {
