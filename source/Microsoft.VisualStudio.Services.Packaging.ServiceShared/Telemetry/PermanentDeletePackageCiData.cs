...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Telemetry.PermanentDeletePackageCiData
...
{
  public class PermanentDeletePackageCiData : PackagingCiData
  {
    public PermanentDeletePackageCiData(
      ...
      : base(requestContext, "PermanentDeletePackage", protocol, feed)
    {
