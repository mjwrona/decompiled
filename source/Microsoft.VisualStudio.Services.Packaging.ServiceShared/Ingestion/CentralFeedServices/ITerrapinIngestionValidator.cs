...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Ingestion.CentralFeedServices.ITerrapinIngestionValidator
...
{
  public interface ITerrapinIngestionValidator
  {
    Task ValidateAsync(
