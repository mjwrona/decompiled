...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Ingestion.IStorablePackageInfo`1
...
{
  public interface IStorablePackageInfo<out TPackageId> : 
    ...
    where TPackageId : IPackageIdentity
  {
    ...
    IngestionDirection IngestionDirection { get; }
  }
}
