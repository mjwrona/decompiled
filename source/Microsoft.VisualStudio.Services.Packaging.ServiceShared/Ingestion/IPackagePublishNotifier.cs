...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.Ingestion.IPackagePublishNotifier
...
{
  public interface IPackagePublishNotifier
  {
    Task NotifyPublishAsync(
