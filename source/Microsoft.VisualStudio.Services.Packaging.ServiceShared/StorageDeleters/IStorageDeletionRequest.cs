...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.StorageDeleters.IStorageDeletionRequest
...
{
  public interface IStorageDeletionRequest
  {
    Guid FeedId { get; }
    ...
    IEnumerable<BlobReferenceIdentifier> ExtraAssetBlobReferences { get; }
  }
}
