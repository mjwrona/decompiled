...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.ContentVerification.IPackageGdprDataStore
...
{
  public interface IPackageGdprDataStore
  {
    IEnumerable<string> DeleteExpiredData();

    Task<PackageGdprData> RetrieveUploaderData(
