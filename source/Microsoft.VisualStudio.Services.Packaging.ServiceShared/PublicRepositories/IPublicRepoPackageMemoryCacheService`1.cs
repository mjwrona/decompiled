...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.PublicRepositories.IPublicRepoPackageMemoryCacheService`1
...
{
  public interface IPublicRepoPackageMemoryCacheService<TDocument> where TDocument : class, IVersionedDocument
  {
    bool TryGet(
