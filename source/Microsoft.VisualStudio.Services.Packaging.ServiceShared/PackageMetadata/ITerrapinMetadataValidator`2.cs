...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.PackageMetadata.ITerrapinMetadataValidator`2
...
{
  public interface ITerrapinMetadataValidator<TPackageName, TPackageVersion>
    where TPackageName : IPackageName
    where TPackageVersion : IPackageVersion
  {
    Task<Dictionary<TPackageVersion, TerrapinIngestionValidationReason>> GetTerrapinData(
