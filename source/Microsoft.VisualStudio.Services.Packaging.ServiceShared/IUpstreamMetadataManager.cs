...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.IUpstreamMetadataManager
...
{
  public interface IUpstreamMetadataManager
  {
    ...
    Task<RefreshPackagesResult> RefreshPackagesAsync(
      IFeedRequest feedRequest,
      bool forceRefreshAllUpstreamVersionLists,
      ISet<Guid> upstreamVersionListsToForceRefreshByUpstreamId,
