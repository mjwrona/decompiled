...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.UpstreamFailureTracking.Classifier.IUpstreamStatusHandler
...
{
  public interface IUpstreamStatusHandler
  {
    Task Handle(
