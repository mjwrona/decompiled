...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.IProtocolRegistrationAcceptor
...
{
  public interface IProtocolRegistrationAcceptor
  {
    ...
    void RegisterItemStoreExperience(
      string name,
      Func<IVssRequestContext, IItemStore> itemStoreFactory);

    void RegisterBookmarkTokenKey(BookmarkTokenKey key);
  }
}
