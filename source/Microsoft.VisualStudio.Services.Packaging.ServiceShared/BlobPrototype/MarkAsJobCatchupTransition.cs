...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.BlobPrototype.MarkAsJobCatchupTransition
...
{
  public class MarkAsJobCatchupTransition : MigrationTransitionBase
  {
    public MarkAsJobCatchupTransition(
