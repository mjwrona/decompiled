...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.BlobPrototype.JobManagement.QueueNothingQueuer
...
{
  public class QueueNothingQueuer : IFeedJobQueuer
  {
    public Task<Guid> QueueJob(
      FeedCore feed,
      IProtocol protocol,
