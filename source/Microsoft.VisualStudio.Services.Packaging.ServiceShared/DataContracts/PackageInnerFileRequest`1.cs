...
// Type: Microsoft.VisualStudio.Services.Packaging.ServiceShared.DataContracts.PackageInnerFileRequest`1
...
{
  public class PackageInnerFileRequest<TPackageId> : 
    ...
    where TPackageId : IPackageIdentity
  {
    public PackageInnerFileRequest(
      ...
      : base(feedRequest, packageId, filePath)
    {
