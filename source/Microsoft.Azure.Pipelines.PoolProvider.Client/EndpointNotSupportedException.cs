...
// Type: Microsoft.Azure.Pipelines.PoolProvider.Client.EndpointNotSupportedException
...
{
  public class EndpointNotSupportedException : Exception
  {
    public EndpointNotSupportedException(string endpoint)
      : base("The remote provider does not support the " + endpoint + " endpoint")
    {
    }
  }
}
