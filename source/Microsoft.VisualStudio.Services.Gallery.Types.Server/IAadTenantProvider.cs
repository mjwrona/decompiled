...
// Type: Microsoft.VisualStudio.Services.Gallery.Types.Server.IAadTenantProvider
...
{
  [InheritedExport]
  public interface IAadTenantProvider
  {
    IEnumerable<Tenant> GetTenants(IVssRequestContext requestContext);
  }
}
