...
// Type: Microsoft.VisualStudio.Services.Gallery.Types.Server.IGalleryAdminAuthorizer
...
{
  [InheritedExport]
  public interface IGalleryAdminAuthorizer
  {
    bool IsPartOfGalleryAdminSecurityGroup(IVssRequestContext requestContext);

    bool IsDomainMSTenant(IVssRequestContext requestContext);
  }
}
