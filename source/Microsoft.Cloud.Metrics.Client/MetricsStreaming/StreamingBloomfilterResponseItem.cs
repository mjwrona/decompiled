...
// Type: Microsoft.Cloud.Metrics.Client.MetricsStreaming.StreamingBloomfilterResponseItem
...
{
  public class StreamingBloomfilterResponseItem
  {
    ...
    public IList<string> StreamingRuleIds { get; set; }

    [JsonProperty(PropertyName = "contactEmail")]
    public string ContactEmail { get; set; }

    public string RelativeBlobId { get; set; }
