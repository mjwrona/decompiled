...
// Type: Microsoft.Cloud.Metrics.Client.Metrics.Etw.EtlBacklogConfig
...
namespace Microsoft.Cloud.Metrics.Client.Metrics.Etw
{
  ...
  {
    public EtlBacklogConfig(
      bool shouldReceiveBacklogFiles,
      DateTime backlogTargetStartTime,
      int maxBacklogFilesRequested)
      : this()
    {
