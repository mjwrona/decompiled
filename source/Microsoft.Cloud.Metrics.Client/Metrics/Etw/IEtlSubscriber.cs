...
// Type: Microsoft.Cloud.Metrics.Client.Metrics.Etw.IEtlSubscriber
...
{
  internal interface IEtlSubscriber
  {
    ...
    unsafe void RecordCallback(NativeMethods.EventRecord* eventRecord);
