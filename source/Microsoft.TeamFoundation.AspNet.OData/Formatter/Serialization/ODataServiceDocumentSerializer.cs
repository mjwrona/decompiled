...
// Type: Microsoft.AspNet.OData.Formatter.Serialization.ODataServiceDocumentSerializer
...
namespace Microsoft.AspNet.OData.Formatter.Serialization
{
  public class ODataServiceDocumentSerializer : ODataSerializer
  {
      ...
      ODataSerializerContext writeContext)
    {
      ...
      if (!(graph is ODataServiceDocument serviceDocument))
        throw new SerializationException(Microsoft.AspNet.OData.Common.Error.Format(SRResources.CannotWriteType, (object) this.GetType().Name, (object) type.Name));
