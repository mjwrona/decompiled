...
// Type: Microsoft.AspNet.OData.Formatter.Serialization.ODataEntityReferenceLinkSerializer
...
namespace Microsoft.AspNet.OData.Formatter.Serialization
{
  public class ODataEntityReferenceLinkSerializer : ODataSerializer
  {
      ...
      ODataSerializerContext writeContext)
    {
      ...
      if (graph == null)
        return;
      if (!(graph is ODataEntityReferenceLink link))
      {
        Uri uri = graph as Uri;
        link = !(uri == (Uri) null) ? new ODataEntityReferenceLink()
        {
          Url = uri
