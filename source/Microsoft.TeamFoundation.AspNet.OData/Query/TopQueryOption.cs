...
// Type: Microsoft.AspNet.OData.Query.TopQueryOption
  ...
  public class TopQueryOption
  {
    ...
    public int Value
    {
      get
      {
        ...
        {
          long? top = this._queryOptionParser.ParseTop();
          if (top.HasValue)
          {
            long? nullable = top;
            long maxValue = (long) int.MaxValue;
            if (nullable.GetValueOrDefault() > maxValue & nullable.HasValue)
              throw new ODataException(Microsoft.AspNet.OData.Common.Error.Format(SRResources.SkipTopLimitExceeded, (object) int.MaxValue, (object) AllowedQueryOptions.Top, (object) this.RawValue));
          }
          long? nullable1 = top;
