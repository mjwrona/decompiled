...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.AnalyticsViewValidationException
...
{
  [Serializable]
  public class AnalyticsViewValidationException : VssServiceException
  {
    public AnalyticsViewValidationException(string message)
      : base(message)
    {
    }

    public AnalyticsViewValidationException(string message, Exception innerException)
