...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.TrendGranularity
...
namespace Microsoft.VisualStudio.Services.Analytics.WebApi
{
  ...
  {
    [DataMember]
    public TrendGranularityType? granularityType { get; set; }

    [DataMember]
    public DayOfWeek? WeeklyEndDay { get; set; }
  }
}
