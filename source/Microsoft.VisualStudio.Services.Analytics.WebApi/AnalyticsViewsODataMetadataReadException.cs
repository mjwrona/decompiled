...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.AnalyticsViewsODataMetadataReadException
...
{
  [Serializable]
  public class AnalyticsViewsODataMetadataReadException : VssServiceException
  {
    public AnalyticsViewsODataMetadataReadException(string message)
      : base(message)
    {
    }

    public AnalyticsViewsODataMetadataReadException(string message, Exception innerException)
