...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.CamelCaseStringEnumConverter
...
namespace Microsoft.VisualStudio.Services.Analytics.WebApi
{
  ...
  {
    public CamelCaseStringEnumConverter() => this.NamingStrategy = (NamingStrategy) new CamelCaseNamingStrategy();
  }
}
