...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.AnalyticsStateInvalidStateException
...
{
  [Serializable]
  public class AnalyticsStateInvalidStateException : VssServiceException
  {
    public AnalyticsStateInvalidStateException(string message)
      : base(message)
    {
    }
  }
