...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.AnalyticsViewMessage
...
{
  [DataContract]
  public class AnalyticsViewMessage
  {
    [DataMember]
    public AnalyticsViewMessageType Type { get; set; }
