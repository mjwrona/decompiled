...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.Contracts.ProviderSyncDataCondition
...
{
  [DataContract]
  public class ProviderSyncDataCondition
  {
    [DataMember(IsRequired = true, EmitDefaultValue = true)]
    public string ProviderTableName { get; set; }

    [DataMember(IsRequired = true, EmitDefaultValue = true)]
    public DateTimeOffset ExpectedSyncDate { get; set; }
  }
}
