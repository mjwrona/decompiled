...
// Type: Microsoft.VisualStudio.Services.Analytics.WebApi.AnalyticsViewDataNotFoundException
...
{
  [Serializable]
  public class AnalyticsViewDataNotFoundException : VssServiceException
  {
    public AnalyticsViewDataNotFoundException(string message)
      : base(message)
    {
    }

    public AnalyticsViewDataNotFoundException(string message, Exception innerException)
