...
// Type: Microsoft.VisualStudio.Services.Search.Common.Arriba.Expressions.NotExpression
...
{
  public class NotExpression : RelevanceExpression
  {
    public NotExpression(IExpression part) => this.Children = new IExpression[1]
    {
      part
    };

    public override IExpression[] Children { get; set; }

    public override string ToString() => "NOT(" + this.Children[0]?.ToString() + ")";
  }
}
