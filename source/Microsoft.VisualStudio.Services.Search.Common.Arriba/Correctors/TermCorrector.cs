...
// Type: Microsoft.VisualStudio.Services.Search.Common.Arriba.Correctors.TermCorrector
...
namespace Microsoft.VisualStudio.Services.Search.Common.Arriba.Correctors
{
  ...
  {
    public IExpression Correct(IVssRequestContext requestContext, IExpression expression) => CorrectorTraverser.CorrectTerms(requestContext, expression, (ICorrector) this);

    public abstract IExpression CorrectTerm(
