...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Common.NotificationTokenAcquisitionException
...
{
  public class NotificationTokenAcquisitionException : Exception
  {
    public NotificationTokenAcquisitionException(string reason) => this.Reason = reason;
