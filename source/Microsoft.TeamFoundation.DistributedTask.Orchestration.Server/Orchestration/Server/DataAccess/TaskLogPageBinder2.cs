...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskLogPageBinder2
...
{
  internal class TaskLogPageBinder2 : ObjectBinder<TaskLogPage>
  {
    ...
    private SqlColumnBinder m_blobFileId = new SqlColumnBinder("BlobFileId");
    ...
    protected override TaskLogPage Bind() => new TaskLogPage()
    {
      ...
      BlobFileId = this.m_blobFileId.GetString((IDataReader) this.Reader, true)
    };
  }
}
