...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskOrchestrationPlanBinder3
...
{
  internal sealed class TaskOrchestrationPlanBinder3 : ObjectBinder<TaskOrchestrationPlan>
  {
    ...
    public TaskOrchestrationPlanBinder3(TaskTrackingComponent component) => this.m_component = component;
