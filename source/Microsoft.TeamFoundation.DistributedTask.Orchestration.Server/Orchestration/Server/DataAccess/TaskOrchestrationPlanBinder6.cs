...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskOrchestrationPlanBinder6
...
{
  internal sealed class TaskOrchestrationPlanBinder6 : ObjectBinder<TaskOrchestrationPlan>
  {
    ...
    public TaskOrchestrationPlanBinder6(TaskTrackingComponent component) => this.m_component = component;
    ...
    protected override TaskOrchestrationPlan Bind()
    {
      ...
      orchestrationPlan.ProcessType = (OrchestrationProcessType) this.m_processType.GetByte((IDataReader) this.Reader);
      ...
      orchestrationPlan.Definition = JsonUtility.Deserialize<TaskOrchestrationOwner>(this.m_definitionReference.GetBytes((IDataReader) this.Reader, true));
      orchestrationPlan.Owner = JsonUtility.Deserialize<TaskOrchestrationOwner>(this.m_ownerReference.GetBytes((IDataReader) this.Reader, true));
