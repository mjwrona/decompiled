...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskOrchestrationPlanReferenceBinder4
...
{
  internal sealed class TaskOrchestrationPlanReferenceBinder4 : 
    ObjectBinder<TaskOrchestrationPlanReference>
  {
    ...
    public TaskOrchestrationPlanReferenceBinder4(TaskTrackingComponent component) => this.m_component = component;
    ...
    protected override TaskOrchestrationPlanReference Bind() => new TaskOrchestrationPlanReference()
    {
      ...
      PlanGroup = this.m_planGroup.GetString((IDataReader) this.Reader, true),
      ...
      ProcessType = (OrchestrationProcessType) this.m_processType.GetByte((IDataReader) this.Reader),
      Definition = JsonUtility.Deserialize<TaskOrchestrationOwner>(this.m_definitionReference.GetBytes((IDataReader) this.Reader, true)),
      Owner = JsonUtility.Deserialize<TaskOrchestrationOwner>(this.m_ownerReference.GetBytes((IDataReader) this.Reader, true))
    };
  }
}
