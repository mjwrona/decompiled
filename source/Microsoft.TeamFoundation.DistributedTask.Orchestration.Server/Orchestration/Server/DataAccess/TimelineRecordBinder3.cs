...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TimelineRecordBinder3
...
{
  internal class TimelineRecordBinder3 : ObjectBinder<TimelineRecord>
  {
    ...
    protected override TimelineRecord Bind()
    {
      ...
      Guid? nullableGuid = this.m_detailTimelineId.GetNullableGuid((IDataReader) this.Reader);
      if (nullableGuid.HasValue)
        timelineRecord1.Details = new TimelineReference()
        {
          Id = nullableGuid.Value,
