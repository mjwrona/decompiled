...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskOrchestrationPlanBinder2
...
{
  internal sealed class TaskOrchestrationPlanBinder2 : ObjectBinder<TaskOrchestrationPlan>
  {
    ...
    public TaskOrchestrationPlanBinder2(TaskTrackingComponent component) => this.m_component = component;
