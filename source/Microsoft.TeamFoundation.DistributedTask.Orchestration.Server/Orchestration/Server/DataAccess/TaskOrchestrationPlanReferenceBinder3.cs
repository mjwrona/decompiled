...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskOrchestrationPlanReferenceBinder3
...
{
  internal sealed class TaskOrchestrationPlanReferenceBinder3 : 
    ObjectBinder<TaskOrchestrationPlanReference>
  {
    ...
    public TaskOrchestrationPlanReferenceBinder3(TaskTrackingComponent component) => this.m_component = component;
