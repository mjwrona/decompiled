...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskTrackingComponent10
...
{
  internal class TaskTrackingComponent10 : TaskTrackingComponent9
  {
    public override TaskHub CreateHub(string name, string dataspaceCategory)
    {
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) this, nameof (CreateHub)))
      {
        ...
        {
          resultCollection.AddBinder<TaskHub>((ObjectBinder<TaskHub>) new TaskHubBinder2());
    ...
    public override async Task<TaskOrchestrationPlan> GetPlanAsync(
      ...
      Guid planId)
    {
      TaskTrackingComponent10 component = this;
      ...
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) component, nameof (GetPlanAsync)))
      {
        ...
        {
          resultCollection.AddBinder<TaskOrchestrationPlan>((ObjectBinder<TaskOrchestrationPlan>) new TaskOrchestrationPlanBinder4((TaskTrackingComponent) component));
