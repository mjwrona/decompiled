...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskTrackingComponent27
...
{
  internal class TaskTrackingComponent27 : TaskTrackingComponent26
  {
      ...
      IList<string> timelineRecordTypes)
    {
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) this, nameof (GetPlans)))
      {
        ...
        this.BindStringTable("@recordTypes", timelineRecordTypes.Distinct<string>((IEqualityComparer<string>) StringComparer.Ordinal));
    ...
    protected override ObjectBinder<TimelineRecord> GetTimelineRecordBinder() => (ObjectBinder<TimelineRecord>) new TimelineRecordBinder7();
  }
}
