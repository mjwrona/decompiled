...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Server.DataAccess.TaskTrackingComponent43
...
{
  internal class TaskTrackingComponent43 : TaskTrackingComponent42
  {
      ...
      bool createExpandedYaml)
    {
      using (new TaskSqlComponentBase.SqlMethodScope((TaskSqlComponentBase) this, nameof (CreatePlan)))
      {
        ...
        this.BindString("@artifactUri", plan.ArtifactUri.ToString(), 512, BindStringBehavior.Unchanged, SqlDbType.NVarChar);
        ...
        this.BindBoolean("@createExpandedYaml", createExpandedYaml);
