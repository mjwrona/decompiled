...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.Tasks.RunCheckpoint
...
{
  public class RunCheckpoint : TaskOrchestration<bool, RunCheckpointInput, object, bool>
  {
    ...
    public override async Task<bool> RunTask(OrchestrationContext context, RunCheckpointInput input)
    {
      ...
      return string.Equals(decision?.Result, "Approved", StringComparison.OrdinalIgnoreCase);
    }
  }
}
