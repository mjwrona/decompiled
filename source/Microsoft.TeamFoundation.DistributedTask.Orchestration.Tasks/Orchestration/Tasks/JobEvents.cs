...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Tasks.JobEvents
...
namespace Microsoft.TeamFoundation.DistributedTask.Orchestration.Tasks
{
  internal static class JobEvents
  {
    ...
    public const string JobCanceled = "JobCanceled";
    public const string JobMetadataUpdate = "JobMetadataUpdate";
  }
}
