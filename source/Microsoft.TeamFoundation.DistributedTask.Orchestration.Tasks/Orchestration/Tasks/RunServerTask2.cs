...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Tasks.RunServerTask2
...
{
  internal sealed class RunServerTask2 : 
    TaskOrchestration<JobResult, RunServerTaskInput, object, string>
  {
      ...
      TaskInstance taskInstance)
    {
      ...
      RunServerTask2.InvokeTaskHandlerResponse taskHandlerResponse = new RunServerTask2.InvokeTaskHandlerResponse();
      taskHandlerResponse.IsCompleted = true;
      taskHandlerResponse.JobResult = new JobResult()
      {
        Result = TaskResult.Failed
      };
      RunServerTask2.InvokeTaskHandlerResponse invokeTaskHandlerResponse = taskHandlerResponse;
      ...
      {
        RunServerTask2.DisposeCancellationToken(retryTaskToken);
        RunServerTask2.DisposeCancellationToken(taskExecutionTimerCancelTokenSource);
      }
    ...
    private async Task<RunServerTask2.InvokeTaskHandlerResponse> InvokeTaskHandler(
      OrchestrationContext context,
      TaskInstance taskInstance,
      ...
      ServerTaskExecutionContext executionContext)
    {
      ...
      try
      {
        ...
        while (waitQueue.Count >= 1)
        {
          ...
          RunServerTask2.WaitEventData waitEventDetails = this.GetWaitEventDetails(context, eventName);
          taskList.Add(waitEventDetails.WaitTask);
          RunServerTask2.DisposeCancellationToken(eventsTimerCancel);
...
label_37:
    ...
    private RunServerTask2.WaitEventData GetWaitEventDetails(
      OrchestrationContext context,
      string eventName)
    {
      ...
      return new RunServerTask2.WaitEventData()
      {
        WaitTask = task,
        Timeout = nullable
      };
