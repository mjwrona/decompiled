...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Tasks.RunPlan3
...
{
  internal sealed class RunPlan3 : TaskOrchestration<TaskResult, RunPlanInput3, object, string>
  {
      ...
      TaskOrchestrationContainer item)
    {
      ...
      if (item.Parallel)
      {
        ...
        while (allTasks.Count > 0)
        {
          ...
          containerResult = RunPlan3.Merge(containerResult, jobResult);
      ...
      bool continueOnError)
    {
      ...
      try
      {
        ...
        Task<TaskResult> jobTask = context.CreateSubOrchestrationInstance<TaskResult>("RunAgentJob", "3.0", jobInstanceId, (object) input1);
