...
// Type: Microsoft.TeamFoundation.DistributedTask.Orchestration.Tasks.IAgentPoolExtension3
...
{
  public interface IAgentPoolExtension3
  {
    Task CancelJob(
      int poolId,
      long requestId,
    ...
    Task StartJob(int poolId, long requestId, Guid scopeId, Guid planId, Guid jobId);
  }
}
