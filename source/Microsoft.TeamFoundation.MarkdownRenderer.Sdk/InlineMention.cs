...
// Type: Microsoft.TeamFoundation.MarkdownRenderer.InlineMention
...
{
  public class InlineMention : LiteralInline
  {
    public InlineMention(Microsoft.TeamFoundation.Mention.Server.Mention mention) => this.Mention = mention;

    public Microsoft.TeamFoundation.Mention.Server.Mention Mention { get; set; }
  }
}
