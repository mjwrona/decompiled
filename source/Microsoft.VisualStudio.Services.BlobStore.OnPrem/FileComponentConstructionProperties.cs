...
// Type: Microsoft.VisualStudio.Services.BlobStore.OnPrem.FileComponentConstructionProperties
...
{
  public class FileComponentConstructionProperties
  {
    public ISqlConnectionInfo SqlConnectionInfo { get; set; }
