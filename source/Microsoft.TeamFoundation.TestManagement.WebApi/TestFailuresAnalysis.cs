...
// Type: Microsoft.TeamFoundation.TestManagement.WebApi.TestFailuresAnalysis
...
{
  [DataContract]
  public class TestFailuresAnalysis : TestManagementBaseSecuredObject
  {
    public TestFailuresAnalysis()
    {
    }

    public TestFailuresAnalysis(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
