...
// Type: Microsoft.TeamFoundation.Favorites.IFavoriteStoreClientFactory
...
{
  internal interface IFavoriteStoreClientFactory
  {
    IAccountIdentityFavorites GetAccountStore(
      IVssRequestContext tfsRequestContext,
      OwnerScope owner);

    IProjectIdentityFavorites GetProjectStore(
      IVssRequestContext tfsRequestContext,
      OwnerScope owner,
      Guid projectGuid,
      string scope);
