...
// Type: Microsoft.TeamFoundation.Dashboards.Services.TestResultsTrendsWidgetAdapter
...
{
  public class TestResultsTrendsWidgetAdapter : WidgetAdapterBase
  {
      ...
      CopyDashboardParameterHandler copyDashboardParameterHandler = null)
    {
      ...
      {
        dictionary["buildDefinition"] = (object) null;
        dictionary["releaseDefinition"] = (object) null;
        dictionary["releaseEnvironment"] = (object) null;
