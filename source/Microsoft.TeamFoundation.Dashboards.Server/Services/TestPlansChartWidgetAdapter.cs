...
// Type: Microsoft.TeamFoundation.Dashboards.Services.TestPlansChartWidgetAdapter
...
{
  public class TestPlansChartWidgetAdapter : WidgetAdapterBase
  {
      ...
      CopyDashboardParameterHandler copyDashboardParameterHandler = null)
    {
      ...
      if (targetDashboardConsumer.GetDataspaceId() != sourceDashboardConsumer.GetDataspaceId() && JsonUtilities.TryDeserialize<Dictionary<string, object>>(widget1.Settings, out dictionary1, true))
      {
        Dictionary<string, object> dictionary2 = JsonUtilities.Deserialize<Dictionary<string, object>>(dictionary1["transformOptions"].ToString(), true);
        dictionary2["filter"] = (object) null;
        dictionary1["transformOptions"] = (object) dictionary2;
