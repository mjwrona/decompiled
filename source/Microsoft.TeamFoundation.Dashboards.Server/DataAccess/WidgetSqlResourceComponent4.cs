...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.WidgetSqlResourceComponent4
...
{
  public class WidgetSqlResourceComponent4 : WidgetSqlResourceComponent
  {
    private static readonly SqlMetaData[] typ_WidgetTable2 = new SqlMetaData[11]
    {
      ...
      IEnumerable<WidgetDataModel> rows)
    {
      ...
      System.Func<WidgetDataModel, SqlDataRecord> selector = (System.Func<WidgetDataModel, SqlDataRecord>) (widget =>
      {
        ...
        SqlDataRecord record = new SqlDataRecord(WidgetSqlResourceComponent4.typ_WidgetTable2);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
      ...
      return this.BindTable(parameterName, "Dashboards.typ_WidgetTable2", rows.Select<WidgetDataModel, SqlDataRecord>(selector));
    }
    ...
    public override Widget GetWidgetById(Guid dataspaceId, Guid id)
    {
      ...
      return items == null || items.Count <= 0 ? (Widget) null : items[0];
    }

    public override IEnumerable<Widget> GetWidgetsByDashboardId(Guid dataspaceId, Guid dashboardId)
    {
