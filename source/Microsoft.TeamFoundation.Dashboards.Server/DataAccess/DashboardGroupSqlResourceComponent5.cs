...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.DashboardGroupSqlResourceComponent5
...
{
  public class DashboardGroupSqlResourceComponent5 : DashboardGroupSqlResourceComponent3
  {
    private static readonly SqlMetaData[] typ_DashboardGroupTable4 = new SqlMetaData[7]
    {
      ...
      IEnumerable<DashboardGroupEntryDataModel2> rows)
    {
      ...
      System.Func<DashboardGroupEntryDataModel2, SqlDataRecord> selector = (System.Func<DashboardGroupEntryDataModel2, SqlDataRecord>) (dashboardGroup =>
      {
        ...
        SqlDataRecord record = new SqlDataRecord(DashboardGroupSqlResourceComponent5.typ_DashboardGroupTable4);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
      ...
      return this.BindTable(parameterName, "Dashboards.typ_DashboardGroupTable4", rows.Select<DashboardGroupEntryDataModel2, SqlDataRecord>(selector));
    }
