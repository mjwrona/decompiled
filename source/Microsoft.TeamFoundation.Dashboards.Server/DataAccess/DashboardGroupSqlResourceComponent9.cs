...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.DashboardGroupSqlResourceComponent9
...
{
  public class DashboardGroupSqlResourceComponent9 : DashboardGroupSqlResourceComponent8
  {
      ...
      IEnumerable<DashboardGroupEntryDataModel2> rows)
    {
      ...
      System.Func<DashboardGroupEntryDataModel2, SqlDataRecord> selector = (System.Func<DashboardGroupEntryDataModel2, SqlDataRecord>) (dashboardGroup =>
      {
        ...
        SqlDataRecord record = new SqlDataRecord(DashboardGroupSqlResourceComponent9.typ_DashboardGroupTable6);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
