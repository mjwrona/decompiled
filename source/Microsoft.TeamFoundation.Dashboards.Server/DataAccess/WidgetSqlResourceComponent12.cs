...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.WidgetSqlResourceComponent12
...
{
  public class WidgetSqlResourceComponent12 : WidgetSqlResourceComponent11
  {
      ...
      IEnumerable<DashboardGroupEntryDataModel2> rows)
    {
      ...
      System.Func<DashboardGroupEntryDataModel2, SqlDataRecord> selector = (System.Func<DashboardGroupEntryDataModel2, SqlDataRecord>) (dashboardGroup =>
      {
        ...
        SqlDataRecord record = new SqlDataRecord(WidgetSqlResourceComponent12.typ_DashboardGroupTable7);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
        ...
        record.SetDateTime(ordinal11, dashboardGroup.ModifiedDate);
        int ordinal12 = num11;
        int num12 = ordinal12 + 1;
        record.SetDateTime(ordinal12, dashboardGroup.LastAccessedDate);
        return record;
      });
