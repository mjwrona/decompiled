...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.DashboardGroupSqlResourceComponent2
...
{
  public class DashboardGroupSqlResourceComponent2 : DashboardGroupSqlResourceComponent
  {
    private static readonly SqlMetaData[] typ_DashboardGroupTable2 = new SqlMetaData[5]
    {
      ...
      Guid id)
    {
      ...
      List<DashboardGroupEntry> items = resultCollection.GetCurrent<DashboardGroupEntry>().Items;
      return !items.Any<DashboardGroupEntry>() ? (DashboardGroupEntry) null : items[0];
    }
      ...
      IEnumerable<DashboardGroupEntryDataModel2> rows)
    {
      ...
      System.Func<DashboardGroupEntryDataModel2, SqlDataRecord> selector = (System.Func<DashboardGroupEntryDataModel2, SqlDataRecord>) (dashboardGroup =>
      {
        ...
        SqlDataRecord sqlDataRecord = new SqlDataRecord(DashboardGroupSqlResourceComponent2.typ_DashboardGroupTable2);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
      ...
      return this.BindTable(parameterName, "Dashboards.typ_DashboardGroupTable2", rows.Select<DashboardGroupEntryDataModel2, SqlDataRecord>(selector));
    }

    protected override void BindScope(DashboardScope scope) => this.BindInt("@scope", (int) scope);
  }
}
