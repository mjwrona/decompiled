...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.DashboardGroupSqlResourceComponent7
...
{
  public class DashboardGroupSqlResourceComponent7 : DashboardGroupSqlResourceComponent5
  {
    private static readonly SqlMetaData[] typ_DashboardGroupTable5 = new SqlMetaData[8]
    {
      ...
      IEnumerable<DashboardGroupEntryDataModel2> rows)
    {
      ...
      System.Func<DashboardGroupEntryDataModel2, SqlDataRecord> selector = (System.Func<DashboardGroupEntryDataModel2, SqlDataRecord>) (dashboardGroup =>
      {
        ...
        SqlDataRecord record = new SqlDataRecord(DashboardGroupSqlResourceComponent7.typ_DashboardGroupTable5);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
      ...
      return this.BindTable(parameterName, "Dashboards.typ_DashboardGroupTable5", rows.Select<DashboardGroupEntryDataModel2, SqlDataRecord>(selector));
    }
  }
}
