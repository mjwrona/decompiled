...
// Type: Microsoft.TeamFoundation.Dashboards.DataAccess.WidgetSqlResourceComponent9
...
{
  public class WidgetSqlResourceComponent9 : WidgetSqlResourceComponent6
  {
    private static readonly SqlMetaData[] typ_WidgetTable4 = new SqlMetaData[14]
    {
      ...
      new SqlMetaData("Settings", SqlDbType.NVarChar, SqlMetaData.Max),
      ...
      IEnumerable<WidgetDataModel> rows)
    {
      ...
      System.Func<WidgetDataModel, SqlDataRecord> selector = (System.Func<WidgetDataModel, SqlDataRecord>) (widget =>
      {
        ...
        SqlDataRecord record = new SqlDataRecord(WidgetSqlResourceComponent9.typ_WidgetTable4);
        int ordinal1 = 0;
        int num1 = ordinal1 + 1;
        ...
        int ordinal9 = num8;
        int num9 = ordinal9 + 1;
        record.SetNullableString(ordinal9, this.GetWidgetSettings(widget.Settings));
        int ordinal10 = num9;
      ...
      return this.BindTable(parameterName, "Dashboards.typ_WidgetTable4", rows.Select<WidgetDataModel, SqlDataRecord>(selector));
    }

    private string GetWidgetSettings(string settings) => !string.IsNullOrEmpty(settings) && settings.Length > 16000 ? settings.Substring(0, 16000) : settings;
  }
}
