...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.PackageNotDeletedException
...
{
  [Serializable]
  public class PackageNotDeletedException : VssServiceException
  {
    public PackageNotDeletedException()
    {
    }

    public PackageNotDeletedException(string message)
      : base(message)
    {
    }

    public PackageNotDeletedException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected PackageNotDeletedException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
