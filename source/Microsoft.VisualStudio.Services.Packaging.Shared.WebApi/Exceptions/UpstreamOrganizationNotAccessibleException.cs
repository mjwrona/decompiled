...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.UpstreamOrganizationNotAccessibleException
...
{
  public class UpstreamOrganizationNotAccessibleException : UpstreamSourceNotFoundException
  {
    public UpstreamOrganizationNotAccessibleException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public UpstreamOrganizationNotAccessibleException(string message)
      : base(message)
    {
    }
  }
