...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.InvalidPublishRequestException
...
{
  public class InvalidPublishRequestException : VssServiceException
  {
    ...
    public InvalidPublishRequestException(string message, Exception innerException)
