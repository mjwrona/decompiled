...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.ViewOperationException
...
{
  public class ViewOperationException : VssServiceException
  {
    ...
    public ViewOperationException(string message, Exception innerException)
