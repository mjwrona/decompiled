...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.PackageBlockedPublishException
...
{
  public class PackageBlockedPublishException : VssServiceException
  {
    public PackageBlockedPublishException(string message)
      : base(message)
    {
    }

    public PackageBlockedPublishException(string message, Exception innerException)
