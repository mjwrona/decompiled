...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.CannotMixFilesFromDifferentUpstreamsException
...
{
  public class CannotMixFilesFromDifferentUpstreamsException : VssServiceException
  {
    public CannotMixFilesFromDifferentUpstreamsException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public CannotMixFilesFromDifferentUpstreamsException(string message)
      : base(message)
    {
    }
  }
