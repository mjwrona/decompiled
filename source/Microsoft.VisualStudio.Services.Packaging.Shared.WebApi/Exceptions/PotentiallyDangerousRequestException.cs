...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.PotentiallyDangerousRequestException
...
{
  public class PotentiallyDangerousRequestException : VssServiceException
  {
    public PotentiallyDangerousRequestException(string message)
      : base(message)
    {
    }

    public PotentiallyDangerousRequestException(string message, Exception innerException)
