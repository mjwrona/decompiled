...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.PackageDeletedException
...
{
  [Serializable]
  public class PackageDeletedException : VssServiceException
  {
    public PackageDeletedException()
    {
    }

    public PackageDeletedException(string message)
      : base(message)
    {
    }

    public PackageDeletedException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected PackageDeletedException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
