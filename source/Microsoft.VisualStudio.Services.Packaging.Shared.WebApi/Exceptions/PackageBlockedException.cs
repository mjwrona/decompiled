...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.PackageBlockedException
...
{
  public class PackageBlockedException : VssServiceException
  {
    public PackageBlockedException(string message)
      : base(message)
    {
    }

    public PackageBlockedException(string message, Exception innerException)
