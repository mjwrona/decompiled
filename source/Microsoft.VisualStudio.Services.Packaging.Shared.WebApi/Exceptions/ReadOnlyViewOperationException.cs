...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.ReadOnlyViewOperationException
...
{
  public class ReadOnlyViewOperationException : VssServiceException
  {
    public ReadOnlyViewOperationException(string message)
      : base(message)
    {
    }

    public ReadOnlyViewOperationException(string message, Exception innerException)
