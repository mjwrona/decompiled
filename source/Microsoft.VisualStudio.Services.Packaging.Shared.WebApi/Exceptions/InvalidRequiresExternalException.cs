...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.InvalidRequiresExternalException
...
{
  public class InvalidRequiresExternalException : VssServiceException
  {
    public InvalidRequiresExternalException(string message)
      : base(message)
    {
    }
  }
