...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.InvalidProjectUrlException
...
{
  [Serializable]
  public class InvalidProjectUrlException : VssServiceException
  {
    public InvalidProjectUrlException(string message)
      : base(message)
    {
    }
  }
