...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.InvalidUpstreamSourceDuplicateVersionsException
...
{
  public class InvalidUpstreamSourceDuplicateVersionsException : VssServiceException
  {
    public InvalidUpstreamSourceDuplicateVersionsException(string message)
      : base(message)
    {
    }

    public InvalidUpstreamSourceDuplicateVersionsException(string message, Exception innerException)
