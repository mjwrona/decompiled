...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.UpstreamUnexpectedPackageDataException
...
{
  public class UpstreamUnexpectedPackageDataException : VssServiceException
  {
    public UpstreamUnexpectedPackageDataException(string message)
      : base(message)
    {
    }

    public UpstreamUnexpectedPackageDataException(string message, Exception innerException)
