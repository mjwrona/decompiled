...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.UpstreamSourceNotFoundException
...
{
  public class UpstreamSourceNotFoundException : VssServiceException
  {
    public UpstreamSourceNotFoundException()
    {
    }

    public UpstreamSourceNotFoundException(string message)
      : base(message)
    {
    }

    public UpstreamSourceNotFoundException(string message, Exception innerException)
