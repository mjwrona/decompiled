...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.ReadOnlyFeedOperationException
...
{
  [Serializable]
  public class ReadOnlyFeedOperationException : VssServiceException
  {
    public ReadOnlyFeedOperationException(string message)
      : base(message)
    {
    }
  }
