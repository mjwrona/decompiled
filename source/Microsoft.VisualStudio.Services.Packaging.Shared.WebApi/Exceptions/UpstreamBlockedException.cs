...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.UpstreamBlockedException
...
{
  public class UpstreamBlockedException : VssServiceException
  {
    public UpstreamBlockedException()
    {
    }

    public UpstreamBlockedException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public UpstreamBlockedException(string message)
      : base(message)
    {
    }
  }
