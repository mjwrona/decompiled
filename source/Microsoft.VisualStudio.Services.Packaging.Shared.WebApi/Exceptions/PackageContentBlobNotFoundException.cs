...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.PackageContentBlobNotFoundException
...
{
  public class PackageContentBlobNotFoundException : VssServiceException
  {
    public PackageContentBlobNotFoundException(string message)
      : base(message)
    {
    }

    public static PackageContentBlobNotFoundException Create(string blobId) => new PackageContentBlobNotFoundException(Resources.Error_PackageContentBlobNotFound());
  }
}
