...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.IngestionProhibitedException
...
{
  public class IngestionProhibitedException : VssServiceException
  {
    public IngestionProhibitedException(string message)
      : base(message)
    {
    }
  }
