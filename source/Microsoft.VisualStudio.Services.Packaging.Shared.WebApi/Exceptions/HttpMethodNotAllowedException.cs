...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.Exceptions.HttpMethodNotAllowedException
...
{
  [Serializable]
  public class HttpMethodNotAllowedException : VssServiceException
  {
    ...
    public HttpMethodNotAllowedException(string message, Exception innerException)
