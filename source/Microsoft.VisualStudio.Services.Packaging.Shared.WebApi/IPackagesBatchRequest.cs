...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.IPackagesBatchRequest
...
{
  public interface IPackagesBatchRequest
  {
    BatchOperationData Data { get; set; }

    IBatchOperationType GetOperationType();

    IEnumerable<MinimalPackageDetails> Packages { get; set; }
  }
}
