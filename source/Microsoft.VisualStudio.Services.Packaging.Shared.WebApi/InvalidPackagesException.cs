...
// Type: Microsoft.VisualStudio.Services.Packaging.Shared.WebApi.InvalidPackagesException
...
{
  [Serializable]
  public class InvalidPackagesException : VssServiceException
  {
    public InvalidPackagesException(string message)
      : base(message)
    {
    }
  }
