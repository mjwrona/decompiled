...
// Type: Microsoft.TeamFoundation.Build.WebApi.Events.BuildTagsAddedEvent
...
namespace Microsoft.TeamFoundation.Build.WebApi.Events
{
  ...
  {
    public BuildTagsAddedEvent(Microsoft.TeamFoundation.Build.WebApi.Build build, List<string> allTags, List<string> newTags)
      : base(build)
    {
