...
// Type: Microsoft.TeamFoundation.Build.WebApi.AgentTargetExecutionOptions
...
namespace Microsoft.TeamFoundation.Build.WebApi
{
  ...
  public class AgentTargetExecutionOptions : BaseSecuredObject
  {
    ...
    internal AgentTargetExecutionOptions(ISecuredObject securedObject)
      : this(0, securedObject)
    {
    }

    internal AgentTargetExecutionOptions(int type, ISecuredObject securedObject)
      : base(securedObject)
    {
      this.Type = type;
    }
