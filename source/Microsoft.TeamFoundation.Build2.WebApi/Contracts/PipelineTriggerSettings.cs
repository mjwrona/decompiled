...
// Type: Microsoft.TeamFoundation.Build.WebApi.Contracts.PipelineTriggerSettings
...
namespace Microsoft.TeamFoundation.Build.WebApi.Contracts
{
  [DataContract]
  public sealed class PipelineTriggerSettings : BaseSecuredObject
  {
    public PipelineTriggerSettings()
    {
    }

    internal PipelineTriggerSettings(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
