...
// Type: Microsoft.TeamFoundation.Build.WebApi.BuildRequestValidationWarningException
...
{
  [ExceptionMapping("0.0", "4.1", "BuildRequestValidationFailedException", "Microsoft.TeamFoundation.Build.WebApi.BuildRequestValidationFailedException, Microsoft.TeamFoundation.Build2.WebApi, Version=14.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class BuildRequestValidationWarningException : BuildException
  {
    ...
    public BuildRequestValidationWarningException(
      string message,
    ...
    protected BuildRequestValidationWarningException(
