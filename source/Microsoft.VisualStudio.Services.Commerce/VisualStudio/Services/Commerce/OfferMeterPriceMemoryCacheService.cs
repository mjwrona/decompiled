...
// Type: Microsoft.VisualStudio.Services.Commerce.OfferMeterPriceMemoryCacheService
...
{
  internal class OfferMeterPriceMemoryCacheService : 
    VssMemoryCacheService<string, OfferMeterPriceCacheContainer>,
    IOfferMeterPriceMemoryCacheService,
    IVssFrameworkService,
    ICommerceMemoryCache<OfferMeterPriceCacheContainer>
  {
    ...
    public OfferMeterPriceMemoryCacheService()
      : base(OfferMeterPriceMemoryCacheService.defaultCleanupInterval)
    {
      this.InactivityInterval.Value = OfferMeterPriceMemoryCacheService.defaultMaxCacheInactivityAge;
    }
