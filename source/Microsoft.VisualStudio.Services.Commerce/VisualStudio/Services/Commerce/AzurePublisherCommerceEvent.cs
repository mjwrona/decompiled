...
// Type: Microsoft.VisualStudio.Services.Commerce.AzurePublisherCommerceEvent
...
{
  public class AzurePublisherCommerceEvent : TableEntity, ICommerceEvent
  {
    public AzurePublisherCommerceEvent()
    {
    }

    public AzurePublisherCommerceEvent(string galleryId, string eventId)
    {
      this.PartitionKey = this.GalleryId = galleryId;
