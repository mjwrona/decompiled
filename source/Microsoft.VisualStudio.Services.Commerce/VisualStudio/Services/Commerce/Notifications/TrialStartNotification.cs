...
// Type: Microsoft.VisualStudio.Services.Commerce.Notifications.TrialStartNotification
...
{
  public class TrialStartNotification : TrialNotification
  {
    private const string Layer = "TrialStartNotification";
      ...
      int includedQuantity)
    {
      ...
      {
        collectionContext.Trace(5109164, TraceLevel.Error, "Commerce", nameof (TrialStartNotification), "No notification is published since offerMeterName is null");
      }
      else
      {
        ...
        string buyLink;
        this.PopulateEmailLinks(collectionContext, offerMeter, out extensionLink, out buyLink);
        ...
        extensionTrialEvent.NotificationType = this.GetNotificationType(offerMeter?.GalleryId, "trial-started");
