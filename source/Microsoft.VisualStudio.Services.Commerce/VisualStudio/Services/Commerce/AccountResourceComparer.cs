...
// Type: Microsoft.VisualStudio.Services.Commerce.AccountResourceComparer
...
{
  public class AccountResourceComparer : IEqualityComparer<AccountResource>
  {
    public bool Equals(AccountResource x, AccountResource y)
    {
      if (x == null && y == null)
        return true;
    ...
    public int GetHashCode(AccountResource x) => x.id.GetHashCode();
  }
}
