...
// Type: Microsoft.VisualStudio.Services.Commerce.WebApi.CommerceToSpsResourceMigrationHttpClient
...
namespace Microsoft.VisualStudio.Services.Commerce.WebApi
{
  ...
  public class CommerceToSpsResourceMigrationHttpClient : VssHttpClientBase
  {
    public CommerceToSpsResourceMigrationHttpClient(Uri baseUrl, VssCredentials credentials)
      : base(baseUrl, credentials)
    {
    }

    public CommerceToSpsResourceMigrationHttpClient(
      Uri baseUrl,
    ...
    {
      CommerceToSpsResourceMigrationHttpClient migrationHttpClient1 = this;
      HttpMethod httpMethod = new HttpMethod("PATCH");
      Guid guid = new Guid("2F11E604-83B2-4596-B3C6-242BAB102DA3");
      ...
      CommerceToSpsResourceMigrationHttpClient migrationHttpClient2 = migrationHttpClient1;
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      object userState1 = obj;
      CancellationToken cancellationToken2 = cancellationToken1;
      using (await migrationHttpClient2.SendAsync(method, locationId, version: version, content: content, queryParameters: queryParameters, userState: userState1, cancellationToken: cancellationToken2).ConfigureAwait(false))
        ;
    }
