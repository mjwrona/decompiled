...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.VSCodeExtensionInvalidPricingTagException
...
{
  [Serializable]
  public class VSCodeExtensionInvalidPricingTagException : VssServiceException
  {
    public VSCodeExtensionInvalidPricingTagException(string message)
      : base(message)
    {
    }

    public VSCodeExtensionInvalidPricingTagException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public VSCodeExtensionInvalidPricingTagException(
      string message,
