...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.DuplicateExtensionDisplayNameException
...
{
  [Serializable]
  public class DuplicateExtensionDisplayNameException : VssServiceException
  {
    public DuplicateExtensionDisplayNameException(string message)
      : base(message)
    {
    }

    public DuplicateExtensionDisplayNameException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public DuplicateExtensionDisplayNameException(
      string message,
