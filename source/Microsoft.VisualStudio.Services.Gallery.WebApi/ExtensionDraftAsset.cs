...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionDraftAsset
...
{
  public class ExtensionDraftAsset : ExtensionFile
  {
    internal bool IsOldAsset { get; set; }

    internal bool IsPayloadAsset { get; set; }
  }
}
