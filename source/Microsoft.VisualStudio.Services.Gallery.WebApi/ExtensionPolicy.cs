...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionPolicy
...
namespace Microsoft.VisualStudio.Services.Gallery.WebApi
{
  ...
  {
    [DataMember]
    public ExtensionPolicyFlags Install { get; set; }

    [DataMember]
    public ExtensionPolicyFlags Request { get; set; }
  }
}
