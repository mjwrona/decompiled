...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionVersionAlreadyExistsException
...
{
  [Serializable]
  public class ExtensionVersionAlreadyExistsException : VssServiceException
  {
    public ExtensionVersionAlreadyExistsException(string message)
      : base(message)
    {
    }

    public ExtensionVersionAlreadyExistsException(string message, Exception innerException)
