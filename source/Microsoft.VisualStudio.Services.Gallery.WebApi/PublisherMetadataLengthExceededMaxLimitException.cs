...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.PublisherMetadataLengthExceededMaxLimitException
...
{
  [Serializable]
  public class PublisherMetadataLengthExceededMaxLimitException : VssServiceException
  {
    ...
    public PublisherMetadataLengthExceededMaxLimitException(
      string message,
