...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.GalleryCookieConsentConstants
...
{
  public static class GalleryCookieConsentConstants
  {
    public const string MSCC = "MSCC";
    public const string AnalyticsConsent = "AnalyticsConsent";
    public const string ConsentEnabled = "CookieConsentEnabled";
    public const string ConsentMarkupJavaScript = "CookieConsentJavaScript";
  }
}
