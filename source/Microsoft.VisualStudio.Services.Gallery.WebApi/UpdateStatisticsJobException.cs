...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.UpdateStatisticsJobException
...
{
  [Serializable]
  public class UpdateStatisticsJobException : VssServiceException
  {
    public UpdateStatisticsJobException(string message)
      : base(message)
    {
    }
  }
