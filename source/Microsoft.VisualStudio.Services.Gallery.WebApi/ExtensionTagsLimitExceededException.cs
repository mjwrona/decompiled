...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionTagsLimitExceededException
...
{
  [Serializable]
  public class ExtensionTagsLimitExceededException : VssServiceException
  {
    public ExtensionTagsLimitExceededException(string message)
      : base(message)
    {
    }

    public ExtensionTagsLimitExceededException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public ExtensionTagsLimitExceededException(
      string message,
