...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.PublisherSpamValidationException
...
{
  [Serializable]
  public class PublisherSpamValidationException : VssServiceException
  {
    public PublisherSpamValidationException(string message)
      : base(message)
    {
    }

    public PublisherSpamValidationException(string message, Exception innerException)
