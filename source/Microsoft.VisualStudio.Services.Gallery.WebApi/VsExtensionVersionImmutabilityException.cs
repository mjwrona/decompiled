...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.VsExtensionVersionImmutabilityException
...
{
  [Serializable]
  public class VsExtensionVersionImmutabilityException : VssServiceException
  {
    public VsExtensionVersionImmutabilityException(string message)
      : base(message)
    {
    }
  }
