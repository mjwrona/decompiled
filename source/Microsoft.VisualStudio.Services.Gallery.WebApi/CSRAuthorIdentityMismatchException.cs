...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.CSRAuthorIdentityMismatchException
...
{
  [Serializable]
  public class CSRAuthorIdentityMismatchException : VssServiceException
  {
    public CSRAuthorIdentityMismatchException(string message)
      : base(message)
    {
    }

    public CSRAuthorIdentityMismatchException(string message, Exception innerException)
