...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.CSRCreateThresholdExceededException
...
{
  [Serializable]
  public class CSRCreateThresholdExceededException : VssServiceException
  {
    public CSRCreateThresholdExceededException(string message)
      : base(message)
    {
    }

    public CSRCreateThresholdExceededException(string message, Exception innerException)
