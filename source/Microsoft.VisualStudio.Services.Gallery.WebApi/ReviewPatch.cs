...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ReviewPatch
...
namespace Microsoft.VisualStudio.Services.Gallery.WebApi
{
  ...
  public class ReviewPatch
  {
    ...
    [DataMember]
    public ReviewPatchOperation Operation { get; set; }

    [DataMember]
    [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
    public UserReportedConcern ReportedConcern { get; set; }
  }
}
