...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionQueryResultMetadataFlags
...
namespace Microsoft.VisualStudio.Services.Gallery.WebApi
{
  ...
  internal enum ExtensionQueryResultMetadataFlags
  {
    ...
    IncludePreCategoryFilterCategories = 2,
    IncludeResultSetCategories = 4,
    IncludeResultSetProjectType = 8,
    IncludeTargetPlatforms = 16, // 0x00000010
  }
}
