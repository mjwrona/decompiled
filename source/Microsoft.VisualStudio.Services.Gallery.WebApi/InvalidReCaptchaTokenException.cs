...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.InvalidReCaptchaTokenException
...
{
  [Serializable]
  public class InvalidReCaptchaTokenException : VssServiceException
  {
    ...
    public InvalidReCaptchaTokenException(string message, Exception innerException)
