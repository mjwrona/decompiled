...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ProductStatisticType
...
{
  public static class ProductStatisticType
  {
    public const string AverageRating = "averagerating";
    public const string MinVotesRequired = "minvotesrequired";
  }
}
