...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.UrlsNotAllowedinPublisherProfileException
...
{
  [Serializable]
  public class UrlsNotAllowedinPublisherProfileException : VssServiceException
  {
    public UrlsNotAllowedinPublisherProfileException(string message)
      : base(message)
    {
    }

    public UrlsNotAllowedinPublisherProfileException(string message, Exception innerException)
