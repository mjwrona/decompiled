...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.AnonymousCustomerSupportRequestException
...
{
  [Serializable]
  public class AnonymousCustomerSupportRequestException : VssServiceException
  {
    public AnonymousCustomerSupportRequestException(string message)
      : base(message)
    {
    }

    public AnonymousCustomerSupportRequestException(string message, Exception innerException)
