...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionCreationLimitExceedException
...
{
  [Serializable]
  public class ExtensionCreationLimitExceedException : VssServiceException
  {
    public ExtensionCreationLimitExceedException(string message)
      : base(message)
    {
    }

    public ExtensionCreationLimitExceedException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public ExtensionCreationLimitExceedException(
      string message,
