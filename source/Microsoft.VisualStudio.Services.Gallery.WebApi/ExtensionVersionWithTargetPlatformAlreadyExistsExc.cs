...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionVersionWithTargetPlatformAlreadyExistsException
...
{
  [Serializable]
  public class ExtensionVersionWithTargetPlatformAlreadyExistsException : VssServiceException
  {
    public ExtensionVersionWithTargetPlatformAlreadyExistsException(string message)
      : base(message)
    {
    }

    public ExtensionVersionWithTargetPlatformAlreadyExistsException(
      string message,
