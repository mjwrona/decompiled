...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionLinkTypeDisabledException
...
{
  [Serializable]
  public class ExtensionLinkTypeDisabledException : VssServiceException
  {
    public ExtensionLinkTypeDisabledException(string message)
      : base(message)
    {
    }
  }
