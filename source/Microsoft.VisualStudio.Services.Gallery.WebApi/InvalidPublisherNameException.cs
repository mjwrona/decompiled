...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.InvalidPublisherNameException
...
{
  [Serializable]
  public class InvalidPublisherNameException : VssServiceException
  {
    ...
    public InvalidPublisherNameException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public InvalidPublisherNameException(string message, Exception innerException, int errorNumber)
      : base(message, innerException)
    {
    }
  }
