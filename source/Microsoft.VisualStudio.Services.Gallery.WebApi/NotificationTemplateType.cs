...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.NotificationTemplateType
...
namespace Microsoft.VisualStudio.Services.Gallery.WebApi
{
  ...
  {
    [EnumMember] ReviewNotification = 1,
    [EnumMember] QnaNotification = 2,
    [EnumMember] CustomerContactNotification = 3,
    [EnumMember] PublisherMemberUpdateNotification = 4,
  }
}
