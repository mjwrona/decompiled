...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.VsVersionNotAllowedForConsolidationException
...
{
  [Serializable]
  public class VsVersionNotAllowedForConsolidationException : VssServiceException
  {
    public VsVersionNotAllowedForConsolidationException(string message)
      : base(message)
    {
    }
  }
