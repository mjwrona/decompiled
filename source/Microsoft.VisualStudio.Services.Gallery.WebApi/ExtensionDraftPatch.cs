...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionDraftPatch
...
{
  public class ExtensionDraftPatch
  {
    public DraftPatchOperation Operation { get; set; }

    public UnpackagedExtensionData ExtensionData { get; set; }
