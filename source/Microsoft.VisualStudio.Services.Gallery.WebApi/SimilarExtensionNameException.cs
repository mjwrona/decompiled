...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.SimilarExtensionNameException
...
{
  [Serializable]
  public class SimilarExtensionNameException : VssServiceException
  {
    public SimilarExtensionNameException(string message)
      : base(message)
    {
    }

    public SimilarExtensionNameException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public SimilarExtensionNameException(string message, Exception innerException, int errorNumber)
      : base(message, innerException)
    {
    }
  }
