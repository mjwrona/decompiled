...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionStatisticUpdate
...
namespace Microsoft.VisualStudio.Services.Gallery.WebApi
{
  public class ExtensionStatisticUpdate
  {
    ...
    public ExtensionStatisticOperation Operation { get; set; }

    public ExtensionStatistic Statistic { get; set; }
  }
}
