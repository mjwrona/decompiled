...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.ExtensionLifecycleEventType
...
{
  [DataContract]
  public enum ExtensionLifecycleEventType
  {
    [EnumMember] Uninstall = 1,
    [EnumMember] Install = 2,
    [EnumMember] Review = 3,
    [EnumMember] Acquisition = 4,
    [EnumMember] Sales = 5,
    [EnumMember] Other = 999, // 0x000003E7
  }
}
