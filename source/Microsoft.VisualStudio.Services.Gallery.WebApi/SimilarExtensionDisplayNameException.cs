...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.SimilarExtensionDisplayNameException
...
{
  [Serializable]
  public class SimilarExtensionDisplayNameException : VssServiceException
  {
    public SimilarExtensionDisplayNameException(string message)
      : base(message)
    {
    }

    public SimilarExtensionDisplayNameException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public SimilarExtensionDisplayNameException(
      string message,
