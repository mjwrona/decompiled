...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.SvgFromNonAllowedHostException
...
{
  [Serializable]
  public class SvgFromNonAllowedHostException : VssServiceException
  {
    public SvgFromNonAllowedHostException(string message)
      : base(message)
    {
    }

    public SvgFromNonAllowedHostException(string message, Exception innerException)
