...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.PublisherDoesNotExistException
...
namespace Microsoft.VisualStudio.Services.Gallery.WebApi
{
  ...
  [Serializable]
  public class PublisherDoesNotExistException : VssServiceException
  {
    ...
    public PublisherDoesNotExistException(
      ...
      int errorNumber)
      : base(GalleryWebApiResources.PublisherDoesNotExist(), innerException)
    {
    }
  }
}
