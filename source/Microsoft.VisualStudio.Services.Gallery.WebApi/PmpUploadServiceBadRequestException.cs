...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.PmpUploadServiceBadRequestException
...
{
  [Serializable]
  public class PmpUploadServiceBadRequestException : VssServiceException
  {
    public PmpUploadServiceBadRequestException(string message)
      : base(message)
    {
    }
  }
