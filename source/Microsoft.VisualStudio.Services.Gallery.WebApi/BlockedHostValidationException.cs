...
// Type: Microsoft.VisualStudio.Services.Gallery.WebApi.BlockedHostValidationException
...
{
  [Serializable]
  public class BlockedHostValidationException : VssServiceException
  {
    public BlockedHostValidationException(string message)
      : base(message)
    {
    }

    public BlockedHostValidationException(string message, Exception innerException)
