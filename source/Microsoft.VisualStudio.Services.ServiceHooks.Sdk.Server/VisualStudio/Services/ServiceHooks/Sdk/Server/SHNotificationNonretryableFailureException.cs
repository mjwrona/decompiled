...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Sdk.Server.SHNotificationNonretryableFailureException
...
{
  [Serializable]
  public class SHNotificationNonretryableFailureException : TeamFoundationServiceException
  {
    public SHNotificationNonretryableFailureException(string message)
      : base(message)
    {
    }

    public SHNotificationNonretryableFailureException(string message, Exception innerException)
