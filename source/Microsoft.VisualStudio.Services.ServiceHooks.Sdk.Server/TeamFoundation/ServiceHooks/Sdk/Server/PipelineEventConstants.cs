...
// Type: Microsoft.TeamFoundation.ServiceHooks.Sdk.Server.PipelineEventConstants
...
{
  public static class PipelineEventConstants
  {
    public static readonly string Retry = "retry";
    public static readonly string NoBuild = "no build";
  }
}
