...
// Type: Microsoft.Azure.Pipelines.Approval.WebApi.ApprovalExistsException
...
{
  [Serializable]
  public sealed class ApprovalExistsException : VssServiceException
  {
    public ApprovalExistsException(string message)
      : base(message)
    {
    }

    public ApprovalExistsException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    private ApprovalExistsException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
