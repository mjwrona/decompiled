...
// Type: Microsoft.Azure.Pipelines.Approval.WebApi.ApprovalBlockedException
...
{
  [Serializable]
  public sealed class ApprovalBlockedException : VssServiceException
  {
    public ApprovalBlockedException(string message)
      : base(message)
    {
    }

    public ApprovalBlockedException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    private ApprovalBlockedException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
