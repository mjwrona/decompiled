...
// Type: Microsoft.Azure.Pipelines.Approval.WebApi.ApprovalException
...
{
  [Serializable]
  public sealed class ApprovalException : VssServiceException
  {
    ...
    public ApprovalException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    private ApprovalException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
