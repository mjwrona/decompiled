...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Internals.GenericDataReader
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Internals
{
    ...
    IEnumerable
  {
    ...
    private IEnumerator<IEnumerable<object>> m_enumerator;
    private object[] m_currentRow;

    public GenericDataReader(IEnumerable<string> columns, IEnumerable<IEnumerable<object>> data)
      : this(GenericDataReader.CreateColumnInfo(columns), data)
    {
    }

    public GenericDataReader(
      ...
      IEnumerable<IEnumerable<object>> data)
    {
      ...
      if (data != null)
        ...
        this.m_enumerator = Enumerable.Empty<IEnumerable<object>>().GetEnumerator();
    }
    ...
    public bool Read()
    {
      ...
      {
        this.m_currentRow = this.m_enumerator.Current.ToArray<object>();
        return true;
      }
    ...
    {
      IEnumerator enumerator = (IEnumerator) new DbEnumerator((IDataReader) this);
