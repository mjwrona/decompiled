...
// Type: Microsoft.VisualStudio.Services.TestManagement.TestPlanning.WebApi.TestSuiteCreateUpdateCommonParams
...
namespace Microsoft.VisualStudio.Services.TestManagement.TestPlanning.WebApi
{
  ...
  public class TestSuiteCreateUpdateCommonParams
  {
    ...
    [DataMember(IsRequired = false, EmitDefaultValue = false)]
    public List<TestConfigurationReference> DefaultConfigurations { get; set; }

    [DataMember(IsRequired = false, EmitDefaultValue = false)]
    public List<IdentityRef> DefaultTesters { get; set; }
  }
}
