...
// Type: Microsoft.VisualStudio.Services.TestManagement.TestPlanning.WebApi.CloneTestCaseParams
...
namespace Microsoft.VisualStudio.Services.TestManagement.TestPlanning.WebApi
{
  ...
  public class CloneTestCaseParams
  {
    ...
    public TestPlanReference sourceTestPlan { get; set; }

    [DataMember(IsRequired = true, EmitDefaultValue = false)]
    public TestPlanReference destinationTestPlan { get; set; }
