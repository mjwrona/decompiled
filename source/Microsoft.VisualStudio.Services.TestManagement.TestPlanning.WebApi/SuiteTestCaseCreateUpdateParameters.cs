...
// Type: Microsoft.VisualStudio.Services.TestManagement.TestPlanning.WebApi.SuiteTestCaseCreateUpdateParameters
...
namespace Microsoft.VisualStudio.Services.TestManagement.TestPlanning.WebApi
{
  public class SuiteTestCaseCreateUpdateParameters
  {
    ...
    public List<Configuration> PointAssignments { get; set; }
  }
}
