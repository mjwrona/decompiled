...
// Type: Microsoft.Azure.Pipelines.Deployment.Sdk.Server.Traceability.Providers.IChangesProvider
...
namespace Microsoft.Azure.Pipelines.Deployment.Sdk.Server.Traceability.Providers
{
  ...
  public interface IChangesProvider
  {
    ...
    TraceabilityChanges GetChanges(
      ...
      int maxItems = 250,
      string continuationTokenVersion = null);

    IList<string> GetDefaultWorkItemsProviderTypes();
  }
}
