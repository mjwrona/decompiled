...
// Type: Microsoft.Azure.Pipelines.Deployment.Sdk.Server.Traceability.Models.PipelineTraceabilityBaseRunDetails
...
{
  public class PipelineTraceabilityBaseRunDetails
  {
    public int baseRunId;
    public string baseRunNumber;
    public string baseRunWebUrl;
  }
}
