...
// Type: Microsoft.Azure.Pipelines.Deployment.Sdk.Server.Artifacts.IPipelineWebHookNotificationService
...
{
  [DefaultServiceImplementation(typeof (FrameworkPipelineWebHookNotificationService))]
  public interface IPipelineWebHookNotificationService : IVssFrameworkService
  {
    void PublishEvent(IVssRequestContext requestContext, VssNotificationEvent notification);
  }
}
