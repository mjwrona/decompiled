...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Client.Wiql.NodeOrOperator
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Client.Wiql
{
  ...
  public class NodeOrOperator : NodeVariableList
  {
    ...
    public override Priority Priority => Priority.OrOperator;

    public override void AppendTo(StringBuilder builder) => this.AppendChildren(builder, " or ");
