...
// Type: Microsoft.Azure.Cosmos.Table.UriQueryBuilder
    ...
    public string this[string name]
    {
      get
      {
        ...
        if (this.Parameters.TryGetValue(name, out str))
          return str;
        throw new KeyNotFoundException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "'{0}' key not found in the query builder.", new object[1]
        {
          (object) name
        }));
      }
