...
// Type: Microsoft.Azure.Cosmos.Table.Queryable.ALinqExpressionVisitor
  ...
  internal abstract class ALinqExpressionVisitor
  {
    internal virtual Expression Visit(Expression exp)
    {
      ...
      switch (exp.NodeType)
      {
        ...
        default:
          throw new NotSupportedException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, "The expression type {0} is not supported.", (object) exp.NodeType.ToString()));
      }
    }
    ...
    internal virtual MemberBinding VisitBinding(MemberBinding binding)
    {
      switch (binding.BindingType)
      {
        ...
        default:
          throw new NotSupportedException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, "The expression type {0} is not supported.", (object) binding.BindingType.ToString()));
      }
    }
      ...
      ReadOnlyCollection<Expression> original)
    {
      ...
      return list != null ? new ReadOnlyCollection<Expression>((IList<Expression>) list) : original;
    }
