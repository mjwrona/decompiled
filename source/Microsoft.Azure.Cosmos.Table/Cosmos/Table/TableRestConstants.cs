...
// Type: Microsoft.Azure.Cosmos.Table.TableRestConstants
...
namespace Microsoft.Azure.Cosmos.Table
{
  internal static class TableRestConstants
  {
    ...
    {
      public static readonly string UserAgentComment = string.Format((IFormatProvider) CultureInfo.InvariantCulture, "(.NET CLR {0}; {1} {2})", (object) Environment.Version, (object) Environment.OSVersion.Platform, (object) Environment.OSVersion.Version);
