...
// Type: Microsoft.TeamFoundation.Diff.DiffFinder`1
...
namespace Microsoft.TeamFoundation.Diff
{
  public abstract class DiffFinder<T> : IDisposable
  {
    ...
    private Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<T> m_predicate;
    ...
    {
      return this.Diff(original, modified, elementComparer, (Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<T>) null);
    }
    ...
    public IList<LineChanges> WordDiff(
      ...
      IList<T> modified)
    {
      return this.WordDiff(lineDiffs, original, modified, (Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<WordPosition>) null);
    }
    ...
    public IList<LineChanges> WordDiff(
      ...
      IList<T> original,
      IList<T> modified,
      Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<WordPosition> continueDiffPredicate)
    {
      ...
      foreach (IDiffChange lineDiff in lineDiffs)
      {
        if (lineDiff.ChangeType == DiffChangeType.Change)
        {
          ...
          IDiffChange[] diffChangeArray = lcsDiff.Diff((IList<WordPosition>) wordPositionArray1, (IList<WordPosition>) wordPositionArray2, (IEqualityComparer<WordPosition>) new DiffFinder<T>.WordComparer(), continueDiffPredicate);
    ...
    public IDiffChange[] Diff(
      ...
      IList<T> modified,
      IEqualityComparer<T> elementComparer,
      Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<T> continueDiffPredicate)
    {
      this.m_original = original;
      this.m_modified = modified;
      this.m_elementComparer = elementComparer;
      this.m_predicate = continueDiffPredicate;
    ...
    public static DiffFinder<T> LcsDiff => (DiffFinder<T>) new Microsoft.TeamFoundation.Diff.LcsDiff<T>();

    protected Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<T> ContinueDifferencePredicate => this.m_predicate;
    ...
    public IDiffChange[] DiffEx(
      ...
      IEqualityComparer<T> secondaryElementComparer)
    {
      return this.DiffEx(original, modified, primaryElementComparer, secondaryElementComparer, (Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<T>) null);
    }
    ...
    public IDiffChange[] DiffEx(
      ...
      IEqualityComparer<T> primaryElementComparer,
      IEqualityComparer<T> secondaryElementComparer,
      Microsoft.TeamFoundation.Diff.ContinueDifferencePredicate<T> predicate)
    {
