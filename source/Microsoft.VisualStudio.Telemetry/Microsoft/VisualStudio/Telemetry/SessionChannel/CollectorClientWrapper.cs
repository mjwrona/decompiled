...
// Type: Microsoft.VisualStudio.Telemetry.SessionChannel.CollectorClientWrapper
...
{
  internal sealed class CollectorClientWrapper : BaseAppInsightsClientWrapper
  {
    private const int MaxTransmissionBufferCapacity = 102400;
    private const string TransportUtc = "utc";
    private const string TransportCollector = "collector";
    ...
    public override bool TryGetTransport(out string transportUsed)
    {
      ...
      {
        transportUsed = this.usedTransport == BaseAppInsightsClientWrapper.Transport.Collector ? "collector" : "utc";
        return true;
      }
    ...
    protected override ITelemetryChannel CreateAppInsightsChannel(TelemetryConfiguration config)
    {
      ...
      if (config.TelemetryChannel == null)
      {
        ...
        persistenceChannel.EndpointAddress = "https://events.data.microsoft.com/OneCollector/1.0";
        ...
        this.usedTransport = BaseAppInsightsClientWrapper.Transport.Collector;
      }
