...
// Type: Microsoft.VisualStudio.Telemetry.IEventProcessorContext
...
namespace Microsoft.VisualStudio.Telemetry
{
  ...
  {
    bool IsEventDropped { get; set; }

    ThrottlingAction ThrottlingAction { get; set; }

    TelemetrySession HostTelemetrySession { get; }

    IEventProcessorRouter Router { get; }

    TelemetryEvent TelemetryEvent { get; }
