...
// Type: Microsoft.VisualStudio.Telemetry.TelemetryManifestActionThrottleBase
...
{
  internal abstract class TelemetryManifestActionThrottleBase : 
    ...
    IEventProcessorAction
  {
    ...
    {
      this.ExecuteThrottlingAction(eventProcessorContext);
      return true;
    }
