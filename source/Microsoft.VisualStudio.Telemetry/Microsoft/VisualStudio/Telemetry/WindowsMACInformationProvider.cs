...
// Type: Microsoft.VisualStudio.Telemetry.WindowsMACInformationProvider
...
namespace Microsoft.VisualStudio.Telemetry
{
  internal sealed class WindowsMACInformationProvider : MACInformationProvider
  {
    ...
    public WindowsMACInformationProvider(
      IProcessTools processTools,
      IPersistentPropertyBag persistentStorage)
      : base(processTools, persistentStorage, "getmac", (string) null)
    {
    }
  }
}
