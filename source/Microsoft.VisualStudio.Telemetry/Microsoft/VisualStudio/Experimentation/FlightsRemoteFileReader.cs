...
// Type: Microsoft.VisualStudio.Experimentation.FlightsRemoteFileReader
...
{
  internal sealed class FlightsRemoteFileReader : 
    ...
    IDisposable
  {
    ...
    {
      FlightsRemoteFileReader remoteFileReader = this;
