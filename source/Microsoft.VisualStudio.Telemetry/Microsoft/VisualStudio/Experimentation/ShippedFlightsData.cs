...
// Type: Microsoft.VisualStudio.Experimentation.ShippedFlightsData
...
{
  internal sealed class ShippedFlightsData : IFlightsData
  {
    [JsonProperty(PropertyName = "ShippedFlights", Required = Required.Always)]
