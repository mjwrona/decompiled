...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ClientDataProviderQuery
...
{
  [DataContract]
  public class ClientDataProviderQuery : DataProviderQuery
  {
    [DataMember]
    public Guid QueryServiceInstanceType;
  }
}
