...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ExtensionAuditLog
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi
{
  ...
  {
    public ExtensionAuditLog() => this.Entries = new List<ExtensionAuditLogEntry>();
    ...
    [DataMember]
    public List<ExtensionAuditLogEntry> Entries { get; }
  }
}
