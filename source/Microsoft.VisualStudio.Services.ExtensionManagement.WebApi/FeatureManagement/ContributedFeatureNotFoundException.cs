...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.FeatureManagement.ContributedFeatureNotFoundException
...
{
  [Serializable]
  public class ContributedFeatureNotFoundException : VssServiceException
  {
    public ContributedFeatureNotFoundException(string message)
      : base(message)
    {
    }
  }
