...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.FeatureManagement.ContributedFeatureSettingScope
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.FeatureManagement
{
  ...
  public class ContributedFeatureSettingScope
  {
    ...
    public override string ToString() => string.Format("{0}{1}", this.UserScoped ? (object) "User-" : (object) "", this.SettingScope == null ? (object) "Default" : (object) this.SettingScope);
  }
}
