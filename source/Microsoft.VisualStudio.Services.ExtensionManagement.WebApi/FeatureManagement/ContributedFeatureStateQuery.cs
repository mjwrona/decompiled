...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.FeatureManagement.ContributedFeatureStateQuery
...
{
  [DataContract]
  public class ContributedFeatureStateQuery
  {
    [DataMember]
    public IList<string> FeatureIds { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public IDictionary<string, ContributedFeatureState> FeatureStates { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public IDictionary<string, string> ScopeValues { get; set; }
  }
}
