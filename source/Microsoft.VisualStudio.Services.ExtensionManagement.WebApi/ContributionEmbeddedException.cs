...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ContributionEmbeddedException
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi
{
  ...
  [Serializable]
  public class ContributionEmbeddedException : VssServiceException
  {
    public ContributionEmbeddedException(string lineInformation)
      : base(ExtensionManagementResources.ContributionEmbeddedException((object) lineInformation))
    {
    }
  }
}
