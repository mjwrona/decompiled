...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ExtensionTemplateException
...
{
  [Serializable]
  public class ExtensionTemplateException : VssServiceException
  {
    public ExtensionTemplateException(string message)
      : base(message)
    {
    }
  }
