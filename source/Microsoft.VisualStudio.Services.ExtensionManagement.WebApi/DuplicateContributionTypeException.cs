...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.DuplicateContributionTypeException
...
{
  [Serializable]
  public class DuplicateContributionTypeException : VssServiceException
  {
    public DuplicateContributionTypeException(
