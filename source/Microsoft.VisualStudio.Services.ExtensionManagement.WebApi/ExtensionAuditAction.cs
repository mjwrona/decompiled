...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ExtensionAuditAction
...
{
  [DataContract]
  public static class ExtensionAuditAction
  {
    public const string Insert = "I";
    public const string Enable = "E";
    public const string Disable = "D";
    public const string Update = "U";
    public const string UpdateVersion = "UV";
    public const string Uninstall = "UI";
  }
}
