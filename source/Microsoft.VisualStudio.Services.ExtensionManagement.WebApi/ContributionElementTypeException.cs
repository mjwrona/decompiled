...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ContributionElementTypeException
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi
{
  ...
  [Serializable]
  public class ContributionElementTypeException : VssServiceException
  {
    public ContributionElementTypeException(string contributionType, string rendererType)
      : base(ExtensionManagementResources.ContributionElementTypeException((object) contributionType, (object) rendererType))
    {
    }
  }
}
