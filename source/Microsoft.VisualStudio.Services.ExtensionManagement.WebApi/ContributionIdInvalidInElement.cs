...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ContributionIdInvalidInElement
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi
{
  ...
  [Serializable]
  public class ContributionIdInvalidInElement : VssServiceException
  {
    public ContributionIdInvalidInElement(string contributionId, string lineInformation)
      : base(ExtensionManagementResources.ContributionIdInvalidInElementException((object) contributionId, (object) lineInformation))
    {
    }
  }
}
