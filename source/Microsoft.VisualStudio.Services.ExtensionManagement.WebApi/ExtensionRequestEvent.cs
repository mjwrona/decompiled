...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ExtensionRequestEvent
...
{
  [NotificationEventBindings(EventSerializerType.Json, "ms.vss-extmgmt-web.extension-request-event")]
  [DataContract]
