...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.DataProviderExceptionDetails
...
{
  [DataContract]
  public class DataProviderExceptionDetails : DataProviderMetadata
  {
    [DataMember]
    ...
    public DataProviderExceptionDetails(string dataspaceId = null)
      : base(dataspaceId)
    {
    }
  }
