...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ExtensionNotLoadedException
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi
{
  ...
  [Serializable]
  public class ExtensionNotLoadedException : VssServiceException
  {
    public ExtensionNotLoadedException(Guid id, string reason, Exception innerException)
      : base(ExtensionManagementResources.ExtensionNotLoaded((object) id, (object) reason), innerException)
    {
    }
  }
}
