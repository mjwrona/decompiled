...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.WebApi.ContributionRendererNotDefinedException
...
namespace Microsoft.VisualStudio.Services.ExtensionManagement.WebApi
{
  ...
  [Serializable]
  public class ContributionRendererNotDefinedException : VssServiceException
  {
    public ContributionRendererNotDefinedException(string contributionId, string lineInformation)
      : base(ExtensionManagementResources.ContributionRendererNotDefinedException((object) contributionId, (object) lineInformation))
    {
    }
  }
}
