...
// Type: Microsoft.TeamFoundation.Server.Types.Team.SecuredTeam
...
{
  internal class SecuredTeam : ISecuredObject
  {
    private string Token;

    public Guid NamespaceId { get; private set; }

    public int RequiredPermissions { get; private set; }

    public string GetToken() => this.Token;

    public SecuredTeam(Guid namespaceId, int permission, string token)
    {
