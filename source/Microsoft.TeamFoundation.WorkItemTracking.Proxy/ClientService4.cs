...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Proxy.ClientService4
...
{
  internal class ClientService4 : ClientService3
  {
    ...
    protected override Guid CollectionServiceIdentifier => new Guid("b73b758b-c1cd-4043-b7af-ae70e505916f");

    protected override string ServiceType => "WorkitemService4";
  }
}
