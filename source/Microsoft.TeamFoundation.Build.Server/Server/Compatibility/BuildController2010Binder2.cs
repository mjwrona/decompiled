...
// Type: Microsoft.TeamFoundation.Build.Server.Compatibility.BuildController2010Binder2
...
{
  internal sealed class BuildController2010Binder2 : BuildObjectBinder<BuildController2010>
  {
    ...
    public BuildController2010Binder2(BuildSqlResourceComponent component)
      : base(component)
    {
    }
    ...
    protected override BuildController2010 Bind()
    {
      ...
      buildController2010.CustomAssemblyPath = this.Component.DataspaceDBPathToVersionControlPath(this.customAssemblyLocation.GetString((IDataReader) this.Reader, true));
