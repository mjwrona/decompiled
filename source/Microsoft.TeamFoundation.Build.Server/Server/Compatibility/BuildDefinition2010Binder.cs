...
// Type: Microsoft.TeamFoundation.Build.Server.Compatibility.BuildDefinition2010Binder
...
{
  internal sealed class BuildDefinition2010Binder : BuildObjectBinder<BuildDefinition2010>
  {
    ...
    internal BuildDefinition2010Binder(
    ...
    protected override BuildDefinition2010 Bind()
    {
      ...
      buildDefinition2010.TeamProject = this.Component.GetTeamProjectFromUri(this.m_requestContext, this.teamProject.GetString((IDataReader) this.Reader, false));
