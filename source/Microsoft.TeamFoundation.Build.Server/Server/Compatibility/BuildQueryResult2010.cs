...
namespace Microsoft.TeamFoundation.Build.Server.Compatibility
{
  ...
  public sealed class BuildQueryResult2010
  {
    ...
    [XmlElement(Order = 3, Type = typeof (List<BuildController2010>))]
    [ClientProperty(ClientVisibility.Private)]
    public List<BuildController2010> Controllers => this.m_controllers;

    [XmlElement(Order = 4, Type = typeof (List<BuildAgent2010>))]
    [ClientProperty(ClientVisibility.Private)]
    public List<BuildAgent2010> Agents => this.m_agents;

    [XmlElement(Order = 5, Type = typeof (List<BuildServiceHost2010>))]
    [ClientProperty(ClientVisibility.Private)]
    public List<BuildServiceHost2010> ServiceHosts => this.m_serviceHosts;

    [XmlElement(Order = 6, Type = typeof (List<Failure2010>))]
