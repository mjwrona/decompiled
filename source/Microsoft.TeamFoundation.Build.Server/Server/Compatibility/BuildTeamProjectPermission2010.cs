...
// Type: Microsoft.TeamFoundation.Build.Server.Compatibility.BuildTeamProjectPermission2010
...
namespace Microsoft.TeamFoundation.Build.Server.Compatibility
{
  ...
  [XmlType("BuildTeamProjectPermission")]
  public sealed class BuildTeamProjectPermission2010
  {
    ...
    public BuildTeamProjectPermission2010()
    {
    ...
    internal void SetPermissionBit(string permission, bool allow)
    {
      if (permission == null)
        return;
    ...
    public override string ToString() => string.Format((IFormatProvider) CultureInfo.InvariantCulture, "[BuildTeamProjectPermission2010 IdentityName={0} Allows={1} Denies={2}]", (object) this.IdentityName, (object) this.Allows.ListItems<string>(), (object) this.Denies.ListItems<string>());
