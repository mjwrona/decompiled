...
// Type: Microsoft.TeamFoundation.Build.Server.Compatibility.Integration
...
namespace Microsoft.TeamFoundation.Build.Server.Compatibility
{
  ...
  internal class Integration : BuildWebServiceBase, ILinkingProvider
  {
    [WebMethod]
    public Artifact[] GetArtifacts(string[] artifactUris)
    {
      try
      {
        ...
        return BisQuery.GetV1Artifacts(this.RequestContext, artifactUris);
      }
      catch (Exception ex)
      {
