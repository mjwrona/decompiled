...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildUpdateTableV2
...
{
  [Obsolete]
  internal sealed class BuildUpdateTableV2 : TeamFoundationTableValueParameter<BuildUpdateOptions>
  {
    private static SqlMetaData[] s_metadata = new SqlMetaData[14]
    {
      ...
      new SqlMetaData("DropLocationRoot", SqlDbType.NVarChar, 260L),
    ...
    public BuildUpdateTableV2(IEnumerable<BuildUpdateOptions> rows)
      : base(rows, "typ_BuildUpdateTableV2", BuildUpdateTableV2.s_metadata)
    {
    }
