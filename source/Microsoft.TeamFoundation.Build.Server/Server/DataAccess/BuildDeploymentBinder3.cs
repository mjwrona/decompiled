...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDeploymentBinder3
...
{
  internal class BuildDeploymentBinder3 : BuildObjectBinder<BuildDeployment>
  {
    ...
    internal BuildDeploymentBinder3(BuildSqlResourceComponent component)
      : base(component)
    {
    }
    ...
    protected override BuildDeployment Bind()
    {
      ...
      return new BuildDeployment(this.Component.GetDataspaceIdentifier(this.DataspaceId.GetInt32((IDataReader) this.Reader)), deployment, source, serverPath, sourceGetVersion);
    }
  }
}
