...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDefinitionTable
...
{
  [Obsolete]
  internal sealed class BuildDefinitionTable : TeamFoundationTableValueParameter<BuildDefinition>
  {
    ...
    public BuildDefinitionTable(ICollection<BuildDefinition> rows)
      : base((IEnumerable<BuildDefinition>) rows, "typ_BuildDefinitionTable", BuildDefinitionTable.s_metadata)
    {
    }
