...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.AffectedBuildDefinitionTable
...
{
  [Obsolete]
  internal sealed class AffectedBuildDefinitionTable : 
    TeamFoundationTableValueParameter<BuildDefinition>
  {
    ...
    public AffectedBuildDefinitionTable(ICollection<BuildDefinition> rows)
      : base((IEnumerable<BuildDefinition>) rows, "typ_AffectedBuildDefinitionTable", AffectedBuildDefinitionTable.s_metadata)
    {
    }
