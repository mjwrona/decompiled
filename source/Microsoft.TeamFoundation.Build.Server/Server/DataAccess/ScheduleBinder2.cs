...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.ScheduleBinder2
...
{
  internal sealed class ScheduleBinder2 : BuildObjectBinder<Schedule>
  {
    ...
    public ScheduleBinder2(BuildSqlResourceComponent component)
      : base(component)
    {
    }
    ...
    protected override Schedule Bind()
    {
      ...
      schedule.ProjectId = this.Component.GetDataspaceIdentifier(this.dataspaceId.GetInt32((IDataReader) this.Reader));
      return schedule;
    }
  }
}
