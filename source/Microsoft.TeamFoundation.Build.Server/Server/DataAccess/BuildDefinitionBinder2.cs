...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDefinitionBinder2
...
{
  internal sealed class BuildDefinitionBinder2 : BuildObjectBinder<BuildDefinition>
  {
    ...
    internal BuildDefinitionBinder2(
    ...
    protected override BuildDefinition Bind()
    {
      BuildDefinition buildDefinition = new BuildDefinition()
      {
        ...
        TeamProject = this.Component.GetTeamProjectFromGuid(this.m_requestContext, this.Component.GetDataspaceIdentifier(this.dataspaceId.GetInt32((IDataReader) this.Reader)))
      };
