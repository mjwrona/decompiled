...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildControllerTable
...
{
  [Obsolete]
  internal sealed class BuildControllerTable : TeamFoundationTableValueParameter<BuildController>
  {
    ...
    public BuildControllerTable(ICollection<BuildController> rows)
      : base((IEnumerable<BuildController>) rows, "typ_BuildControllerTable", BuildControllerTable.s_metadata)
    {
    }
