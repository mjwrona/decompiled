...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.WorkspaceTemplateBinder2
...
{
  internal sealed class WorkspaceTemplateBinder2 : BuildObjectBinder<WorkspaceTemplate>
  {
    ...
    public WorkspaceTemplateBinder2(
    ...
    protected override WorkspaceTemplate Bind() => new WorkspaceTemplate()
    {
      ...
      LastModifiedBy = this.lastModifiedBy.GetString((IDataReader) this.Reader, false),
