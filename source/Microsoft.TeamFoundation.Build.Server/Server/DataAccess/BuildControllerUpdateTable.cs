...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildControllerUpdateTable
...
{
  [Obsolete]
  internal sealed class BuildControllerUpdateTable : 
    TeamFoundationTableValueParameter<BuildControllerUpdateOptions>
  {
    private static SqlMetaData[] s_metadata = new SqlMetaData[9]
    {
      ...
      new SqlMetaData("CustomAssemblyPath", SqlDbType.NVarChar, 260L),
    ...
    public BuildControllerUpdateTable(ICollection<BuildControllerUpdateOptions> rows)
      : base((IEnumerable<BuildControllerUpdateOptions>) rows, "typ_BuildControllerUpdateTable", BuildControllerUpdateTable.s_metadata)
    {
    }
