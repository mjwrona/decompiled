...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDeploymentBinder
...
{
  internal class BuildDeploymentBinder : ObjectBinder<BuildDeployment>
  {
    ...
    internal BuildDeploymentBinder()
    {
    }
    ...
    protected override BuildDeployment Bind()
    {
      ...
      deployment.Uri = this.DeploymentUriColumn.GetArtifactUriFromInt64(this.Reader, "Build", false);
      source.Uri = this.SourceUriColumn.GetArtifactUriFromInt64(this.Reader, "Build", false);
