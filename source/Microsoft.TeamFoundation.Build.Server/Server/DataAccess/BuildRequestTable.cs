...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildRequestTable
...
{
  [Obsolete]
  internal sealed class BuildRequestTable : TeamFoundationTableValueParameter<BuildRequest>
  {
    ...
    internal BuildRequestTable(ICollection<BuildRequest> rows)
      : base((IEnumerable<BuildRequest>) rows, "typ_BuildRequestTable", BuildRequestTable.s_metadata)
    {
    }
