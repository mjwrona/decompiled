...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDetailBinder2
...
{
  internal sealed class BuildDetailBinder2 : BuildObjectBinder<BuildDetail>
  {
    ...
    private SqlColumnBinder containerId = new SqlColumnBinder("ContainerId");
    ...
    protected override BuildDetail Bind()
    {
      ...
      buildDetail.ContainerId = this.containerId.IsNull((IDataReader) this.Reader) ? new long?() : new long?(this.containerId.GetInt64((IDataReader) this.Reader, 0L, 0L));
