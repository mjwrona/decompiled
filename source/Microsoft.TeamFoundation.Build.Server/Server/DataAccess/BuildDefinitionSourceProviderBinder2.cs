...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDefinitionSourceProviderBinder2
...
{
  internal sealed class BuildDefinitionSourceProviderBinder2 : 
    BuildObjectBinder<BuildDefinitionSourceProvider>
  {
    ...
    public BuildDefinitionSourceProviderBinder2(BuildSqlResourceComponent component)
      : base(component)
    {
    }
    ...
    protected override BuildDefinitionSourceProvider Bind()
    {
      ...
      definitionSourceProvider.ProjectId = this.Component.GetDataspaceIdentifier(this.dataspaceId.GetInt32((IDataReader) this.Reader));
