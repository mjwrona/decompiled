...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildProcessTemplateTable2
...
{
  [Obsolete]
  internal sealed class BuildProcessTemplateTable2 : 
    TeamFoundationTableValueParameter<ProcessTemplate>
  {
    ...
    public BuildProcessTemplateTable2(IEnumerable<ProcessTemplate> rows, bool isAdd)
      : base(rows, "typ_BuildProcessTemplateTableV2", BuildProcessTemplateTable2.s_metadata)
    {
      this.m_isAdd = isAdd;
    }
