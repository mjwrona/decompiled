...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildControllerBinder
...
{
  internal sealed class BuildControllerBinder : BuildObjectBinder<BuildController>
  {
    ...
    protected override BuildController Bind()
    {
      ...
      buildController.CustomAssemblyPath = this.customAssemblyLocation.GetString((IDataReader) this.Reader, true);
