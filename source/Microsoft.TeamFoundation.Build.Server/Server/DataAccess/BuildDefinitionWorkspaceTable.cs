...
// Type: Microsoft.TeamFoundation.Build.Server.DataAccess.BuildDefinitionWorkspaceTable
...
{
  [Obsolete]
  internal sealed class BuildDefinitionWorkspaceTable : 
    TeamFoundationTableValueParameter<WorkspaceMapping>
  {
    private static SqlMetaData[] s_metadata = new SqlMetaData[5]
    {
      ...
      new SqlMetaData("ServerItem", SqlDbType.NVarChar, 260L),
    ...
    public BuildDefinitionWorkspaceTable(ICollection<WorkspaceMapping> rows)
      : base((IEnumerable<WorkspaceMapping>) rows, "typ_BuildDefinitionWorkspaceTable", BuildDefinitionWorkspaceTable.s_metadata)
    {
    }
