...
// Type: Microsoft.TeamFoundation.Build.Server.WorkspaceMapping
...
namespace Microsoft.TeamFoundation.Build.Server
{
  ...
  public class WorkspaceMapping : IValidatable
  {
    ...
    [XmlAttribute]
    [DefaultValue(WorkspaceMappingType.Map)]
    [ClientProperty(ClientVisibility.Public, ClientVisibility.Public)]
    ...
    void IValidatable.Validate(IVssRequestContext requestContext, ValidationContext context)
    {
      ...
      if (this.m_mappingType == WorkspaceMappingType.Cloak)
      {
