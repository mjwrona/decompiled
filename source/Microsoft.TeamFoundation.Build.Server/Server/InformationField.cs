...
// Type: Microsoft.TeamFoundation.Build.Server.InformationField
...
namespace Microsoft.TeamFoundation.Build.Server
{
  ...
  public sealed class InformationField : IValidatable
  {
    ...
    public override string ToString() => string.Format((IFormatProvider) CultureInfo.InvariantCulture, "[InformationField Name={0} Value={1}]", (object) this.Name, (object) this.Value);
  }
}
