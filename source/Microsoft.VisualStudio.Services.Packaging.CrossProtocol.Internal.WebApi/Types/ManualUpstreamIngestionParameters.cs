...
// Type: Microsoft.VisualStudio.Services.Packaging.CrossProtocol.Internal.WebApi.Types.ManualUpstreamIngestionParameters
...
{
  [DataContract]
  public class ManualUpstreamIngestionParameters
  {
    [DataMember(IsRequired = true)]
    [Required]
    public bool IngestFromUpstream { get; set; }
  }
}
