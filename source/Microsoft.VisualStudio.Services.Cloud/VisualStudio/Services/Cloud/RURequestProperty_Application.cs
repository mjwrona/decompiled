...
// Type: Microsoft.VisualStudio.Services.Cloud.RURequestProperty_Application
...
{
  internal class RURequestProperty_Application : RURequestProperty_String
  {
    ...
    public override object GetRequestValue(IVssRequestContext requestContext) => (object) requestContext.ServiceName;
