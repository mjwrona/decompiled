...
// Type: Microsoft.VisualStudio.Services.Cloud.HostMigrationComponent9
...
{
  public class HostMigrationComponent9 : HostMigrationComponent8
  {
    public override TargetHostMigration CreateTargetMigration(TargetHostMigration entry)
    {
      ...
      this.BindByte("@options", (byte) entry.Options);
    ...
    public override SourceHostMigration CreateSourceMigration(SourceHostMigration migrationRequest)
    {
      ...
      this.BindByte("@options", (byte) migrationRequest.Options);
