...
// Type: Microsoft.VisualStudio.Services.Cloud.Security.BackingStoreInheritController
...
namespace Microsoft.VisualStudio.Services.Cloud.Security
{
  ...
  [VersionedApiControllerCustomName(Area = "SBS", ResourceName = "SBSInherit")]
  public class BackingStoreInheritController : SecurityBackingStoreController
  {
    [HttpPatch]
    public int SetInheritFlag(Guid securityNamespaceId, string token, bool inheritFlag)
    {
      ...
      TokenStoreSequenceId newSequenceId = aclStore.BackingStore.SetInheritFlag(this.TfsRequestContext, token, inheritFlag);
