...
// Type: Microsoft.VisualStudio.Services.Redis.V1.RedisConnection
...
namespace Microsoft.VisualStudio.Services.Redis.V1
{
  ...
  {
    private static readonly BlockingCollection<Tuple<Action, string>> s_pendingConnectionManagers = new BlockingCollection<Tuple<Action, string>>();
