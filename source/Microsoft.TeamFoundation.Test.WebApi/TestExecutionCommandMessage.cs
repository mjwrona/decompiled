...
// Type: Microsoft.TeamFoundation.Test.WebApi.TestExecutionCommandMessage
...
{
  [DataContract]
  public class TestExecutionCommandMessage
  {
    [DataMember]
    public TestExecutionCommand Command { get; set; }
  }
}
