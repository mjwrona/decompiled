...
// Type: Microsoft.VisualStudio.Services.Search.Server.Storage.FileSystem.Definitions.IFileSystem
...
namespace Microsoft.VisualStudio.Services.Search.Server.Storage.FileSystem.Definitions
{
  public interface IFileSystem
  {
    ...
    IDirectory GetDirectory(string directoryPath, bool createIfNotExists);

    IDirectory GetTemporaryDirectory(string directoryName, bool createIfNotExists);

    IDirectory GetLocalAppDataDirectory(string directoryName, bool createIfNotExists);

    IEnumerable<IDirectory> EnumerateDirectories(string directoryPath);

    void DeleteDirectory(string directoryPath);

    void CleanDirectoryAttributes(string directoryPath);
  }
}
