...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.WebApi.ProjectActivityMetrics
...
{
  [DataContract]
  public class ProjectActivityMetrics
  {
    [DataMember]
    public int PullRequestsCreatedCount;
    [DataMember]
    public int PullRequestsCompletedCount;
    [DataMember]
    public int AuthorsCount;
    [DataMember]
    public int CodeChangesCount;
    [DataMember]
    public IList<CodeChangeTrendItem> CodeChangesTrend;
