...
// Type: Microsoft.VisualStudio.Services.BlobStore.AzureStorage.AzureTableBlobMetadataProviderOptions
...
{
  public class AzureTableBlobMetadataProviderOptions
  {
    public int TotalExistsRows { get; set; } = 16;
