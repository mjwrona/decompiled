...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Process.WebApi.Models.UpdateProcessRuleRequest
...
{
  [DataContract]
  public class UpdateProcessRuleRequest : CreateProcessRuleRequest
  {
    [DataMember]
