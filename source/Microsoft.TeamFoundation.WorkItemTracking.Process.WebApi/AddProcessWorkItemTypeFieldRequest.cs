...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Process.WebApi.Models.AddProcessWorkItemTypeFieldRequest
...
{
  [DataContract]
  public class AddProcessWorkItemTypeFieldRequest : IFieldRuleProperties
  {
    [DataMember]
