...
// Type: Microsoft.VisualStudio.Services.Commerce.OfferMeterNotFoundException
...
namespace Microsoft.VisualStudio.Services.Commerce
{
  ...
  public class OfferMeterNotFoundException : CommerceException
  {
    public OfferMeterNotFoundException(string nameOrGalleryId)
      : base(CommerceResources.OfferMeterNotFoundExceptionMessage((object) nameOrGalleryId))
    {
    }
  }
}
