...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityMaterializationFailedException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class IdentityMaterializationFailedException : IdentityServiceException
  {
    ...
    public IdentityMaterializationFailedException(string principalName)
      : this(IdentityResources.IdentityMaterializationFailedMessage((object) principalName), (Exception) null)
    {
    }

    protected IdentityMaterializationFailedException(
