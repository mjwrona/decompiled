...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityAliasAlreadyInUseException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class IdentityAliasAlreadyInUseException : IdentityServiceException
  {
    public IdentityAliasAlreadyInUseException(string conflictingAlias)
      : base(IdentityResources.IdentityAliasAlreadyInUseError((object) conflictingAlias))
    {
    }
