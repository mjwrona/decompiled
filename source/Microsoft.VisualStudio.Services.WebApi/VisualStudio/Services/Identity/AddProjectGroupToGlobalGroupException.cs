...
// Type: Microsoft.VisualStudio.Services.Identity.AddProjectGroupToGlobalGroupException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class AddProjectGroupToGlobalGroupException : IdentityServiceException
  {
    ...
    public AddProjectGroupToGlobalGroupException(string globalGroupName, string projectGroupName)
      : base(IdentityResources.ADDPROJECTGROUPTOGLOBALGROUPERROR((object) projectGroupName, (object) globalGroupName))
    {
    }
    ...
    protected AddProjectGroupToGlobalGroupException(
