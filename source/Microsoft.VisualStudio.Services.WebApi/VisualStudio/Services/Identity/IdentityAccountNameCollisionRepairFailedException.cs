...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityAccountNameCollisionRepairFailedException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class IdentityAccountNameCollisionRepairFailedException : IdentityServiceException
  {
    public IdentityAccountNameCollisionRepairFailedException(string accountName)
      : base(IdentityResources.IdentityAccountNameCollisionRepairFailedError((object) accountName))
    {
    }

    public IdentityAccountNameCollisionRepairFailedException(
      string accountName,
      Exception innerException)
      : base(IdentityResources.IdentityAccountNameCollisionRepairFailedError((object) accountName), innerException)
    {
    }
  }
}
