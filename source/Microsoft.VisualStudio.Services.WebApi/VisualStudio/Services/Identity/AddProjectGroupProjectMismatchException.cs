...
// Type: Microsoft.VisualStudio.Services.Identity.AddProjectGroupProjectMismatchException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class AddProjectGroupProjectMismatchException : IdentityServiceException
  {
    ...
    public AddProjectGroupProjectMismatchException(string groupName, string memberName)
      : base(IdentityResources.ADDPROJECTGROUPTPROJECTMISMATCHERROR((object) groupName, (object) memberName))
    {
    }
    ...
    protected AddProjectGroupProjectMismatchException(
