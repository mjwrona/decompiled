...
// Type: Microsoft.VisualStudio.Services.Identity.AddGroupMemberIllegalInternetIdentityException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  {
    public AddGroupMemberIllegalInternetIdentityException(Microsoft.VisualStudio.Services.Identity.Identity member)
      : base(IdentityResources.ADDGROUPMEMBERILLEGALINTERNETIDENTITY((object) member.DisplayName))
    {
    }
