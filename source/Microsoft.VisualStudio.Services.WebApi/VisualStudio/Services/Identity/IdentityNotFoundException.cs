...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityNotFoundException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class IdentityNotFoundException : IdentityServiceException
  {
    ...
    public IdentityNotFoundException(IdentityDescriptor descriptor)
      : base(IdentityResources.IdentityNotFoundMessage((object) descriptor.IdentityType))
    {
    }

    public IdentityNotFoundException(SubjectDescriptor subjectDescriptor)
      : base(IdentityResources.IdentityNotFoundMessage((object) subjectDescriptor.SubjectType))
    {
    }

    public IdentityNotFoundException(Guid tfid)
      : base(IdentityResources.IdentityNotFoundWithTfid((object) tfid))
    {
    }
  }
}
