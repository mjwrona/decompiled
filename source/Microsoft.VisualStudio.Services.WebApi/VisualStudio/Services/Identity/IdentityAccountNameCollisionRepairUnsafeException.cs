...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityAccountNameCollisionRepairUnsafeException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class IdentityAccountNameCollisionRepairUnsafeException : IdentityServiceException
  {
    public IdentityAccountNameCollisionRepairUnsafeException(string accountName)
      : base(IdentityResources.IdentityAccountNameCollisionRepairUnsafeError((object) accountName))
    {
    }

    public IdentityAccountNameCollisionRepairUnsafeException(
      string accountName,
      Exception innerException)
      : base(IdentityResources.IdentityAccountNameCollisionRepairUnsafeError((object) accountName), innerException)
    {
    }
  }
}
