...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityDomainMismatchException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class IdentityDomainMismatchException : IdentityServiceException
  {
    public IdentityDomainMismatchException(string incorrectHost, string correctHost)
      : base(IdentityResources.IDENTITYDOMAINMISMATCHERROR((object) incorrectHost, (object) correctHost))
    {
    }
