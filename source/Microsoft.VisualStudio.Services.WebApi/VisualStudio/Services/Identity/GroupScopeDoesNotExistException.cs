...
// Type: Microsoft.VisualStudio.Services.Identity.GroupScopeDoesNotExistException
...
namespace Microsoft.VisualStudio.Services.Identity
{
  ...
  public class GroupScopeDoesNotExistException : IdentityServiceException
  {
    public GroupScopeDoesNotExistException(string projectUri)
      : base(IdentityResources.GROUPSCOPEDOESNOTEXISTERROR((object) projectUri))
    {
    }

    public GroupScopeDoesNotExistException(Guid scopeId)
      : base(IdentityResources.GROUPSCOPEDOESNOTEXISTERROR((object) scopeId))
    {
    }
