...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityLoopingLoginException
...
{
  [Serializable]
  public class IdentityLoopingLoginException : IdentityServiceException
  {
    public IdentityLoopingLoginException()
    {
    }
