...
// Type: Microsoft.VisualStudio.Services.Account.AccountNotMarkedForDeletionException
...
namespace Microsoft.VisualStudio.Services.Account
{
  ...
  public class AccountNotMarkedForDeletionException : AccountException
  {
    public AccountNotMarkedForDeletionException(string accountId)
      : base(AccountResources.AccountNotMarkedForDeletionError((object) accountId))
    {
    }
