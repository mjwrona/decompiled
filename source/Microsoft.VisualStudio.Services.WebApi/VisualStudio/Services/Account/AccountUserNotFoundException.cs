...
// Type: Microsoft.VisualStudio.Services.Account.AccountUserNotFoundException
...
namespace Microsoft.VisualStudio.Services.Account
{
  ...
  public class AccountUserNotFoundException : AccountException
  {
    public AccountUserNotFoundException(string userId, string accountId)
      : base(AccountResources.AccountUserNotFoundException((object) userId, (object) accountId))
    {
    }
