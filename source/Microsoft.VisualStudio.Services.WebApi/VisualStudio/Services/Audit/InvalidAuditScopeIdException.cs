...
// Type: Microsoft.VisualStudio.Services.Audit.InvalidAuditScopeIdException
...
{
  [Serializable]
  public class InvalidAuditScopeIdException : VssServiceException
  {
    public InvalidAuditScopeIdException()
    {
    }
