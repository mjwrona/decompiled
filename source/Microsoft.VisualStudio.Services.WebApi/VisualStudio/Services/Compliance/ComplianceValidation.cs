...
// Type: Microsoft.VisualStudio.Services.Compliance.ComplianceValidation
...
namespace Microsoft.VisualStudio.Services.Compliance
{
  public class ComplianceValidation
  {
    ...
    public ComplianceValidation(DateTimeOffset complianceValidated) => this.ComplianceValidated = complianceValidated;

    public ComplianceValidation(Uri redirectUrl) => this.RedirectUrl = redirectUrl;
