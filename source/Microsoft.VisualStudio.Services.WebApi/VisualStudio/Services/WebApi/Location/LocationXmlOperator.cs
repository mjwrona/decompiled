...
// Type: Microsoft.VisualStudio.Services.WebApi.Location.LocationXmlOperator
...
namespace Microsoft.VisualStudio.Services.WebApi.Location
{
  internal class LocationXmlOperator
  {
    ...
    public LocationXmlOperator(bool isClientCache)
    {
      ...
      this.m_accessMappingLocationServiceUrls = new Dictionary<string, string>((IEqualityComparer<string>) StringComparer.OrdinalIgnoreCase);
    }
      ...
      Dictionary<string, AccessMapping> accessMappings)
    {
      ...
      foreach (XmlNode xmlNode1 in xmlNodeList)
      {
        foreach (XmlNode selectNode1 in xmlNode1.SelectNodes("./" + LocationXmlOperator.s_serviceDefinition))
        {
          ...
          XmlNode xmlNode3 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_relativePath);
          LocationXmlOperator.CheckXmlNodeNull(xmlNode3, LocationXmlOperator.s_relativePath, selectNode1);
          serviceDefinition.RelativePath = xmlNode3.InnerText;
          XmlAttribute attribute = xmlNode3.Attributes[LocationXmlOperator.s_relativeTo];
          LocationXmlOperator.CheckXmlAttributeNullOrEmpty(attribute, LocationXmlOperator.s_relativeTo, xmlNode3);
          ...
          if (!RelativeToEnumCache.GetRelativeToEnums().TryGetValue(attribute.InnerText, out relativeToSetting))
            throw new ConfigFileException(attribute.InnerText);
          ...
          XmlNode xmlNode4 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_parentServiceType);
          serviceDefinition.ParentServiceType = xmlNode4?.InnerText;
          XmlNode xmlNode5 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_parentIdentifier);
          serviceDefinition.ParentIdentifier = xmlNode5 != null ? XmlConvert.ToGuid(xmlNode5.InnerText) : Guid.Empty;
          serviceDefinition.LocationMappings = new List<LocationMapping>();
          if (serviceDefinition.RelativeToSetting == RelativeToSetting.FullyQualified)
          {
            foreach (XmlNode selectNode2 in selectNode1.SelectNodes(".//" + LocationXmlOperator.s_locationMapping))
            {
              ...
              locationMapping.AccessMappingMoniker = node4.InnerText;
          ...
          XmlNode xmlNode6 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_resourceVersion);
          serviceDefinition.ResourceVersion = xmlNode6 != null ? XmlConvert.ToInt32(xmlNode6.InnerText) : 0;
          XmlNode xmlNode7 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_minVersion);
          serviceDefinition.MinVersionString = xmlNode7?.InnerText;
          XmlNode xmlNode8 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_maxVersion);
          serviceDefinition.MaxVersionString = xmlNode8?.InnerText;
          XmlNode xmlNode9 = selectNode1.SelectSingleNode("./" + LocationXmlOperator.s_releasedVersion);
          serviceDefinition.ReleasedVersionString = xmlNode9?.InnerText;
      ...
      IEnumerable<ServiceDefinition> serviceDefinitions)
    {
      ...
      foreach (ServiceDefinition serviceDefinition in serviceDefinitions)
      {
        ...
        node2.AppendChild(node3);
        node3.InnerText = serviceDefinition.ServiceType;
        XmlNode node4 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_identifier, (string) null);
        node2.AppendChild(node4);
        node4.InnerText = XmlConvert.ToString(serviceDefinition.Identifier);
        if (serviceDefinition.DisplayName != null)
        {
          XmlNode node5 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_displayName, (string) null);
          node2.AppendChild(node5);
          node5.InnerText = serviceDefinition.DisplayName;
        }
        if (serviceDefinition.Description != null)
        {
          ...
          node2.AppendChild(node6);
          node6.InnerText = serviceDefinition.Description;
        }
        XmlNode node7 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_relativePath, (string) null);
        node2.AppendChild(node7);
        node7.InnerText = serviceDefinition.RelativePath;
        XmlUtility.AddXmlAttribute(node7, LocationXmlOperator.s_relativeTo, serviceDefinition.RelativeToSetting.ToString());
        XmlNode node8 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_parentServiceType, (string) null);
        node2.AppendChild(node8);
        node8.InnerText = serviceDefinition.ParentServiceType;
        XmlNode node9 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_parentIdentifier, (string) null);
        node2.AppendChild(node9);
        node9.InnerText = XmlConvert.ToString(serviceDefinition.ParentIdentifier);
        if (serviceDefinition.RelativeToSetting == RelativeToSetting.FullyQualified)
        {
          XmlNode node10 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_locationMappings, (string) null);
          node2.AppendChild(node10);
          foreach (LocationMapping locationMapping in serviceDefinition.LocationMappings)
          {
            XmlNode node11 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_locationMapping, (string) null);
            node10.AppendChild(node11);
            XmlNode node12 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_accessMapping, (string) null);
            node11.AppendChild(node12);
            node12.InnerText = locationMapping.AccessMappingMoniker;
            XmlNode node13 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_location, (string) null);
            node11.AppendChild(node13);
            node13.InnerText = locationMapping.Location;
          }
        }
        if (serviceDefinition.ResourceVersion > 0)
        {
          XmlNode node14 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_resourceVersion, (string) null);
          node2.AppendChild(node14);
          node14.InnerText = XmlConvert.ToString(serviceDefinition.ResourceVersion);
        }
        if (serviceDefinition.MinVersionString != null)
        {
          XmlNode node15 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_minVersion, (string) null);
          node2.AppendChild(node15);
          node15.InnerText = serviceDefinition.MinVersionString;
        }
        if (serviceDefinition.MaxVersionString != null)
        {
          XmlNode node16 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_maxVersion, (string) null);
          node2.AppendChild(node16);
          node16.InnerText = serviceDefinition.MaxVersionString;
        }
        if (serviceDefinition.ReleasedVersionString != null)
        {
          XmlNode node17 = ownerDocument.CreateNode(XmlNodeType.Element, LocationXmlOperator.s_releasedVersion, (string) null);
          node2.AppendChild(node17);
          node17.InnerText = serviceDefinition.ReleasedVersionString;
        }
      }
    }
    ...
    {
      if (node == null)
        throw new ConfigFileException(CommonResources.XmlNodeMissing((object) nodeName, (object) parent));
    }
    ...
    private static void CheckXmlNodeNullOrEmpty(XmlNode node, string nodeName, XmlNode parent)
    {
      ...
      if (node.InnerText.Equals(string.Empty))
        throw new ConfigFileException(CommonResources.XmlNodeEmpty((object) nodeName, (object) parent.Name));
    }
    ...
    {
      if (attribute == null)
        throw new ConfigFileException(CommonResources.XmlAttributeNull((object) attributeName, (object) element.Name));
      if (attribute.InnerText.Equals(string.Empty))
        throw new ConfigFileException(CommonResources.XmlAttributeEmpty((object) attributeName, (object) element.Name));
    }
  }
}
