...
// Type: Microsoft.VisualStudio.Services.WebApi.CannotGetUnattributedClientException
...
namespace Microsoft.VisualStudio.Services.WebApi
{
  public class CannotGetUnattributedClientException : VssException
  {
    public CannotGetUnattributedClientException(Type clientType)
      : base(WebApiResources.CannotGetUnattributedClient((object) clientType.Name))
    {
    }
