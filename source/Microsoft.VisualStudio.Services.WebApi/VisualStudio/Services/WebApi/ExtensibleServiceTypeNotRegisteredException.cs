...
// Type: Microsoft.VisualStudio.Services.WebApi.ExtensibleServiceTypeNotRegisteredException
...
namespace Microsoft.VisualStudio.Services.WebApi
{
  ...
  public class ExtensibleServiceTypeNotRegisteredException : VssException
  {
    public ExtensibleServiceTypeNotRegisteredException(Type managedType)
      : base(WebApiResources.ExtensibleServiceTypeNotRegistered((object) managedType.Name))
    {
    }
