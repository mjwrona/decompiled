...
// Type: Microsoft.VisualStudio.Services.WebApi.Jwt.JsonWebTokenSerializationException
...
namespace Microsoft.VisualStudio.Services.WebApi.Jwt
{
  ...
  {
    public JsonWebTokenSerializationException()
      : base(JwtResources.SerializationException())
    {
    }
  }
}
