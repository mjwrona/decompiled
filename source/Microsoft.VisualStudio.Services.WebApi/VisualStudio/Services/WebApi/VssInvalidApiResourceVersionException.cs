...
// Type: Microsoft.VisualStudio.Services.WebApi.VssInvalidApiResourceVersionException
...
namespace Microsoft.VisualStudio.Services.WebApi
{
  ...
  public class VssInvalidApiResourceVersionException : VssResourceVersionException
  {
    public VssInvalidApiResourceVersionException(string apiResourceVersionString)
      : base(WebApiResources.InvalidApiVersionStringMessage((object) apiResourceVersionString))
    {
    }
  }
}
