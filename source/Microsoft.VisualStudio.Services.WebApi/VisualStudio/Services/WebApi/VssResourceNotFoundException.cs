...
// Type: Microsoft.VisualStudio.Services.WebApi.VssResourceNotFoundException
...
namespace Microsoft.VisualStudio.Services.WebApi
{
  ...
  public class VssResourceNotFoundException : VssServiceException
  {
    public VssResourceNotFoundException(Guid locationId)
      : this(WebApiResources.ResourceNotRegisteredMessage((object) locationId))
    {
    }

    public VssResourceNotFoundException(Guid locationId, Uri serverBaseUri)
      : this(WebApiResources.ResourceNotFoundOnServerMessage((object) locationId, (object) serverBaseUri))
    {
    }
