...
// Type: Microsoft.VisualStudio.Services.WebApi.VssInvalidPreviewVersionException
...
namespace Microsoft.VisualStudio.Services.WebApi
{
  ...
  public class VssInvalidPreviewVersionException : VssResourceVersionException
  {
    public VssInvalidPreviewVersionException(ApiResourceVersion requestedVersion)
      : base(WebApiResources.PreviewVersionNotSuppliedMessage((object) requestedVersion.ToString()))
    {
    }
  }
}
