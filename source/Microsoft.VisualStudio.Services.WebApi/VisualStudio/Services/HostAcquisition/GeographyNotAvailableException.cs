...
// Type: Microsoft.VisualStudio.Services.HostAcquisition.GeographyNotAvailableException
...
{
  [Serializable]
  public class GeographyNotAvailableException : HostAcquisitionException
  {
    public GeographyNotAvailableException()
    {
    }
