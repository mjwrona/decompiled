...
// Type: Microsoft.VisualStudio.Services.FileContainer.FileContainerException
...
namespace Microsoft.VisualStudio.Services.FileContainer
{
  ...
  {
    public FileContainerException() => this.EventId = VssEventId.FileContainerBaseEventId;

    public FileContainerException(string message)
      : base(message)
    {
      this.EventId = VssEventId.FileContainerBaseEventId;
    }
