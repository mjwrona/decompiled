...
// Type: Microsoft.VisualStudio.Services.FileContainer.ContainerNotFoundException
...
namespace Microsoft.VisualStudio.Services.FileContainer
{
  ...
  public class ContainerNotFoundException : FileContainerException
  {
    ...
    public ContainerNotFoundException(long containerId)
      : base(FileContainerResources.ContainerNotFoundException((object) containerId))
    {
    }
