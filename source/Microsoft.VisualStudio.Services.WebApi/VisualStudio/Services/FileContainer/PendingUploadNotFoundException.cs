...
// Type: Microsoft.VisualStudio.Services.FileContainer.PendingUploadNotFoundException
...
namespace Microsoft.VisualStudio.Services.FileContainer
{
  ...
  public class PendingUploadNotFoundException : FileContainerException
  {
    public PendingUploadNotFoundException(int uploadId)
      : base(FileContainerResources.PendingUploadNotFoundException((object) uploadId))
    {
    }
