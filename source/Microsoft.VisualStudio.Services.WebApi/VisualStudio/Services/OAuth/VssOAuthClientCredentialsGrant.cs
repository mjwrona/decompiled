...
// Type: Microsoft.VisualStudio.Services.OAuth.VssOAuthClientCredentialsGrant
...
namespace Microsoft.VisualStudio.Services.OAuth
{
  public sealed class VssOAuthClientCredentialsGrant : VssOAuthGrant
  {
    ...
    protected override void SetParameters(IDictionary<string, string> parameters) => parameters["grant_type"] = "client_credentials";
  }
}
