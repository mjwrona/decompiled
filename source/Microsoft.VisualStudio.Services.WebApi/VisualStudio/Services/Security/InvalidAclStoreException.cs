...
// Type: Microsoft.VisualStudio.Services.Security.InvalidAclStoreException
...
namespace Microsoft.VisualStudio.Services.Security
{
  ...
  public class InvalidAclStoreException : SecurityException
  {
    public InvalidAclStoreException(Guid namespaceId, Guid aclStoreId)
      : this(SecurityResources.InvalidAclStoreException((object) namespaceId, (object) aclStoreId))
    {
    }
