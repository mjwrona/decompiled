...
// Type: Microsoft.VisualStudio.Services.Directories.DirectoryGroupProperty
...
{
  public static class DirectoryGroupProperty
  {
    public const string Active = "Active";
    public const string Description = "Description";
    public const string DisplayName = "DisplayName";
    public const string SubjectDescriptor = "SubjectDescriptor";
    public const string LocalDescriptor = "LocalDescriptor";
