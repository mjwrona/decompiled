...
// Type: Microsoft.VisualStudio.Services.Location.ParentDefinitionNotFoundException
...
namespace Microsoft.VisualStudio.Services.Location
{
  ...
  [Serializable]
  public class ParentDefinitionNotFoundException : VssServiceException
  {
    public ParentDefinitionNotFoundException(
      ...
      : this(LocationResources.ParentDefinitionNotFound((object) serviceType, (object) identifier, (object) parentServiceType, (object) serviceInstance))
    {
    }
