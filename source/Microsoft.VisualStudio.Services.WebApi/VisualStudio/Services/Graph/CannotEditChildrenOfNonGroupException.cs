...
// Type: Microsoft.VisualStudio.Services.Graph.CannotEditChildrenOfNonGroupException
...
namespace Microsoft.VisualStudio.Services.Graph
{
  ...
  public class CannotEditChildrenOfNonGroupException : GraphException
  {
    ...
    protected CannotEditChildrenOfNonGroupException(
    ...
    public CannotEditChildrenOfNonGroupException(SubjectDescriptor subjectDescriptor)
      : base(GraphResources.CannotEditChildrenOfNonGroup((object) subjectDescriptor.ToString()))
    {
    }
  }
}
