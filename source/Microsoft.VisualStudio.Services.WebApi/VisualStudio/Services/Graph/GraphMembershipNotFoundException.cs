...
// Type: Microsoft.VisualStudio.Services.Graph.GraphMembershipNotFoundException
...
namespace Microsoft.VisualStudio.Services.Graph
{
  ...
  public class GraphMembershipNotFoundException : GraphException
  {
    ...
    public GraphMembershipNotFoundException(
      SubjectDescriptor subjectDescriptor,
      SubjectDescriptor containerDescriptor)
      : base(GraphResources.GraphMembershipNotFound((object) subjectDescriptor.ToString(), (object) containerDescriptor.ToString()))
    {
    }
  }
}
