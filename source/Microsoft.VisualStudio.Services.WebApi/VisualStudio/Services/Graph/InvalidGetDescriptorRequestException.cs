...
// Type: Microsoft.VisualStudio.Services.Graph.InvalidGetDescriptorRequestException
...
namespace Microsoft.VisualStudio.Services.Graph
{
  ...
  public class InvalidGetDescriptorRequestException : GraphException
  {
    ...
    public InvalidGetDescriptorRequestException(Guid id)
      : base(IdentityResources.InvalidGetDescriptorRequestWithLocalId((object) id))
    {
    }
  }
}
