...
// Type: Microsoft.VisualStudio.Services.EnterpriseCatalog.FailedToReachEverySpsException
...
{
  [Serializable]
  public class FailedToReachEverySpsException : VssServiceException
  {
    public FailedToReachEverySpsException()
    {
    }
