...
// Type: Microsoft.VisualStudio.Services.TenantPolicy.TenantPolicyUpdateException
...
{
  public class TenantPolicyUpdateException : VssServiceException
  {
    public TenantPolicyUpdateException()
    {
    }
