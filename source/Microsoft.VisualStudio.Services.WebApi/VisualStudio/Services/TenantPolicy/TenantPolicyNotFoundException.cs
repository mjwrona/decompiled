...
// Type: Microsoft.VisualStudio.Services.TenantPolicy.TenantPolicyNotFoundException
...
{
  public class TenantPolicyNotFoundException : VssServiceException
  {
    public TenantPolicyNotFoundException()
    {
    }
