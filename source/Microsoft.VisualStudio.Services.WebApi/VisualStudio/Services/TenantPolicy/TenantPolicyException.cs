...
// Type: Microsoft.VisualStudio.Services.TenantPolicy.TenantPolicyException
...
{
  [Serializable]
  public class TenantPolicyException : VssServiceException
  {
    public TenantPolicyException()
    {
    }
