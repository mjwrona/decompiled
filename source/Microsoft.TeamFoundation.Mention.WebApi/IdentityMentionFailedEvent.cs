...
// Type: Microsoft.TeamFoundation.Mention.WebApi.IdentityMentionFailedEvent
...
{
  [NotificationEventBindings(EventSerializerType.Json, "ms.vss-mentions.identity-mention-failed-event")]
  [DataContract]
  public class IdentityMentionFailedEvent : BaseMentionEvent
  {
    [DataMember]
    public IdentityRefWithEmail Mentioned { get; set; }
