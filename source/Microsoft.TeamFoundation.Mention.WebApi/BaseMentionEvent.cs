...
// Type: Microsoft.TeamFoundation.Mention.WebApi.BaseMentionEvent
...
{
  [DataContract]
  public abstract class BaseMentionEvent
  {
    [DataMember]
    public SourceArtifact Source { get; set; }

    [DataMember]
    public IdentityRefWithEmail Mentioner { get; set; }

    [DataMember]
    public string MentionDescription { get; set; }
  }
}
