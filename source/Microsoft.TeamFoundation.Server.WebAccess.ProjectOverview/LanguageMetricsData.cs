...
// Type: Microsoft.TeamFoundation.Server.WebAccess.ProjectOverview.LanguageMetricsData
...
{
  [DataContract]
  public class LanguageMetricsData : AbstractProjectSecuredObject
  {
    [DataMember]
    public IList<LanguageMetricInfo> Tags { get; set; }
    ...
    public override void SetSecuredObject(ISecuredObject securedObject)
    {
      ...
      AbstractProjectSecuredObject.SetSecuredObject(securedObject, (IEnumerable<AbstractProjectSecuredObject>) this.Tags);
    }
  }
}
