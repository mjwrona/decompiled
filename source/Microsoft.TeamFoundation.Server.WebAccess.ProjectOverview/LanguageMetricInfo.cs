...
// Type: Microsoft.TeamFoundation.Server.WebAccess.ProjectOverview.LanguageMetricInfo
...
{
  [DataContract]
  public class LanguageMetricInfo : AbstractProjectSecuredObject
  {
    public LanguageMetricInfo(string name, double? languagePercentage)
    {
      this.Name = name;
