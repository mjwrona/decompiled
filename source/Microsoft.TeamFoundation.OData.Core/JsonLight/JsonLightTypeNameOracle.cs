...
// Type: Microsoft.OData.JsonLight.JsonLightTypeNameOracle
...
namespace Microsoft.OData.JsonLight
{
  ...
  {
    internal abstract string GetResourceSetTypeNameForWriting(
      string expectedResourceTypeName,
      ODataResourceSet resourceSet,
      bool isUndeclared);

    internal abstract string GetResourceTypeNameForWriting(
