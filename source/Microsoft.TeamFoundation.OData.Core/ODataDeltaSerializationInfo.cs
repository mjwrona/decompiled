...
// Type: Microsoft.OData.ODataDeltaSerializationInfo
...
namespace Microsoft.OData
{
  public sealed class ODataDeltaSerializationInfo
  {
    ...
    public string NavigationSourceName
    {
      ...
      set
      {
        ExceptionUtils.CheckArgumentStringNotNullOrEmpty(value, nameof (NavigationSourceName));
        this.navigationSourceName = value;
      }
    }

    internal static ODataDeltaSerializationInfo Validate(
