...
// Type: Microsoft.OData.UriParser.FunctionSignatureWithReturnType
...
namespace Microsoft.OData.UriParser
{
  public sealed class FunctionSignatureWithReturnType
  {
    ...
    public FunctionSignatureWithReturnType(
      IEdmTypeReference returnType,
      params IEdmTypeReference[] argumentTypes)
    {
    ...
    public IEdmTypeReference[] ArgumentTypes => this.argumentTypes;
  }
}
