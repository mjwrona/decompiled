...
// Type: Microsoft.OData.UriParser.ComputeExpression
...
namespace Microsoft.OData.UriParser
{
  public sealed class ComputeExpression
  {
    ...
    {
      ExceptionUtils.CheckArgumentNotNull<QueryNode>(expression, nameof (expression));
    ...
    public QueryNode Expression => this.expression;
