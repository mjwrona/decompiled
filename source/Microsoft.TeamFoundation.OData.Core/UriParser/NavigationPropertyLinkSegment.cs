...
// Type: Microsoft.OData.UriParser.NavigationPropertyLinkSegment
...
namespace Microsoft.OData.UriParser
{
  public sealed class NavigationPropertyLinkSegment : ODataPathSegment
  {
    ...
    public NavigationPropertyLinkSegment(
    ...
    internal override bool Equals(ODataPathSegment other)
    {
      ...
      return other is NavigationPropertyLinkSegment propertyLinkSegment && propertyLinkSegment.NavigationProperty == this.navigationProperty;
    }
  }
}
