...
// Type: Microsoft.OData.UriParser.AnyNode
...
namespace Microsoft.OData.UriParser
{
  public sealed class AnyNode : LambdaNode
  {
    public AnyNode(Collection<RangeVariable> parameters)
      : this(parameters, (RangeVariable) null)
    {
    }
    ...
    internal override InternalQueryNodeKind InternalKind => InternalQueryNodeKind.Any;
