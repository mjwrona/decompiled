...
// Type: Microsoft.TeamFoundation.Policy.WebApi.VersionedPolicyConfigurationRef
...
{
  [DataContract]
  public class VersionedPolicyConfigurationRef : PolicyConfigurationRef
  {
    public VersionedPolicyConfigurationRef()
    {
    }
