...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.NotificationResult
...
{
  [DataContract]
  public enum NotificationResult : short
  {
    [EnumMember] Pending = 0,
    [EnumMember] Succeeded = 10, // 0x000A
    [EnumMember] Failed = 20, // 0x0014
    [EnumMember] Filtered = 30, // 0x001E
  }
}
