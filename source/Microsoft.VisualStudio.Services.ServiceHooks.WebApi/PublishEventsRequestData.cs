...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.PublishEventsRequestData
...
{
  [DataContract]
  public class PublishEventsRequestData
  {
    [DataMember]
    public IEnumerable<PublisherEvent> Events { get; set; }
  }
}
