...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.SubscriptionNotFoundException
...
{
  [ExceptionMapping("0.0", "3.0", "SubscriptionNotFoundException", "Microsoft.VisualStudio.Services.ServiceHooks.WebApi.SubscriptionNotFoundException, Microsoft.VisualStudio.Services.ServiceHooks.WebApi, Version=14.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class SubscriptionNotFoundException : ServiceHookException
  {
    public SubscriptionNotFoundException(Guid subscriptionId)
      : base(ServiceHooksWebApiResources.Error_NoSubscriptionWithId((object) subscriptionId))
    {
    }
