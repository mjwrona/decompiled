...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.ConsumerNotFoundException
...
{
  [ExceptionMapping("0.0", "3.0", "ConsumerNotFoundException", "Microsoft.VisualStudio.Services.ServiceHooks.WebApi.ConsumerNotFoundException, Microsoft.VisualStudio.Services.ServiceHooks.WebApi, Version=14.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class ConsumerNotFoundException : ServiceHookException
  {
    public ConsumerNotFoundException(string consumerId)
      : base(ServiceHooksWebApiResources.Error_ConsumerNotFoundByIdFormat((object) consumerId))
    {
    }
