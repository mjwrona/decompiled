...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.ServiceHooksDefaultServiceData
...
{
  [DataContract]
  public class ServiceHooksDefaultServiceData
  {
    [DataMember]
    public Dictionary<int, bool> UserPermissions { get; set; }

    [DataMember]
    public Dictionary<string, string> PublisherServiceInstanceTypes { get; set; }
  }
}
