...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.NotificationResultsSummaryDetail
...
{
  [DataContract]
  [DebuggerDisplay("Result:{Result} NotificationCount:{NotificationCount}")]
