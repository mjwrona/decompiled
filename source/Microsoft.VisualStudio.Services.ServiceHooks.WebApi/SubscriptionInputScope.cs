...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.WebApi.SubscriptionInputScope
...
{
  [DataContract]
  public enum SubscriptionInputScope : short
  {
    [EnumMember] Publisher = 10, // 0x000A
    [EnumMember] Consumer = 20, // 0x0014
  }
}
