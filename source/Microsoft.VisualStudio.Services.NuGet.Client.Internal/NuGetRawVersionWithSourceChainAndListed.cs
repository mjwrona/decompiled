...
// Type: Microsoft.VisualStudio.Services.NuGet.Client.Internal.NuGetRawVersionWithSourceChainAndListed
...
{
  [DataContract]
  public class NuGetRawVersionWithSourceChainAndListed : PackagingSecuredObject
  {
    [DataMember]
