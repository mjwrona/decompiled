...
// Type: Microsoft.TeamFoundation.Build2.Server.blankResources
...
namespace Microsoft.TeamFoundation.Build2.Server
{
  ...
  {
    private static ResourceManager s_resMgr = new ResourceManager(nameof (blankResources), typeof (blankResources).GetTypeInfo().Assembly);
