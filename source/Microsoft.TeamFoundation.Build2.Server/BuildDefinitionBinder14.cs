...
// Type: Microsoft.TeamFoundation.Build2.Server.BuildDefinitionBinder14
...
{
  internal sealed class BuildDefinitionBinder14 : BuildObjectBinder<BuildDefinition>
  {
    ...
    private SqlColumnBinder m_variableGroups = new SqlColumnBinder("VariableGroups");
    ...
    private SqlColumnBinder m_buildCompletionTriggers = new SqlColumnBinder("BuildCompletionTriggers");

    public BuildDefinitionBinder14(
    ...
    protected override BuildDefinition Bind()
    {
      ...
      buildDefinition1.VariableGroupsString = this.m_variableGroups.GetString((IDataReader) this.Reader, true);
      ...
      buildDefinition1.BuildCompletionTriggersString = this.m_buildCompletionTriggers.GetString((IDataReader) this.Reader, true);
