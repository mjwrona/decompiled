...
// Type: Microsoft.TeamFoundation.Build2.Server.Build2Component33
...
{
  internal class Build2Component33 : Build2Component32
  {
    ...
    {
      Build2Component33 build2Component33 = this;
      build2Component33.TraceEnter(0, nameof (GetDefinitionAsync));
      build2Component33.PrepareStoredProcedure("Build.prc_GetDefinition");
      build2Component33.BindInt("@dataspaceId", build2Component33.GetDataspaceId(projectId));
      build2Component33.BindInt("@definitionId", definitionId);
      build2Component33.BindNullableInt32("@definitionVersion", definitionVersion);
      build2Component33.BindBoolean("@includeDeleted", includeDeleted);
      build2Component33.BindNullableUtcDateTime2("@minMetricsTime", minMetricsTime);
      build2Component33.BindBoolean("@includeLatestBuilds", includeLatestBuilds);
      BuildDefinition definitionAsync;
      using (ResultCollection rc = new ResultCollection((IDataReader) await build2Component33.ExecuteReaderAsync(), build2Component33.ProcedureName, build2Component33.RequestContext))
      {
        rc.AddBinder<BuildDefinition>(build2Component33.GetBuildDefinitionBinder());
        rc.AddBinder<BuildDefinitionMetric>(build2Component33.GetBuildDefinitionMetricBinder());
        rc.AddBinder<BuildData>(build2Component33.GetBuildDataBinder());
        rc.AddBinder<BuildTagData>(build2Component33.GetBuildTagDataBinder());
        rc.AddBinder<BuildOrchestrationData>(build2Component33.GetBuildOrchestrationDataBinder());
        ...
        if (includeLatestBuilds)
          build2Component33.BindLatestBuilds(rc, definition);
        build2Component33.TraceLeave(0, nameof (GetDefinitionAsync));
    ...
    public override async Task<List<BuildDefinition>> GetDefinitionsByIdsAsync(
      ...
      bool includeDrafts = false)
    {
      Build2Component33 component = this;
    ...
    {
      Build2Component33 build2Component33 = this;
      build2Component33.TraceEnter(0, nameof (UpdateBuildsAsync));
      build2Component33.PrepareStoredProcedure("Build.prc_UpdateBuilds");
      build2Component33.BindInt("@dataspaceId", build2Component33.GetDataspaceId(projectId));
      build2Component33.BindBuildUpdateTable("@buildUpdateTable", builds);
      build2Component33.BindGuid("@requestedBy", changedBy);
      UpdateBuildsResult result = new UpdateBuildsResult();
      UpdateBuildsResult updateBuildsResult;
      using (ResultCollection resultCollection = new ResultCollection((IDataReader) await build2Component33.ExecuteReaderAsync(), build2Component33.ProcedureName, build2Component33.RequestContext))
      {
        resultCollection.AddBinder<BuildData>(build2Component33.GetBuildDataBinder());
        resultCollection.AddBinder<BuildData>(build2Component33.GetBuildDataBinder());
        resultCollection.AddBinder<BuildDefinition>(build2Component33.GetBuildDefinitionBinder());
        resultCollection.AddBinder<BuildTagData>(build2Component33.GetBuildTagDataBinder());
        resultCollection.AddBinder<BuildOrchestrationData>(build2Component33.GetBuildOrchestrationDataBinder());
        ...
        build2Component33.TraceLeave(0, nameof (UpdateBuildsAsync));
    ...
    protected override ObjectBinder<BuildDefinition> GetBuildDefinitionBinder() => (ObjectBinder<BuildDefinition>) new BuildDefinitionBinder11(this.RequestContext, (BuildSqlComponentBase) this);
  }
}
