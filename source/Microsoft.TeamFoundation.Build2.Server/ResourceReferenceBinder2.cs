...
// Type: Microsoft.TeamFoundation.Build2.Server.ResourceReferenceBinder2
...
{
  internal sealed class ResourceReferenceBinder2 : BuildObjectBinder<ResourceReference>
  {
    ...
    public ResourceReferenceBinder2(IVssRequestContext requestContext)
      : base(requestContext)
    {
    }
