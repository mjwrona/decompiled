...
// Type: Microsoft.TeamFoundation.Build2.Server.BuildEventBinder2
...
{
  internal sealed class BuildEventBinder2 : ObjectBinder<BuildChangeEvent>
  {
    ...
    private SqlColumnBinder m_retriesRemaining = new SqlColumnBinder("RetriesRemaining");
    private BuildSqlComponentBase m_resourceComponent;

    public BuildEventBinder2(BuildSqlComponentBase component) => this.m_resourceComponent = component;
    ...
    protected override BuildChangeEvent Bind() => new BuildChangeEvent()
    {
      ...
      RetriesRemaining = this.m_retriesRemaining.GetByte((IDataReader) this.Reader)
    };
  }
}
