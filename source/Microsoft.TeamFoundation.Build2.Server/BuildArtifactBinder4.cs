...
// Type: Microsoft.TeamFoundation.Build2.Server.BuildArtifactBinder4
...
{
  internal sealed class BuildArtifactBinder4 : BuildObjectBinder<BuildArtifact>
  {
    ...
    public BuildArtifactBinder4(IVssRequestContext requestContext)
      : base(requestContext)
    {
    }
