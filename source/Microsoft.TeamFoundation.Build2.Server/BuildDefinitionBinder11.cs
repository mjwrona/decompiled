...
// Type: Microsoft.TeamFoundation.Build2.Server.BuildDefinitionBinder11
...
{
  internal sealed class BuildDefinitionBinder11 : BuildObjectBinder<BuildDefinition>
  {
    ...
    private SqlColumnBinder m_steps = new SqlColumnBinder("Steps");
    ...
    public BuildDefinitionBinder11(
    ...
    protected override BuildDefinition Bind()
    {
      ...
      List<BuildDefinitionStep> source = JsonUtility.FromString<List<BuildDefinitionStep>>(this.m_steps.GetString((IDataReader) this.Reader, true));
      if (source != null)
      {
        Phase phase = new Phase()
        {
          Name = BuildServerResources.BuildJobName()
        };
        phase.Steps.AddRange(source.Where<BuildDefinitionStep>((System.Func<BuildDefinitionStep, bool>) (s => s != null)));
