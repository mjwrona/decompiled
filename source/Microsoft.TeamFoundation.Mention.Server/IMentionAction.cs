...
// Type: Microsoft.TeamFoundation.Mention.Server.IMentionAction
...
{
  [InheritedExport]
  public interface IMentionAction
  {
    string Name { get; }

    void PerformAction(IVssRequestContext requestContext, IEnumerable<Microsoft.TeamFoundation.Mention.Server.Mention> mentions);

    IEnumerable<Microsoft.TeamFoundation.Mention.Server.Mention> FilterMentions(
