...
// Type: Microsoft.TeamFoundation.Mention.Server.IMentionSourceContext
...
{
  public interface IMentionSourceContext
  {
    string Type { get; }
    ...
    MentionActionType SupportedActionTypes { get; }

    Guid Mentioner { get; }

    string NormalizedId { get; }
  }
}
