...
// Type: Microsoft.TeamFoundation.Server.WebAccess.Build.AdminAgentQueueController
...
namespace Microsoft.TeamFoundation.Server.WebAccess.Build
{
  ...
  public class AdminAgentQueueController : BuildAreaController
  {
    public AdminAgentQueueController() => this.m_executeContributedRequestHandlers = true;
    ...
    {
      this.AddSignalRData();
      return (ActionResult) this.View((object) AgentQueueAdminViewModel.Create(this.TfsWebContext));
    }
