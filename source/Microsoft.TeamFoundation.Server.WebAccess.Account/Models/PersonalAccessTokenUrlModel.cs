...
// Type: Microsoft.TeamFoundation.Server.WebAccess.Account.Models.PersonalAccessTokenUrlModel
...
{
  [DataContract]
  public class PersonalAccessTokenUrlModel
  {
    ...
    [DataMember(Name = "RevokeAll", EmitDefaultValue = false)]
    ...
    [DataMember(Name = "Regenerate", EmitDefaultValue = false)]
    public string Regenerate { get; set; }

    [DataMember(Name = "GetToken", EmitDefaultValue = false)]
