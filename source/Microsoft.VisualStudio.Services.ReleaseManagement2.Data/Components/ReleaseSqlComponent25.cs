...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components.ReleaseSqlComponent25
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components
{
  ...
  public class ReleaseSqlComponent25 : ReleaseSqlComponent24
  {
      ...
      string comment)
    {
      ...
      this.BindGuid(nameof (requestedFor), requestedFor);
      ...
      string comment)
    {
      ...
      return this.GetRelease(projectId, releaseId, false);
    }

    [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Complexity is necessary.")]
    ...
    protected override DeploymentBinder GetDeploymentBinder() => (DeploymentBinder) new DeploymentBinder3((ReleaseManagementSqlResourceComponentBase) this);

    protected override void BindDeployments(IEnumerable<Deployment> deployments) => this.BindDeploymentTable2(nameof (deployments), deployments);
  }
}
