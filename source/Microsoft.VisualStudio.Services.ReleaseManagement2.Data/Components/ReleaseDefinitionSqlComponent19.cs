...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components.ReleaseDefinitionSqlComponent19
...
{
  [SuppressMessage("Microsoft.Maintainability", "CA1501:AvoidExcessiveInheritance", Justification = "It is supposed to be like this")]
  public class ReleaseDefinitionSqlComponent19 : ReleaseDefinitionSqlComponent18
  {
    ...
    protected override ReleaseDefinitionBinder GetReleaseDefinitionBinder() => (ReleaseDefinitionBinder) new ReleaseDefinitionBinder3((ReleaseManagementSqlResourceComponentBase) this);

    protected override DefinitionEnvironmentListBinder GetDefinitionEnvironmentListBinder() => (DefinitionEnvironmentListBinder) new DefinitionEnvironmentListBinder2((ReleaseManagementSqlResourceComponentBase) this);

    protected override void BindFolderPath(string path) => this.BindString(nameof (path), PathHelper.UserToDBPath(path), -1, BindStringBehavior.Unchanged, SqlDbType.NVarChar);

    protected override void BindIsExactNameMatch(bool isExactNameMatch) => this.BindBoolean(nameof (isExactNameMatch), isExactNameMatch);
  }
}
