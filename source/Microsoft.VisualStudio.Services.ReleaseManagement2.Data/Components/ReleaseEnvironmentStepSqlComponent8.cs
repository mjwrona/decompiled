...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components.ReleaseEnvironmentStepSqlComponent8
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components
{
  ...
  public class ReleaseEnvironmentStepSqlComponent8 : ReleaseEnvironmentStepSqlComponent7
  {
    public override IEnumerable<ReleaseEnvironmentStep> GetReleaseEnvironmentStep(
      Guid projectId,
      ...
      bool includeHistory)
    {
      ...
      this.BindBoolean(nameof (includeHistory), includeHistory);
