...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components.ReleaseEnvironmentQueueSqlComponent7
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components
{
  ...
  public class ReleaseEnvironmentQueueSqlComponent7 : ReleaseEnvironmentQueueSqlComponent6
  {
    ...
    public override void RemoveEnvironmentFromQueue(
      Guid projectId,
      int releaseId,
      int releaseEnvironmentId)
    {
      this.PrepareStoredProcedure("Release.prc_RemoveEnvironmentFromQueue", projectId);
      this.BindInt(nameof (releaseId), releaseId);
      this.BindInt(nameof (releaseEnvironmentId), releaseEnvironmentId);
      this.ExecuteScalar();
    }
