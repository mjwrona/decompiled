...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components.ReleaseSqlComponent24
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components
{
  ...
  public class ReleaseSqlComponent24 : ReleaseSqlComponent23
  {
    ...
    protected override Release GetReleaseObject(Guid projectId)
    {
      using (ResultCollection resultCollection = new ResultCollection((IDataReader) this.ExecuteReader(), this.ProcedureName, this.RequestContext))
      {
        ...
        resultCollection.NextResult();
        List<ReleaseTagData> items7 = resultCollection.GetCurrent<ReleaseTagData>().Items;
        if (release != null)
    ...
    [SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate", Justification = "It could be overridden in future")]
    protected virtual ReleaseTagBinder GetReleaseTagsBinder() => new ReleaseTagBinder((ReleaseManagementSqlResourceComponentBase) this);
  }
}
