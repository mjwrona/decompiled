...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Components.ActionRequestSqlComponent2
...
{
  public class ActionRequestSqlComponent2 : ActionRequestSqlComponent
  {
      ...
      int continuationToken)
    {
      ...
      this.BindInt(nameof (actionRequestType), actionRequestType);
