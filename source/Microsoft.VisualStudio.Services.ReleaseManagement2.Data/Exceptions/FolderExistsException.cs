...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Exceptions.FolderExistsException
...
{
  [Serializable]
  public class FolderExistsException : TeamFoundationServiceException
  {
    ...
    public FolderExistsException(string message, Exception innerException)
