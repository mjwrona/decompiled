...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Exceptions.InvalidFolderException
...
{
  [Serializable]
  public class InvalidFolderException : TeamFoundationServiceException
  {
    ...
    public InvalidFolderException(string message, Exception innerException)
