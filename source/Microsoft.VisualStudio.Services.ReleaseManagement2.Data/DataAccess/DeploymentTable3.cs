...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess.DeploymentTable3
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess
{
  ...
  public static class DeploymentTable3
  {
    private static readonly SqlMetaData[] SqlMetaData3 = new SqlMetaData[11]
    {
      ...
      new SqlMetaData("QueuedOn", SqlDbType.DateTime),
      new SqlMetaData("StartedOn", SqlDbType.DateTime),
    ...
    public static void BindDeploymentTable3(
      ...
      IEnumerable<Deployment> deployments)
    {
      ...
      component.BindTable(parameterName, "Release.typ_DeploymentTableV3", DeploymentTable3.GetSqlDataRecords3(deployments));
    }
    ...
    private static IEnumerable<SqlDataRecord> GetSqlDataRecords3(IEnumerable<Deployment> rows)
    {
      ...
      {
        int ordinal = 0;
        SqlDataRecord sqlDataRecord = new SqlDataRecord(DeploymentTable3.SqlMetaData3);
        ...
        int num7;
        sqlDataRecord.SetDateTime(num7 = num6 + 1, deployment.StartedOn.ToUtcDateTime());
        int num8;
        sqlDataRecord.SetDateTime(num8 = num7 + 1, deployment.LastModifiedOn.ToUtcDateTime());
        int num9;
        sqlDataRecord.SetGuid(num9 = num8 + 1, deployment.LastModifiedBy);
        int num10;
        sqlDataRecord.SetInt32(num10 = num9 + 1, 0);
