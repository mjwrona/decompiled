...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess.ReleaseArtifactSourceTable3
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess
{
  ...
  public static class ReleaseArtifactSourceTable3
  {
    ...
    public static void BindReleaseArtifactSourceTable3(
      ...
      IEnumerable<PipelineArtifactSource> releaseArtifactSources)
    {
      ...
      component.BindTable(parameterName, "Release.typ_ReleaseArtifactSourceTableV3", ReleaseArtifactSourceTable3.GetSqlDataRecords3(releaseArtifactSources));
    }
      ...
      IEnumerable<PipelineArtifactSource> rows)
    {
      ...
      {
        int ordinal = 0;
        SqlDataRecord sqlDataRecord = new SqlDataRecord(ReleaseArtifactSourceTable3.SqlMetaData);
