...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess.ReleaseDefinitionArtifactSourceTable2
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess
{
  ...
  public static class ReleaseDefinitionArtifactSourceTable2
  {
    ...
    public static void BindReleaseDefinitionArtifactSourceTable2(
      ...
      IEnumerable<ArtifactSource> artifactSources)
    {
      ...
      component.BindTable(parameterName, "Release.typ_ReleaseDefinitionArtifactSourceTableV2", ReleaseDefinitionArtifactSourceTable2.GetSqlDataRecords(artifactSources));
    }
    ...
    private static IEnumerable<SqlDataRecord> GetSqlDataRecords(IEnumerable<ArtifactSource> rows)
    {
      ...
      foreach (ArtifactSource artifactSource in rows.Where<ArtifactSource>((System.Func<ArtifactSource, bool>) (r => r != null)))
      {
        ...
        int ordinal = 0;
        SqlDataRecord sqlDataRecord = new SqlDataRecord(ReleaseDefinitionArtifactSourceTable2.SqlMetaData);
