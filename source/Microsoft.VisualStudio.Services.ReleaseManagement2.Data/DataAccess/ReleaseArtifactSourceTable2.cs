...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess.ReleaseArtifactSourceTable2
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess
{
  ...
  public static class ReleaseArtifactSourceTable2
  {
    ...
    public static void BindReleaseArtifactSourceTable2(
      ...
      IEnumerable<PipelineArtifactSource> releaseArtifactSources)
    {
      ...
      component.BindTable(parameterName, "Release.typ_ReleaseArtifactSourceTableV2", ReleaseArtifactSourceTable2.GetSqlDataRecords2(releaseArtifactSources));
    }
    ...
    private static IEnumerable<SqlDataRecord> GetSqlDataRecords2(
      IEnumerable<PipelineArtifactSource> rows)
    {
      ...
      {
        int ordinal = 0;
        SqlDataRecord sqlDataRecord = new SqlDataRecord(ReleaseArtifactSourceTable2.SqlMetaData);
