...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess.ReleaseArtifactSourceTable4
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataAccess
{
  ...
  public static class ReleaseArtifactSourceTable4
  {
    private static readonly Microsoft.SqlServer.Server.SqlMetaData[] SqlMetaData = new Microsoft.SqlServer.Server.SqlMetaData[5]
    {
      ...
      new Microsoft.SqlServer.Server.SqlMetaData("ArtifactVersion", SqlDbType.NVarChar, 256L),
    ...
    public static void BindReleaseArtifactSourceTable4(
      ...
      IEnumerable<PipelineArtifactSource> releaseArtifactSources)
    {
      ...
      component.BindTable(parameterName, "Release.typ_ReleaseArtifactSourceTableV4", ReleaseArtifactSourceTable4.GetSqlDataRecords4(releaseArtifactSources));
    }
      ...
      IEnumerable<PipelineArtifactSource> rows)
    {
      ...
      {
        int ordinal = 0;
        SqlDataRecord sqlDataRecord = new SqlDataRecord(ReleaseArtifactSourceTable4.SqlMetaData);
        sqlDataRecord.SetInt32(ordinal, pipelineArtifactSource.ArtifactSourceId);
        int num1;
        sqlDataRecord.SetString(num1 = ordinal + 1, pipelineArtifactSource.ArtifactVersion);
        int num2;
        sqlDataRecord.SetString(num2 = num1 + 1, string.IsNullOrEmpty(pipelineArtifactSource.Alias) ? string.Empty : pipelineArtifactSource.Alias);
        int num3;
        sqlDataRecord.SetString(num3 = num2 + 1, string.IsNullOrEmpty(pipelineArtifactSource.SourceBranch) ? string.Empty : pipelineArtifactSource.SourceBranch);
        int num4;
        sqlDataRecord.SetBoolean(num4 = num3 + 1, pipelineArtifactSource.IsPrimary);
