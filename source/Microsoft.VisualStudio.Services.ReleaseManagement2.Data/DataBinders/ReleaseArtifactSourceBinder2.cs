...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataBinders.ReleaseArtifactSourceBinder2
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataBinders
{
  ...
  public class ReleaseArtifactSourceBinder2 : ReleaseArtifactSourceBinder
  {
    private SqlColumnBinder sourceAlias = new SqlColumnBinder("Alias");
    private SqlColumnBinder branch = new SqlColumnBinder("SourceBranch");

    public ReleaseArtifactSourceBinder2(
    ...
    protected ref SqlColumnBinder Branch => ref this.branch;
  }
}
