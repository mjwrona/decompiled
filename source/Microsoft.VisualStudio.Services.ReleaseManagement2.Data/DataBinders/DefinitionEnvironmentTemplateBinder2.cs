...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataBinders.DefinitionEnvironmentTemplateBinder2
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataBinders
{
  ...
  public class DefinitionEnvironmentTemplateBinder2 : DefinitionEnvironmentTemplateBinder
  {
    ...
    protected override DefinitionEnvironmentTemplate Bind()
    {
      DefinitionEnvironmentTemplate environmentTemplate = new DefinitionEnvironmentTemplate()
      {
        ...
        ModifiedOn = this.modifiedOn.GetDateTime((IDataReader) this.Reader, DateTime.UtcNow)
      };
