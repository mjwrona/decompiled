...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataBinders.DeploymentResourceBinder
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.DataBinders
{
  ...
  public class DeploymentResourceBinder : ObjectBinder<DeploymentResource>
  {
    private SqlColumnBinder id = new SqlColumnBinder("Id");
    private SqlColumnBinder resourceIdentifier = new SqlColumnBinder("ResourceIdentifier");
    ...
    protected override DeploymentResource Bind() => new DeploymentResource()
    {
      Id = this.id.GetInt32((IDataReader) this.Reader),
      ResourceIdentifier = this.resourceIdentifier.GetString((IDataReader) this.Reader, false),
