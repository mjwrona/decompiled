...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.Data.Migration.ReleaseTriggerDataspaceIdDataBinder
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.Data.Migration
{
  ...
  public class ReleaseTriggerDataspaceIdDataBinder : ObjectBinder<int>
  {
    private SqlColumnBinder dataSpaceId = new SqlColumnBinder("DataspaceId");

    protected override int Bind() => this.dataSpaceId.GetInt32((IDataReader) this.Reader);
  }
}
