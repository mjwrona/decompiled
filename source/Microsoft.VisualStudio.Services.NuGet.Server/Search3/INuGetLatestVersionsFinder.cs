...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.Search3.INuGetLatestVersionsFinder
...
{
  public interface INuGetLatestVersionsFinder
  {
    LatestVersions FindLatestVersions(
