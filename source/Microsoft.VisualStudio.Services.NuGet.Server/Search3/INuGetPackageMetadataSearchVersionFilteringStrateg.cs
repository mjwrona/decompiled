...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.Search3.INuGetPackageMetadataSearchVersionFilteringStrategy
...
{
  public interface INuGetPackageMetadataSearchVersionFilteringStrategy
  {
    bool DoesVersionAppearToExist(
      NuGetSearchCategoryToggles query,
      Guid viewId,
      NuGetSearchResultVersionSummary versionInfo);

    bool IsVersionSelectable(
      NuGetSearchCategoryToggles query,
      NuGetSearchResultVersionSummary versionInfo);
  }
}
