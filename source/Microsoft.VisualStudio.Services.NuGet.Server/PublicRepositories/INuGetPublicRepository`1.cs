...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.PublicRepositories.INuGetPublicRepository`1
...
{
  public interface INuGetPublicRepository<out TDirectClient> : 
  ...
  {
    TDirectClient DirectClient { get; }
  }
}
