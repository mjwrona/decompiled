...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.PackageIngestion.NuGetNoopPackageIngestionService
...
{
  public class NuGetNoopPackageIngestionService : 
    ...
    IVssFrameworkService
  {
    ...
    public Task AddPackageFromStreamAsync(
    ...
    public Task AddPackageFromBlobAsync(
      IVssRequestContext requestContext,
      IFeedRequest feedRequest,
    ...
    public Task AddPackageFromDropAsync(
      IVssRequestContext requestContext,
      IFeedRequest feedRequest,
      string dropName,
      string protocolVersion)
