...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.BlobPrototype.V2PackageRequest
...
{
  public class V2PackageRequest : PackageRequest<VssNuGetPackageIdentity>
  {
    public V2PackageRequest(
      IFeedRequest feedRequest,
      VssNuGetPackageIdentity packageIdentity,
      System.Web.Http.OData.Query.ODataQueryOptions<V2FeedPackage> oDataQueryOptions)
      : base(feedRequest, packageIdentity)
    {
