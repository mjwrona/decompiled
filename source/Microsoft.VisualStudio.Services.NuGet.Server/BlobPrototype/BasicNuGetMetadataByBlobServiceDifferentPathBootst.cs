...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.BlobPrototype.BasicNuGetMetadataByBlobServiceDifferentPathBootstrapper
...
{
  public class BasicNuGetMetadataByBlobServiceDifferentPathBootstrapper : 
    IBootstrapper<IFactory<ContainerAddress, IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>>>
  {
    private readonly IVssRequestContext requestContext;

    public BasicNuGetMetadataByBlobServiceDifferentPathBootstrapper(
    ...
    public IFactory<ContainerAddress, IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>> Bootstrap()
    {
      ...
      return (IFactory<ContainerAddress, IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>>) new ByFuncInputFactory<ContainerAddress, IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>>((Func<ContainerAddress, IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>>) (containerAddress => (IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>) new UpstreamFilteringMetadataService<VssNuGetPackageIdentity, INuGetMetadataEntry>((IMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>) new MetadataByBlobService<VssNuGetPackageIdentity, INuGetMetadataEntry>(BlobServiceFactoryBootstrapper.CreateLegacyUnsharded(this.requestContext).Bootstrap(), containerAddress, (IFactory<PackageNameQuery<INuGetMetadataEntry>, ISerializer<MetadataDocument<INuGetMetadataEntry>>>) serializerFactory, (IMetadataEntryOpApplierFactory<INuGetMetadataEntry, MetadataDocument<INuGetMetadataEntry>>) new NuGetMetadataOpApplierFactory(), (IMetadataDocumentOpApplierFactory<MetadataDocument<INuGetMetadataEntry>>) new NuGetMetadataDocumentOpApplierFactory(tracerService), (IConverter<IPackageNameRequest, Locator>) new ByFuncConverter<IPackageNameRequest, Locator>((Func<IPackageNameRequest, Locator>) (req => new Locator(new string[3]
      {
        "pkgNameMetadata",
