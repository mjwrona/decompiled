...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.BlobPrototype.V2FindPackagesByIdBlobHandlerBootstrapper
...
{
  public class V2FindPackagesByIdBlobHandlerBootstrapper : 
    RequireAggHandlerBootstrapper<RawV2PackageNameRequest, IEnumerable<V2FeedPackage>, INuGetMetadataService, IUpstreamVersionListService<VssNuGetPackageName, VssNuGetPackageVersion>>
  {
    private readonly IVssRequestContext requestContext;

    public V2FindPackagesByIdBlobHandlerBootstrapper(IVssRequestContext requestContext) => this.requestContext = requestContext;

    protected override IAsyncHandler<RawV2PackageNameRequest, IEnumerable<V2FeedPackage>> Bootstrap(
      ...
      IUpstreamVersionListService<VssNuGetPackageName, VssNuGetPackageVersion> upstreamVersionListService)
    {
      ...
      V2PackageNameRequestConverter converter = new V2PackageNameRequestConverter(new NuGetPackageNameParsingConverterBootstrapper(this.requestContext).Bootstrap());
      ...
      V2FindPackagesByIdBlobHandler handler = new V2FindPackagesByIdBlobHandler((IReadMetadataService<VssNuGetPackageIdentity, INuGetMetadataEntry>) new NuGetUpstreamFetchingMetadataServiceBootstrapper(this.requestContext, (IReadMetadataDocumentService<VssNuGetPackageIdentity, INuGetMetadataEntry>) packageMetadataService, upstreamVersionListService, true).Bootstrap(), (IConverter<IPackageRequest<VssNuGetPackageIdentity, INuGetMetadataEntry>, ServerV2FeedPackage>) metadataEntryConverter, (IConverter<V2FilterRequest, IEnumerable<ServerV2FeedPackage>>) oDataFilter, (IConverter<V2GetDownloadUrlBatchRequest, IEnumerable<V2FeedPackage>>) downloadUrlPopulator);
      return converter.ThenDelegateTo<RawV2PackageNameRequest, V2PackageNameRequest, IEnumerable<V2FeedPackage>>((IAsyncHandler<V2PackageNameRequest, IEnumerable<V2FeedPackage>>) handler);
    }
  }
}
