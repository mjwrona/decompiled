...
// Type: Microsoft.VisualStudio.Services.NuGet.Server.BlobPrototype.RawV2PackageNameRequest
...
{
  public class RawV2PackageNameRequest : FeedRequest
  {
    public RawV2PackageNameRequest(
