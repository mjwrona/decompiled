...
// Type: Microsoft.OData.Edm.BadStringTypeReference
...
namespace Microsoft.OData.Edm
{
  internal class BadStringTypeReference : EdmStringTypeReference, IEdmCheckable
  {
    ...
    public BadStringTypeReference(
      string qualifiedName,
      bool isNullable,
      IEnumerable<EdmError> errors)
      : base((IEdmPrimitiveType) new BadPrimitiveType(qualifiedName, EdmPrimitiveTypeKind.String, errors), isNullable, false, new int?(), new bool?(false))
    {
      this.errors = errors;
    }
