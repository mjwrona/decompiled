...
// Type: Microsoft.OData.Edm.BadBinaryTypeReference
...
namespace Microsoft.OData.Edm
{
  internal class BadBinaryTypeReference : EdmBinaryTypeReference, IEdmCheckable
  {
    ...
    public BadBinaryTypeReference(
      string qualifiedName,
      bool isNullable,
      IEnumerable<EdmError> errors)
      : base((IEdmPrimitiveType) new BadPrimitiveType(qualifiedName, EdmPrimitiveTypeKind.Binary, errors), isNullable, false, new int?())
    {
      this.errors = errors;
    }
