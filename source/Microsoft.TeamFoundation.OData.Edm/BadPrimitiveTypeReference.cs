...
// Type: Microsoft.OData.Edm.BadPrimitiveTypeReference
...
namespace Microsoft.OData.Edm
{
  internal class BadPrimitiveTypeReference : EdmPrimitiveTypeReference, IEdmCheckable
  {
    ...
    public BadPrimitiveTypeReference(
      string qualifiedName,
      bool isNullable,
      IEnumerable<EdmError> errors)
      : base((IEdmPrimitiveType) new BadPrimitiveType(qualifiedName, EdmPrimitiveTypeKind.None, errors), isNullable)
    {
      this.errors = errors;
    }
