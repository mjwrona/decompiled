...
// Type: Microsoft.OData.Edm.Csdl.Parsing.Ast.CsdlCollectionExpression
...
namespace Microsoft.OData.Edm.Csdl.Parsing.Ast
{
  internal class CsdlCollectionExpression : CsdlExpressionBase
  {
    ...
    public CsdlCollectionExpression(
      CsdlTypeReference type,
      IEnumerable<CsdlExpressionBase> elementValues,
    ...
    public IEnumerable<CsdlExpressionBase> ElementValues => (IEnumerable<CsdlExpressionBase>) this.elementValues;
  }
}
