...
// Type: Microsoft.OData.Edm.Csdl.Parsing.Ast.CsdlRecordExpression
...
namespace Microsoft.OData.Edm.Csdl.Parsing.Ast
{
  internal class CsdlRecordExpression : CsdlExpressionBase
  {
    ...
    public CsdlRecordExpression(
      CsdlTypeReference type,
      IEnumerable<CsdlPropertyValue> propertyValues,
    ...
    public IEnumerable<CsdlPropertyValue> PropertyValues => (IEnumerable<CsdlPropertyValue>) this.propertyValues;
  }
}
