...
// Type: Microsoft.OData.Edm.BadDecimalTypeReference
...
namespace Microsoft.OData.Edm
{
  internal class BadDecimalTypeReference : EdmDecimalTypeReference, IEdmCheckable
  {
    ...
    public BadDecimalTypeReference(
      string qualifiedName,
      bool isNullable,
      IEnumerable<EdmError> errors)
      : base((IEdmPrimitiveType) new BadPrimitiveType(qualifiedName, EdmPrimitiveTypeKind.Decimal, errors), isNullable, new int?(), new int?())
    {
      this.errors = errors;
    }
