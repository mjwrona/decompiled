...
// Type: Microsoft.OData.Edm.EdmCoreModelUntypedType
...
{
  internal sealed class EdmCoreModelUntypedType : 
    EdmType,
    IEdmUntypedType,
    IEdmSchemaType,
    IEdmSchemaElement,
    ...
    IEdmFullNamedElement
  {
    ...
    public string Name => "Untyped";

    public string Namespace => "Edm";

    public string FullName => "Edm.Untyped";
  }
}
