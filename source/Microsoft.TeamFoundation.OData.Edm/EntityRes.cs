...
// Type: Microsoft.OData.Edm.EntityRes
...
namespace Microsoft.OData.Edm
{
  internal sealed class EntityRes
  {
    ...
    internal EntityRes() => this.resources = new ResourceManager("Microsoft.OData.Edm", this.GetType().Assembly);
    ...
    public static ResourceManager Resources => EntityRes.GetLoader().resources;
    ...
    public static string GetString(string name) => EntityRes.GetLoader()?.resources.GetString(name, EntityRes.Culture);
    ...
    public static object GetObject(string name) => EntityRes.GetLoader()?.resources.GetObject(name, EntityRes.Culture);
  }
}
