...
// Type: Microsoft.Azure.NotificationHubs.Messaging.MessageLockLostException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class MessageLockLostException : MessagingException
  {
    ...
    private MessageLockLostException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
