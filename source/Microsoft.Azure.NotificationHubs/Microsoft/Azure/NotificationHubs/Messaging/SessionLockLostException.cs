...
// Type: Microsoft.Azure.NotificationHubs.Messaging.SessionLockLostException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class SessionLockLostException : MessagingException
  {
    ...
    private SessionLockLostException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
