...
// Type: Microsoft.Azure.NotificationHubs.Messaging.SessionCannotBeLockedException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class SessionCannotBeLockedException : MessagingException
  {
    ...
    private SessionCannotBeLockedException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
