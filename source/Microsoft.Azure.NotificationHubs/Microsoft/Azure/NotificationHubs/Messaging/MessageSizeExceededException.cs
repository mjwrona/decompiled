...
// Type: Microsoft.Azure.NotificationHubs.Messaging.MessageSizeExceededException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class MessageSizeExceededException : MessagingException
  {
    ...
    private MessageSizeExceededException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
