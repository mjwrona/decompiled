...
// Type: Microsoft.Azure.NotificationHubs.Messaging.ReceiverDisconnectedException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class ReceiverDisconnectedException : MessagingException
  {
    ...
    internal ReceiverDisconnectedException(
    ...
    private ReceiverDisconnectedException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
