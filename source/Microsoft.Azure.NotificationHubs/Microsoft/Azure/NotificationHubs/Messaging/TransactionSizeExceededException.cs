...
// Type: Microsoft.Azure.NotificationHubs.Messaging.TransactionSizeExceededException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class TransactionSizeExceededException : QuotaExceededException
  {
    ...
    internal TransactionSizeExceededException(
    ...
    private TransactionSizeExceededException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
