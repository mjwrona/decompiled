...
// Type: Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing.DeliveryAnnotations
...
namespace Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing
{
  internal sealed class DeliveryAnnotations : DescribedAnnotations
  {
    ...
    public static readonly ulong Code = 113;

    public DeliveryAnnotations()
      : base((AmqpSymbol) DeliveryAnnotations.Name, DeliveryAnnotations.Code)
    {
    }
  }
}
