...
// Type: Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing.MessageAnnotations
...
namespace Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing
{
  internal sealed class MessageAnnotations : DescribedAnnotations
  {
    ...
    public static readonly ulong Code = 114;

    public MessageAnnotations()
      : base((AmqpSymbol) MessageAnnotations.Name, MessageAnnotations.Code)
    {
    }
  }
}
