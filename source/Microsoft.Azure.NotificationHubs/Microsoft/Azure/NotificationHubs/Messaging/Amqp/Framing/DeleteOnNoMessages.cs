...
// Type: Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing.DeleteOnNoMessages
...
namespace Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing
{
  internal sealed class DeleteOnNoMessages : LifeTimePolicy
  {
    ...
    public static readonly ulong Code = 45;

    public DeleteOnNoMessages()
      : base((AmqpSymbol) DeleteOnNoMessages.Name, DeleteOnNoMessages.Code)
    {
    }

    public override string ToString() => "delete-on-no-messages()";
  }
}
