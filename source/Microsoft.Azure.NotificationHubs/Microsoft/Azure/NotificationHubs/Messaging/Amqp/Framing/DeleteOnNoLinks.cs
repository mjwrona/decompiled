...
// Type: Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing.DeleteOnNoLinks
...
namespace Microsoft.Azure.NotificationHubs.Messaging.Amqp.Framing
{
  internal sealed class DeleteOnNoLinks : LifeTimePolicy
  {
    ...
    public static readonly ulong Code = 44;

    public DeleteOnNoLinks()
      : base((AmqpSymbol) DeleteOnNoLinks.Name, DeleteOnNoLinks.Code)
    {
    }

    public override string ToString() => "delete-on-no-links()";
  }
}
