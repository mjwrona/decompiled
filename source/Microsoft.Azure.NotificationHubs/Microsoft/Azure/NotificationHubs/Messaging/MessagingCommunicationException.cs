...
// Type: Microsoft.Azure.NotificationHubs.Messaging.MessagingCommunicationException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class MessagingCommunicationException : MessagingException
  {
    public MessagingCommunicationException(string communicationPath)
      : this(SRClient.MessagingEndpointCommunicationError((object) communicationPath), (Exception) null)
    {
    }
