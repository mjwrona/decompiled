...
// Type: Microsoft.Azure.NotificationHubs.Messaging.MessageStoreLockLostException
...
namespace Microsoft.Azure.NotificationHubs.Messaging
{
  ...
  public sealed class MessageStoreLockLostException : MessagingException
  {
    ...
    internal MessageStoreLockLostException(
    ...
    private MessageStoreLockLostException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
      this.IsTransient = false;
    }
