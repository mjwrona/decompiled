...
// Type: Microsoft.TeamFoundation.Build.Common.BuildParameterSerializationException
...
{
  [Serializable]
  public class BuildParameterSerializationException : BuildParameterException
  {
    public BuildParameterSerializationException(string detailedMessage, Exception innerException)
      : base(BuildTypeResource.BuildParameterDeserializationException((object) detailedMessage), innerException)
    {
    }
  }
}
