...
// Type: Microsoft.VisualStudio.Services.Cargo.Server.PackageMetadata.CargoRawPackageMetadata
...
{
  public record CargoRawPackageMetadata(
    LazySerDesValue<DeflateCompressibleBytes, CargoPublishManifest>? PublishManifest,
    LazySerDesValue<DeflateCompressibleBytes, CargoIndexVersionRow>? UpstreamIndexRow,
    LazySerDesValue<DeflateCompressibleBytes, CargoTomlManifest>? CargoToml,
    string? ActualReadmeFilePath,
