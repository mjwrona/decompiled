...
// Type: Microsoft.VisualStudio.Services.Cargo.Server.Upstreams.LimitedCargoMetadata
...
{
  public record LimitedCargoMetadata(
    VersionWithSourceChain<CargoPackageVersion> PackageVersion,
    LazySerDesValue<DeflateCompressibleBytes, CargoIndexVersionRow> IndexRow,
    IImmutableList<HashAndType> Hashes)
  ;
}
