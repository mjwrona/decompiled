...
// Type: Microsoft.Azure.Pipelines.Authorization.Server.IPipelineDefinitionPlugin
...
{
  [InheritedExport]
  public interface IPipelineDefinitionPlugin
  {
    Task<List<string>> GetDefinitionVariableGroupIds(
      IVssRequestContext requestContext,
      Guid projectId,
      int definitionId);

    Task<string> GetDefinitionRepositoryEndpointAsync(
      IVssRequestContext requestContext,
      Guid projectId,
      int definitionId);
  }
