...
// Type: Microsoft.VisualStudio.Services.Favorites.Server.IFavoriteProviderService
...
{
  [DefaultServiceImplementation(typeof (FavoriteProviderService))]
  public interface IFavoriteProviderService : IVssFrameworkService
  {
    IEnumerable<FavoriteProvider> GetFavoriteProviders(
