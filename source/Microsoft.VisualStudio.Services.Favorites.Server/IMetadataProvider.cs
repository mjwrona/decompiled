...
// Type: Microsoft.VisualStudio.Services.Favorites.Server.IMetadataProvider
...
namespace Microsoft.VisualStudio.Services.Favorites.Server
{
  ...
  public interface IMetadataProvider
  {
    ...
    string GetArtifactPageLink(IVssRequestContext requestContext, Favorite item);

    void UpdateMetadata(IVssRequestContext requestContext, IEnumerable<Favorite> favorites);
  }
}
