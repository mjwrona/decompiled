...
// Type: Microsoft.VisualStudio.Services.Favorites.Server.ITeamFavoritesPermissionsProvider
...
{
  [InheritedExport]
  public interface ITeamFavoritesPermissionsProvider
  {
    bool CanUseFavoritesOfTeam(
      IVssRequestContext requestContext,
      FavoriteAccessMode favoriteAccessMode,
      Guid teamId);
  }
}
