...
// Type: Microsoft.VisualStudio.Services.ItemStore.AzureStorage.StepPerformers.PassThroughFilter
...
{
  public class PassThroughFilter : IPartitionKeyFilter
  {
    public IEnumerable<string> Filter(IEnumerable<string> partitionKeys) => partitionKeys;
  }
}
