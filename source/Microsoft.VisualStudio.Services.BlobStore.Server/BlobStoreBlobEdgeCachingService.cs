...
// Type: Microsoft.VisualStudio.Services.BlobStore.Server.BlobStoreBlobEdgeCachingService
...
{
  public class BlobStoreBlobEdgeCachingService : 
    BlobEdgeCachingService,
    IBlobStoreBlobEdgeCachingService,
