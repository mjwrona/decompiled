...
// Type: Microsoft.VisualStudio.Services.Packaging.CrossProtocol.WebApi.Exceptions.UnknownPackagingProtocolException
...
{
  public class UnknownPackagingProtocolException : VssServiceException
  {
    public UnknownPackagingProtocolException(string message)
      : base(message)
    {
    }

    public UnknownPackagingProtocolException(string message, Exception innerException)
