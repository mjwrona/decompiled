...
// Type: Microsoft.VisualStudio.Services.Packaging.CrossProtocol.WebApi.Exceptions.ProvenanceSessionAlreadyExistsException
...
{
  public class ProvenanceSessionAlreadyExistsException : VssServiceException
  {
    public ProvenanceSessionAlreadyExistsException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public ProvenanceSessionAlreadyExistsException(string message)
      : base(message)
    {
    }
  }
