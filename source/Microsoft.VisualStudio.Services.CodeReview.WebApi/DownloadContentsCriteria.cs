...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.DownloadContentsCriteria
...
{
  [DataContract]
  public class DownloadContentsCriteria
  {
    [DataMember(EmitDefaultValue = false)]
    public List<string> ContentHashes { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public ReviewFileType? FileType { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public List<int> IterationIds { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public ChangeEntryFileType? FilterBy { get; set; }
  }
}
