...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.CommentThreadConverter
...
{
  public class CommentThreadConverter : JsonCreationConverter<CommentThread>
  {
    public override CommentThread Create(Type objectType, JObject jObject) => new CommentThread();
  }
}
