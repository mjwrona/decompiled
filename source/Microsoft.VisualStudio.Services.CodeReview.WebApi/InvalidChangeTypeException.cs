...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.InvalidChangeTypeException
...
namespace Microsoft.VisualStudio.Services.CodeReview.WebApi
{
  ...
  {
    public InvalidChangeTypeException(ChangeType changeType, int iterationId)
      : base(CodeReviewWebAPIResources.InvalidChangeTypeException((object) changeType, (object) iterationId))
    {
    }
  }
}
