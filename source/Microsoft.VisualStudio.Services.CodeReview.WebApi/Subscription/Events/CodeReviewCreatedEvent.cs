...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Subscription.Events.CodeReviewCreatedEvent
...
{
  [ServiceEventObject]
  [NotificationEventBindings(EventSerializerType.Json, "ms.vss-code.codereview-created-event")]
  public class CodeReviewCreatedEvent : CodeReviewEvent
  {
    public CodeReviewCreatedEvent()
    {
    }
    ...
    public override void UpdateEventTriggeredBy() => this.EventTriggeredBy = this.CodeReview.Author;
