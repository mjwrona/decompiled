...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.StatusUpdatedNotification
...
{
  [DataContract]
  public class StatusUpdatedNotification : StatusNotification
  {
    public StatusUpdatedNotification(
      Guid projectId,
      Review review,
      int? iterationId,
      Status status,
      DateTime? priorReviewUpdatedTimestamp)
      : base(projectId, review.Id, iterationId, review.SourceArtifactId, status, priorReviewUpdatedTimestamp)
    {
    }
  }
}
