...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.ShareReviewNotification
...
{
  [DataContract]
  public class ShareReviewNotification : ReviewNotification
  {
    public ShareReviewNotification(Guid projectId, Review review)
      : base(projectId, review, review.SourceArtifactId, new DateTime?())
    {
    }

    [DataMember(EmitDefaultValue = false)]
    public NotificationContext ShareMessage { get; set; }
  }
}
