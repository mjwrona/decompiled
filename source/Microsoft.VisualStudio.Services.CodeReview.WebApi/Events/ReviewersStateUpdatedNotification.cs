...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.ReviewersStateUpdatedNotification
...
{
  [DataContract]
  public class ReviewersStateUpdatedNotification : ReviewersNotification
  {
    public ReviewersStateUpdatedNotification(
      Guid projectId,
      Review review,
      IEnumerable<Reviewer> reviewers,
      DateTime? priorReviewUpdatedTimestamp)
      : base(projectId, review.Id, review.SourceArtifactId, reviewers, priorReviewUpdatedTimestamp, new DateTime?(), EventType.Updated)
    {
    }

    public bool HasAllReviewerStatusesReset { get; set; }
  }
}
