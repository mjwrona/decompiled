...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.ReviewersAddedNotification
...
{
  [DataContract]
  public class ReviewersAddedNotification : ReviewersNotification
  {
    public ReviewersAddedNotification(
      Guid projectId,
      Review review,
      IEnumerable<Reviewer> reviewers,
      DateTime? priorReviewUpdatedTimestamp)
      : base(projectId, review.Id, review.SourceArtifactId, reviewers, priorReviewUpdatedTimestamp, new DateTime?(), EventType.Added)
    {
    }
  }
}
