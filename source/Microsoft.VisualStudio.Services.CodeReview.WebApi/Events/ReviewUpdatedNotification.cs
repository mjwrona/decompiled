...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.ReviewUpdatedNotification
...
{
  [DataContract]
  public class ReviewUpdatedNotification : ReviewNotification
  {
    public ReviewUpdatedNotification(
      Guid projectId,
      Review updatedReview,
      string sourceArtifactId,
      DateTime? priorReviewUpdatedTimestamp,
      bool hasStateChanged = false)
      : base(projectId, updatedReview, sourceArtifactId, priorReviewUpdatedTimestamp)
    {
