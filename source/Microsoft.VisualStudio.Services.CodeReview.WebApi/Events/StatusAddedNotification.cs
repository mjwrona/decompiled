...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.StatusAddedNotification
...
{
  [DataContract]
  public class StatusAddedNotification : StatusNotification
  {
    public StatusAddedNotification(
      Guid projectId,
      Review review,
      int? iterationId,
      Status status,
