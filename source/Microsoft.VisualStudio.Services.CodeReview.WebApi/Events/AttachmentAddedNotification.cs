...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.AttachmentAddedNotification
...
{
  [DataContract]
  public class AttachmentAddedNotification : AttachmentNotification
  {
    public AttachmentAddedNotification(
      Guid projectId,
      Review review,
      IEnumerable<Attachment> attachments,
      DateTime? priorReviewUpdatedTimestamp,
      DateTime? latestReviewUpdatedTimestamp)
      : base(projectId, review.Id, review.SourceArtifactId, attachments, priorReviewUpdatedTimestamp, latestReviewUpdatedTimestamp, EventType.Added)
    {
    }
  }
}
