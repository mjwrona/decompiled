...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.IterationDeletedNotification
...
{
  [DataContract]
  public class IterationDeletedNotification : IterationNotification
  {
    public IterationDeletedNotification(
      Guid projectId,
      Review review,
      Iteration iteration,
      DateTime? priorReviewUpdatedTimestamp)
      : base(projectId, review.Id, review.SourceArtifactId, iteration, priorReviewUpdatedTimestamp)
    {
    }
  }
}
