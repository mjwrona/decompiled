...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.AttachmentDeletedNotification
...
{
  [DataContract]
  public class AttachmentDeletedNotification : AttachmentNotification
  {
    public AttachmentDeletedNotification(
      Guid projectId,
      Review review,
      IEnumerable<Attachment> attachments,
      DateTime? priorReviewUpdatedTimestamp,
      DateTime? latestReviewUpdatedTimestamp)
      : base(projectId, review.Id, review.SourceArtifactId, attachments, priorReviewUpdatedTimestamp, latestReviewUpdatedTimestamp, EventType.Deleted)
    {
    }
  }
}
