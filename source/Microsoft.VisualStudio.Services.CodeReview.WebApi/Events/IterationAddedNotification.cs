...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.IterationAddedNotification
...
{
  [DataContract]
  public class IterationAddedNotification : IterationNotification
  {
    public IterationAddedNotification(
      Guid projectId,
      Review review,
      Iteration iteration,
