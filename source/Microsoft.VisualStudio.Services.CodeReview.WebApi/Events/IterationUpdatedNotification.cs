...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.IterationUpdatedNotification
...
{
  [DataContract]
  public class IterationUpdatedNotification : IterationNotification
  {
    public IterationUpdatedNotification(
      Guid projectId,
      Review review,
      Iteration iteration,
