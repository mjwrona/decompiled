...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.AttachmentNotification
...
{
  [DataContract]
  public class AttachmentNotification : CodeReviewEventNotification
  {
    public AttachmentNotification(
      Guid projectId,
      int reviewId,
