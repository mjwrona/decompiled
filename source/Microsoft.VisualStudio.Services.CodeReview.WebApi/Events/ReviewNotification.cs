...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.Events.ReviewNotification
...
{
  [DataContract]
  public class ReviewNotification : CodeReviewEventNotification
  {
    public ReviewNotification(
      ...
      : base(projectId, review.Id, sourceArtifactId, priorReviewUpdatedTimestamp, review.UpdatedDate)
    {
      this.Review = review;
    }
