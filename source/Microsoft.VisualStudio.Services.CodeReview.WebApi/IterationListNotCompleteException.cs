...
// Type: Microsoft.VisualStudio.Services.CodeReview.WebApi.IterationListNotCompleteException
...
{
  public class IterationListNotCompleteException : Exception
  {
    public IterationListNotCompleteException()
      : base(CodeReviewWebAPIResources.IterationListNotCompleteException())
    {
    }
  }
}
