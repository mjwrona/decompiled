...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemFieldUpdate
...
{
  [DataContract]
  public class WorkItemFieldUpdate : BaseSecuredObject
  {
    public WorkItemFieldUpdate()
    {
    }

    public WorkItemFieldUpdate(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
