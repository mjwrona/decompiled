...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.RemoteWorkItemLinkUpdateResult
...
namespace Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models
{
  ...
  [DataContract]
  public class RemoteWorkItemLinkUpdateResult : RemoteWorkItemLinkUpdate
  {
    [DataMember]
    ...
    [ClientInternalUseOnly(true)]
    [DataMember]
    public bool IsNonRetryableExceptionType { get; set; }
  }
}
