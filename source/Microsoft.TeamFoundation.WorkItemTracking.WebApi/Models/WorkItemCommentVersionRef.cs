...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemCommentVersionRef
...
{
  [DataContract]
  public class WorkItemCommentVersionRef : WorkItemTrackingResourceReference
  {
    public WorkItemCommentVersionRef()
    {
    }

    public WorkItemCommentVersionRef(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
