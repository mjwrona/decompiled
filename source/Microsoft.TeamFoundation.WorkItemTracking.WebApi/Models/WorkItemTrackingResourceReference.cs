...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemTrackingResourceReference
...
{
  [DataContract]
  public class WorkItemTrackingResourceReference : BaseSecuredObject
  {
    public WorkItemTrackingResourceReference()
    {
    }

    protected WorkItemTrackingResourceReference(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
