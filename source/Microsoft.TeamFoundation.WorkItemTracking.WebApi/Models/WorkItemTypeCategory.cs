...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemTypeCategory
...
{
  [DataContract]
  public class WorkItemTypeCategory : WorkItemTrackingResource
  {
    public WorkItemTypeCategory()
    {
    }

    public WorkItemTypeCategory(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
    ...
    [DataMember]
    public IEnumerable<WorkItemTypeReference> WorkItemTypes { get; set; }
  }
}
