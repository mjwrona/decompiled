...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.QueryBatchGetRequest
...
namespace Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models
{
  ...
  public class QueryBatchGetRequest
  {
    ...
    public QueryExpand Expand { get; set; }

    [DataMember]
    public QueryErrorPolicy ErrorPolicy { get; set; } = QueryErrorPolicy.Fail;
  }
}
