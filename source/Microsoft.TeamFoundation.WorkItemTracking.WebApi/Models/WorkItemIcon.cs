...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemIcon
...
{
  [DataContract]
  public class WorkItemIcon : BaseSecuredObject
  {
    public WorkItemIcon()
    {
    }

    public WorkItemIcon(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
