...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemTypeReference
...
{
  [DataContract]
  public class WorkItemTypeReference : WorkItemTrackingResourceReference
  {
    public WorkItemTypeReference()
    {
    }

    public WorkItemTypeReference(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
