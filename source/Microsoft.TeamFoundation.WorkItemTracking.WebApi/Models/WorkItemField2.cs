...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemField2
...
{
  [DataContract]
  public class WorkItemField2 : WorkItemField
  {
    public WorkItemField2()
    {
    }

    public WorkItemField2(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
