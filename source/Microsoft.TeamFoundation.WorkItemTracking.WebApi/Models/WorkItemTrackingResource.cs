...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemTrackingResource
...
{
  [DataContract]
  public class WorkItemTrackingResource : WorkItemTrackingResourceReference
  {
    public WorkItemTrackingResource()
    {
    }

    protected WorkItemTrackingResource(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
