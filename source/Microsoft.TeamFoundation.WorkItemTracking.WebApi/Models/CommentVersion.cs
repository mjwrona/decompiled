...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.CommentVersion
...
{
  [DataContract]
  public class CommentVersion : WorkItemTrackingResource
  {
    public CommentVersion()
    {
    }

    public CommentVersion(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
