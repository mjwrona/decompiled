...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemTypeFieldInstance
...
{
  [DataContract]
  public class WorkItemTypeFieldInstance : WorkItemTypeFieldInstanceBase
  {
    public WorkItemTypeFieldInstance()
    {
    }

    public WorkItemTypeFieldInstance(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
