...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.ArtifactUriQueryResult
...
{
  [DataContract]
  public class ArtifactUriQueryResult : BaseSecuredObject
  {
    [DataMember(EmitDefaultValue = false)]
    public IDictionary<string, IEnumerable<WorkItemReference>> ArtifactUrisQueryResult { get; set; }

    public ArtifactUriQueryResult()
    {
    }

    public ArtifactUriQueryResult(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
  }
