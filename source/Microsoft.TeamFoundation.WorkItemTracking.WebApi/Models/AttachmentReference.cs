...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.AttachmentReference
...
{
  [DataContract]
  public class AttachmentReference : BaseSecuredObject
  {
    public AttachmentReference()
    {
    }

    public AttachmentReference(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
