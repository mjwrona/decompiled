...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemComments
...
{
  [DataContract]
  public class WorkItemComments : WorkItemTrackingResource
  {
    public WorkItemComments()
    {
    }

    public WorkItemComments(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
