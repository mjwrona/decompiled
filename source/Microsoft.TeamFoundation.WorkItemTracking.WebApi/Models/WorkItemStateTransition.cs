...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemStateTransition
...
{
  [DataContract]
  public class WorkItemStateTransition : BaseSecuredObject
  {
    public WorkItemStateTransition()
    {
    }

    public WorkItemStateTransition(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
