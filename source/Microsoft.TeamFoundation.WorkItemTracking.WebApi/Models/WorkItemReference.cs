...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemReference
...
{
  [DataContract]
  public class WorkItemReference : ISecuredObject
  {
    ...
    public WorkItemReference(string token) => this.m_token = token;
