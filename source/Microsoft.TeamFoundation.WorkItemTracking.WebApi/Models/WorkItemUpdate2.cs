...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItemUpdate2
...
{
  [DataContract]
  public class WorkItemUpdate2 : WorkItemUpdate
  {
    public WorkItemUpdate2()
    {
    }

    public WorkItemUpdate2(ISecuredObject securedObject)
      : base(securedObject)
    {
    }
