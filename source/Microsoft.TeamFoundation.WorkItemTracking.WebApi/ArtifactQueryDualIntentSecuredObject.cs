...
// Type: Microsoft.TeamFoundation.WorkItemTracking.WebApi.ArtifactQueryDualIntentSecuredObject
...
{
  public class ArtifactQueryDualIntentSecuredObject : DualIntentSecuredObject
  {
    public ArtifactQueryDualIntentSecuredObject(Guid? filterUnderProjectId)
      : base(filterUnderProjectId)
    {
    }

    protected override Guid CollectionScopeNamespaceId => WitConstants.SecurityConstants.WorkItemTrackingNamespaceId;

    protected override Guid ProjectScopeNamespaceId => TeamProjectSecurityConstants.NamespaceId;

    protected override int CollectionScopeRequiredPermissions => 2;

    protected override int ProjectScopeRequiredPermissions => TeamProjectSecurityConstants.GenericRead;

    protected override string CollectionScopeToken => WitConstants.SecurityConstants.WorkItemTrackingArtifactUriQueryToken;
