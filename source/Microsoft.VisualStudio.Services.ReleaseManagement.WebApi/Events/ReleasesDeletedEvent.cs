...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Events.ReleasesDeletedEvent
...
{
  [ServiceEventObject]
  public class ReleasesDeletedEvent
  {
    ...
    [DataMember]
    public List<ReleaseShallowReference> ReleaseReferences { get; set; }
