...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.DeploymentAuthorizationInfo
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.WebApi
{
  ...
  public class DeploymentAuthorizationInfo
  {
    ...
    [DataMember]
    public string VstsAccessTokenKey;
    [DataMember]
    public IList<string> Resources;

    [DataMember]
    public AuthorizationHeaderFor AuthorizationHeaderFor { get; set; }
