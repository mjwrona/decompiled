...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Contracts.ReleaseShallowReference
...
{
  public class ReleaseShallowReference : ShallowReference
  {
    [DataMember]
    public new int Id
    {
    ...
    public ReleaseShallowReference() => this.Links = new ReferenceLinks();
