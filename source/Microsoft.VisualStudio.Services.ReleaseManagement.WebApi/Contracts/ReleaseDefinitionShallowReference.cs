...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Contracts.ReleaseDefinitionShallowReference
...
namespace Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Contracts
{
  ...
  [DataContract]
  public class ReleaseDefinitionShallowReference : ShallowReference
  {
    [DataMember]
    public new int Id
    {
    ...
    public ReleaseDefinitionShallowReference() => this.Links = new ReferenceLinks();
