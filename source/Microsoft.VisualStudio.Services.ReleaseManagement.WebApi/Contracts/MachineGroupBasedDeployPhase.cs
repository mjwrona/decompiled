...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.Contracts.MachineGroupBasedDeployPhase
...
{
  [DataContract]
  public class MachineGroupBasedDeployPhase : DeployPhase
  {
    public MachineGroupBasedDeployPhase()
      : base(DeployPhaseTypes.MachineGroupBasedDeployment)
    {
      this.DeploymentInput = new MachineGroupDeploymentInput();
    }
