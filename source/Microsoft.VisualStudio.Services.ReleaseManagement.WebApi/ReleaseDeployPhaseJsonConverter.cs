...
// Type: Microsoft.VisualStudio.Services.ReleaseManagement.WebApi.ReleaseDeployPhaseJsonConverter
...
{
  public class ReleaseDeployPhaseJsonConverter : VssSecureJsonConverter
  {
      ...
      JsonSerializer serializer)
    {
      ...
      switch (result)
      {
        ...
        case DeployPhaseTypes.MachineGroupBasedDeployment:
          target = (object) new ReleaseDeployPhase();
          break;
        case DeployPhaseTypes.DeploymentGates:
          target = (object) new ReleaseGatesPhase();
          break;
      }
      if (target != null)
      {
