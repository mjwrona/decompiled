...
// Type: Microsoft.Azure.Pipelines.Server.SignedContentConstants
...
{
  public static class SignedContentConstants
  {
    public static TimeSpan TimeToLive = TimeSpan.FromMinutes(1.0);
  }
}
