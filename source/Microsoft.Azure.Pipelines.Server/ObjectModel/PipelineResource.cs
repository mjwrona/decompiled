...
// Type: Microsoft.Azure.Pipelines.Server.ObjectModel.PipelineResource
...
namespace Microsoft.Azure.Pipelines.Server.ObjectModel
{
  ...
  {
    public PipelineResource(PipelineReference pipeline, PipelineResourceParameters parameters)
    {
    ...
    public PipelineResourceParameters Parameters { get; private set; }
  }
}
