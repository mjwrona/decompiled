...
// Type: Microsoft.Azure.Pipelines.Server.ObjectModel.CreateAzureReposGitRepositoryParameters
...
{
  public class CreateAzureReposGitRepositoryParameters : CreateRepositoryParameters
  {
    public CreateAzureReposGitRepositoryParameters()
      : base(RepositoryType.AzureReposGit)
    {
    }
