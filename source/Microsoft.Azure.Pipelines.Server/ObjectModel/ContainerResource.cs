...
// Type: Microsoft.Azure.Pipelines.Server.ObjectModel.ContainerResource
...
{
  public sealed class ContainerResource
  {
    public ContainerResource(Container container) => this.Container = container;
