...
// Type: Microsoft.Azure.Pipelines.Server.ObjectModel.CreateJustInTimePipelineConfigurationParameters
...
{
  public class CreateJustInTimePipelineConfigurationParameters : 
    CreatePipelineConfigurationParameters
  {
    public CreateJustInTimePipelineConfigurationParameters()
      : base(ConfigurationType.JustInTime)
    {
    }

    public CreateRepositoryParameters Repository { get; set; }

    public override string GeneratePipelineName() => "DefaultPipeline";
  }
}
