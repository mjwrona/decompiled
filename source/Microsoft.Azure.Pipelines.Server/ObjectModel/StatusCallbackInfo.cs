...
// Type: Microsoft.Azure.Pipelines.Server.ObjectModel.StatusCallbackInfo
...
{
  public class StatusCallbackInfo
  {
    public string SignatureKey { get; set; }

    public Uri JobStatusUrl { get; set; }

    public Uri RunStatusUrl { get; set; }
  }
}
