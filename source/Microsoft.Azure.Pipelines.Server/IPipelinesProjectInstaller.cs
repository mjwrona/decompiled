...
// Type: Microsoft.Azure.Pipelines.Server.IPipelinesProjectInstaller
...
{
  [InheritedExport]
  public interface IPipelinesProjectInstaller
  {
    void Install(IVssRequestContext requestContext, Guid projectId);

    void Uninstall(IVssRequestContext requestContext, Guid projectId);
  }
}
