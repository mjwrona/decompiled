...
BEGIN
    DECLARE @statement NVARCHAR(MAX) = 'ALTER DATABASE ' + QUOTENAME(@databaseName) + ' SET QUERY_STORE = OFF'
...
ELSE
BEGIN
    PRINT 'Skipping disabling Query Store because it is not supported by this version of SQL Server'
END