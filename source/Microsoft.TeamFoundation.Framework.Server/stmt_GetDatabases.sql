/*
** Queries attribute for ALL dbs in the specified instance (does not work on SQL Azure).
** Parameters:
**  None.
*/
DECLARE @stmt NVARCHAR(MAX)
SET @stmt = '
    -- If SQL Azure, simply look up the sys.databases table
    ...
    END
    ELSE
    -- If not SQL Azure, check HA replicas, mirrored databases, as well as the databases table
    BEGIN
        DECLARE @agi TABLE (
