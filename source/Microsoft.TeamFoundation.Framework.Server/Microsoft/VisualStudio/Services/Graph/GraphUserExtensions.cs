...
// Type: Microsoft.VisualStudio.Services.Graph.GraphUserExtensions
...
namespace Microsoft.VisualStudio.Services.Graph
{
  ...
  {
    public static GraphUser ToGraphUserClient(
      ...
      IVssRequestContext requestContext)
    {
      ...
      string property4 = identity.GetProperty<string>("DirectoryAlias", (string) null);
      ...
      DateTime property5 = identity.GetProperty<DateTime>("MetadataUpdateDate", DateTime.MinValue);
      bool property6 = identity.GetProperty<bool>("IsDeletedInOrigin", false);
      string url1;
      ReferenceLinks links1;
      GraphObjectExtensionHelpers.GetUserUrlAndLinks(requestContext, subjectDescriptor, identity.Id, out url1, out links1);
      ...
      DateTime metadataUpdateDate = property5;
      int num = property6 ? 1 : 0;
      string directoryAlias = property4;
      return new GraphUser(origin2, originId2, descriptor1, descriptor2, displayName, links2, url2, domain, principalName, mailAddress, metaType, metadataUpdateDate, num != 0, directoryAlias);
    }
  }
}
