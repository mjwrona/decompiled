...
// Type: Microsoft.VisualStudio.Services.RegistryService.Server.RegistryCallbackAndServiceHost
...
{
  public readonly struct RegistryCallbackAndServiceHost
  {
    public readonly RegistrySettingsChangedCallback Callback;
    public readonly Guid ServiceHostId;

    public RegistryCallbackAndServiceHost(
