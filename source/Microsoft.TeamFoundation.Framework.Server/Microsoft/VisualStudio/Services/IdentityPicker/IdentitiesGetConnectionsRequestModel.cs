...
// Type: Microsoft.VisualStudio.Services.IdentityPicker.IdentitiesGetConnectionsRequestModel
...
{
  [DataContract]
  public sealed class IdentitiesGetConnectionsRequestModel
  {
    [DataMember(EmitDefaultValue = false, Name = "connectionTypes")]
    public IList<string> ConnectionTypes { get; set; }
    ...
    [DataMember(EmitDefaultValue = false, Name = "objectId")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "depth")]
