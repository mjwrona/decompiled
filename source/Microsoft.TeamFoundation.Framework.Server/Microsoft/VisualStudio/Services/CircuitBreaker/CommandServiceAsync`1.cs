...
// Type: Microsoft.VisualStudio.Services.CircuitBreaker.CommandServiceAsync`1
...
{
  public class CommandServiceAsync<TResult> : CommandAsync<TResult>
  {
    ...
    public CommandServiceAsync(
      ...
      : this(requestContext, setter, (ICommandProperties) new CommandPropertiesRegistry(requestContext, setter.CommandKey, setter.CommandPropertiesDefaults), run, fallback, continueOnCapturedContext)
    {
    }
