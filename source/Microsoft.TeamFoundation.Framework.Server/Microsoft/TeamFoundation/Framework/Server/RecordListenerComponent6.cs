...
// Type: Microsoft.TeamFoundation.Framework.Server.RecordListenerComponent6
...
{
  internal class RecordListenerComponent6 : RecordListenerComponent5
  {
    private static readonly SqlMetaData[] typ_CommandTable5 = new SqlMetaData[16]
    {
    ...
    protected override SqlMetaData[] CommandTableType => RecordListenerComponent6.typ_CommandTable5;

    protected override string CommandTableTypeString => "typ_CommandTable5";
      ...
      SqlMetaData[] type)
    {
      ...
      sqlDataRecord.SetInt64(15, requestDetails.TimeToFirstPage);
