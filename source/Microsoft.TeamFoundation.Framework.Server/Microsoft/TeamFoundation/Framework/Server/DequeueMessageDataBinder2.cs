...
// Type: Microsoft.TeamFoundation.Framework.Server.DequeueMessageDataBinder2
...
{
  internal sealed class DequeueMessageDataBinder2 : ObjectBinder<TfsmqDequeueData>
  {
    ...
    private SqlColumnBinder MessageTypeColumn = new SqlColumnBinder("MessageType");
    ...
    protected override TfsmqDequeueData Bind() => new TfsmqDequeueData()
    {
      ...
      MessageType = this.MessageTypeColumn.GetString((IDataReader) this.Reader, true),
