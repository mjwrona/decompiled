...
// Type: Microsoft.TeamFoundation.Framework.Server.TeamFoundationJobQueueEntryColumns3
...
{
  internal class TeamFoundationJobQueueEntryColumns3 : TeamFoundationJobQueueEntryColumns2
  {
    protected override TeamFoundationJobQueueEntry Bind()
    {
      ...
      foundationJobQueueEntry.Priority = (int) this.PriorityColumn.GetByte((IDataReader) this.Reader);
      ...
      foundationJobQueueEntry.State = (TeamFoundationJobState) this.StateColumn.GetInt16((IDataReader) this.Reader);
      foundationJobQueueEntry.RequesterActivityId = this.RequesterActivityIdColumn.GetGuid((IDataReader) this.Reader, true, Guid.Empty);
      foundationJobQueueEntry.RequesterVsid = this.RequesterVsidColumn.GetGuid((IDataReader) this.Reader, true, Guid.Empty);
