...
// Type: Microsoft.TeamFoundation.Framework.Server.AccessControl.ConditionalRule
...
namespace Microsoft.TeamFoundation.Framework.Server.AccessControl
{
  ...
  [DataServiceKey("Id")]
  public class ConditionalRule : INotifyPropertyChanged
  {
    ...
    [GeneratedCode("System.Data.Services.Design", "1.0.0")]
    public static ConditionalRule CreateConditionalRule(
      long ID,
      long ruleGroupId,
      long issuerId,
      long conditionIssuerId,
      bool systemReserved)
    {
      return new ConditionalRule()
      {
        ...
        IssuerId = issuerId,
        ConditionIssuerId = conditionIssuerId,
    ...
    {
      get => this._ConditionIssuerId;
      set
      {
        this._ConditionIssuerId = value;
        this.OnPropertyChanged(nameof (ConditionIssuerId));
      }
    }
    ...
    {
      get => this._ConditionClaimType;
      set
      {
        this._ConditionClaimType = value;
        this.OnPropertyChanged(nameof (ConditionClaimType));
      }
    }
    ...
    {
      get => this._ConditionClaimValue;
      set
      {
        this._ConditionClaimValue = value;
        this.OnPropertyChanged(nameof (ConditionClaimValue));
      }
    }
