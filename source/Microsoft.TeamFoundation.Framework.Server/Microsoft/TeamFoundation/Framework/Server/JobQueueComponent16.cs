...
// Type: Microsoft.TeamFoundation.Framework.Server.JobQueueComponent16
...
{
  internal class JobQueueComponent16 : JobQueueComponent15
  {
    internal override List<TeamFoundationJobQueueEntry> QueryRunningJobs(bool includePendingJobs)
    {
      ...
      this.BindBoolean("@includePendingJobs", includePendingJobs);
