...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabaseManagementComponent12
...
{
  internal class DatabaseManagementComponent12 : DatabaseManagementComponent11
  {
    ...
    protected override DatabasePropertiesBinder CreatePropertiesBinder() => (DatabasePropertiesBinder) new DatabasePropertiesBinder7();

    protected override DatabasePropertiesBinder CreatePropertiesBinder(
      SqlDataReader dataReader,
      string storedProcedure)
    {
      return (DatabasePropertiesBinder) new DatabasePropertiesBinder7(dataReader, storedProcedure);
    }
  }
}
