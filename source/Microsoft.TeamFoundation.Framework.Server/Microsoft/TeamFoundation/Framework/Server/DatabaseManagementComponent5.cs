...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabaseManagementComponent5
...
{
  internal class DatabaseManagementComponent5 : DatabaseManagementComponent4
  {
      ...
      TeamFoundationDatabaseProperties properties)
    {
      ...
      if (properties.IsServiceLevelDirty)
        this.BindString("@serviceLevel", properties.ServiceLevel, (int) byte.MaxValue, false, SqlDbType.VarChar);
    ...
    protected override DatabasePropertiesBinder CreatePropertiesBinder() => (DatabasePropertiesBinder) new DatabasePropertiesBinder3();

    protected override DatabasePropertiesBinder CreatePropertiesBinder(
      SqlDataReader dataReader,
      string storedProcedure)
    {
      return (DatabasePropertiesBinder) new DatabasePropertiesBinder3(dataReader, storedProcedure);
    }
  }
}
