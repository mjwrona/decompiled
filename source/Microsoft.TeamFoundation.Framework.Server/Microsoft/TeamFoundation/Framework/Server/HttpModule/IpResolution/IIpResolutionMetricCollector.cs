...
// Type: Microsoft.TeamFoundation.Framework.Server.HttpModule.IpResolution.IIpResolutionMetricCollector
...
{
  internal interface IIpResolutionMetricCollector
  {
    void CollectMetric(
      IVssRequestContext requestContext,
      ArrStatus arrDimension,
      AfdStatus afdValidationStatus,
      SmartRouterIpStatus smartRouterStatus);
  }
}
