...
// Type: Microsoft.TeamFoundation.Framework.Server.DiagnosticComponent20
...
{
  internal class DiagnosticComponent20 : DiagnosticComponent19
  {
      ...
      IDataReader reader)
    {
      using (ResultCollection resultCollection = new ResultCollection(reader, this.ProcedureName, this.RequestContext))
      {
        ...
        resultCollection.AddBinder<DiagnosticComponent.DatabasePerformanceStatisticsViewResult>((ObjectBinder<DiagnosticComponent.DatabasePerformanceStatisticsViewResult>) new DiagnosticComponent20.DatabasePerformanceStatisticsViewBinder4(tuple.Item1, tuple.Item2, tuple.Item3, (short) 0));
        return resultCollection.GetCurrent<DiagnosticComponent.DatabasePerformanceStatisticsViewResult>().Items;
      }
    }

    protected class DatabasePerformanceStatisticsViewBinder4 : 
      ObjectBinder<DiagnosticComponent.DatabasePerformanceStatisticsViewResult>
    {
      ...
      private string ServiceObjectiveHardware { get; set; }

      internal DatabasePerformanceStatisticsViewBinder4(
        ...
        string serviceObjectiveHardware)
      {
        ...
        this.Schedulers = schedulers;
        this.CompatibilityLevel = compatibilityLevel;
        this.ServiceObjectiveHardware = serviceObjectiveHardware;
      }

      internal DatabasePerformanceStatisticsViewBinder4(SqlDataReader reader)
      ...
      protected override DiagnosticComponent.DatabasePerformanceStatisticsViewResult Bind()
      {
        ...
        statisticsViewResult.ServiceObjectiveHardware = this.ServiceObjectiveHardware;
