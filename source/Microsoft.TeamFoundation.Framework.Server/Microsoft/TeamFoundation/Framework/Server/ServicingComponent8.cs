...
// Type: Microsoft.TeamFoundation.Framework.Server.ServicingComponent8
...
{
  internal class ServicingComponent8 : ServicingComponent7
  {
    public override void StartServicingDeployment(string serviceLevels)
    {
      ...
      this.BindString("@serviceLevel", serviceLevels.ToString(), 20, false, SqlDbType.VarChar);
    ...
    public override void FinishServicingDeployment(string serviceLevels)
    {
      ...
      this.BindString("@serviceLevel", serviceLevels, 20, false, SqlDbType.VarChar);
      this.ExecuteNonQuery();
    }
