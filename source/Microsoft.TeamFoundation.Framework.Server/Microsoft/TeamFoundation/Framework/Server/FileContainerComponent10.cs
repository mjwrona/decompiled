...
// Type: Microsoft.TeamFoundation.Framework.Server.FileContainerComponent10
...
{
  internal class FileContainerComponent10 : FileContainerComponent9
  {
    public override FileContainerCleanupStats CleanupDeletedFileContent(
    ...
    {
      this.PrepareStoredProcedure("prc_CleanupDeletedFileContentSegmentedBatchSelect", 21600);
