...
// Type: Microsoft.TeamFoundation.Framework.Server.ConnectionNotificationBinder
...
{
  internal sealed class ConnectionNotificationBinder : ObjectBinder<TfsmqConnectionNotification>
  {
    ...
    protected override TfsmqConnectionNotification Bind()
    {
      ...
      return new TfsmqConnectionNotification(int32_1, queueName, sequenceId, empty, dateLastConnected, (MessageQueueStatus) oldConnectionStatus, (MessageQueueStatus) newConnectionStatus);
    }
  }
}
