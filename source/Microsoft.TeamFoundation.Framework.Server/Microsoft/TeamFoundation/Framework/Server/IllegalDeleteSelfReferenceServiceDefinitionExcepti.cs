...
// Type: Microsoft.TeamFoundation.Framework.Server.IllegalDeleteSelfReferenceServiceDefinitionException
...
namespace Microsoft.TeamFoundation.Framework.Server
{
  ...
  {
    public IllegalDeleteSelfReferenceServiceDefinitionException()
    {
    }
    ...
    public IllegalDeleteSelfReferenceServiceDefinitionException(
      ...
      SqlException ex,
      SqlError sqlError)
      : this(FrameworkResources.IllegalDeleteSelfReferenceServiceDefinition())
    {
    }
