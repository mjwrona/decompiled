...
// Type: Microsoft.TeamFoundation.Framework.Server.DMVBinder
...
{
  internal class DMVBinder : ObjectBinder<DatabaseManagementViewResult>
  {
    ...
    private SqlColumnBinder m_head_blocker_session_id = new SqlColumnBinder("head_blocker_session_id");
    private SqlColumnBinder m_blocking_level = new SqlColumnBinder("blocking_level");
    private SqlColumnBinder m_text = new SqlColumnBinder("text");
    private SqlColumnBinder m_stmt = new SqlColumnBinder("stmt");
    private SqlColumnBinder m_blocker_query_text = new SqlColumnBinder("blocker_query_text");
    ...
    private SqlColumnBinder m_login_name = new SqlColumnBinder("login_name");

    internal DMVBinder()
    {
    }

    internal DMVBinder(SqlDataReader reader)
    ...
    protected override DatabaseManagementViewResult Bind()
    {
      ...
      managementViewResult.HeadBlockerSessionId = this.m_head_blocker_session_id.GetInt16((IDataReader) this.Reader, (short) 0, (short) 0);
      managementViewResult.BlockingLevel = this.m_blocking_level.GetInt32((IDataReader) this.Reader, 0, 0);
      ...
      managementViewResult.BlockerQueryText = this.m_blocker_query_text.GetString((IDataReader) this.Reader, true, "");
      ...
      managementViewResult.LoginName = this.m_login_name.GetString((IDataReader) this.Reader, true, "NA");
