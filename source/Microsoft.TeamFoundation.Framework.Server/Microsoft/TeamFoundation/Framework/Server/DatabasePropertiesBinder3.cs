...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabasePropertiesBinder3
...
{
  internal class DatabasePropertiesBinder3 : DatabasePropertiesBinder2
  {
    protected SqlColumnBinder DatabaseSizeColumn = new SqlColumnBinder("DatabaseSize");
    protected SqlColumnBinder DatabaseCapacityColumn = new SqlColumnBinder("DatabaseCapacity");
    protected SqlColumnBinder SizeChangedDateColumn = new SqlColumnBinder("SizeChangedDate");

    internal DatabasePropertiesBinder3()
    {
    }

    internal DatabasePropertiesBinder3(SqlDataReader dataReader, string storedProcedure)
    ...
    protected override InternalDatabaseProperties Bind()
    {
      ...
      databaseProperties.Initialize(int32_1, connectionString, databaseName, serviceLevel, poolName, int32_2, int32_3, int32_4, int32_5, int32_6, dateTime4, status, dateTime1, statusReason, dateTime2, dateTime3, flags);
