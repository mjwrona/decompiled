...
// Type: Microsoft.TeamFoundation.Framework.Server.RecordListenerComponent5
...
{
  internal class RecordListenerComponent5 : RecordListenerComponent4
  {
    private static readonly SqlMetaData[] typ_CommandTable4 = new SqlMetaData[15]
    {
    ...
    protected override SqlMetaData[] CommandTableType => RecordListenerComponent5.typ_CommandTable4;

    protected override string CommandTableTypeString => "typ_CommandTable4";
      ...
      SqlMetaData[] type)
    {
      ...
      sqlDataRecord.SetInt32(14, requestDetails.ResponseCode);
