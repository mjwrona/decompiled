...
// Type: Microsoft.TeamFoundation.Framework.Server.JobDidntPauseException
...
namespace Microsoft.TeamFoundation.Framework.Server
{
  ...
  public class JobDidntPauseException : TeamFoundationJobServiceException
  {
    ...
    public JobDidntPauseException(string message, Exception innerException)
    ...
    public JobDidntPauseException(
      ...
      SqlException ex,
      SqlError sqlError)
      : this(FrameworkResources.JobDidntPauseError())
    {
    }
  }
}
