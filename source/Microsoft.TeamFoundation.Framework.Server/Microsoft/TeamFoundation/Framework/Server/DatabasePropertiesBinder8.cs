...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabasePropertiesBinder8
...
{
  internal class DatabasePropertiesBinder8 : DatabasePropertiesBinder7
  {
    protected SqlColumnBinder BreakerDisabledColumn = new SqlColumnBinder("BreakerDisabled");
    protected SqlColumnBinder BreakerErrorThresholdPercColumn = new SqlColumnBinder("BreakerErrorThresholdPerc");
    protected SqlColumnBinder BreakerForceClosedColumn = new SqlColumnBinder("BreakerForceClosed");
    protected SqlColumnBinder BreakerForceOpenColumn = new SqlColumnBinder("BreakerForceOpen");
    protected SqlColumnBinder BreakerMaxBackoffColumn = new SqlColumnBinder("BreakerMaxBackoff");
    protected SqlColumnBinder BreakerRequestVolumeThresholdColumn = new SqlColumnBinder("BreakerRequestVolumeThreshold");
    protected SqlColumnBinder BreakerExecutionTimeoutColumn = new SqlColumnBinder("BreakerExecutionTimeout");
    protected SqlColumnBinder BreakerMaxExecConcurrentRequestsColumn = new SqlColumnBinder("BreakerMaxExecConcurrentRequests");
    protected SqlColumnBinder BreakerMaxFallbackConcurrentRequestsColumn = new SqlColumnBinder("BreakerMaxFallbackConcurrentRequests");
    protected SqlColumnBinder DboNameColumn = new SqlColumnBinder("DboUserId");
    protected SqlColumnBinder DboPasswordColumn = new SqlColumnBinder("DboPasswordEncrypted");
    protected SqlColumnBinder DboSigningKeyIdColumn = new SqlColumnBinder("DboSigningKeyId");

    internal DatabasePropertiesBinder8()
    {
    }

    internal DatabasePropertiesBinder8(SqlDataReader dataReader, string storedProcedure)
    ...
    protected override InternalDatabaseProperties Bind()
    {
      ...
      databaseProperties.Initialize(int32_1, defaultConnectionInfoWrapper, dboConnectionInfoWrapper, databaseName, serviceLevel, poolName, int32_2, int32_3, int32_4, int32_5, int32_6, dateTime4, status, dateTime1, statusReason, dateTime2, dateTime3, flags, int64, int32_7, int32_8, int32_9, loggingOptions, executionTimeThreshold, boolean1, breakerErrorThresholdPerc, boolean2, boolean3, int32_10, int32_11, int32_12, int32_13, int32_14);
