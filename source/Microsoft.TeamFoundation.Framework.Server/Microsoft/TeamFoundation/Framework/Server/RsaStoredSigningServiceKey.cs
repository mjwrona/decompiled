...
// Type: Microsoft.TeamFoundation.Framework.Server.RsaStoredSigningServiceKey
...
{
  internal class RsaStoredSigningServiceKey : SigningServiceKey
  {
    internal RsaStoredSigningServiceKey(Guid identifier)
      : base(SigningKeyType.RSAStored, identifier)
    {
    }
