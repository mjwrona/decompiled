...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabasePropertiesBinder6
...
{
  internal class DatabasePropertiesBinder6 : DatabasePropertiesBinder5
  {
    protected SqlColumnBinder SigningKeyIdColumn = new SqlColumnBinder("SigningKeyId");

    internal DatabasePropertiesBinder6()
    {
    }

    internal DatabasePropertiesBinder6(SqlDataReader dataReader, string storedProcedure)
    ...
    protected override InternalDatabaseProperties Bind()
    {
      ...
      Guid guid = this.SigningKeyIdColumn.ColumnExists((IDataReader) this.Reader) ? this.SigningKeyIdColumn.GetGuid((IDataReader) this.Reader, true) : Guid.Empty;
      if (guid == Guid.Empty)
        guid = FrameworkServerConstants.FrameworkSigningKey;
      ...
      databaseProperties.Initialize(int32_1, connectionInfo, databaseName, serviceLevel, poolName, int32_2, int32_3, int32_4, int32_5, int32_6, dateTime4, status, dateTime1, statusReason, dateTime2, dateTime3, flags, int64);
