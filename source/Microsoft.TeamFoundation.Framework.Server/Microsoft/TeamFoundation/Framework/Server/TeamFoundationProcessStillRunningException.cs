...
// Type: Microsoft.TeamFoundation.Framework.Server.TeamFoundationProcessStillRunningException
...
namespace Microsoft.TeamFoundation.Framework.Server
{
  ...
  public class TeamFoundationProcessStillRunningException : TeamFoundationServiceException
  {
    ...
    public TeamFoundationProcessStillRunningException(string message, Exception innerException)
