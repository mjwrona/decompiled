...
// Type: Microsoft.TeamFoundation.Framework.Server.DuplicateJobIdException
...
namespace Microsoft.TeamFoundation.Framework.Server
{
  ...
  public class DuplicateJobIdException : TeamFoundationJobServiceException
  {
    public DuplicateJobIdException()
      : base(FrameworkResources.DuplicateJobIdError())
    {
    }
    ...
    public DuplicateJobIdException(string message, Exception innerException)
