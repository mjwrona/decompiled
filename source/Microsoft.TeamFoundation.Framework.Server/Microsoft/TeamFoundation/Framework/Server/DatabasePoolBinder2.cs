...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabasePoolBinder2
...
{
  internal class DatabasePoolBinder2 : DatabasePoolBinder
  {
    protected SqlColumnBinder CredentialPolicyColumn = new SqlColumnBinder("CredentialPolicy");

    internal DatabasePoolBinder2()
    {
    }

    internal DatabasePoolBinder2(SqlDataReader dataReader, string storedProcedure)
