...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabasePropertiesBinder5
...
{
  internal class DatabasePropertiesBinder5 : DatabasePropertiesBinder4
  {
    protected SqlColumnBinder VersionColumn = new SqlColumnBinder("Version");

    internal DatabasePropertiesBinder5()
    {
    }

    internal DatabasePropertiesBinder5(SqlDataReader dataReader, string storedProcedure)
