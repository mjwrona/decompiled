...
// Type: Microsoft.TeamFoundation.Framework.Server.DatabasePropertiesBinder7
...
{
  internal class DatabasePropertiesBinder7 : DatabasePropertiesBinder6
  {
    protected SqlColumnBinder RequestTimeoutColumn = new SqlColumnBinder("RequestTimeout");
    protected SqlColumnBinder DeadlockRetriesColumn = new SqlColumnBinder("DeadlockRetries");
    protected SqlColumnBinder DeadlockPauseColumn = new SqlColumnBinder("DeadlockPause");
    protected SqlColumnBinder LoggingOptionsColumn = new SqlColumnBinder("LoggingOptions");
    protected SqlColumnBinder ExecutionTimeThresholdColumn = new SqlColumnBinder("ExecutionTimeThreshold");

    internal DatabasePropertiesBinder7()
    {
    }

    internal DatabasePropertiesBinder7(SqlDataReader dataReader, string storedProcedure)
    ...
    protected override InternalDatabaseProperties Bind()
    {
      ...
      Guid guid = this.SigningKeyIdColumn.GetGuid((IDataReader) this.Reader, true);
      ...
      databaseProperties.Initialize(int32_1, connectionInfo, databaseName, serviceLevel, poolName, int32_2, int32_3, int32_4, int32_5, int32_6, dateTime4, status, dateTime1, statusReason, dateTime2, dateTime3, flags, int64, int32_7, int32_8, int32_9, loggingOptions, executionTimeThreshold);
