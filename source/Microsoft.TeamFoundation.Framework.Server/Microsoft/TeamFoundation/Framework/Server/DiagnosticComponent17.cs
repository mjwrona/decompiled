...
// Type: Microsoft.TeamFoundation.Framework.Server.DiagnosticComponent17
...
{
  internal class DiagnosticComponent17 : DiagnosticComponent16
  {
    protected override ObjectBinder<QDSExpensiveQuery> GetQDSBinder() => (ObjectBinder<QDSExpensiveQuery>) new DiagnosticComponent17.QDSExpensiveQueriesBinder2();

    internal class QDSExpensiveQueriesBinder2 : ObjectBinder<QDSExpensiveQuery>
    {
      ...
      private SqlColumnBinder m_queryHash = new SqlColumnBinder("query_hash");
      private SqlColumnBinder m_queryPlanHash = new SqlColumnBinder("query_plan_hash");
      ...
      protected override QDSExpensiveQuery Bind() => new QDSExpensiveQuery()
      {
        ...
        QueryHash = BitConverter.ToInt64(this.m_queryHash.GetBytes((IDataReader) this.Reader, false), 0),
        QueryPlanHash = BitConverter.ToInt64(this.m_queryPlanHash.GetBytes((IDataReader) this.Reader, false), 0)
      };
    }
  }
}
