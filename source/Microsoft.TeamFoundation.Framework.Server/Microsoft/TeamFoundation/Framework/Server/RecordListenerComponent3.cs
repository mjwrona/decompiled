...
// Type: Microsoft.TeamFoundation.Framework.Server.RecordListenerComponent3
...
{
  internal class RecordListenerComponent3 : RecordListenerComponent2
  {
    private static readonly SqlMetaData[] typ_CommandTable2 = new SqlMetaData[13]
    {
    ...
    protected override SqlMetaData[] CommandTableType => RecordListenerComponent3.typ_CommandTable2;

    protected override string CommandTableTypeString => "typ_CommandTable2";
      ...
      SqlMetaData[] type)
    {
      ...
      sqlDataRecord.SetString(12, RecordListenerComponent.MakeStringValue(requestDetails.AuthenticationType, type[12].MaxLength));
