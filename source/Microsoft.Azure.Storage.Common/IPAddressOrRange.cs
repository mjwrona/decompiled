...
// Type: Microsoft.Azure.Storage.IPAddressOrRange
  ...
  public class IPAddressOrRange
  {
    ...
    private static void AssertIPv4(string address)
    {
      ...
      if (address1.AddressFamily != AddressFamily.InterNetwork)
        throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, "When specifying an IP Address in a SAS token, it must be an IPv4 address. Input address was {0}.", (object) address));
    }
  }
}
