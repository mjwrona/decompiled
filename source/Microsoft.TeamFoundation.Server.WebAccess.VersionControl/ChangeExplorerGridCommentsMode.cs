...
// Type: Microsoft.TeamFoundation.Server.WebAccess.VersionControl.ChangeExplorerGridCommentsMode
...
{
  [DataContract]
  public enum ChangeExplorerGridCommentsMode
  {
    [EnumMember] Default,
    [EnumMember] Off,
    [EnumMember] OnlyFilesWithComments,
    [EnumMember] CommentsOnly,
    [EnumMember] ActiveCommentsUnderFiles,
    [EnumMember] OnlyFilesWithActiveComments,
  }
}
