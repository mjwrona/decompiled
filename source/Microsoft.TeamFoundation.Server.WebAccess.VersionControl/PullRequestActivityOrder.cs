...
// Type: Microsoft.TeamFoundation.Server.WebAccess.VersionControl.PullRequestActivityOrder
...
{
  public enum PullRequestActivityOrder
  {
    [EnumMember] Time_NewFirst = 1,
    [EnumMember] Time_OldFirst = 2,
  }
}
