...
// Type: Microsoft.TeamFoundation.Server.WebAccess.VersionControl.CodeReviewLandingPageMode
...
{
  [DataContract]
  public enum CodeReviewLandingPageMode
  {
    [EnumMember] RequestedByMe,
    [EnumMember] AssignedToMe,
    [EnumMember] AssignedToTeam,
    [EnumMember] AllPullRequests,
  }
}
