...
// Type: Microsoft.TeamFoundation.Server.WebAccess.VersionControl.ChangeExplorerGridDisplayMode
...
{
  [DataContract]
  public enum ChangeExplorerGridDisplayMode
  {
    [EnumMember] FilesByFolder,
    [EnumMember] FilesOnly,
    [EnumMember] FullTree,
    [EnumMember] SingleFoldersExceptFirstlevel,
  }
}
