...
// Type: Microsoft.VisualStudio.Services.ItemStore.Common.IExpiringItem
...
namespace Microsoft.VisualStudio.Services.ItemStore.Common
{
  ...
  {
    DateTime? ExpirationTime { set; }

    bool TryGetExpirationTime(out DateTime? expirationTime);

    bool IsRetainedForever();
  }
}
