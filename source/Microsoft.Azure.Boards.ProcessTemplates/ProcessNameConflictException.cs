...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessNameConflictException
...
{
  [Serializable]
  public class ProcessNameConflictException : ProcessServiceException
  {
    public ProcessNameConflictException()
      : base(Resources.ProcessNameNotUnique(), 402358)
    {
    }

    public ProcessNameConflictException(string name)
      : base(Resources.ProcessTemplateNameConflict((object) name), 402358)
    {
      this.Name = name;
    }
