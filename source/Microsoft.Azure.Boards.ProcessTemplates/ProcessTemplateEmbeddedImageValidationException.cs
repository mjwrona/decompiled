...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessTemplateEmbeddedImageValidationException
...
{
  public class ProcessTemplateEmbeddedImageValidationException : ProcessTemplateValidatorException
  {
    public ProcessTemplateEmbeddedImageValidationException(string fileName)
      : base(Resources.ProcessTemplateValidationEmbeddedImage(), fileName, 412458)
    {
    }
  }
}
