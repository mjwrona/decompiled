...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessDescriptionLengthExceededException
...
{
  [Serializable]
  public class ProcessDescriptionLengthExceededException : ProcessServiceException
  {
    public ProcessDescriptionLengthExceededException(int descriptionLength)
      : base(Resources.ProcessTemplateDescriptionTooLarge((object) descriptionLength), 402613)
    {
