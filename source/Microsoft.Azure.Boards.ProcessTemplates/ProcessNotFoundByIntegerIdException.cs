...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessNotFoundByIntegerIdException
...
{
  [Serializable]
  public class ProcessNotFoundByIntegerIdException : ProcessNotFoundException
  {
    public ProcessNotFoundByIntegerIdException(int integerId)
      : base(Resources.ProcessTemplateNotFoundByIntegerId((object) integerId), 402360)
    {
