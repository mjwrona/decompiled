...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessTemplateFileNotFoundException
...
{
  public class ProcessTemplateFileNotFoundException : ProcessTemplateValidatorException
  {
    public ProcessTemplateFileNotFoundException(string fileName)
      : base(Resources.ProcessTemplateFileNotFound((object) fileName), fileName, 412457)
    {
    }
  }
}
