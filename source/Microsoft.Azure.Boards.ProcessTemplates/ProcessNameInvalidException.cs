...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessNameInvalidException
...
{
  [Serializable]
  public class ProcessNameInvalidException : ProcessServiceException
  {
    public ProcessNameInvalidException(int max, string illegalChars)
      : base(Resources.ProcessNameInvalid((object) max, (object) illegalChars), 402378)
    {
    }
  }
}
