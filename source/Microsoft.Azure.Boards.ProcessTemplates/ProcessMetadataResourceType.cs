...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessMetadataResourceType
...
{
  public enum ProcessMetadataResourceType
  {
    RuleMetadata = 1,
    HelpTextMetadata = 2,
    OutOfBoxPicklistValuesMetadata = 3,
    BehaviorMetadata = 4,
    WorkItemTypeDefinitionMetadata = 5,
    OutOfBoxStateIdsAndCategoriesMetadata = 6,
  }
}
