...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessTemplateEmptyNameException
...
{
  [Serializable]
  public class ProcessTemplateEmptyNameException : ProcessTemplateServiceException
  {
    public ProcessTemplateEmptyNameException()
      : base(Resources.ProcessTemplateEmptyName(), 403671)
    {
    }
  }
}
