...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessPermissionException
...
{
  [Serializable]
  public class ProcessPermissionException : ProcessServicePermissionException
  {
    public ProcessPermissionException()
      : base(Resources.PermissionDeniedOnProcess(), 402356)
    {
    }
  }
}
