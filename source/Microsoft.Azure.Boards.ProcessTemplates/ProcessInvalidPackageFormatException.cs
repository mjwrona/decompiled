...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessInvalidPackageFormatException
...
{
  [Serializable]
  public class ProcessInvalidPackageFormatException : ProcessTemplateServiceException
  {
    public ProcessInvalidPackageFormatException()
      : this((Exception) null)
    {
    }

    public ProcessInvalidPackageFormatException(Exception innerException)
      : base(Resources.InvalidProcessTemplatePackage(), innerException)
    {
    }
  }
}
