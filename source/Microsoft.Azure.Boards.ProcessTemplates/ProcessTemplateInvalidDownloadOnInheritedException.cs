...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessTemplateInvalidDownloadOnInheritedException
...
{
  [Serializable]
  public class ProcessTemplateInvalidDownloadOnInheritedException : ProcessServiceException
  {
    public ProcessTemplateInvalidDownloadOnInheritedException()
      : base(Resources.ProcessTemplateInvalidDownloadOnInherited(), 402381)
    {
    }
  }
}
