...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessProjectWithInvalidProcessException
...
{
  [Serializable]
  public class ProcessProjectWithInvalidProcessException : ProcessServiceException
  {
    public ProcessProjectWithInvalidProcessException(string projectName)
      : base(Resources.ProcessProjectWithInvalidProcess((object) projectName), 402375)
    {
    }
  }
}
