...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessCannotDeleteDefault
...
{
  public class ProcessCannotDeleteDefault : ProcessServiceException
  {
    public ProcessCannotDeleteDefault()
      : base(Resources.ProcessCannotDeleteDefault(), 1300702)
    {
    }
  }
}
