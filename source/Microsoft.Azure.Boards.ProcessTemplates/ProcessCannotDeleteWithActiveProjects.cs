...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessCannotDeleteWithActiveProjects
...
{
  public class ProcessCannotDeleteWithActiveProjects : ProcessServiceException
  {
    public ProcessCannotDeleteWithActiveProjects()
      : base(Resources.ProcessCannotDeleteWithActiveProjects(), 1300700)
    {
    }
  }
}
