...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessCannotDeleteNonReady
...
{
  public class ProcessCannotDeleteNonReady : ProcessServiceException
  {
    public ProcessCannotDeleteNonReady()
      : base(Resources.ProcessCannotBeDeleted(), 1300700)
    {
    }
  }
}
