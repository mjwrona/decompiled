...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessServicePermissionException
...
{
  public abstract class ProcessServicePermissionException : ProcessServiceException
  {
    public ProcessServicePermissionException(string message, int errorCode)
