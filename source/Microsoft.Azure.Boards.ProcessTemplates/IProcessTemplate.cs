...
// Type: Microsoft.Azure.Boards.ProcessTemplates.IProcessTemplate
...
namespace Microsoft.Azure.Boards.ProcessTemplates
{
  ...
  {
    ProcessDescriptor Descriptor { get; }

    Stream GetResource(string resourceName);

    Stream GetResource(string resourceName, out byte[] hashValue, out long contentLength);
  }
}
