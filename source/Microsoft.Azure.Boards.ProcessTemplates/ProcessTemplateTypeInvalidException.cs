...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessTemplateTypeInvalidException
...
{
  public class ProcessTemplateTypeInvalidException : ProcessTemplateValidatorException
  {
    public ProcessTemplateTypeInvalidException(string processTemplateXmlPath)
      : base(Resources.ProcessTemplateValidatorTypeInvalid(), processTemplateXmlPath, 402400)
    {
    }
  }
}
