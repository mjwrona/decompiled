...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessInvalidMetadataException
...
{
  [Serializable]
  public class ProcessInvalidMetadataException : ProcessTemplateServiceException
  {
    public ProcessInvalidMetadataException()
      : base(Resources.ProcessTemplateBadlyFormattedMetadata(), 402367)
    {
    }
  }
}
