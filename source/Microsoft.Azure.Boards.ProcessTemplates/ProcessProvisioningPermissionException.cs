...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessProvisioningPermissionException
...
{
  [Serializable]
  public class ProcessProvisioningPermissionException : ProcessServicePermissionException
  {
    public ProcessProvisioningPermissionException()
      : base(Resources.ProcessTemplatesProvisioningPermissionDenied(), 402363)
    {
    }
  }
}
