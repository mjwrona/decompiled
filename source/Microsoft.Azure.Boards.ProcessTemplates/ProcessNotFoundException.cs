...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessNotFoundException
...
{
  [Serializable]
  public class ProcessNotFoundException : ProcessServiceException
  {
    public ProcessNotFoundException()
      : base(Resources.ProcessTemplateNotFound(), 402481)
    {
    }

    public ProcessNotFoundException(string message, int errorCode)
