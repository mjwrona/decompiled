...
// Type: Microsoft.Azure.Boards.ProcessTemplates.CannotCreateProjectsWithDisableProcessException
...
{
  [Serializable]
  public class CannotCreateProjectsWithDisableProcessException : ProcessServiceException
  {
    public CannotCreateProjectsWithDisableProcessException(string name)
      : base(Resources.CannotCreateProjectsWithDisableProcess((object) name), 403119)
    {
    }
  }
}
