...
// Type: Microsoft.Azure.Boards.ProcessTemplates.ProcessInvalidInheritedProcessUpdateInputException
...
{
  [Serializable]
  public class ProcessInvalidInheritedProcessUpdateInputException : ProcessServiceException
  {
    public ProcessInvalidInheritedProcessUpdateInputException()
      : base(Resources.ProcessInvalidInheritedProcessUpdateInput(), 402373)
    {
    }
  }
}
