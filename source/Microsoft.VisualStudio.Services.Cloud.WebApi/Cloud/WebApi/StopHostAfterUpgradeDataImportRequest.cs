...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.StopHostAfterUpgradeDataImportRequest
...
{
  [DataContract]
  public class StopHostAfterUpgradeDataImportRequest : FrameworkDataImportRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.StopHostAfterUpgradeDataImportJob";
