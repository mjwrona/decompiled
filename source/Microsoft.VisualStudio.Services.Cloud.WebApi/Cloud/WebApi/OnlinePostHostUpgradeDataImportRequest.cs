...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.OnlinePostHostUpgradeDataImportRequest
...
{
  [DataContract]
  public class OnlinePostHostUpgradeDataImportRequest : FrameworkDataImportRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.OnlinePostHostUpgradeDataImportJob";
