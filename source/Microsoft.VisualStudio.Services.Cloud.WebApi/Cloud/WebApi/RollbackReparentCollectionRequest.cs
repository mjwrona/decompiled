...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.RollbackReparentCollectionRequest
...
{
  [DataContract]
  public class RollbackReparentCollectionRequest : FrameworkReparentCollectionRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Organization.RollbackReparentCollectionJob";
