...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.DataImportDehydrateRequest
...
{
  [DataContract]
  public class DataImportDehydrateRequest : FrameworkDataImportRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.DataImportDehydrateJob";
