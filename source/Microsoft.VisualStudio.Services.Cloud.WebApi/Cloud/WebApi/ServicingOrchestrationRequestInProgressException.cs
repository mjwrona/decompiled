...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.ServicingOrchestrationRequestInProgressException
...
{
  [Serializable]
  public class ServicingOrchestrationRequestInProgressException : 
    ServicingOrchestrationRequestOutOfOrderException
  {
    public ServicingOrchestrationRequestInProgressException(
      string message,
    ...
    protected ServicingOrchestrationRequestInProgressException(
