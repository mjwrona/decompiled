...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.RemoveDataImportRequest
...
{
  [DataContract]
  public class RemoveDataImportRequest : FrameworkDataImportRequest
  {
    [DataMember]
    public bool IgnoreImportStatus { get; set; }

    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.RemoveDataImportJob";
