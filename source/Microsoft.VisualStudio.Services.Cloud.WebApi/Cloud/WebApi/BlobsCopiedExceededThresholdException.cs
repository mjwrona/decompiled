...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.BlobsCopiedExceededThresholdException
...
{
  [Serializable]
  public class BlobsCopiedExceededThresholdException : DataImportException
  {
    public BlobsCopiedExceededThresholdException(string message)
      : base(message)
    {
    }

    public BlobsCopiedExceededThresholdException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected BlobsCopiedExceededThresholdException(
