...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.ResetRoutingDataRequest
...
{
  [DataContract]
  public class ResetRoutingDataRequest : FrameworkNewDomainUrlMigrationRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.ResetRoutingDataJob";
