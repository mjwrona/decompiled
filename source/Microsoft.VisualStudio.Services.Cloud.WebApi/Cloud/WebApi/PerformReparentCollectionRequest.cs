...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.PerformReparentCollectionRequest
...
{
  [DataContract]
  public class PerformReparentCollectionRequest : FrameworkReparentCollectionRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Organization.PerformReparentCollectionJob";
