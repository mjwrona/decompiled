...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.ServicingOrchestrationRequestOutOfOrderException
...
{
  [Serializable]
  public class ServicingOrchestrationRequestOutOfOrderException : ServicingOrchestrationException
  {
    public ServicingOrchestrationRequestOutOfOrderException(
      string message,
    ...
    protected ServicingOrchestrationRequestOutOfOrderException(
