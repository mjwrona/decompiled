...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.OnboardNewDomainRequest
...
{
  public class OnboardNewDomainRequest : PlatformNewDomainUrlMigrationRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.OnboardNewDomainUrlJob";
