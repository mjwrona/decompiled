...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.FinalizeReparentCollectionRequest
...
{
  [DataContract]
  public class FinalizeReparentCollectionRequest : FrameworkReparentCollectionRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Organization.FinalizeReparentCollectionJob";
