...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.CompleteReparentCollectionRequest
...
{
  [DataContract]
  public class CompleteReparentCollectionRequest : FrameworkReparentCollectionRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Organization.CompleteReparentCollectionJob";
