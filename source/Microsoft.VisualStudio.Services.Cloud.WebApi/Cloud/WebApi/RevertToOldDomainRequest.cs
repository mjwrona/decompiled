...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.RevertToOldDomainRequest
...
{
  public class RevertToOldDomainRequest : PlatformNewDomainUrlMigrationRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.RevertToOldDomainUrlJob";
