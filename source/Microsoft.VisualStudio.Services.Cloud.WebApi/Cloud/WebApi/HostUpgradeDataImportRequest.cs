...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.HostUpgradeDataImportRequest
...
{
  [DataContract]
  public class HostUpgradeDataImportRequest : FrameworkDataImportRequest
  {
    [IgnoreDataMember]
    ...
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Cloud.HostUpgradeDataImportJob";
  }
}
