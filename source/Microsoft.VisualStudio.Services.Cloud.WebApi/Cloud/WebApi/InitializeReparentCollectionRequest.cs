...
// Type: Microsoft.VisualStudio.Services.Cloud.WebApi.InitializeReparentCollectionRequest
...
{
  [DataContract]
  public class InitializeReparentCollectionRequest : FrameworkReparentCollectionRequest
  {
    [IgnoreDataMember]
    public override string JobPluginName => "Microsoft.VisualStudio.Services.Organization.InitializeReparentCollectionJob";
