...
// Type: Microsoft.VisualStudio.Services.MSGraph.Client.MicrosoftGraphClientConstants
...
{
  public static class MicrosoftGraphClientConstants
  {
    public const string Separator = "/";

    internal static class Resources
    {
      internal const string GraphApiDomainName = "graph.microsoft.com";

      internal static class Invitations
      {
        internal const string Path = "invitations";
      }
    }
  }
}
