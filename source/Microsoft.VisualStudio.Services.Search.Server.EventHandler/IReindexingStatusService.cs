...
// Type: Microsoft.VisualStudio.Services.Search.Server.EventHandler.IReindexingStatusService
...
{
  [DefaultServiceImplementation(typeof (ReindexingStatusService))]
  public interface IReindexingStatusService : IVssFrameworkService
  {
    bool CanFinalize(IVssRequestContext requestContext, IEntityType entityType);
  }
}
