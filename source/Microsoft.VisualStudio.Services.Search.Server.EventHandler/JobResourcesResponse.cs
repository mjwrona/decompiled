...
// Type: Microsoft.VisualStudio.Services.Search.Server.EventHandler.JobResourcesResponse
...
{
  public class JobResourcesResponse
  {
    public TimeSpan DelayToQueueJobs { get; set; }

    public TimeSpan DelayToQueueCallback { get; set; }

    public int AllottedResources { get; set; }
  }
}
