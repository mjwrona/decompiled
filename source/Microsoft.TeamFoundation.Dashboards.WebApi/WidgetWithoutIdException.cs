...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetWithoutIdException
...
{
  [Serializable]
  public class WidgetWithoutIdException : TeamFoundationServerException
  {
    public WidgetWithoutIdException()
      : base(DashboardResources.ErrorMissingWidgetId)
    {
    }
