...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.DashboardNameLengthExceededException
...
{
  [Serializable]
  public class DashboardNameLengthExceededException : TeamFoundationServerException
  {
    public DashboardNameLengthExceededException()
    {
    }

    public DashboardNameLengthExceededException(int allowed, int requested)
      : base(string.Format(DashboardResources.ErrorDashboardNameMoreThanMaxLength, (object) allowed, (object) requested))
    {
    }
