...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetExistsException
...
{
  [Serializable]
  public class WidgetExistsException : TeamFoundationServerException
  {
    public WidgetExistsException()
    {
    }
