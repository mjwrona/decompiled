...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.EmptyDashboardNameException
...
{
  [Serializable]
  public class EmptyDashboardNameException : TeamFoundationServerException
  {
    public EmptyDashboardNameException()
      : base(DashboardResources.ErrorEmptyDashboardName)
    {
    }
