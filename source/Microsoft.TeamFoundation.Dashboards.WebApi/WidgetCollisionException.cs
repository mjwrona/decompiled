...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetCollisionException
...
{
  [Serializable]
  public class WidgetCollisionException : TeamFoundationServerException
  {
    public WidgetCollisionException()
      : base(DashboardResources.ErrorWidgetCollision)
    {
    }
