...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.EmptyWidgetNameException
...
{
  [Serializable]
  public class EmptyWidgetNameException : TeamFoundationServerException
  {
    public EmptyWidgetNameException()
      : base(DashboardResources.ErrorEmptyWidgetName)
    {
    }
