...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetServiceUnavailableException
...
{
  [Serializable]
  public class WidgetServiceUnavailableException : TeamFoundationServerException
  {
    public WidgetServiceUnavailableException()
    {
    }

    public WidgetServiceUnavailableException(string service)
      : base(string.Format(DashboardResources.ErrorWidgetServiceUnavailable, (object) service), (Exception) null)
    {
    }
