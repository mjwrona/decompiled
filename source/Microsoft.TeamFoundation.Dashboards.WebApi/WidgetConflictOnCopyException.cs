...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetConflictOnCopyException
...
{
  [Serializable]
  public class WidgetConflictOnCopyException : TeamFoundationServerException
  {
    public WidgetConflictOnCopyException(string message = null)
      : base(message)
    {
    }
