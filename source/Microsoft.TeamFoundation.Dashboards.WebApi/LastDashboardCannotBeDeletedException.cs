...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.LastDashboardCannotBeDeletedException
...
{
  [Serializable]
  public class LastDashboardCannotBeDeletedException : TeamFoundationServerException
  {
    public LastDashboardCannotBeDeletedException()
      : base(DashboardResources.ErrorDeletingLastDashboard, (Exception) null)
    {
    }

    protected LastDashboardCannotBeDeletedException(
