...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.DashboardEntryExistsException
...
{
  [Serializable]
  public class DashboardEntryExistsException : TeamFoundationServerException
  {
    public DashboardEntryExistsException()
    {
    }
