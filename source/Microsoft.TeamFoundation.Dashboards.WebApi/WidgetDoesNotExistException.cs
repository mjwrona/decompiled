...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetDoesNotExistException
...
{
  [Serializable]
  public class WidgetDoesNotExistException : TeamFoundationServerException
  {
    public WidgetDoesNotExistException()
    {
    }

    public WidgetDoesNotExistException(Guid widgetId)
      : base(string.Format(DashboardResources.ErrorWidgetDoesNotExist, (object) widgetId))
    {
    }
