...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.CreateDashboardWithExistingIdException
...
{
  [Serializable]
  public class CreateDashboardWithExistingIdException : TeamFoundationServerException
  {
    public CreateDashboardWithExistingIdException()
      : base(DashboardResources.ErrorCannotHaveDashboardId)
    {
    }

    protected CreateDashboardWithExistingIdException(
