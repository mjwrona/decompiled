...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetTypeLengthExceededException
...
{
  [Serializable]
  public class WidgetTypeLengthExceededException : TeamFoundationServerException
  {
    public WidgetTypeLengthExceededException()
    {
    }

    public WidgetTypeLengthExceededException(int allowed, int requested)
      : base(string.Format(DashboardResources.ErrorMoreThanMaxLength, (object) "WidgetType", (object) allowed, (object) requested))
    {
    }
