...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetComparer
...
{
  public class WidgetComparer : IEqualityComparer<Widget>
  {
    ...
    public int GetHashCode(Widget w) => w != null && w.Id.HasValue ? w.Id.GetHashCode() : 0;
  }
}
