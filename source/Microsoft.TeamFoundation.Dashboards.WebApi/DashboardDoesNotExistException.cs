...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.DashboardDoesNotExistException
...
{
  [Serializable]
  public class DashboardDoesNotExistException : TeamFoundationServerException
  {
    public DashboardDoesNotExistException()
    {
    }

    public DashboardDoesNotExistException(Guid dashboardId)
      : base(string.Format(DashboardResources.ErrorDashboardDoesNotExist, (object) dashboardId))
    {
    }
