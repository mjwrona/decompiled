...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.DashboardDescriptionLengthExceededException
...
{
  [Serializable]
  public class DashboardDescriptionLengthExceededException : TeamFoundationServerException
  {
    public DashboardDescriptionLengthExceededException()
    {
    }

    public DashboardDescriptionLengthExceededException(int allowed, int requested)
      : base(string.Format(DashboardResources.ErrorDashboardDescriptionMoreThanMaxLength, (object) allowed, (object) requested))
    {
    }
    ...
    protected DashboardDescriptionLengthExceededException(
