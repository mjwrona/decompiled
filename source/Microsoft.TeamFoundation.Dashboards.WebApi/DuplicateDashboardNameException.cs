...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.DuplicateDashboardNameException
...
{
  [Serializable]
  public class DuplicateDashboardNameException : TeamFoundationServerException
  {
    public DuplicateDashboardNameException()
      : base(DashboardResources.ErrorDuplicateDashboardName)
    {
    }
