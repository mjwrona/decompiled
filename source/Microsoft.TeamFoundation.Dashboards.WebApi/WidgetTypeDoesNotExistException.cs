...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetTypeDoesNotExistException
...
{
  [Serializable]
  public class WidgetTypeDoesNotExistException : TeamFoundationServerException
  {
    public WidgetTypeDoesNotExistException()
    {
    }
