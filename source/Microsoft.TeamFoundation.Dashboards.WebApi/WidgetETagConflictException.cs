...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetETagConflictException
...
{
  [Serializable]
  public class WidgetETagConflictException : TeamFoundationServerException
  {
    public WidgetETagConflictException(string message = null)
      : base(message)
    {
    }
