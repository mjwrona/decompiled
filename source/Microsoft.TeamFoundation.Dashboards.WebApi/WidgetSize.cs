...
// Type: Microsoft.TeamFoundation.Dashboards.WebApi.WidgetSize
...
{
  [DataContract]
  public class WidgetSize : DashboardSecuredObject
  {
    ...
    public bool IsValid() => this.RowSpan >= 1 && this.RowSpan <= 10 && this.ColumnSpan >= 1 && this.ColumnSpan <= 10;

    public WidgetSize Clone() => new WidgetSize()
    {
