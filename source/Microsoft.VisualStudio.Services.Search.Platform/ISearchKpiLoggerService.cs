...
// Type: Microsoft.TeamFoundation.Search.Platform.Common.ISearchKpiLoggerService
...
{
  [DefaultServiceImplementation(typeof (SearchKpiLoggerService))]
  public interface ISearchKpiLoggerService : IVssFrameworkService
  {
    void Publish(
