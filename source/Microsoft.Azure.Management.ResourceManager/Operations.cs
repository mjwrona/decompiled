...
// Type: Microsoft.Azure.Management.ResourceManager.Operations
...
{
  internal class Operations : IServiceOperations<ResourceManagementClient>, IOperations
  {
    internal Operations(ResourceManagementClient client) => this.Client = client != null ? client : throw new ArgumentNullException(nameof (client));

    public ResourceManagementClient Client { get; private set; }

    public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Resources/operations").ToString();
      ...
      AzureOperationResponse<IPage<Operation>> _result = new AzureOperationResponse<IPage<Operation>>();
      ...
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = (IPage<Operation>) SafeJsonConvert.DeserializeObject<Page<Operation>>(_responseContent, this.Client.DeserializationSettings);
        }
    ...
    public async Task<AzureOperationResponse<IPage<Operation>>> ListNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
