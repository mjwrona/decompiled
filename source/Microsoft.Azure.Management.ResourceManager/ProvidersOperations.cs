...
// Type: Microsoft.Azure.Management.ResourceManager.ProvidersOperations
...
{
  internal class ProvidersOperations : 
    IServiceOperations<ResourceManagementClient>,
    IProvidersOperations
  {
    internal ProvidersOperations(ResourceManagementClient client) => this.Client = client != null ? client : throw new ArgumentNullException(nameof (client));

    public ResourceManagementClient Client { get; private set; }

    public async Task<AzureOperationResponse<Provider>> UnregisterWithHttpMessagesAsync(
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        ServiceClientTracing.Enter(_invocationId, (object) this, "Unregister", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/{resourceProviderNamespace}/unregister").ToString();
      ...
      AzureOperationResponse<Provider> _result = new AzureOperationResponse<Provider>();
    ...
    public async Task<AzureOperationResponse<Provider>> RegisterWithHttpMessagesAsync(
      string resourceProviderNamespace,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/{resourceProviderNamespace}/register").ToString();
      _url = _url.Replace("{resourceProviderNamespace}", Uri.EscapeDataString(resourceProviderNamespace));
      _url = _url.Replace("{subscriptionId}", Uri.EscapeDataString(this.Client.SubscriptionId));
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
    ...
    public async Task<AzureOperationResponse<IPage<Provider>>> ListWithHttpMessagesAsync(
      int? top = null,
      string expand = null,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (expand), (object) expand);
        tracingParameters.Add(nameof (cancellationToken), (object) cancellationToken);
        ServiceClientTracing.Enter(_invocationId, (object) this, "List", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers").ToString();
      _url = _url.Replace("{subscriptionId}", Uri.EscapeDataString(this.Client.SubscriptionId));
      List<string> _queryParameters = new List<string>();
      if (top.HasValue)
      ...
      if (expand != null)
        _queryParameters.Add(string.Format("$expand={0}", (object) Uri.EscapeDataString(expand)));
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
      if (_queryParameters.Count > 0)
        _url = _url + (_url.Contains("?") ? "&" : "?") + string.Join("&", (IEnumerable<string>) _queryParameters);
      ...
      AzureOperationResponse<IPage<Provider>> _result = new AzureOperationResponse<IPage<Provider>>();
      _result.Request = _httpRequest;
      _result.Response = _httpResponse;
      if (_httpResponse.Headers.Contains("x-ms-request-id"))
        _result.RequestId = _httpResponse.Headers.GetValues("x-ms-request-id").FirstOrDefault<string>();
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = (IPage<Provider>) SafeJsonConvert.DeserializeObject<Page<Provider>>(_responseContent, this.Client.DeserializationSettings);
        }
        catch (JsonException ex)
        {
          _httpRequest.Dispose();
    ...
    public async Task<AzureOperationResponse<IPage<Provider>>> ListAtTenantScopeWithHttpMessagesAsync(
      int? top = null,
      string expand = null,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers").ToString();
      List<string> _queryParameters = new List<string>();
      if (top.HasValue)
        _queryParameters.Add(string.Format("$top={0}", (object) Uri.EscapeDataString(SafeJsonConvert.SerializeObject((object) top, this.Client.SerializationSettings).Trim('"'))));
      if (expand != null)
    ...
    public async Task<AzureOperationResponse<Provider>> GetWithHttpMessagesAsync(
      string resourceProviderNamespace,
      string expand = null,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/{resourceProviderNamespace}").ToString();
      _url = _url.Replace("{resourceProviderNamespace}", Uri.EscapeDataString(resourceProviderNamespace));
      _url = _url.Replace("{subscriptionId}", Uri.EscapeDataString(this.Client.SubscriptionId));
      List<string> _queryParameters = new List<string>();
      if (expand != null)
    ...
    public async Task<AzureOperationResponse<Provider>> GetAtTenantScopeWithHttpMessagesAsync(
      string resourceProviderNamespace,
      string expand = null,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/{resourceProviderNamespace}").ToString();
      _url = _url.Replace("{resourceProviderNamespace}", Uri.EscapeDataString(resourceProviderNamespace));
      List<string> _queryParameters = new List<string>();
      if (expand != null)
        _queryParameters.Add(string.Format("$expand={0}", (object) Uri.EscapeDataString(expand)));
    ...
    public async Task<AzureOperationResponse<IPage<Provider>>> ListNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
    ...
    public async Task<AzureOperationResponse<IPage<Provider>>> ListAtTenantScopeNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
