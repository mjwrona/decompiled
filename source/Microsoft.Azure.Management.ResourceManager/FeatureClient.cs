...
// Type: Microsoft.Azure.Management.ResourceManager.FeatureClient
...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    IAzureClient
  {
    ...
    protected FeatureClient(HttpClient httpClient, bool disposeHttpClient)
      : base(httpClient, disposeHttpClient)
    {
      this.Initialize();
    }

    protected FeatureClient(params DelegatingHandler[] handlers)
      : base(handlers)
    {
      this.Initialize();
    }

    protected FeatureClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers)
      : base(rootHandler, handlers)
    {
      this.Initialize();
    }

    protected FeatureClient(Uri baseUri, params DelegatingHandler[] handlers)
      : this(handlers)
    {
      this.BaseUri = !(baseUri == (Uri) null) ? baseUri : throw new ArgumentNullException(nameof (baseUri));
    }

    protected FeatureClient(
      Uri baseUri,
    ...
    public FeatureClient(ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
      : this(handlers)
    {
      this.Credentials = credentials != null ? credentials : throw new ArgumentNullException(nameof (credentials));
      if (this.Credentials == null)
        return;
      this.Credentials.InitializeServiceClient<FeatureClient>((ServiceClient<FeatureClient>) this);
    }
    ...
    {
      this.Features = (IFeaturesOperations) new FeaturesOperations(this);
