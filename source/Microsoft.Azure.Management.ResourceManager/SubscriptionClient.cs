...
// Type: Microsoft.Azure.Management.ResourceManager.SubscriptionClient
...
namespace Microsoft.Azure.Management.ResourceManager
{
  public class SubscriptionClient : 
    ServiceClient<SubscriptionClient>,
    ISubscriptionClient,
    IDisposable,
    IAzureClient
  {
    ...
    protected SubscriptionClient(HttpClient httpClient, bool disposeHttpClient)
      : base(httpClient, disposeHttpClient)
    {
      this.Initialize();
    }

    protected SubscriptionClient(params DelegatingHandler[] handlers)
      : base(handlers)
    {
      this.Initialize();
    }

    protected SubscriptionClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers)
      : base(rootHandler, handlers)
    {
      this.Initialize();
    }

    protected SubscriptionClient(Uri baseUri, params DelegatingHandler[] handlers)
      : this(handlers)
    {
      ...
      : this(handlers)
    {
      ...
      if (this.Credentials == null)
        return;
      this.Credentials.InitializeServiceClient<SubscriptionClient>((ServiceClient<SubscriptionClient>) this);
    }
    ...
    {
      this.Subscriptions = (ISubscriptionsOperations) new SubscriptionsOperations(this);
      this.Tenants = (ITenantsOperations) new TenantsOperations(this);
