...
// Type: Microsoft.Azure.Management.ResourceManager.SubscriptionsOperations
...
{
  internal class SubscriptionsOperations : 
    IServiceOperations<SubscriptionClient>,
    ISubscriptionsOperations
  {
    internal SubscriptionsOperations(SubscriptionClient client) => this.Client = client != null ? client : throw new ArgumentNullException(nameof (client));

    public SubscriptionClient Client { get; private set; }

    public async Task<AzureOperationResponse<IEnumerable<Location>>> ListLocationsWithHttpMessagesAsync(
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (subscriptionId), (object) subscriptionId);
        tracingParameters.Add(nameof (cancellationToken), (object) cancellationToken);
        ServiceClientTracing.Enter(_invocationId, (object) this, "ListLocations", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/locations").ToString();
      ...
      AzureOperationResponse<IEnumerable<Location>> _result = new AzureOperationResponse<IEnumerable<Location>>();
      ...
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = (IEnumerable<Location>) SafeJsonConvert.DeserializeObject<Page<Location>>(_responseContent, this.Client.DeserializationSettings);
        }
    ...
    public async Task<AzureOperationResponse<Subscription>> GetWithHttpMessagesAsync(
      string subscriptionId,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}").ToString();
      _url = _url.Replace("{subscriptionId}", Uri.EscapeDataString(subscriptionId));
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
      ...
      AzureOperationResponse<Subscription> _result = new AzureOperationResponse<Subscription>();
      _result.Request = _httpRequest;
      _result.Response = _httpResponse;
      if (_httpResponse.Headers.Contains("x-ms-request-id"))
        _result.RequestId = _httpResponse.Headers.GetValues("x-ms-request-id").FirstOrDefault<string>();
    ...
    public async Task<AzureOperationResponse<IPage<Subscription>>> ListWithHttpMessagesAsync(
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      if (this.Client.ApiVersion == null)
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions").ToString();
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
      if (_queryParameters.Count > 0)
      ...
      AzureOperationResponse<IPage<Subscription>> _result = new AzureOperationResponse<IPage<Subscription>>();
      _result.Request = _httpRequest;
      _result.Response = _httpResponse;
      if (_httpResponse.Headers.Contains("x-ms-request-id"))
        _result.RequestId = _httpResponse.Headers.GetValues("x-ms-request-id").FirstOrDefault<string>();
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = (IPage<Subscription>) SafeJsonConvert.DeserializeObject<Page1<Subscription>>(_responseContent, this.Client.DeserializationSettings);
        }
        catch (JsonException ex)
        {
          _httpRequest.Dispose();
    ...
    public async Task<AzureOperationResponse<IPage<Subscription>>> ListNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
