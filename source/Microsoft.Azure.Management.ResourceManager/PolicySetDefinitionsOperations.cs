...
// Type: Microsoft.Azure.Management.ResourceManager.PolicySetDefinitionsOperations
...
{
  internal class PolicySetDefinitionsOperations : 
    IServiceOperations<PolicyClient>,
    IPolicySetDefinitionsOperations
  {
    internal PolicySetDefinitionsOperations(PolicyClient client) => this.Client = client != null ? client : throw new ArgumentNullException(nameof (client));

    public PolicyClient Client { get; private set; }

    public async Task<AzureOperationResponse<PolicySetDefinition>> CreateOrUpdateWithHttpMessagesAsync(
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      if (policySetDefinitionName == null)
        throw new ValidationException(ValidationRules.CannotBeNull, nameof (policySetDefinitionName));
      if (parameters == null)
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (policySetDefinitionName), (object) policySetDefinitionName);
      ...
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policySetDefinitions/{policySetDefinitionName}").ToString();
      _url = _url.Replace("{policySetDefinitionName}", Uri.EscapeDataString(policySetDefinitionName));
      ...
      AzureOperationResponse<PolicySetDefinition> _result = new AzureOperationResponse<PolicySetDefinition>();
      ...
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = SafeJsonConvert.DeserializeObject<PolicySetDefinition>(_responseContent, this.Client.DeserializationSettings);
        }
    ...
    public async Task<AzureOperationResponse<PolicySetDefinition>> GetWithHttpMessagesAsync(
      string policySetDefinitionName,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
    ...
    public async Task<AzureOperationResponse<PolicySetDefinition>> GetBuiltInWithHttpMessagesAsync(
      string policySetDefinitionName,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Authorization/policySetDefinitions/{policySetDefinitionName}").ToString();
      _url = _url.Replace("{policySetDefinitionName}", Uri.EscapeDataString(policySetDefinitionName));
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
    ...
    public async Task<AzureOperationResponse<IPage<PolicySetDefinition>>> ListWithHttpMessagesAsync(
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      if (this.Client.ApiVersion == null)
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policySetDefinitions").ToString();
      _url = _url.Replace("{subscriptionId}", Uri.EscapeDataString(this.Client.SubscriptionId));
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
      ...
      AzureOperationResponse<IPage<PolicySetDefinition>> _result = new AzureOperationResponse<IPage<PolicySetDefinition>>();
      _result.Request = _httpRequest;
      _result.Response = _httpResponse;
      if (_httpResponse.Headers.Contains("x-ms-request-id"))
        _result.RequestId = _httpResponse.Headers.GetValues("x-ms-request-id").FirstOrDefault<string>();
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = (IPage<PolicySetDefinition>) SafeJsonConvert.DeserializeObject<Page<PolicySetDefinition>>(_responseContent, this.Client.DeserializationSettings);
        }
        catch (JsonException ex)
        {
          _httpRequest.Dispose();
    ...
    public async Task<AzureOperationResponse<IPage<PolicySetDefinition>>> ListBuiltInWithHttpMessagesAsync(
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      if (this.Client.ApiVersion == null)
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Authorization/policySetDefinitions").ToString();
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
      if (_queryParameters.Count > 0)
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Management/managementgroups/{managementGroupId}/providers/Microsoft.Authorization/policySetDefinitions/{policySetDefinitionName}").ToString();
      _url = _url.Replace("{policySetDefinitionName}", Uri.EscapeDataString(policySetDefinitionName));
    ...
    public async Task<AzureOperationResponse<PolicySetDefinition>> GetAtManagementGroupWithHttpMessagesAsync(
      string policySetDefinitionName,
      string managementGroupId,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    ...
    public async Task<AzureOperationResponse<IPage<PolicySetDefinition>>> ListByManagementGroupWithHttpMessagesAsync(
      string managementGroupId,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Management/managementgroups/{managementGroupId}/providers/Microsoft.Authorization/policySetDefinitions").ToString();
      _url = _url.Replace("{managementGroupId}", Uri.EscapeDataString(managementGroupId));
      List<string> _queryParameters = new List<string>();
      if (this.Client.ApiVersion != null)
        _queryParameters.Add(string.Format("api-version={0}", (object) Uri.EscapeDataString(this.Client.ApiVersion)));
    ...
    public async Task<AzureOperationResponse<IPage<PolicySetDefinition>>> ListNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
    ...
    public async Task<AzureOperationResponse<IPage<PolicySetDefinition>>> ListBuiltInNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
    ...
    public async Task<AzureOperationResponse<IPage<PolicySetDefinition>>> ListByManagementGroupNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
