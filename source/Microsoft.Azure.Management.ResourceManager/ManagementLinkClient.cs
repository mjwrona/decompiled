...
// Type: Microsoft.Azure.Management.ResourceManager.ManagementLinkClient
...
{
  public class ManagementLinkClient : 
    ServiceClient<ManagementLinkClient>,
    IManagementLinkClient,
    IDisposable,
    IAzureClient
  {
    ...
    public virtual IResourceLinksOperations ResourceLinks { get; private set; }

    protected ManagementLinkClient(HttpClient httpClient, bool disposeHttpClient)
      : base(httpClient, disposeHttpClient)
    {
      this.Initialize();
    }

    protected ManagementLinkClient(params DelegatingHandler[] handlers)
      : base(handlers)
    {
      this.Initialize();
    }

    protected ManagementLinkClient(
    ...
    protected ManagementLinkClient(Uri baseUri, params DelegatingHandler[] handlers)
      : this(handlers)
    {
      ...
      : this(handlers)
    {
      ...
      if (this.Credentials == null)
        return;
      this.Credentials.InitializeServiceClient<ManagementLinkClient>((ServiceClient<ManagementLinkClient>) this);
    }
    ...
    {
      this.ResourceLinks = (IResourceLinksOperations) new ResourceLinksOperations(this);
