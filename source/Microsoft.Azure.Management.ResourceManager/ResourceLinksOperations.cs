...
// Type: Microsoft.Azure.Management.ResourceManager.ResourceLinksOperations
...
{
  internal class ResourceLinksOperations : 
    IServiceOperations<ManagementLinkClient>,
    IResourceLinksOperations
  {
    internal ResourceLinksOperations(ManagementLinkClient client) => this.Client = client != null ? client : throw new ArgumentNullException(nameof (client));
    ...
    {
      if (linkId == null)
        throw new ValidationException(ValidationRules.CannotBeNull, nameof (linkId));
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (linkId), (object) linkId);
      ...
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{linkId}").ToString();
    ...
    public async Task<AzureOperationResponse<ResourceLink>> CreateOrUpdateWithHttpMessagesAsync(
      string linkId,
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      AzureOperationResponse<ResourceLink> _result = new AzureOperationResponse<ResourceLink>();
      _result.Request = _httpRequest;
      _result.Response = _httpResponse;
      if (_httpResponse.Headers.Contains("x-ms-request-id"))
        _result.RequestId = _httpResponse.Headers.GetValues("x-ms-request-id").FirstOrDefault<string>();
    ...
    public async Task<AzureOperationResponse<ResourceLink>> GetWithHttpMessagesAsync(
      string linkId,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
    ...
    public async Task<AzureOperationResponse<IPage<ResourceLink>>> ListAtSubscriptionWithHttpMessagesAsync(
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (cancellationToken), (object) cancellationToken);
        ServiceClientTracing.Enter(_invocationId, (object) this, "ListAtSubscription", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Resources/links").ToString();
      ...
      AzureOperationResponse<IPage<ResourceLink>> _result = new AzureOperationResponse<IPage<ResourceLink>>();
      _result.Request = _httpRequest;
      _result.Response = _httpResponse;
      if (_httpResponse.Headers.Contains("x-ms-request-id"))
        _result.RequestId = _httpResponse.Headers.GetValues("x-ms-request-id").FirstOrDefault<string>();
      if (_statusCode == HttpStatusCode.OK)
      {
        ...
        try
        {
          _result.Body = (IPage<ResourceLink>) SafeJsonConvert.DeserializeObject<Page<ResourceLink>>(_responseContent, this.Client.DeserializationSettings);
        }
        catch (JsonException ex)
        {
          _httpRequest.Dispose();
    ...
    public async Task<AzureOperationResponse<IPage<ResourceLink>>> ListAtSourceScopeWithHttpMessagesAsync(
      string scope,
      ODataQuery<ResourceLinkFilter> odataQuery = null,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (cancellationToken), (object) cancellationToken);
        ServiceClientTracing.Enter(_invocationId, (object) this, "ListAtSourceScope", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
      string _baseUrl = this.Client.BaseUri.AbsoluteUri;
      string _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{scope}/providers/Microsoft.Resources/links").ToString();
    ...
    public async Task<AzureOperationResponse<IPage<ResourceLink>>> ListAtSubscriptionNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (cancellationToken), (object) cancellationToken);
        ServiceClientTracing.Enter(_invocationId, (object) this, "ListAtSubscriptionNext", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
    ...
    public async Task<AzureOperationResponse<IPage<ResourceLink>>> ListAtSourceScopeNextWithHttpMessagesAsync(
      string nextPageLink,
      Dictionary<string, List<string>> customHeaders = null,
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      if (_shouldTrace)
      {
        ...
        tracingParameters.Add(nameof (nextPageLink), (object) nextPageLink);
        tracingParameters.Add(nameof (cancellationToken), (object) cancellationToken);
        ServiceClientTracing.Enter(_invocationId, (object) this, "ListAtSourceScopeNext", (IDictionary<string, object>) tracingParameters);
        tracingParameters = (Dictionary<string, object>) null;
      }
      string _url = "{nextLink}";
      _url = _url.Replace("{nextLink}", nextPageLink);
