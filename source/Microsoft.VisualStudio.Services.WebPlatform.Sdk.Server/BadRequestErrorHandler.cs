...
// Type: Microsoft.VisualStudio.Services.WebPlatform.Sdk.Server.BadRequestErrorHandler
...
{
  internal class BadRequestErrorHandler : IErrorPageHandler
  {
    public void HandleError(IVssRequestContext requestContext, ErrorContext context)
    {
      if (context.StatusCode != 400)
        return;
      context.ErrorTitle = WebFrameworkResources.BadReqeust_Title();
