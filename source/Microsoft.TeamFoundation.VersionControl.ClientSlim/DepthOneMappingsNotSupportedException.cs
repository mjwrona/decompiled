...
// Type: Microsoft.TeamFoundation.VersionControl.Client.DepthOneMappingsNotSupportedException
...
{
  [Serializable]
  public class DepthOneMappingsNotSupportedException : VersionControlException
  {
    public DepthOneMappingsNotSupportedException()
      : base(Resources.Format("DepthOneMappingsNotSupported"))
    {
    }
  }
}
