...
// Type: Microsoft.TeamFoundation.VersionControl.Client.UnableToLoadPendingChangesTableException
...
{
  [Serializable]
  public class UnableToLoadPendingChangesTableException : VersionControlException
  {
    public UnableToLoadPendingChangesTableException(string workspaceSpec, Exception innerException)
      : base(Resources.Format("UnableToLoadPendingChangesTable", (object) workspaceSpec, (object) innerException.Message), innerException)
    {
    }
  }
}
