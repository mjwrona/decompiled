...
// Type: Microsoft.TeamFoundation.VersionControl.Client.MultipleWorkspacesFoundException
...
{
  [Serializable]
  public class MultipleWorkspacesFoundException : VersionControlException
  {
    public MultipleWorkspacesFoundException(
      ...
      : base(Resources.Format("MultipleWorkspacesSameSpec", (object) suppliedWorkspaceName, (object) suppliedOwnerName, (object) string.Join("\n", matchingWorkspaceSpecs.ToArray())))
    {
    }
  }
}
