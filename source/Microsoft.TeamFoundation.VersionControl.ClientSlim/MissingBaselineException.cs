...
// Type: Microsoft.TeamFoundation.VersionControl.Client.MissingBaselineException
...
{
  [Serializable]
  public class MissingBaselineException : VersionControlException
  {
    public MissingBaselineException(string targetLocalItem)
      : base(Resources.Format("MissingBaseline", (object) targetLocalItem))
    {
