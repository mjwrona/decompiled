...
// Type: Microsoft.TeamFoundation.VersionControl.Client.ResolveRequiresOneResolutionException
...
{
  [Serializable]
  internal class ResolveRequiresOneResolutionException : VersionConflictException
  {
    public ResolveRequiresOneResolutionException()
      : base(Resources.Get("ResolveRequiresOneResolutionMessage"))
    {
    }
  }
}
