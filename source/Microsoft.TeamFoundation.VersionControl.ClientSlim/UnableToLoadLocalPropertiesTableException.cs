...
// Type: Microsoft.TeamFoundation.VersionControl.Client.UnableToLoadLocalPropertiesTableException
...
{
  [Serializable]
  public class UnableToLoadLocalPropertiesTableException : VersionControlException
  {
    public UnableToLoadLocalPropertiesTableException(string workspaceSpec, Exception innerException)
      : base(Resources.Format("UnableToLoadLocalPropertiesTable", (object) workspaceSpec, (object) innerException.Message), innerException)
    {
    }
  }
}
