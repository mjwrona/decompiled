...
// Type: Microsoft.Azure.Pipelines.Checks.Server.DataAccess.CheckSuiteBinder2
...
{
  internal class CheckSuiteBinder2 : CheckSuiteBinder
  {
    ...
    protected override CheckRun Bind()
    {
      ...
      try
      {
        resource = JsonUtility.FromString<Resource>(this.m_scope.GetString((IDataReader) this.Reader, string.Empty));
      }
      ...
      checkRun.CheckConfigurationRef = new CheckConfigurationRef()
      {
        ...
        Id = this.m_checkConfigurationId.GetInt32((IDataReader) this.Reader),
        Resource = resource
      };
      return checkRun;
    }
