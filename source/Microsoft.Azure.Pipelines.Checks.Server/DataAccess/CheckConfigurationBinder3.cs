...
// Type: Microsoft.Azure.Pipelines.Checks.Server.DataAccess.CheckConfigurationBinder3
...
{
  internal class CheckConfigurationBinder3 : CheckConfigurationBinder2
  {
    private SqlColumnBinder m_checkConfigurationId = new SqlColumnBinder("AssignmentId");
    private SqlColumnBinder m_checkConfigurationVersion = new SqlColumnBinder("AssignmentVersion");
    ...
    private SqlColumnBinder m_isDisabled = new SqlColumnBinder("IsDisabled");
    ...
    protected override CheckConfiguration Bind()
    {
      ...
      configurationObject.Version = this.m_checkConfigurationVersion.GetInt32((IDataReader) this.Reader, 1, 1);
      ...
      configurationObject.IsDisabled = this.m_isDisabled.GetBoolean((IDataReader) this.Reader);
