...
// Type: Microsoft.Azure.Pipelines.Checks.Server.IChecksExtensionService
...
{
  [DefaultServiceImplementation(typeof (ChecksExtensionService))]
  public interface IChecksExtensionService : IVssFrameworkService
  {
    ICheckType GetCheckInstance(CheckType checkType);
  }
}
