...
// Type: Microsoft.VisualStudio.Services.Search.Indexer.CodeIndexProvisionerFactory
...
{
  public class CodeIndexProvisionerFactory : IndexProvisionerFactory
  {
    ...
    {
      if (indexingUnit != null && indexingUnit.IsRepository() && indexingUnit.IsLargeRepository(indexingExecutionContext.RequestContext))
        return (IIndexProvisioner) new RepositoryDedicatedIndexProvisioner(indexingExecutionContext, this.EntityType);
