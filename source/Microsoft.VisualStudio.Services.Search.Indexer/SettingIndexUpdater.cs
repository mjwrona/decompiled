...
// Type: Microsoft.VisualStudio.Services.Search.Indexer.SettingIndexUpdater
...
{
  internal sealed class SettingIndexUpdater : AbstractIndexUpdater
  {
    public SettingIndexUpdater(
    ...
    public override IndexOperationsResponse DeleteDocumentsByQuery(
      ...
      bool leniant = false)
    {
      return this.SearchIndex.BulkDeleteByQuery<SettingContract>((ExecutionContext) this.IndexingExecutionContext, new BulkDeleteByQueryRequest<SettingContract>(query, this.DocumentContractType)
      {
        Lenient = leniant
      }, forceComplete);
    }
