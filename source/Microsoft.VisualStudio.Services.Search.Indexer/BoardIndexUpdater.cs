...
// Type: Microsoft.VisualStudio.Services.Search.Indexer.BoardIndexUpdater
...
{
  internal sealed class BoardIndexUpdater : AbstractIndexUpdater
  {
    public BoardIndexUpdater(
    ...
    public override IndexOperationsResponse DeleteDocumentsByQuery(
      ...
      bool leniant = false)
    {
      return this.SearchIndex.BulkDeleteByQuery<BoardVersionContract>((ExecutionContext) this.IndexingExecutionContext, new BulkDeleteByQueryRequest<BoardVersionContract>(query, this.DocumentContractType)
      {
        Lenient = leniant
      }, forceComplete);
    }
