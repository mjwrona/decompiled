...
// Type: Microsoft.VisualStudio.Services.Search.Indexer.ProjectIndexUpdater
...
{
  internal sealed class ProjectIndexUpdater : AbstractIndexUpdater
  {
    public ProjectIndexUpdater(
    ...
    {
      return this.SearchIndex.BulkUpdateSync<AbstractSearchDocumentContract>((ExecutionContext) this.IndexingExecutionContext, new BulkUpdateRequest<AbstractSearchDocumentContract>()
      {
        Batch = batch,
    ...
    public override IndexOperationsResponse DeleteDocumentsByQuery(
      ...
      bool leniant = false)
    {
      return this.SearchIndex.BulkDeleteByQuery<ProjectContract>((ExecutionContext) this.IndexingExecutionContext, new BulkDeleteByQueryRequest<ProjectContract>(query, this.DocumentContractType)
      {
        Lenient = leniant
      }, forceComplete);
    }
