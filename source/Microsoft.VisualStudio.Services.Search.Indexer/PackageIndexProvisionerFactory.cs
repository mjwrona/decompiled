...
// Type: Microsoft.VisualStudio.Services.Search.Indexer.PackageIndexProvisionerFactory
...
{
  public class PackageIndexProvisionerFactory : IndexProvisionerFactory
  {
      ...
      IndexingUnit indexingUnit)
    {
      ...
      if (indexingUnitType == "Collection" || indexingUnitType == "Organization")
