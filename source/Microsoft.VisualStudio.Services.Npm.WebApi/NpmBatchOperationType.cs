...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.NpmBatchOperationType
...
namespace Microsoft.VisualStudio.Services.Npm.WebApi
{
  ...
  {
    [DataMember] Promote,
    [DataMember] Deprecate,
    [DataMember] Unpublish,
    [DataMember] PermanentDelete,
    [DataMember] RestoreToFeed,
    [DataMember] Delete,
    [DataMember, ClientInternalUseOnly(true)] UpgradeCachedPackages,
  }
}
