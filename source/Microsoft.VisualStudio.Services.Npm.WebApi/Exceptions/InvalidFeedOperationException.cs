...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidFeedOperationException
...
{
  public class InvalidFeedOperationException : VssServiceException
  {
    public InvalidFeedOperationException(string message)
      : base(message)
    {
    }

    public InvalidFeedOperationException(string message, Exception innerException)
