...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidPackageTarballException
...
{
  public class InvalidPackageTarballException : InvalidPackageException
  {
    public InvalidPackageTarballException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public InvalidPackageTarballException(string message)
      : base(message)
    {
    }
  }
