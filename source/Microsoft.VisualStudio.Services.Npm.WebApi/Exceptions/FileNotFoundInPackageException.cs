...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.FileNotFoundInPackageException
...
{
  [Serializable]
  public class FileNotFoundInPackageException : VssServiceException
  {
    public FileNotFoundInPackageException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public FileNotFoundInPackageException(string message)
      : base(message)
    {
    }
  }
