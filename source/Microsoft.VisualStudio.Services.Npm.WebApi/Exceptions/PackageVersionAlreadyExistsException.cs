...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.PackageVersionAlreadyExistsException
...
{
  public class PackageVersionAlreadyExistsException : NpmClientException
  {
    public PackageVersionAlreadyExistsException(string message)
      : base(message)
    {
    }

    public PackageVersionAlreadyExistsException(string message, Exception innerException)
