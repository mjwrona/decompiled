...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.UnknownUpstreamErrorException
...
{
  public class UnknownUpstreamErrorException : NpmClientException
  {
    public UnknownUpstreamErrorException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public UnknownUpstreamErrorException(string message)
      : base(message)
    {
    }

    public static bool IsUnknown(Exception e) => !(e is UpstreamUnavailableException);
  }
}
