...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidDownloadRequestException
...
{
  [Obsolete("Use Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidRequestException instead.")]
  public class InvalidDownloadRequestException : NpmClientException
  {
    ...
    public InvalidDownloadRequestException(string message, Exception innerException)
