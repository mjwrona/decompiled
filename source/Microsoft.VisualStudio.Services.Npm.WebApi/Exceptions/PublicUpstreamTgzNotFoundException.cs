...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.PublicUpstreamTgzNotFoundException
...
{
  public class PublicUpstreamTgzNotFoundException : NpmClientException
  {
    public PublicUpstreamTgzNotFoundException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public PublicUpstreamTgzNotFoundException(string message)
      : base(message)
    {
    }
  }
