...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.MultipleVersionsUnpublishedException
...
{
  public class MultipleVersionsUnpublishedException : NpmClientException
  {
    public MultipleVersionsUnpublishedException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public MultipleVersionsUnpublishedException(string message)
      : base(message)
    {
    }
  }
