...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidPackageJsonException
...
{
  public class InvalidPackageJsonException : NpmClientException
  {
    public InvalidPackageJsonException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public InvalidPackageJsonException(string message)
      : base(message)
    {
    }
  }
