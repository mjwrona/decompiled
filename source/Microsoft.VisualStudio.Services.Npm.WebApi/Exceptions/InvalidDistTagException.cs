...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidDistTagException
...
{
  public class InvalidDistTagException : NpmClientException
  {
    public InvalidDistTagException(string message)
      : base(message)
    {
    }

    public InvalidDistTagException(string message, Exception innerException)
