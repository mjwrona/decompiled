...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.PackageTooLargeException
...
{
  public class PackageTooLargeException : VssServiceException
  {
    public PackageTooLargeException(string message)
      : base(message)
    {
    }

    public PackageTooLargeException(string message, Exception innerException)
