...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidUpstreamPackage
...
{
  public class InvalidUpstreamPackage : NpmClientException
  {
    public InvalidUpstreamPackage(string message, string packageJson)
      : base(message)
    {
      this.PackageJson = packageJson;
    }

    public InvalidUpstreamPackage(string message, Exception innerException, string packageJson)
