...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.InvalidPublishException
...
{
  public class InvalidPublishException : NpmClientException
  {
    public InvalidPublishException(string message, Exception innerException)
