...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.RequiredFieldPackageJsonException
...
{
  public class RequiredFieldPackageJsonException : NpmClientException
  {
    public RequiredFieldPackageJsonException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public RequiredFieldPackageJsonException(string message)
      : base(message)
    {
    }
  }
