...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Exceptions.NpmClientException
...
{
  public abstract class NpmClientException : VssServiceException
  {
    protected NpmClientException(string message)
      : base(message)
    {
    }

    protected NpmClientException(string message, Exception innerException)
