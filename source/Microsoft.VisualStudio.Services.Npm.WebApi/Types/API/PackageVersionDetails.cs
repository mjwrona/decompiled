...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Types.API.PackageVersionDetails
...
{
  [DataContract]
  public class PackageVersionDetails : INpmDeprecateData, IPackageVersionDetails
  {
    [DataMember]
    ...
    public string GetDeprecateMessage() => this.DeprecateMessage;
  }
}
