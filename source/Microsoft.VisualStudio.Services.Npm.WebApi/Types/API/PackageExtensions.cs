...
// Type: Microsoft.VisualStudio.Services.Npm.WebApi.Types.API.PackageExtensions
...
namespace Microsoft.VisualStudio.Services.Npm.WebApi.Types.API
{
  ...
  {
    public static NpmPackageVersionDeletionState ToNpmPackageVersionDeletionState(
      this Package package)
    {
      if (!package.UnpublishedDate.HasValue)
        throw new ArgumentException("UnpublishedDate");
      return new NpmPackageVersionDeletionState(package.Name, package.Version, package.UnpublishedDate.Value);
    }
  }
}
