...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Web.Controllers.ReportingWorkItemLinks2Controller
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Web.Controllers
{
  ...
  [ClientIgnore]
  public class ReportingWorkItemLinks2Controller : ReportingWorkItemLinksControllerBase
  {
      ...
      [FromUri(Name = "startDateTime")] DateTime? startDateTime = null)
    {
      ...
      return this.ReadReportingLinksImpl<ReportingWorkItemLink>(new ReportingWorkItemLinksRequest<ReportingWorkItemLink>()
      {
        ...
        CreateLink = ReportingWorkItemLinks2Controller.\u003C\u003EO.\u003C0\u003E__Create ?? (ReportingWorkItemLinks2Controller.\u003C\u003EO.\u003C0\u003E__Create = new CreateLink<ReportingWorkItemLink>(ReportingWorkItemLink.Create))
      });
    }
  }
}
