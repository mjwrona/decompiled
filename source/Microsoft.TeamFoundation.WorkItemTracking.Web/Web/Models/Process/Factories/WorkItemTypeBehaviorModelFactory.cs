...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Web.Models.Process.Factories.WorkItemTypeBehaviorModelFactory
  ...
  internal static class WorkItemTypeBehaviorModelFactory
  {
      ...
      BehaviorRelation behaviorRelation)
    {
      ...
      return new WorkItemTypeBehavior()
      {
        ...
        IsLegacyDefault = behaviorRelation.IsLegacyDefault,
