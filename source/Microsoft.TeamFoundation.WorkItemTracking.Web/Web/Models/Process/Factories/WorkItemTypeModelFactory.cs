...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Web.Models.Process.Factories.WorkItemTypeModelFactory
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Web.Models.Process.Factories
{
  internal static class WorkItemTypeModelFactory
  {
    internal static WorkItemTypeModel Create(
      ...
      Microsoft.TeamFoundation.WorkItemTracking.Server.ProcessWorkItemType wit,
      ...
      Layout layout = null)
    {
      return new WorkItemTypeModel()
      {
        ...
        Layout = layout != null ? layout.GetProcessWebApiModel() : (Microsoft.TeamFoundation.WorkItemTracking.Process.WebApi.Models.FormLayout) null
      };
    }
