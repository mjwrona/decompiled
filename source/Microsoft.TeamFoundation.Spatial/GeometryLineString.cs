...
// Type: Microsoft.Spatial.GeometryLineString
...
namespace Microsoft.Spatial
{
  public abstract class GeometryLineString : GeometryCurve
  {
    ...
    public bool Equals(GeometryLineString other) => this.BaseEquals((Geometry) other) ?? this.Points.SequenceEqual<GeometryPoint>((IEnumerable<GeometryPoint>) other.Points);

    public override bool Equals(object obj) => this.Equals(obj as GeometryLineString);
