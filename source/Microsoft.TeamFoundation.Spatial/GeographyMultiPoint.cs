...
// Type: Microsoft.Spatial.GeographyMultiPoint
...
namespace Microsoft.Spatial
{
  public abstract class GeographyMultiPoint : GeographyCollection
  {
    ...
    public bool Equals(GeographyMultiPoint other) => this.BaseEquals((Geography) other) ?? this.Points.SequenceEqual<GeographyPoint>((IEnumerable<GeographyPoint>) other.Points);

    public override bool Equals(object obj) => this.Equals(obj as GeographyMultiPoint);
