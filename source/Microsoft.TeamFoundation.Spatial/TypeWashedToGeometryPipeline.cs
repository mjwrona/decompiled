...
// Type: Microsoft.Spatial.TypeWashedToGeometryPipeline
...
namespace Microsoft.Spatial
{
  internal class TypeWashedToGeometryPipeline : TypeWashedPipeline
  {
    ...
    internal override void SetCoordinateSystem(int? epsgId) => this.output.SetCoordinateSystem(CoordinateSystem.Geometry(epsgId));

    internal override void Reset() => this.output.Reset();

    internal override void BeginGeo(SpatialType type) => this.output.BeginGeometry(type);
    ...
    internal override void EndGeo() => this.output.EndGeometry();
  }
}
