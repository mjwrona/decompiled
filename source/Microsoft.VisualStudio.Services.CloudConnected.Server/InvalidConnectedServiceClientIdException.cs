...
// Type: Microsoft.VisualStudio.Services.CloudConnected.InvalidConnectedServiceClientIdException
...
{
  [Serializable]
  public class InvalidConnectedServiceClientIdException : CloudConnectedServiceException
  {
    public InvalidConnectedServiceClientIdException(string message)
      : base(message)
    {
    }

    public InvalidConnectedServiceClientIdException(
