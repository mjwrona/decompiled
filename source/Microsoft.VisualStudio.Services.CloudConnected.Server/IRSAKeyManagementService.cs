...
// Type: Microsoft.VisualStudio.Services.CloudConnected.IRSAKeyManagementService
...
{
  [DefaultServiceImplementation(typeof (RSAKeyManagementService))]
  public interface IRSAKeyManagementService : IVssFrameworkService
  {
    void DeleteKey(IVssRequestContext requestContext);
