...
// Type: Microsoft.VisualStudio.Services.CloudConnected.ICloudConnectedConnectionService
...
{
  [DefaultServiceImplementation(typeof (CloudConnectedConnectionService))]
  public interface ICloudConnectedConnectionService : IVssFrameworkService
  {
    VssConnection GetConnection(IVssRequestContext requestContext);
  }
}
