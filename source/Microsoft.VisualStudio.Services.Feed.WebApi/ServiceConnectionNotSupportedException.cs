...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.ServiceConnectionNotSupportedException
...
{
  [Serializable]
  public class ServiceConnectionNotSupportedException : VssServiceException
  {
    public ServiceConnectionNotSupportedException(string message)
      : base(message)
    {
    }
  }
