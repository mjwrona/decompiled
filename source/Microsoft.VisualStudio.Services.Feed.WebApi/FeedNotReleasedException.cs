...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.FeedNotReleasedException
...
{
  [Serializable]
  public class FeedNotReleasedException : VssServiceException
  {
    public FeedNotReleasedException(string message)
      : base(message)
    {
    }

    public static FeedNotReleasedException Create(string feedName) => new FeedNotReleasedException(Resources.Error_FeedNotReleased((object) feedName));
  }
}
