...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.InvalidFeedViewNameException
...
{
  [Serializable]
  public class InvalidFeedViewNameException : VssServiceException
  {
    public InvalidFeedViewNameException(string message)
      : base(message)
    {
    }
  }
