...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.AzureArtifacts.FeedListData
...
{
  [DataContract]
  public class FeedListData : FeedSecuredObject
  {
    [DataMember]
    public List<FeedIdentifier> Feeds { get; set; }

    [DataMember]
    public List<FeedIdentifier> DeletedFeeds { get; set; }
  }
}
