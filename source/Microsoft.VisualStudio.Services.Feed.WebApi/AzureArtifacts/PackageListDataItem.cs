...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.AzureArtifacts.PackageListDataItem
...
{
  [DataContract]
  public class PackageListDataItem : FeedSecuredObject
  {
    [DataMember]
    public MinimalPackage Package { get; set; }

    [DataMember]
    public SkeletalPackageVersion LatestVersion { get; set; }
  }
}
