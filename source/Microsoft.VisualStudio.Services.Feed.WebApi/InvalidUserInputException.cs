...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.InvalidUserInputException
...
{
  [Serializable]
  public class InvalidUserInputException : VssServiceException
  {
    ...
    public static InvalidUserInputException Create(string parameter) => new InvalidUserInputException(Resources.Error_InvalidUserInputMessage((object) parameter));
  }
}
