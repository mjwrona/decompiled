...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.InvalidFeedCapabilitiesException
...
{
  [Serializable]
  public class InvalidFeedCapabilitiesException : VssServiceException
  {
    public InvalidFeedCapabilitiesException(string message)
      : base(message)
    {
    }
  }
