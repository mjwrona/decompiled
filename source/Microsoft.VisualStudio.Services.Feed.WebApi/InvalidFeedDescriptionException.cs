...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.InvalidFeedDescriptionException
...
{
  [Serializable]
  public class InvalidFeedDescriptionException : VssServiceException
  {
    public InvalidFeedDescriptionException(string message)
      : base(message)
    {
    }
  }
