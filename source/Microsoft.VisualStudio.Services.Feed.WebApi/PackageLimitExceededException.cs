...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.PackageLimitExceededException
...
{
  [Serializable]
  public class PackageLimitExceededException : VssServiceException
  {
    ...
    public static PackageLimitExceededException Create(int top, int skip) => new PackageLimitExceededException(Resources.Error_PackageLimitExceededMessage((object) top, (object) skip));
  }
}
