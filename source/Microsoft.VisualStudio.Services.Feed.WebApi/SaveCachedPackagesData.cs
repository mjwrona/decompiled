...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.SaveCachedPackagesData
...
namespace Microsoft.VisualStudio.Services.Feed.WebApi
{
  ...
  public class SaveCachedPackagesData : FeedBatchOperationData
  {
    [DataMember]
    public IEnumerable<string> NormalizedPackageNames { get; set; }

    [DataMember]
    public IEnumerable<Guid> ViewsForPromotion { get; set; }
  }
}
