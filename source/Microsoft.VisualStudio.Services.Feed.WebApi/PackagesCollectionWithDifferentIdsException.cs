...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.PackagesCollectionWithDifferentIdsException
...
{
  [Serializable]
  public class PackagesCollectionWithDifferentIdsException : VssServiceException
  {
    public PackagesCollectionWithDifferentIdsException()
      : base(Resources.Error_PackagesCollectionWithDifferentIdsMessage())
    {
    }
  }
}
