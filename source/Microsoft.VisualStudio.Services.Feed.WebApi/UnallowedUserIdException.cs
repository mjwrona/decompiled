...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.UnallowedUserIdException
...
{
  [Serializable]
  public class UnallowedUserIdException : VssServiceException
  {
    public UnallowedUserIdException(string message)
      : base(message)
    {
    }

    public static UnallowedUserIdException Create(string user) => new UnallowedUserIdException(Resources.Error_UnallowedUserIdMessage((object) user));
  }
}
