...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.ProvenanceSourceConstants
...
{
  public class ProvenanceSourceConstants
  {
    public const string None = "None";
    public const string InternalBuild = "InternalBuild";
    public const string InternalRelease = "InternalRelease";
