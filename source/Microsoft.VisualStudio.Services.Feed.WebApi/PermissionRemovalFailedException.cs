...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.PermissionRemovalFailedException
...
{
  [Serializable]
  public class PermissionRemovalFailedException : VssServiceException
  {
    public PermissionRemovalFailedException()
      : base(Resources.Error_FeedPermissionsRemovalFailedMessage())
    {
    }
  }
}
