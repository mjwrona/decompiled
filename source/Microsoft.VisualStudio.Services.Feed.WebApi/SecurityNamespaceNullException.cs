...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.SecurityNamespaceNullException
...
{
  [Serializable]
  public class SecurityNamespaceNullException : VssServiceException
  {
    public SecurityNamespaceNullException()
      : base(Resources.Error_NullSecurityNamespaceMessage())
    {
    }
  }
}
