...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.IncompatibleQueryParametersException
...
{
  [Serializable]
  public class IncompatibleQueryParametersException : VssServiceException
  {
    public IncompatibleQueryParametersException(string message)
      : base(message)
    {
    }
  }
