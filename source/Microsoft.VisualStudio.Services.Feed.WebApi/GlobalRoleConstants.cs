...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.GlobalRoleConstants
...
{
  public static class GlobalRoleConstants
  {
    public const FeedPermissionConstants None = FeedPermissionConstants.None;
    public const FeedPermissionConstants FeedCreator = FeedPermissionConstants.CreateFeed;
    public const FeedPermissionConstants Administrator = FeedPermissionConstants.AdministerFeed | FeedPermissionConstants.ArchiveFeed | FeedPermissionConstants.DeleteFeed | FeedPermissionConstants.CreateFeed | FeedPermissionConstants.EditFeed | FeedPermissionConstants.ReadPackages | FeedPermissionConstants.AddPackage | FeedPermissionConstants.UpdatePackage | FeedPermissionConstants.DeletePackage | FeedPermissionConstants.DelistPackage | FeedPermissionConstants.AddUpstreamPackage;
  }
}
