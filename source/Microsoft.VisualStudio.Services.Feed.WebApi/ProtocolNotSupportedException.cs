...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.ProtocolNotSupportedException
...
{
  [Serializable]
  public class ProtocolNotSupportedException : VssServiceException
  {
    ...
    public static ProtocolNotSupportedException Create(string protocol) => new ProtocolNotSupportedException(Resources.Error_ProtocolNotSupportedMessage((object) protocol));
  }
}
