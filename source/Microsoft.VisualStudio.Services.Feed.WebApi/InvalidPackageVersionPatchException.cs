...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.InvalidPackageVersionPatchException
...
{
  [Serializable]
  public class InvalidPackageVersionPatchException : VssServiceException
  {
    public InvalidPackageVersionPatchException()
      : base(Resources.Error_InvalidPackageVersionPatchMessage())
    {
    }
  }
}
