...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.ViewInvalidRoleException
...
{
  [Serializable]
  public class ViewInvalidRoleException : VssServiceException
  {
    public ViewInvalidRoleException()
      : base(Resources.Error_ViewPermissionsInvalidRoleMessage())
    {
    }
  }
}
