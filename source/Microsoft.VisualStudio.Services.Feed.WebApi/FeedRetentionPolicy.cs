...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.FeedRetentionPolicy
...
{
  [DataContract]
  public class FeedRetentionPolicy : FeedSecuredObject
  {
    [DataMember]
    ...
    public bool HasValue => this.CountLimit.HasValue;
  }
}
