...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.DatabaseStateIsNoLongerValidException
...
{
  [Serializable]
  public class DatabaseStateIsNoLongerValidException : VssServiceException
  {
    public DatabaseStateIsNoLongerValidException()
      : base(Resources.Error_KnownDBStateIsNoLongerValid())
    {
    }
  }
}
