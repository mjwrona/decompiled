...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.GenericDatabaseFailureException
...
{
  [Serializable]
  public class GenericDatabaseFailureException : VssServiceException
  {
    public GenericDatabaseFailureException()
      : base(Resources.Error_GenericDatabaseFailure())
    {
    }
  }
}
