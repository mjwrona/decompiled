...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.FeedIdNotFoundException
...
{
  [Serializable]
  public class FeedIdNotFoundException : VssServiceException
  {
    ...
    public static FeedIdNotFoundException Create(string feedId) => new FeedIdNotFoundException(Resources.Error_FeedIdNotFoundMessage((object) feedId));
  }
}
