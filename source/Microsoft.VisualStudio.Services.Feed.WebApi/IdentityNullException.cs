...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.IdentityNullException
...
{
  [Serializable]
  public class IdentityNullException : VssServiceException
  {
    public IdentityNullException()
      : base(Resources.Error_NullIdentityMessage())
    {
    }
  }
}
