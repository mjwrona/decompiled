...
// Type: Microsoft.VisualStudio.Services.Feed.WebApi.InvalidAliasException
...
{
  [Serializable]
  public class InvalidAliasException : VssServiceException
  {
    ...
    public static InvalidAliasException Create(string user) => new InvalidAliasException(Resources.Error_InvalidAliasMessage((object) user));
  }
}
