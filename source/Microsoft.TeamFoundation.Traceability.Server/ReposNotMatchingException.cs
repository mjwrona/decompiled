...
// Type: Microsoft.TeamFoundation.Traceability.Server.ReposNotMatchingException
...
{
  [Serializable]
  public sealed class ReposNotMatchingException : VssServiceException
  {
    public ReposNotMatchingException(string message)
      : base(message)
    {
    }

    public ReposNotMatchingException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    private ReposNotMatchingException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
