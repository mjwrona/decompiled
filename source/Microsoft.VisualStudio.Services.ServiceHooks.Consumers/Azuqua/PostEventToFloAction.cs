...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Consumers.Azuqua.PostEventToFloAction
...
namespace Microsoft.VisualStudio.Services.ServiceHooks.Consumers.Azuqua
{
  ...
  public class PostEventToFloAction : DataDrivenConsumerAction<AzuquaConsumer>
  {
    private const string c_id = "postEventToFlo";

    public PostEventToFloAction()
      : base("postEventToFlo")
    {
    }
