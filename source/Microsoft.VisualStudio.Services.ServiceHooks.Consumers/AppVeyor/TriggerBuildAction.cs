...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Consumers.AppVeyor.TriggerBuildAction
...
namespace Microsoft.VisualStudio.Services.ServiceHooks.Consumers.AppVeyor
{
  ...
  public class TriggerBuildAction : DataDrivenConsumerAction<AppVeyorConsumer>
  {
    private const string c_id = "triggerBuild";
