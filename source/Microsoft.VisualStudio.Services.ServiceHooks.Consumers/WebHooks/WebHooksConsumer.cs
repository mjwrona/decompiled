...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Consumers.WebHooks.WebHooksConsumer
...
namespace Microsoft.VisualStudio.Services.ServiceHooks.Consumers.WebHooks
{
  ...
  public class WebHooksConsumer : ConsumerImplementation
  {
    public const string ConsumerId = "webHooks";
    private const string c_infoUrl = "https://go.microsoft.com/fwlink/?LinkID=390531";

    public override string Id => "webHooks";

    public override string Name => WebHooksConsumerResources.ConsumerName;

    public override string Description => WebHooksConsumerResources.ConsumerDescription;
