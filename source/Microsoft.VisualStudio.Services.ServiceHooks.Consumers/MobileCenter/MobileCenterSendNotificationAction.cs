...
// Type: Microsoft.VisualStudio.Services.ServiceHooks.Consumers.MobileCenter.MobileCenterSendNotificationAction
...
namespace Microsoft.VisualStudio.Services.ServiceHooks.Consumers.MobileCenter
{
  ...
  public class MobileCenterSendNotificationAction : HttpRequestAction
  {
    ...
    public override string ConsumerId => MobileCenterConsumer.ConsumerId;

    public override string Name => MobileCenterConsumerResources.SendNotificationActionName;

    public override string Description => MobileCenterConsumerResources.SendNotificationActionDescription;

    public override IList<InputDescriptor> InputDescriptors => (IList<InputDescriptor>) new List<InputDescriptor>()
    {
      new InputDescriptor()
      {
        Name = MobileCenterConsumerResources.SendNotificationAction_InputUrlName,
        Description = MobileCenterConsumerResources.SendNotificationAction_InputUrlDescription,
    ...
    public override string[] SupportedEventTypes => MobileCenterSendNotificationAction.s_supportedEventTypes;

    public override IDictionary<string, string[]> SupportedResourceVersions => MobileCenterSendNotificationAction.s_supportedResourceVersions;
  }
}
