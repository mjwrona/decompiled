...
// Type: Microsoft.VisualStudio.Services.Search.Platforms.SearchEngine.Definitions.Entities.WorkItem.TurkishAnalyzers
...
{
  public class TurkishAnalyzers : WorkItemIndexAnalyzers
  {
    ...
    protected override WorkItemIndexAnalyzers.WorkItemIndexAnalysis GetAnalyzers()
    {
      ...
      analyzers.MinimallyStemmedFullTextAnalyzer = (IAnalyzer) customAnalyzer1;
