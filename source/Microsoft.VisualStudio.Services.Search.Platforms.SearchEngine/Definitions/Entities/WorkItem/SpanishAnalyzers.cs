...
// Type: Microsoft.VisualStudio.Services.Search.Platforms.SearchEngine.Definitions.Entities.WorkItem.SpanishAnalyzers
...
{
  public class SpanishAnalyzers : WorkItemIndexAnalyzers
  {
    protected override WorkItemIndexAnalyzers.WorkItemIndexAnalysis GetAnalyzers()
    {
      ...
      {
        StopWords = new StopWords("_spanish_")
      };
