...
// Type: Windows.CertEntroll.IX509ExtensionAuthorityKeyIdentifier
...
namespace Windows.CertEntroll
{
  ...
  public interface IX509ExtensionAuthorityKeyIdentifier : IX509Extension
  {
    ...
    void InitializeEncode([In] EncodingType Encoding, [MarshalAs(UnmanagedType.BStr), In] string strKeyIdentifier);
  }
}
