...
// Type: Microsoft.VisualStudio.Services.Configuration.InvalidBackupException
...
namespace Microsoft.VisualStudio.Services.Configuration
{
  ...
  public class InvalidBackupException : Exception
  {
    ...
    protected InvalidBackupException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
