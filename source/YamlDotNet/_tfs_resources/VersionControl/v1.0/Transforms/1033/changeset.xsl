<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <table>
      <tr>
        <td _locID="changeset">Changeset:</td>
        <td class="PropValue">
      ...
      <tr>
        <xsl:choose>
            <xsl:when test="@owner != @cmtr">
                <td _locID="checkedInOnBehalfOf">Checked in on behalf of:</td>
            </xsl:when>
            <xsl:when test="@owner = @cmtr">
                <td _locID="checkedInBy">Checked in by:</td>
            </xsl:when>
        </xsl:choose>
        <td class="PropValue">
      ...
      <tr>
        <td _locID="checkedInOn">Checked in on:</td>
        <td class="PropValue">
    ...
    <table class="WithBorder">
        <tr>
            ...
            <td class="ColHeading" _locID="changeType">Change Type</td>
        </tr>
