    ...
    <xsl:for-each select="planAndSuites">
      <div id="exported-data">
        ...
        <xsl:for-each select="testPlan">
          <div class="heading">
              Plan de pruebas <xsl:call-template name="url-generator">
                  <xsl:with-param name="label">
                      Plan de pruebas: <xsl:value-of select="@title"/> 
                  </xsl:with-param>
          ...
          <xsl:for-each select="configurations">
            ...
            <div class="sub-tab">
              CONFIGURACIONES DEL PLAN DE PRUEBAS
            </div>
            <table class="table-style">
              <tr>
                <th width="5%">Id.</th>
                <th width="45%">Nombre</th>
                <th width="50%">Variables de configuración</th>
              </tr>
            ...
            <xsl:for-each select="additionalConfiguration">
              <div class="sub-tab">
                CONFIGURACIONES ADICIONALES A LAS QUE HACEN REFERENCIA CONJUNTOS SECUNDARIOS
              </div>
              <table class="table-style">
                <tr>
                  <th width="5%">Id.</th>
        ...
        <xsl:for-each select="testSuites">
          <xsl:for-each select="testSuite">
            ...
            <div class="heading">
              Conjunto de pruebas <xsl:call-template name="url-generator">
                <xsl:with-param name="label">
                    Conjunto de pruebas: <xsl:value-of select="@title"/>
                </xsl:with-param>
              </xsl:call-template>: <xsl:value-of select="@title"/>
            </div>
            ...
            <xsl:for-each select="testCases">
              ...
              <div class="tab">
                Casos de prueba (<xsl:value-of select="@count"/>)
                <hr/>
              </div>

              <xsl:for-each select="testCase">
                <div class="test-case-heading heading">
                  Caso de prueba <xsl:call-template name="url-generator">
                    <xsl:with-param name="label">
                        Caso de prueba: <xsl:value-of select="@title"/>
                       </xsl:with-param>
                    </xsl:call-template>: <xsl:value-of select="@title"/>
                </div>
                ...
                <xsl:comment>Resumen</xsl:comment>
                ...
                <xsl:comment>Parámetros</xsl:comment>
                ...
                <xsl:for-each select="parameters">
                  ...
                  <xsl:for-each select="sharedParameterDataSet">
                    <div class="sub-tab">
                      Parámetro compartido <xsl:call-template name="url-generator">
                          <xsl:with-param name="label">
                            Parámetro compartido: <xsl:value-of select="@title"/>
                          </xsl:with-param>
                ...
                <xsl:comment>Resultado de la prueba más reciente</xsl:comment>
                <xsl:for-each select="latestTestOutcomes">
                  <div class="avoid-page-break">
                    <div class="sub-tab">
                      RESULTADO DE LA PRUEBA MÁS RECIENTE<br/>
                    </div>
                  </div>
