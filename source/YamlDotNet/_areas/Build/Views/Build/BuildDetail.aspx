...
<asp:Content ContentPlaceHolderID="DocumentBegin" runat="server">
    <%
        ...
        Html.UseScriptModules("Build/Scripts/Views.Details",
            "Build/Scenarios/BuildDetail/BuildView3");
        ...
        // Add a feature flag for diagnostic log capabilities. This includes queuing and showing the section on the build summary page.
        Html.IncludeFeatureFlagState(FeatureAvailabilityFlags.WebAccessBuildDiagnosticLogs);
