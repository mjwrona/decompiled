...
<asp:Content ID="Content1" ContentPlaceHolderID="DocumentBegin" runat="server">
    <% 
        ...
        Html.UseScriptModules("Agile/Scripts/TFS.Agile.IterationBoardWorkItemLimitExceeded.View");
...
<asp:Content ID="Content7" ContentPlaceHolderID="RightHubContent" runat="server">
    ...
    <div class="hub-no-content-gutter">
        <p><%: String.Format(System.Globalization.CultureInfo.CurrentCulture, AgileViewResources.TaskBoard_WorkItemLimt_Line1, Model.WorkItemCount, Model.WorkItemLimit) %></p>
        <p><%: AgileViewResources.TaskBoard_WorkItemLimt_Line2 %></p>
    </div>
    <ul>
        <li><a href="https://go.microsoft.com/fwlink/?LinkId=209524" target="_blank"><%: AgileViewResources.TaskBoard_WorkItemLimit_ReduceItems %></a></li>
        <li><a href="https://go.microsoft.com/fwlink/?LinkId=209522" target="_blank"><%: AgileViewResources.TaskBoard_WorkItemLimit_IncreaseMaximum %></a></li>
    </ul>
</asp:Content>
