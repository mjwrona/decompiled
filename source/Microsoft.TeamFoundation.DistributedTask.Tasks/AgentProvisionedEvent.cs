...
// Type: Microsoft.TeamFoundation.DistributedTask.Tasks.AgentProvisionedEvent
...
{
  public sealed class AgentProvisionedEvent : RunAgentEvent
  {
    public AgentProvisionedEvent()
    {
    }
    ...
    public AgentProvisionedEvent(
      ...
      int poolId,
      int agentId,
      AgentRequestProvisioningResult result)
      : base(agentCloudId, agentCloudRequestId, poolId, agentId)
    {
      this.ProvisioningResult = result;
    }

    public override string EventType => "AgentProvisioned";

    public AgentRequestProvisioningResult ProvisioningResult { get; set; }

    public override object GetEventData() => (object) this.ProvisioningResult;
  }
}
