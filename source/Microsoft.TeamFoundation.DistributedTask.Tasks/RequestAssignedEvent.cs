...
// Type: Microsoft.TeamFoundation.DistributedTask.Tasks.RequestAssignedEvent
...
{
  public sealed class RequestAssignedEvent : RunAgentEvent
  {
    public override string EventType => "RequestAssigned";
