...
// Type: Microsoft.TeamFoundation.DistributedTask.Tasks.PoolProviderResponse
...
{
  public class PoolProviderResponse
  {
    public ProvisionResponseType ResponseType { get; set; }
