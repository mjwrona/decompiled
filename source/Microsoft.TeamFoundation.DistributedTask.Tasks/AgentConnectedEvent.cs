...
// Type: Microsoft.TeamFoundation.DistributedTask.Tasks.AgentConnectedEvent
...
{
  public sealed class AgentConnectedEvent : RunAgentEvent
  {
    public override string EventType => "AgentConnected";

    public DateTime ConnectedOn { get; set; }

    public override object GetEventData() => (object) this.ConnectedOn;
  }
}
