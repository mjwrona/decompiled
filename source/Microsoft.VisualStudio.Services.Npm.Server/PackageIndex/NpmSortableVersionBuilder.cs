...
// Type: Microsoft.VisualStudio.Services.Npm.Server.PackageIndex.NpmSortableVersionBuilder
...
{
  public class NpmSortableVersionBuilder : SortableVersionBuilder
  {
    public NpmSortableVersionBuilder()
      : base(3)
    {
    }
