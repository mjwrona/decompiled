...
// Type: Microsoft.VisualStudio.Services.AzComm.WebApi.Enums.ValidationErrorReason
...
namespace Microsoft.VisualStudio.Services.AzComm.WebApi.Enums
{
  public enum ValidationErrorReason
  {
    ...
    InvalidUser,
    NotSubscriptionUser,
    UnsupportedSubscriptionCsp,
    TemporarySpendingLimit,
    AzureServiceError,
    Unknown,
  }
}
