...
// Type: Microsoft.VisualStudio.Services.AzComm.WebApi.Contracts.MeterResourceUpdateRequest
...
{
  [DataContract]
  public class MeterResourceUpdateRequest
  {
    ...
    public bool? IsTrialEnabled { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public double? AdditionalFreeQuantity { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public double? TrialQuantity { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public DateTime? TrialQuantityEndDateTime { get; set; }
  }
}
