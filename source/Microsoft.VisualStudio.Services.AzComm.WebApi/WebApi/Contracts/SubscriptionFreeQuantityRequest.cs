...
// Type: Microsoft.VisualStudio.Services.AzComm.WebApi.Contracts.SubscriptionFreeQuantityRequest
...
{
  [DataContract]
  public class SubscriptionFreeQuantityRequest
  {
    ...
    public Guid MeterId;
    [DataMember(EmitDefaultValue = false)]
    public double AdditionalFreeQuantity;
  }
}
