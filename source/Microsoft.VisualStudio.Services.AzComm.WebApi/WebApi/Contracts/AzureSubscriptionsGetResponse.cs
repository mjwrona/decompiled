...
// Type: Microsoft.VisualStudio.Services.AzComm.WebApi.Contracts.AzureSubscriptionsGetResponse
...
{
  [DataContract]
  public class AzureSubscriptionsGetResponse
  {
    [DataMember(EmitDefaultValue = false)]
    public IEnumerable<AzureSubscriptionInfoGetResponse> AzureSubscriptionResources { get; set; }
  }
}
