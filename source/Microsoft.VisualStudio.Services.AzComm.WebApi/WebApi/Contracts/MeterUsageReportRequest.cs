...
// Type: Microsoft.VisualStudio.Services.AzComm.WebApi.Contracts.MeterUsageReportRequest
...
{
  [DataContract]
  public class MeterUsageReportRequest
  {
    ...
    [DataMember(EmitDefaultValue = false)]
    public UsageReportOperation Kind { get; set; }
