...
// Type: Microsoft.VisualStudio.Services.AzComm.Rest.Contracts.BillingOperations
...
namespace Microsoft.VisualStudio.Services.AzComm.Rest.Contracts
{
  ...
  {
    [EnumMember] None = 0,
    [EnumMember] CanPurchase = 1,
    [EnumMember] CanChangeBilling = 2,
    [EnumMember] CanStartTrial = 4,
  }
}
