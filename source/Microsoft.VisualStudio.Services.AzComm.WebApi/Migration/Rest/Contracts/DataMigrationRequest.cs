...
// Type: Microsoft.VisualStudio.Services.AzComm.Migration.Rest.Contracts.DataMigrationRequest
...
namespace Microsoft.VisualStudio.Services.AzComm.Migration.Rest.Contracts
{
  ...
  public class DataMigrationRequest
  {
    ...
    [DataMember]
    public IEnumerable<SubscriptionResourceUsage> ResourceUsages { get; set; }

    [DataMember]
    public IEnumerable<AzureResourceAccount> AzureResourceAccounts { get; set; }

    [DataMember]
    public AzureSubscriptionInternal AzureSubscription { get; set; }
  }
}
