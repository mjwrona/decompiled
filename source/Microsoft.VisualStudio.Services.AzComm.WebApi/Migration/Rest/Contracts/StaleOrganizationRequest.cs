...
// Type: Microsoft.VisualStudio.Services.AzComm.Migration.Rest.Contracts.StaleOrganizationRequest
...
{
  [DataContract]
  public class StaleOrganizationRequest
  {
    [DataMember]
    public Guid OrganizationId { get; set; }

    [DataMember]
    public IEnumerable<int> CommerceMeterIds { get; set; }
  }
}
