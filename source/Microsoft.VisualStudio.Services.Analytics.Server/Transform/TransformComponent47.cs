...
// Type: Microsoft.VisualStudio.Services.Analytics.Transform.TransformComponent47
...
{
  internal class TransformComponent47 : TransformComponent30
  {
      ...
      IDictionary<string, string> transformSettings)
    {
      ...
      this.BindInt("@selectionOffset", selectionOffset);
