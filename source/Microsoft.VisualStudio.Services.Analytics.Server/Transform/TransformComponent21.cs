...
// Type: Microsoft.VisualStudio.Services.Analytics.Transform.TransformComponent21
...
{
  internal class TransformComponent21 : TransformComponent19
  {
    public override void InstallTransformDefinitions(IEnumerable<TransformDefinition> definitions = null)
    {
      ...
      SqlMetaData[] schema = new SqlMetaData[10]
      {
      ...
      this.BindTable("@definitions", "AnalyticsInternal.typ_TransformDefinition3", (IEnumerable<SqlDataRecord>) definitions.Select<TransformDefinition, SqlDataRecord>((Func<TransformDefinition, int, SqlDataRecord>) ((def, index) =>
      {
