...
// Type: Microsoft.VisualStudio.Services.Analytics.StageComponent57
...
{
  internal class StageComponent57 : StageComponent56
  {
      ...
      out bool terminate)
    {
      ...
      SqlParameter sqlParameter = this.BindBoolean("@terminate", false);
      ...
      terminate = !(sqlParameter.Value is DBNull) && (bool) sqlParameter.Value;
    }
  }
}
