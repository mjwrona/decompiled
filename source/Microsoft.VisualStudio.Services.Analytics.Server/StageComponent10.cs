...
// Type: Microsoft.VisualStudio.Services.Analytics.StageComponent10
...
{
  internal class StageComponent10 : StageComponent3
  {
    public override CleanupStreamResult CleanupOrphanedStreamData(string table, int commandTimeout)
    {
      ...
      string parameterValue3 = strArray1[0];
      string parameterValue4 = strArray1[1];
      ...
      if (parameterValue4 == null)
        throw new InvalidOperationException(AnalyticsResources.UNKNOWN_TABLE_NAME((object) parameterValue4));
      ...
      this.BindString("@dbTableSchemaName", parameterValue3, 64, BindStringBehavior.EmptyStringToNull, SqlDbType.VarChar);
      this.BindString("@dbTableName", parameterValue4, 64, BindStringBehavior.EmptyStringToNull, SqlDbType.VarChar);
