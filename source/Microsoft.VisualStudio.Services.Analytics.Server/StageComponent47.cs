...
// Type: Microsoft.VisualStudio.Services.Analytics.StageComponent47
...
{
  internal class StageComponent47 : StageComponent43
  {
    ...
    protected override void SetWatermark(
      ...
      int? contentVersion)
    {
      throw new InvalidOperationException("SetWatermark not supported outside data tier transactions");
    }
  }
}
