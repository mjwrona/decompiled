...
// Type: Microsoft.VisualStudio.Services.Analytics.Model.GitHubPullRequestSnapshot
...
{
  [DataContract]
  [DisplayNameAnnotation("ENTITY_SET_NAME_GITHUBPULLREQUESTSNAPSHOT")]
  [ODataHide(0, 3)]
  [Table("AnalyticsModel.vw_GitHubPullRequestSnapshot")]
  [ModelTableMapping("Model.GitHubPullRequest")]
  [DatabaseHide(0, 53)]
  public class GitHubPullRequestSnapshot : IPartitionScoped
  {
    [IgnoreDataMember]
