...
// Type: Microsoft.TeamFoundation.WorkItemTracking.ProcessDefinitions.WebApi.Models.PickListModel
...
{
  [DataContract]
  public class PickListModel : PickListMetadataModel
  {
    [DataMember]
    public IList<PickListItemModel> Items { get; set; }
  }
}
