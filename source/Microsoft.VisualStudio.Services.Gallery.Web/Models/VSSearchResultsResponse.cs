...
// Type: Microsoft.VisualStudio.Services.Gallery.Web.Models.VSSearchResultsResponse
...
{
  [DataContract]
  public class VSSearchResultsResponse
  {
    public VSSearchResult[] Items;
    public VSMetadataSelectorModel[] MetadataSelectorModels;
    public VSTagSelectorModel[] TagSelectorModels;
