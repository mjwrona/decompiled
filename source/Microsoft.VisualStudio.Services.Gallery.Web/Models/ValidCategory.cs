...
// Type: Microsoft.VisualStudio.Services.Gallery.Web.Models.ValidCategory
...
{
  internal class ValidCategory
  {
    [JsonProperty("cn")]
    public string CategoryName;
    [JsonProperty("pcn", NullValueHandling = NullValueHandling.Ignore)]
    public string ParentCategoryName;
    [JsonProperty("icn", NullValueHandling = NullValueHandling.Ignore)]
    public string InternalCategoryName;

    public ValidCategory(string categoryName) => this.CategoryName = categoryName;
  }
}
