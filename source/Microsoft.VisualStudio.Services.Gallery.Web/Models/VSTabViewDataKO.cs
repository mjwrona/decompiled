...
// Type: Microsoft.VisualStudio.Services.Gallery.Web.Models.VSTabViewDataKO
...
{
  public class VSTabViewDataKO
  {
    public VSTabViewDataKO(
      List<ExtensionPerCategory> extensionsPerCategory,
      VSCategoryKO[] categories)
    {
      this.ExtensionsPerCategory = extensionsPerCategory;
      this.Categories = categories;
    }

    [JsonProperty("epc")]
    public List<ExtensionPerCategory> ExtensionsPerCategory { get; private set; }

    [JsonProperty("c")]
    public VSCategoryKO[] Categories { get; private set; }
  }
}
