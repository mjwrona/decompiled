...
// Type: Microsoft.VisualStudio.Services.Gallery.Web.Models.VSMetadataSelectorModel
...
{
  [DataContract]
  public class VSMetadataSelectorModel
  {
    public string FilterType;
    public string HeaderText;
    public VSMetadataItem[] MetadataItems;
