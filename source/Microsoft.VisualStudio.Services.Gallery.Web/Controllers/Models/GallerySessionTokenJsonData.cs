...
// Type: Microsoft.VisualStudio.Services.Gallery.Web.Controllers.Models.GallerySessionTokenJsonData
...
{
  public class GallerySessionTokenJsonData
  {
    public GallerySessionToken passthroughToken { get; set; }

    public GallerySessionToken authenticatedToken { get; set; }
  }
}
