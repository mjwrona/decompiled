...
// Type: Microsoft.VisualStudio.Services.Gallery.Web.IProductExtensionsDataProvider
...
{
  public interface IProductExtensionsDataProvider
  {
    object GetProductExtensions(IVssRequestContext requestContext, string product);
  }
}
