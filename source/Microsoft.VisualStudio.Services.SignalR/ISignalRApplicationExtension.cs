...
// Type: Microsoft.VisualStudio.Services.SignalR.ISignalRApplicationExtension
...
{
  [InheritedExport]
  public interface ISignalRApplicationExtension
  {
    void Start(IVssRequestContext requestContext);
  }
}
