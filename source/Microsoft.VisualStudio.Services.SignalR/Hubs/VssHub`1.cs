...
// Type: Microsoft.VisualStudio.Services.SignalR.Hubs.VssHub`1
...
{
  public abstract class VssHub<T> : Hub<T>, IVssHub, IHub, IUntrackedDisposable, IDisposable where T : class
  {
    ...
    IHubCallerConnectionContext<object> IHub.get_Clients() => ((Hub) this).Clients;
