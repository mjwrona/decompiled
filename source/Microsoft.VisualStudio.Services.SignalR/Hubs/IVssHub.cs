...
// Type: Microsoft.VisualStudio.Services.SignalR.Hubs.IVssHub
...
{
  public interface IVssHub : IHub, IUntrackedDisposable, IDisposable
  {
    bool RequiresHostContext { get; }

    IVssRequestContext VssRequestContext { get; set; }
  }
}
