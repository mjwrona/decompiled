...
// Type: Microsoft.TeamFoundation.Server.InvalidDomainException
...
{
  [Serializable]
  public class InvalidDomainException : GroupSecuritySubsystemServiceException
  {
    ...
    public InvalidDomainException(string domain)
      : this(domain, (Exception) null)
    {
    }

    public InvalidDomainException(string domain, Exception innerException)
      : base(ServerResources.GSS_INVALID_DOMAIN((object) domain), innerException)
    {
    }
