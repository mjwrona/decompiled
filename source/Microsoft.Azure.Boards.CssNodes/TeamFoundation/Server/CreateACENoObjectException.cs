...
// Type: Microsoft.TeamFoundation.Server.CreateACENoObjectException
...
{
  [Serializable]
  public class CreateACENoObjectException : AuthorizationSubsystemServiceException
  {
    public CreateACENoObjectException(string objectId)
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.GSS_CREATEACENOOBJECTERROR((object) objectId))
    {
    }

    public CreateACENoObjectException(
