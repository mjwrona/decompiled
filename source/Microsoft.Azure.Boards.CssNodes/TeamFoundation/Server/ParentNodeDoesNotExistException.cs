...
// Type: Microsoft.TeamFoundation.Server.ParentNodeDoesNotExistException
...
{
  [Serializable]
  public class ParentNodeDoesNotExistException : ParentNodeUriDoesNotExistException
  {
    public ParentNodeDoesNotExistException(string objectId)
      : this(objectId, (Exception) null)
    {
    }

    public ParentNodeDoesNotExistException()
    {
    }
    ...
    public ParentNodeDoesNotExistException(string objectId, Exception innerException)
