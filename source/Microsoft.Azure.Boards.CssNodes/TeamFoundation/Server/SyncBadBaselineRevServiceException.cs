...
// Type: Microsoft.TeamFoundation.Server.SyncBadBaselineRevServiceException
...
{
  [Serializable]
  public class SyncBadBaselineRevServiceException : SyncSubsystemServiceException
  {
    public SyncBadBaselineRevServiceException()
      : this(Microsoft.Azure.Boards.CssNodes.ServerResources.SYNC_BAD_BASELINE_REV(), (Exception) null)
    {
    }

    public SyncBadBaselineRevServiceException(string message, Exception innerException)
