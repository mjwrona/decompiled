...
// Type: Microsoft.TeamFoundation.Server.CreateACENoActionException
...
{
  [Serializable]
  public class CreateACENoActionException : AuthorizationSubsystemServiceException
  {
    public CreateACENoActionException()
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.GSS_CREATEACENOACTIONERROR())
    {
    }
