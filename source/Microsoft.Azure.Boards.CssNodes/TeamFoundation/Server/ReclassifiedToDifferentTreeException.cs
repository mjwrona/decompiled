...
// Type: Microsoft.TeamFoundation.Server.ReclassifiedToDifferentTreeException
...
{
  [Serializable]
  public class ReclassifiedToDifferentTreeException : InvalidReclassificationException
  {
    public ReclassifiedToDifferentTreeException(string objectId, string reclassifyId)
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.CSS_RECLASSIFICATION_TO_DIFFERENT_TREE((object) CommonStructureUtils.GetNodeUri(objectId), (object) CommonStructureUtils.GetNodeUri(reclassifyId)))
    {
    }
