...
// Type: Microsoft.TeamFoundation.Server.ClassIdDoesNotExistException
...
{
  [Serializable]
  public class ClassIdDoesNotExistException : GroupSecuritySubsystemServiceException
  {
    public ClassIdDoesNotExistException(string classId)
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.GSS_CLASSIDDOESNOTEXISTERROR((object) classId))
    {
    }
