...
// Type: Microsoft.TeamFoundation.Server.ActiveDirectoryAccessException
...
{
  [Serializable]
  public class ActiveDirectoryAccessException : GroupSecuritySubsystemServiceException
  {
    ...
    public ActiveDirectoryAccessException(string message, Exception innerException)
