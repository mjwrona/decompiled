...
// Type: Microsoft.TeamFoundation.Server.InternalStoredProcedureException
...
namespace Microsoft.TeamFoundation.Server
{
  ...
  {
    public InternalStoredProcedureException()
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.GSS_INTERNALSTOREDPROCDUREERROR())
    {
    }
