...
// Type: Microsoft.TeamFoundation.Server.SecurityObjectDoesNotExistException
...
{
  [Serializable]
  public class SecurityObjectDoesNotExistException : GroupSecuritySubsystemServiceException
  {
    public SecurityObjectDoesNotExistException(string objectId)
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.GSS_SECURITYOBJECTDOESNOTEXISTERROR((object) objectId))
    {
    }
