...
// Type: Microsoft.TeamFoundation.Server.MaximumDepthExceededException
...
{
  [Serializable]
  public class MaximumDepthExceededException : CommonStructureSubsystemServiceException
  {
    public MaximumDepthExceededException()
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.CSS_MAX_DEPTH_EXCEEDED())
    {
    }
