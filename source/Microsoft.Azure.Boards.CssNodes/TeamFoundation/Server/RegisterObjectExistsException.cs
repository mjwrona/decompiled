...
// Type: Microsoft.TeamFoundation.Server.RegisterObjectExistsException
...
{
  [Serializable]
  public class RegisterObjectExistsException : AuthorizationSubsystemServiceException
  {
    public RegisterObjectExistsException(string objectId)
      : base(Microsoft.Azure.Boards.CssNodes.ServerResources.GSS_REGISTEROBJECTEXISTSERROR((object) objectId))
    {
    }
