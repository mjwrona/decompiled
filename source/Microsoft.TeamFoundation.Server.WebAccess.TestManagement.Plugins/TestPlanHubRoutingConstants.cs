...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TestManagement.Plugins.TestPlanHubRoutingConstants
...
{
  public class TestPlanHubRoutingConstants
  {
    public const string AllPivot = "all";
    public const string MinePivot = "mine";
    public const string HubName = "Test Plans";
  }
}
