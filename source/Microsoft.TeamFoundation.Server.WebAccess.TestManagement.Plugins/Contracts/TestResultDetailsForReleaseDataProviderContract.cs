...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TestManagement.Plugins.Contracts.TestResultDetailsForReleaseDataProviderContract
...
{
  [DataContract]
  internal class TestResultDetailsForReleaseDataProviderContract : ISecuredObject
  {
    private Guid projectId;

    public TestResultDetailsForReleaseDataProviderContract(Guid projectId) => this.projectId = projectId;
