...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TestManagement.Plugins.Contracts.UserOptions
...
namespace Microsoft.TeamFoundation.Server.WebAccess.TestManagement.Plugins.Contracts
{
  ...
  {
    public string MyPlansFilterState { get; set; }

    public string AllPlansFilterState { get; set; }

    public string SelectedPivot { get; set; }
  }
}
