...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TestManagement.Plugins.Contracts.TestPlanViewDataProviderContract
...
{
  public abstract class TestPlanViewDataProviderContract
  {
    public virtual List<Team> Teams { get; }
