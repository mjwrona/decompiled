...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TestManagement.Plugins.Contracts.CodeCoverageAllTabDataProviderContract
...
{
  [DataContract]
  public class CodeCoverageAllTabDataProviderContract
  {
    [DataMember(EmitDefaultValue = false)]
    public DirectoryCoverageSummary DirectoryCoverageSummary { get; set; }
  }
}
