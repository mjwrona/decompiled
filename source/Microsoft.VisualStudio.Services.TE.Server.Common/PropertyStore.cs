...
// Type: Microsoft.TeamFoundation.TestExecution.Server.PropertyStore
...
namespace Microsoft.TeamFoundation.TestExecution.Server
{
  ...
  {
    public static void RegisterInternalArtifactKind(
    ...
    {
      ArtifactSpec artifcactSpec = PropertyStore.GetArtifcactSpec(artifactKind, artifactId);
      PropertyStore.AddOrUpdate(context, artifcactSpec, properties);
    }
      ...
      IDictionary<string, object> properties)
    {
      ...
      PropertyStore.AddOrUpdate(context, artifactSpec, properties);
    }
    ...
    {
      ArtifactSpec artifcactSpec = PropertyStore.GetArtifcactSpec(artifactKind, artifactId);
      return PropertyStore.Get(context, artifcactSpec, propertyNameFilters);
    }
    ...
    {
      ArtifactSpec artifactSpec = new ArtifactSpec(artifactKind, artifactId, 0);
      return PropertyStore.Get(context, artifactSpec, propertyNameFilters);
    }

    private static IDictionary<string, object> Get(
      TestExecutionRequestContext context,
