...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.ServiceEntry
...
namespace Microsoft.VisualStudio.Services.NuGet.WebApi
{
  ...
  public class ServiceEntry : PackagingSecuredObject
  {
    [DataMember(Name = "@id")]
    ...
    public ServiceEntry(string id, string type)
    {
      this.Id = id;
      this.Type = type;
    }
