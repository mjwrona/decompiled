...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.QueryResultPackageVersion
...
{
  [DataContract]
  public class QueryResultPackageVersion : PackagingSecuredObject
  {
    [DataMember(Name = "@id")]
    ...
    [Obsolete("No longer populated by the server.")]
    [JsonIgnore]
