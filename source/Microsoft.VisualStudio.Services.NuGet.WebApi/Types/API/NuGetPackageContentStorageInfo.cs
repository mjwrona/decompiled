...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Types.API.NuGetPackageContentStorageInfo
...
{
  [DataContract]
  public abstract class NuGetPackageContentStorageInfo
  {
    protected NuGetPackageContentStorageInfo(PackageContentStorageType storageType) => this.StorageType = storageType;

    [DataMember]
    public PackageContentStorageType StorageType { get; }
  }
}
