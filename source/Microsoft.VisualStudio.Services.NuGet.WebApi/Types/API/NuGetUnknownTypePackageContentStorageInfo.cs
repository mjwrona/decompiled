...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Types.API.NuGetUnknownTypePackageContentStorageInfo
...
{
  public class NuGetUnknownTypePackageContentStorageInfo : NuGetPackageContentStorageInfo
  {
    public NuGetUnknownTypePackageContentStorageInfo(string storageType, JObject json)
      : base(PackageContentStorageType.Unknown)
    {
      this.ActualStorageType = storageType;
      this.Json = json;
    }
