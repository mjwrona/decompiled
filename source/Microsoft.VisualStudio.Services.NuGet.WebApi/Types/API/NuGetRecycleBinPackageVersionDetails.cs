...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Types.API.NuGetRecycleBinPackageVersionDetails
...
{
  [DataContract]
  public class NuGetRecycleBinPackageVersionDetails : IRecycleBinPackageVersionDetails
  {
    [DataMember]
