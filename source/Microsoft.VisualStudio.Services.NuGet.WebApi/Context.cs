...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Context
...
{
  [DataContract]
  public class Context : PackagingSecuredObject
  {
    [DataMember(Name = "@vocab")]
    public Uri Vocab { get; set; } = JsonLdUris.NuGetServicesVocab;

    [DataMember(Name = "comment")]
    public Uri Comment { get; set; } = JsonLdUris.RdfSchemaCommentType;

    [DataMember(Name = "label")]
    public Uri Label { get; set; } = JsonLdUris.RdfSchemaLabelType;
  }
}
