...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.CatalogPageModel
...
{
  [DataContract]
  public class CatalogPageModel : CatalogModelBase
  {
    [DataMember]
    public List<PackageDetailsLinkModel> Items { get; set; }
  }
}
