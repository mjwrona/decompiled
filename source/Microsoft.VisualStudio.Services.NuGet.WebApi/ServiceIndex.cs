...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.ServiceIndex
...
{
  [DataContract]
  public class ServiceIndex : PackagingSecuredObject
  {
    [DataMember(Name = "@context")]
    public Context Context { get; set; } = new Context();

    [DataMember]
    public IEnumerable<ServiceEntry> Resources { get; set; }
    ...
    public override void SetSecuredObject(ISecuredObject securedObject)
    {
      ...
      IEnumerable<ServiceEntry> resources = this.Resources;
      this.Resources = resources != null ? resources.ToSecuredObject<ServiceEntry>(securedObject) : (IEnumerable<ServiceEntry>) null;
    }
  }
}
