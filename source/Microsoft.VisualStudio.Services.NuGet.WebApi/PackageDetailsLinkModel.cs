...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.PackageDetailsLinkModel
...
{
  [DataContract]
  public class PackageDetailsLinkModel : CatalogModelBase
  {
    [DataMember(Name = "nuget:id")]
    public string NugetId { get; set; }

    [DataMember(Name = "nuget:version")]
