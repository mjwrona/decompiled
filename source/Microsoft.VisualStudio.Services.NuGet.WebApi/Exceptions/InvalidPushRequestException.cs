...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.InvalidPushRequestException
...
{
  public class InvalidPushRequestException : VssServiceException
  {
    ...
    public InvalidPushRequestException(string message, Exception innerException)
