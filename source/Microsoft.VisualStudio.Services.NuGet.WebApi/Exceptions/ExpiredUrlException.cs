...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.ExpiredUrlException
...
{
  public class ExpiredUrlException : VssServiceException
  {
    ...
    public ExpiredUrlException(string message, Exception innerException)
