...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.NuGetApiKeyRequiredException
...
{
  public class NuGetApiKeyRequiredException : VssServiceException
  {
    public NuGetApiKeyRequiredException(string message)
      : base(message)
    {
    }

    public NuGetApiKeyRequiredException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected NuGetApiKeyRequiredException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
