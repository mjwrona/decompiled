...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.ArgumentFormatException
...
{
  public class ArgumentFormatException : VssServiceException
  {
    ...
    protected ArgumentFormatException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
