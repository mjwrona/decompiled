...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.UnsupportedODataFilterException
...
{
  public class UnsupportedODataFilterException : Exception
  {
    public UnsupportedODataFilterException(string message)
      : base(message)
    {
    }
  }
