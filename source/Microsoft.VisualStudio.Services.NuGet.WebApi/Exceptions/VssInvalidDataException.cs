...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.VssInvalidDataException
...
{
  public class VssInvalidDataException : VssServiceException
  {
    public VssInvalidDataException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    public VssInvalidDataException(string message)
      : base(message)
    {
    }
  }
