...
// Type: Microsoft.VisualStudio.Services.NuGet.WebApi.Exceptions.TooLargePackagePushException
...
{
  public class TooLargePackagePushException : VssServiceException
  {
    public TooLargePackagePushException(string message)
      : base(message)
    {
    }

    public TooLargePackagePushException(string message, Exception innerException)
