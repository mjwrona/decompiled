...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.Metadata.WorkItemTrackingMetadataComponent50
...
{
  internal class WorkItemTrackingMetadataComponent50 : WorkItemTrackingMetadataComponent49
  {
      ...
      bool excludeIdentities = false)
    {
      ...
      this.BindInt("@projectId", projectId.GetValueOrDefault());
