...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.ProcessValidator.PickListDefinition
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Server.ProcessValidator
{
  public class PickListDefinition
  {
    ...
    public PickListDefinition(string fieldReferenceName, ISet<string> allowedValues)
    {
