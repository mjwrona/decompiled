...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.Mentions.WorkItemHtmlFieldSourceContext
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Server.Mentions
{
  internal class WorkItemHtmlFieldSourceContext : IMentionSourceContext
  {
    public WorkItemHtmlFieldSourceContext(
      int workItemId,
      Guid projectGuid,
      string displayText,
    ...
    public string Identifier => this.NormalizedId + "|" + this.FieldRefName;
    ...
    public string FieldRefName { get; }
  }
}
