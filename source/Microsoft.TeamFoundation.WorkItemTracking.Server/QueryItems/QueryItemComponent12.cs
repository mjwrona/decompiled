...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.QueryItems.QueryItemComponent12
...
{
  internal class QueryItemComponent12 : QueryItemComponent11
  {
      ...
      Guid? filterUnderProjectId = null)
    {
      ...
      if (filterUnderProjectId.HasValue)
        this.BindInt("@dataspaceId", this.GetDataspaceId(filterUnderProjectId.Value));
    ...
    public override void UpdateQueryHash(IList<QueryHash> queryHashInfo)
    {
      ...
      new QueryItemComponent.QueryHashTable("@queryHashInfo", (IEnumerable<QueryHash>) queryHashInfo).BindTable((QueryItemComponent11) this);
