...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.History.HistoryComponent10
...
{
  internal class HistoryComponent10 : HistoryComponent9
  {
      ...
      bool includeDiscussionHistory = false)
    {
      ...
      this.BindBoolean("@useLegacyDiscussionChanges", useLegacyDiscussionChanges);
    }
