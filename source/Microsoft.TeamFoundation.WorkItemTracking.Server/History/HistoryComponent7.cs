...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.History.HistoryComponent7
...
{
  internal class HistoryComponent7 : HistoryComponent6
  {
      ...
      bool includeDiscussionHistory = false)
    {
      ...
      this.BindBoolean("@latestOnly", includeLatestOnly);
    }
