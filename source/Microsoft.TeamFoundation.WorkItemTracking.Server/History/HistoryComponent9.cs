...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.History.HistoryComponent9
...
{
  internal class HistoryComponent9 : HistoryComponent8
  {
      ...
      bool includeDiscussionHistory = false)
    {
      ...
      this.BindBoolean("@includeDiscussionChangesOnly", includeDiscussionChangesOnly);
    }
