...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.History.HistoryComponent6
...
{
  internal class HistoryComponent6 : HistoryComponent5
  {
    internal virtual void PrepareGetChangedWorkItemsPageable(
      ...
      bool includeDiscussionHistory = false)
    {
      ...
      this.PrepareStoredProcedure("prc_GetChangedWorkItemsPageable");
      this.BindNullableInt("@dataspaceId", dataspaceId, 0);
      this.BindInt("@watermark", workItemIdRevPair.Watermark);
      this.BindInt("@id", workItemIdRevPair.Id);
      this.BindInt("@revision", workItemIdRevPair.Revision);
