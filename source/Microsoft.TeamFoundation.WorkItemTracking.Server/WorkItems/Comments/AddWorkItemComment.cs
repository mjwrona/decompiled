...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.WorkItems.Comments.AddWorkItemComment
...
namespace Microsoft.TeamFoundation.WorkItemTracking.Server.WorkItems.Comments
{
  ...
  {
    public AddWorkItemComment(int workItemId, string text, CommentFormat format = CommentFormat.Html)
    {
