...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.WorkItems.WorkItemComponent53
...
{
  internal class WorkItemComponent53 : WorkItemComponent51
  {
    public override List<WorkItemDependencyGraph> LoadDependencyGraphForWorkItems(int[] workItemIds)
    {
      this.PrepareStoredProcedure("prc_LoadDependencyGraphBatchWithRootId");
