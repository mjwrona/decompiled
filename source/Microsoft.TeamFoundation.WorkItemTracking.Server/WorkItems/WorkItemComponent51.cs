...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.WorkItems.WorkItemComponent51
...
{
  internal class WorkItemComponent51 : WorkItemComponent46
  {
    public override List<WorkItemDependencyGraph> LoadDependencyGraphForWorkItems(int[] workItemIds)
    {
      this.PrepareStoredProcedure("prc_LoadDependencyGraphBatch");
