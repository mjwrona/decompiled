...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.DataAccess.WorkItemTypeExtensionComponent10
...
{
  internal class WorkItemTypeExtensionComponent10 : WorkItemTypeExtensionComponent9
  {
    protected override SqlParameter BindCustomFieldTable(
      string parameterName,
      IEnumerable<CustomFieldEntry> fieldEntries)
    {
      return this.BindBasicTvp<CustomFieldEntry>((WorkItemTrackingResourceComponent.TvpRecordBinder<CustomFieldEntry>) new WorkItemTypeExtensionComponent10.CustomFieldTableRecordBinder4(), parameterName, fieldEntries);
    }

    protected class CustomFieldTableRecordBinder4 : 
      WorkItemTypeExtensionComponent8.CustomFieldTableRecordBinder3
    {
