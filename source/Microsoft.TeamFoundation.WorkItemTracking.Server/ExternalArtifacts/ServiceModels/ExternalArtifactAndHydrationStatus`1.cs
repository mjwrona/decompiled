...
// Type: Microsoft.TeamFoundation.WorkItemTracking.Server.ExternalArtifacts.ServiceModels.ExternalArtifactAndHydrationStatus`1
...
{
  public class ExternalArtifactAndHydrationStatus<T> where T : IExternalArtifact
  {
    public T ExternalArtifact { get; set; }
