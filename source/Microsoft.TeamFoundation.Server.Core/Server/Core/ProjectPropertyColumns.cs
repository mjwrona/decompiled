...
// Type: Microsoft.TeamFoundation.Server.Core.ProjectPropertyColumns
...
{
  internal class ProjectPropertyColumns : ObjectBinder<ProjectProperty>
  {
    private SqlColumnBinder nameColumn = new SqlColumnBinder("name");
    private SqlColumnBinder valueColumn = new SqlColumnBinder("value");

    protected override ProjectProperty Bind() => new ProjectProperty()
    {
