...
// Type: Microsoft.Azure.Documents.Linq.ConstantFolding
...
namespace Microsoft.Azure.Documents.Linq
{
  internal static class ConstantFolding
  {
    ...
    public static Expression FoldMethodCall(MethodCallExpression inputExpression)
    {
      ...
      return inputExpression.Method.IsStatic && CustomTypeExtensions.IsAssignableFrom(inputExpression.Method.DeclaringType, typeof (Queryable)) && inputExpression.Method.Name.Equals("Take") ? expr : ExpressionSimplifier.EvaluateToExpression(expr);
    }
