...
// Type: Microsoft.Azure.Documents.Client.StoredProcedureResponse`1
...
namespace Microsoft.Azure.Documents.Client
{
  public class StoredProcedureResponse<TValue> : IStoredProcedureResponse<TValue>
  {
      ...
      JsonSerializerSettings serializerSettings = null)
    {
      ...
      if (CustomTypeExtensions.IsSubclassOf(typeof (TValue), typeof (JsonSerializable)))
      {
        if ((object) typeof (TValue) == (object) typeof (Document) || CustomTypeExtensions.IsAssignableFrom(typeof (Document), typeof (TValue)))
        {
        ...
        {
          if ((object) typeof (TValue) != (object) typeof (Attachment) && !CustomTypeExtensions.IsAssignableFrom(typeof (Attachment), typeof (TValue)))
