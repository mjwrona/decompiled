...
// Type: Microsoft.Azure.Documents.Sql.SqlPropertyName
...
namespace Microsoft.Azure.Documents.Sql
{
  internal sealed class SqlPropertyName : SqlObject
  {
    ...
    {
      this.Value = !string.IsNullOrWhiteSpace(value) ? value : throw new ArgumentException("value must not be null, empty, or whitespace.");
    }
