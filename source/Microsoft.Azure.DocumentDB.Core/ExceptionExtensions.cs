...
namespace Microsoft.Azure.Documents
{
  internal static class ExceptionExtensions
  {
    ...
    {
      IEnumerable<string> values = ((IEnumerable<PropertyInfo>) CustomTypeExtensions.GetProperties(((object) exception).GetType())).Select(property => new
      {
        Name = property.Name,
      ...
      return ((object) exception).GetType().ToString() + " : " + string.Join(",", values);
    }
