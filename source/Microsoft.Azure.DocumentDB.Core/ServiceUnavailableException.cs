...
namespace Microsoft.Azure.Documents
{
  ...
  internal sealed class ServiceUnavailableException : DocumentClientException
  {
    ...
    public ServiceUnavailableException(
      ...
      Uri requestUri = null)
      : base(message, (Exception) null, headers, new HttpStatusCode?(HttpStatusCode.ServiceUnavailable), requestUri)
    {
      this.SetDescription();
    }
    ...
    public ServiceUnavailableException(
      ...
      Uri requestUri = null)
      : base(message, innerException, headers, new HttpStatusCode?(HttpStatusCode.ServiceUnavailable), requestUri)
    {
      this.SetDescription();
    }
