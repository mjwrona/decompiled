...
// Type: Microsoft.TeamFoundation.TestManagement.Server.TestManagementDatabase7
...
{
  [CLSCompliant(false)]
  public class TestManagementDatabase7 : TestManagementDatabase6
  {
    internal TestManagementDatabase7(string connectionString, int partitionId)
      : base(connectionString, partitionId)
    {
    }

    public TestManagementDatabase7()
    {
    }
      ...
      bool skipRunStateTransitionCheck = false)
    {
      ...
      UpdatedRunProperties updatedRunProperties = reader.Read() ? new TestManagementDatabase7.UpdatedPropertyColumns().bindUpdatedRunProperties(reader, out completeDate) : throw new UnexpectedDatabaseResultException("prc_UpdateTestRun");
      updatedRunProperties.LastUpdatedBy = updatedBy;
      if (updatedRunProperties.IsRunCompleted)
        run.CompleteDate = completeDate;
    ...
    private new class UpdatedPropertyColumns
    {
      ...
      internal UpdatedRunProperties bindUpdatedRunProperties(
        SqlDataReader reader,
        out DateTime completeDate)
      {
        ...
        completeDate = this.CompleteDate.GetDateTime((IDataReader) reader);
        return updatedRunProperties;
      }
    }
  }
