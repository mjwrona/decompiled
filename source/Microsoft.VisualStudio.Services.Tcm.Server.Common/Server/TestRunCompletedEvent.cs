...
// Type: Microsoft.TeamFoundation.TestManagement.Server.TestRunCompletedEvent
...
namespace Microsoft.TeamFoundation.TestManagement.Server
{
  ...
  public class TestRunCompletedEvent
  {
    ...
    private string passedTestsField;
    private string unanalyzedTestsField;
    private string linkedWorkItemCount;
    ...
    {
      get => this.passedTestsField;
      set => this.passedTestsField = value;
    }

    public string UnanalyzedTests
    {
      get => this.unanalyzedTestsField;
      set => this.unanalyzedTestsField = value;
    }

    public string LinkedWorkItemCount
    {
      get => this.linkedWorkItemCount;
      set => this.linkedWorkItemCount = value;
    }
