...
// Type: Microsoft.TeamFoundation.TestManagement.Server.Hub.IBuildCodeCoverageHubDispatcher
...
{
  [CLSCompliant(false)]
  [DefaultServiceImplementation(typeof (CodeCoverageHubDispatcher))]
  public interface IBuildCodeCoverageHubDispatcher : IVssFrameworkService
  {
    ...
    void SendCoverageStatsChanged(IVssRequestContext requestContext, int buildId);

    void HandleCoverageStatsChange(
