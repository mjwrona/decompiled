...
// Type: Microsoft.VisualStudio.Services.Symbol.WebApi.RequestListInvalidQueryParameterValuesException
...
{
  public class RequestListInvalidQueryParameterValuesException : VssServiceException
  {
    public RequestListInvalidQueryParameterValuesException(string message)
      : base(message)
    {
    }
  }
