...
// Type: Microsoft.TeamFoundation.Comments.Server.ICommentSecuredObjectContainer
...
{
  internal interface ICommentSecuredObjectContainer
  {
    ISecuredObject SecuredObject { get; set; }
  }
}
