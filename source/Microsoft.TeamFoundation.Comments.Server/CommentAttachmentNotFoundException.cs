...
// Type: Microsoft.TeamFoundation.Comments.Server.CommentAttachmentNotFoundException
...
{
  public class CommentAttachmentNotFoundException : VssServiceException
  {
    public CommentAttachmentNotFoundException(Guid attachmentId)
      : base(string.Format(Resources.CommentAttachmentNotFoundMessage, (object) attachmentId))
    {
    }
  }
}
