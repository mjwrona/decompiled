...
// Type: Microsoft.TeamFoundation.Comments.Server.CommentUpdateException
...
{
  public class CommentUpdateException : VssServiceException
  {
    public CommentUpdateException(int commentId)
      : base(string.Format(Resources.CommentUpdateException, (object) commentId))
    {
    }
  }
}
