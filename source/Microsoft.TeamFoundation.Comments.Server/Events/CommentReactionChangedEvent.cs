...
// Type: Microsoft.TeamFoundation.Comments.Server.Events.CommentReactionChangedEvent
...
namespace Microsoft.TeamFoundation.Comments.Server.Events
{
  ...
  {
    public bool IsReactionAdded { get; set; }
    ...
    public IdentityRef ReactionModifiedBy { get; set; }
