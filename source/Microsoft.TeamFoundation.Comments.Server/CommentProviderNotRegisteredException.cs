...
// Type: Microsoft.TeamFoundation.Comments.Server.CommentProviderNotRegisteredException
...
{
  public class CommentProviderNotRegisteredException : VssServiceException
  {
    public CommentProviderNotRegisteredException(Guid artifactKind)
      : base(string.Format(Resources.CommentProviderNotRegisteredMessage, (object) artifactKind))
    {
    }
  }
}
