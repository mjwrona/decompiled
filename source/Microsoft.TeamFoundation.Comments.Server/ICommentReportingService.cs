...
// Type: Microsoft.TeamFoundation.Comments.Server.ICommentReportingService
...
{
  [DefaultServiceImplementation(typeof (CommentReportingService))]
  public interface ICommentReportingService : IVssFrameworkService
  {
    IList<CommentVersion> GetCommentsVersions(
