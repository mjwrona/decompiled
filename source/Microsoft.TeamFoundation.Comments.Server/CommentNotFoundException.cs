...
// Type: Microsoft.TeamFoundation.Comments.Server.CommentNotFoundException
...
{
  public class CommentNotFoundException : VssServiceException
  {
    public CommentNotFoundException(int commentId)
      : base(string.Format(Resources.CommentNotFoundMessage, (object) commentId))
    {
    }
  }
}
