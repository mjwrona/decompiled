...
// Type: Microsoft.VisualStudio.Services.Search.Shared.WebApi.Contracts.Repository
...
{
  [DataContract]
  public class Repository : SearchSecuredV2Object
  {
    ...
    public VersionControlType Type { get; set; }
  }
}
