...
// Type: Microsoft.VisualStudio.Services.Search.Shared.WebApi.Contracts.Package.PackageHit
...
{
  [DataContract]
  public class PackageHit : SearchSecuredV2Object
  {
    ...
    public PackageHit(string fieldReferenceName, IEnumerable<string> highLights)
    {
