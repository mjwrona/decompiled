...
// Type: Microsoft.VisualStudio.Services.Search.Shared.WebApi.Contracts.Setting.SettingSearchResponse
...
{
  [DataContract]
  public class SettingSearchResponse : EntitySearchResponse
  {
    [DataMember(Name = "count")]
    public int Count { get; set; }

    [DataMember(Name = "results")]
    public IEnumerable<SettingResult> Results { get; set; }
    ...
    public override string ToString()
    {
      ...
      IEnumerable<SettingResult> results = this.Results;
      IEnumerable<\u003C\u003Ef__AnonymousType2<string, string, string, Dictionary<string, string>, string, string>> datas = results != null ? results.Select(v => new
      {
        title = v.Title,
        description = v.Description,
        routeId = v.RouteId,
        routeParameterMapping = v.RouteParameterMapping,
