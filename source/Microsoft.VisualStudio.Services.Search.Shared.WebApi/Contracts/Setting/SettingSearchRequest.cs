...
// Type: Microsoft.VisualStudio.Services.Search.Shared.WebApi.Contracts.Setting.SettingSearchRequest
...
{
  [DataContract]
  public class SettingSearchRequest : EntitySearchRequest
  {
    ...
    public override bool IsSupportedFilter(string filterName) => SettingSearchRequest.s_validFilters.Contains(filterName);
    ...
    public override void ValidateQuery()
    {
      ...
      {
        if (!SettingSearchRequest.s_sortSupportedFields.Contains(sortOption.Field))
