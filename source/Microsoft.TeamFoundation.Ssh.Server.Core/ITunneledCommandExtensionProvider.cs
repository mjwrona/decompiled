...
// Type: Microsoft.TeamFoundation.Ssh.Server.Core.ITunneledCommandExtensionProvider
...
{
  public interface ITunneledCommandExtensionProvider
  {
    void Initialize(IVssRequestContext requestContext);

    ITunneledCommandExtension GetCommandExtension(IVssRequestContext requestContext, string command);
  }
}
