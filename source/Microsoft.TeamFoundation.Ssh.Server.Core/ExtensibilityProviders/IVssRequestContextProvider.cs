...
// Type: Microsoft.TeamFoundation.Ssh.Server.Core.ExtensibilityProviders.IVssRequestContextProvider
...
{
  public interface IVssRequestContextProvider
  {
    IVssRequestContext CreateSystemDeploymentContext();

    IVssRequestContext CreateSshDeploymentContext(
