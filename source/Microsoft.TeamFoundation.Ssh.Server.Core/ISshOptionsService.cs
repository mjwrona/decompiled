...
// Type: Microsoft.TeamFoundation.Ssh.Server.Core.ISshOptionsService
...
{
  [DefaultServiceImplementation(typeof (SshOptionsService))]
  public interface ISshOptionsService : IVssFrameworkService
  {
    SshOptions Options { get; }
  }
}
