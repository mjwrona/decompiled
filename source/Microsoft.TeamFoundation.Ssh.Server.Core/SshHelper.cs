...
// Type: Microsoft.TeamFoundation.Ssh.Server.Core.SshHelper
...
namespace Microsoft.TeamFoundation.Ssh.Server.Core
{
  ...
  {
    public static string GetDevFabricSshServiceName(string deploymentName, string roleInstanceId) => "TeamFoundationSshService-Hosted-" + deploymentName + "-" + roleInstanceId;
  }
}
