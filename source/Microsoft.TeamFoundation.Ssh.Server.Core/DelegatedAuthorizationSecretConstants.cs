...
// Type: Microsoft.TeamFoundation.Ssh.Server.Core.DelegatedAuthorizationSecretConstants
...
{
  public static class DelegatedAuthorizationSecretConstants
  {
    public const string SecretsDrawerName = "DelegatedAuthorizationSecrets";
    public const string FrameworkAccessTokenKeySecret = "FrameworkAccessTokenKeySecret";
  }
}
