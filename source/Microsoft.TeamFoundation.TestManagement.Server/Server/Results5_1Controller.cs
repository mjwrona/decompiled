...
// Type: Microsoft.TeamFoundation.TestManagement.Server.Results5_1Controller
...
namespace Microsoft.TeamFoundation.TestManagement.Server
{
  ...
  [VersionedApiControllerCustomName(Area = "Test", ResourceName = "Results", ResourceVersion = 6)]
  public class Results5_1Controller : TestResultsControllerBase
  {
      ...
      [ClientParameterAsIEnumerable(typeof (TestOutcome), ',')] string outcomes = "")
    {
      ...
      if (!this.TestManagementRequestContext.RequestContext.IsFeatureEnabled("TestManagement.Server.EnableDirectTCMS2SCallFromTFS"))
        return (IList<Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult>) this.ResultsHelper.GetTestResults(this.ProjectId.ToString(), runId, includeIterationDetails, includeAssociatedWorkItems, includePoint, (IList<TestOutcome>) this.GetListOfOutcome(outcomes), skip, validatedTop, detailsToInclude);
      ...
      if ((detailsToInclude & ResultDetails.Point) == ResultDetails.Point)
        this.TestManagementRequestContext.PlannedTestResultsHelper.PopulateTestSuiteDetails(testCaseResults, this.ProjectName);
      testCaseResults.ForEach((Action<Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult>) (r => this.ResultsHelper.SecureTestResultWebApiObject(r)));
      return (IList<Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult>) testCaseResults;
    }
    ...
    {
      return !this.TestManagementRequestContext.RequestContext.IsFeatureEnabled("TestManagement.Server.EnableDirectTCMS2SCallFromTFS") ? this.ResultsHelper.AddTestResultsToTestRun(this.ProjectId.ToString(), runId, results) : TestManagementController.InvokeAction<List<Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult>>((Func<List<Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult>>) (() => this.TestResultsHttpClient.AddTestResultsToTestRunAsync(results, this.ProjectId, runId, (object) null, new CancellationToken())?.Result));
    }
      ...
      Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult[] results)
    {
      ...
      return this.TestResultsHttpClient.UpdateTestResultsAsync(results, this.ProjectId, runId, (object) null, new CancellationToken())?.Result;
    }
