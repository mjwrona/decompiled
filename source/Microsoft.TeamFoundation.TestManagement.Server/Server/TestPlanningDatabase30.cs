...
// Type: Microsoft.TeamFoundation.TestManagement.Server.TestPlanningDatabase30
...
{
  public class TestPlanningDatabase30 : TestPlanningDatabase29
  {
    internal TestPlanningDatabase30(string connectionString, int partitionId)
      : base(connectionString, partitionId)
    {
    }

    public TestPlanningDatabase30()
    {
    }
      ...
      Guid updatedBy)
    {
      ...
      this.BindString("@automatedTestName", result.AutomatedTestName, 512, false, SqlDbType.NVarChar);
      this.BindString("@automatedTestStorage", result.AutomatedTestStorage, 512, false, SqlDbType.NVarChar);
