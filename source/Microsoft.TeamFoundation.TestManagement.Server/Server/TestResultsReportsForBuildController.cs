...
// Type: Microsoft.TeamFoundation.TestManagement.Server.TestResultsReportsForBuildController
...
namespace Microsoft.TeamFoundation.TestManagement.Server
{
  ...
  [VersionedApiControllerCustomName(Area = "Test", ResourceName = "ResultSummaryByBuild", ResourceVersion = 1)]
  [DemandFeature("D104EA57-16EA-4191-9B60-160D664EE9A8", true)]
  public class TestResultsReportsForBuildController : TestResultsControllerBase
  {
      ...
      [FromUri(Name = "buildToCompare")] BuildReference buildToCompare = null)
    {
      ...
      if (!this.TestManagementRequestContext.RequestContext.IsFeatureEnabled("TestManagement.Server.EnableDirectTCMS2SCallFromTFS"))
      {
        ...
        summary = testReportsHelper.QueryTestReportForBuild(projectId, build, sourceWorkflow, buildToCompare1, true, num != 0);
      }
      else
      {
        summary = TestManagementController.InvokeAction<TestResultSummary>((Func<TestResultSummary>) (() => this.TestResultsHttpClient.QueryTestResultsReportForBuildAsync(this.ProjectId.ToString(), buildId, publishContext, new bool?(includeFailureDetails), buildToCompare)?.Result));
