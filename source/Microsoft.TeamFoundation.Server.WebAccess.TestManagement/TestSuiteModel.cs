...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TestManagement.TestSuiteModel
...
{
  [DataContract]
  internal class TestSuiteModel
  {
    public TestSuiteModel()
    {
    }

    public TestSuiteModel(ServerTestSuite suite)
    {
      this.Id = suite.Id;
      ...
      this.Configurations = suite.DefaultConfigurations;
    }
    ...
    public List<int> Configurations { get; set; }
  }
}
