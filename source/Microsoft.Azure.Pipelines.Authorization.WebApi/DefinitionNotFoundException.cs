...
// Type: Microsoft.Azure.Pipelines.Authorization.WebApi.DefinitionNotFoundException
...
{
  [Serializable]
  public sealed class DefinitionNotFoundException : VssServiceException
  {
    ...
    private DefinitionNotFoundException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
