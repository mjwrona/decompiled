...
// Type: Microsoft.Azure.Pipelines.Authorization.WebApi.InvalidResourceType
...
{
  [Serializable]
  public sealed class InvalidResourceType : VssServiceException
  {
    ...
    public InvalidResourceType(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    private InvalidResourceType(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
