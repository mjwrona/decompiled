...
// Type: Nest.PercentilesAggregationFormatter
...
namespace Nest
{
  internal class PercentilesAggregationFormatter : 
    IJsonFormatter<IPercentilesAggregation>,
    IJsonFormatter
  {
    ...
    public IPercentilesAggregation Deserialize(
      ...
      IJsonFormatterResolver formatterResolver)
    {
      if (reader.GetCurrentJsonToken() != JsonToken.BeginObject)
      {
        ...
        return (IPercentilesAggregation) null;
      }
      int count = 0;
      ...
      while (reader.ReadIsInObject(ref count))
      {
        ...
        int num;
        if (PercentilesAggregationFormatter.AutomataDictionary.TryGetValue(bytes, out num))
        {
          switch (num)
          {
            case 0:
              percentilesAggregation.Method = (IPercentilesMethod) formatterResolver.GetFormatter<HDRHistogramMethod>().Deserialize(ref reader, formatterResolver);
              continue;
            case 1:
              percentilesAggregation.Method = (IPercentilesMethod) formatterResolver.GetFormatter<TDigestMethod>().Deserialize(ref reader, formatterResolver);
              continue;
            case 2:
              percentilesAggregation.Field = (Field) reader.ReadString();
              continue;
            case 3:
              percentilesAggregation.Script = formatterResolver.GetFormatter<IScript>().Deserialize(ref reader, formatterResolver);
              continue;
            case 4:
              percentilesAggregation.Missing = new double?(reader.ReadDouble());
              continue;
            case 5:
              percentilesAggregation.Percents = formatterResolver.GetFormatter<IEnumerable<double>>().Deserialize(ref reader, formatterResolver);
              continue;
            case 6:
              percentilesAggregation.Meta = formatterResolver.GetFormatter<IDictionary<string, object>>().Deserialize(ref reader, formatterResolver);
              continue;
            case 7:
              percentilesAggregation.Keyed = new bool?(reader.ReadBoolean());
              continue;
            case 8:
              percentilesAggregation.Format = reader.ReadString();
              continue;
            default:
              continue;
          }
      ...
      return (IPercentilesAggregation) percentilesAggregation;
    }

    public void Serialize(
      ref JsonWriter writer,
      IPercentilesAggregation value,
      IJsonFormatterResolver formatterResolver)
    {
      if (value == null)
      {
      ...
      else
      {
        ...
        if (value.Percents != null)
        {
          ...
          formatterResolver.GetFormatter<IEnumerable<double>>().Serialize(ref writer, value.Percents, formatterResolver);
          flag = true;
        }
