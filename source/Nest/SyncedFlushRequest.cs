...
namespace Nest
{
  public class SyncedFlushRequest : 
    PlainRequestBase<SyncedFlushRequestParameters>,
    ISyncedFlushRequest,
    IRequest<SyncedFlushRequestParameters>,
    IRequest
  {
    protected ISyncedFlushRequest Self => (ISyncedFlushRequest) this;
    ...
    public SyncedFlushRequest(Indices index)
