...
// Type: Nest.SignificantTermsAggregation
...
namespace Nest
{
    ...
    IAggregation
  {
    ...
    internal override void WrapInContainer(AggregationContainer c) => c.SignificantTerms = (ISignificantTermsAggregation) this;
  }
}
