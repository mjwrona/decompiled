...
// Type: Nest.DeleteEnrichPolicyDescriptor
...
namespace Nest
{
  public class DeleteEnrichPolicyDescriptor : 
    RequestDescriptorBase<DeleteEnrichPolicyDescriptor, DeleteEnrichPolicyRequestParameters, IDeleteEnrichPolicyRequest>,
    ...
    IRequest
  {
    ...
    public DeleteEnrichPolicyDescriptor(Name name)
      : base((Func<RouteValues, RouteValues>) (r => r.Required(nameof (name), (IUrlParameter) name)))
    {
    }

    [SerializationConstructor]
    protected DeleteEnrichPolicyDescriptor()
    {
    }
