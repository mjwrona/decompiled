...
namespace Nest
{
  public class CatTemplatesRequest : 
    ...
    IRequest
  {
    protected ICatTemplatesRequest Self => (ICatTemplatesRequest) this;
    ...
    [IgnoreDataMember]
    Name ICatTemplatesRequest.Name => this.Self.RouteValues.Get<Name>("name");
