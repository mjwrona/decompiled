...
namespace Nest
{
  public class GetScriptDescriptor : 
    ...
    IRequest
  {
    ...
    public GetScriptDescriptor MasterTimeout(Time mastertimeout) => this.Qs("master_timeout", (object) mastertimeout);
  }
}
