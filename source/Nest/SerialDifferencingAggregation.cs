...
// Type: Nest.SerialDifferencingAggregation
...
namespace Nest
{
    ...
    IAggregation
  {
    ...
    internal override void WrapInContainer(AggregationContainer c) => c.SerialDifferencing = (ISerialDifferencingAggregation) this;
  }
}
