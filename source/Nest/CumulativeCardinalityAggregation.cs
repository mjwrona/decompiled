...
// Type: Nest.CumulativeCardinalityAggregation
...
namespace Nest
{
    ...
    IAggregation
  {
    ...
    internal override void WrapInContainer(AggregationContainer c) => c.CumulativeCardinality = (ICumulativeCardinalityAggregation) this;
  }
}
