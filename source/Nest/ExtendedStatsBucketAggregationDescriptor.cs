...
// Type: Nest.ExtendedStatsBucketAggregationDescriptor
...
namespace Nest
{
    ...
    IAggregation
  {
    ...
    public ExtendedStatsBucketAggregationDescriptor Sigma(double? sigma) => this.Assign<double?>(sigma, (Action<IExtendedStatsBucketAggregation, double?>) ((a, v) => a.Sigma = v));
  }
}
