...
// Type: Nest.BulkCreateOperation`1
...
{
  [DataContract]
  public class BulkCreateOperation<T> : BulkOperationBase, IBulkCreateOperation<T>, IBulkOperation where T : class
  {
    public BulkCreateOperation(T document) => this.Document = document;
