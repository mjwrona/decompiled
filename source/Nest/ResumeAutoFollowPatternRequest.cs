...
// Type: Nest.ResumeAutoFollowPatternRequest
...
namespace Nest
{
  public class ResumeAutoFollowPatternRequest : 
    PlainRequestBase<ResumeAutoFollowPatternRequestParameters>,
    IResumeAutoFollowPatternRequest,
    IRequest<ResumeAutoFollowPatternRequestParameters>,
    IRequest
  {
    protected IResumeAutoFollowPatternRequest Self => (IResumeAutoFollowPatternRequest) this;

    internal override ApiUrls ApiUrls => ApiUrlsLookups.CrossClusterReplicationResumeAutoFollowPattern;

    public ResumeAutoFollowPatternRequest(Name name)
      : base((Func<RouteValues, RouteValues>) (r => r.Required(nameof (name), (IUrlParameter) name)))
    {
    }

    [SerializationConstructor]
    protected ResumeAutoFollowPatternRequest()
    {
    }
