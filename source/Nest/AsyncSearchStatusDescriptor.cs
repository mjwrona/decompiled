...
// Type: Nest.AsyncSearchStatusDescriptor
...
namespace Nest
{
  public class AsyncSearchStatusDescriptor : 
    RequestDescriptorBase<AsyncSearchStatusDescriptor, AsyncSearchStatusRequestParameters, IAsyncSearchStatusRequest>,
    ...
    IRequest
  {
    ...
    public AsyncSearchStatusDescriptor(Id id)
      : base((Func<RouteValues, RouteValues>) (r => r.Required(nameof (id), (IUrlParameter) id)))
    {
    }

    [SerializationConstructor]
    protected AsyncSearchStatusDescriptor()
    {
    }
