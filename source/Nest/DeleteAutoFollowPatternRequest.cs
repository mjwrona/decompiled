...
// Type: Nest.DeleteAutoFollowPatternRequest
...
namespace Nest
{
  public class DeleteAutoFollowPatternRequest : 
    PlainRequestBase<DeleteAutoFollowPatternRequestParameters>,
    IDeleteAutoFollowPatternRequest,
    IRequest<DeleteAutoFollowPatternRequestParameters>,
    IRequest
  {
    protected IDeleteAutoFollowPatternRequest Self => (IDeleteAutoFollowPatternRequest) this;

    internal override ApiUrls ApiUrls => ApiUrlsLookups.CrossClusterReplicationDeleteAutoFollowPattern;

    public DeleteAutoFollowPatternRequest(Name name)
      : base((Func<RouteValues, RouteValues>) (r => r.Required(nameof (name), (IUrlParameter) name)))
    {
    }

    [SerializationConstructor]
    protected DeleteAutoFollowPatternRequest()
    {
    }
