...
// Type: Nest.GetEnrichPolicyRequest
...
namespace Nest
{
  public class GetEnrichPolicyRequest : 
    PlainRequestBase<GetEnrichPolicyRequestParameters>,
    IGetEnrichPolicyRequest,
    IRequest<GetEnrichPolicyRequestParameters>,
    IRequest
  {
    protected IGetEnrichPolicyRequest Self => (IGetEnrichPolicyRequest) this;

    internal override ApiUrls ApiUrls => ApiUrlsLookups.EnrichGetPolicy;

    public GetEnrichPolicyRequest(Names name)
      : base((Func<RouteValues, RouteValues>) (r => r.Optional(nameof (name), (IUrlParameter) name)))
    {
    }

    public GetEnrichPolicyRequest()
    {
    }
