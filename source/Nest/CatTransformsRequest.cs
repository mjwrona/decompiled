...
// Type: Nest.CatTransformsRequest
...
namespace Nest
{
  public class CatTransformsRequest : 
    PlainRequestBase<CatTransformsRequestParameters>,
    ICatTransformsRequest,
    IRequest<CatTransformsRequestParameters>,
    IRequest
  {
    protected ICatTransformsRequest Self => (ICatTransformsRequest) this;

    internal override ApiUrls ApiUrls => ApiUrlsLookups.CatTransforms;

    public CatTransformsRequest()
    {
    }

    public CatTransformsRequest(Id transformId)
