...
// Type: Nest.EstimateModelMemoryRequest
...
namespace Nest
{
  public class EstimateModelMemoryRequest : 
    PlainRequestBase<EstimateModelMemoryRequestParameters>,
    IEstimateModelMemoryRequest,
    IRequest<EstimateModelMemoryRequestParameters>,
    IRequest
  {
    protected IEstimateModelMemoryRequest Self => (IEstimateModelMemoryRequest) this;
