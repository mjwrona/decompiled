...
// Type: Nest.ScriptDescriptorBase`2
...
namespace Nest
{
  public abstract class ScriptDescriptorBase<TDescriptor, TInterface> : 
    ...
    where TInterface : class, IScript
  {
    ...
    {
      return this.Assign<Func<FluentDictionary<string, object>, FluentDictionary<string, object>>>(paramsDictionary, (Action<TInterface, Func<FluentDictionary<string, object>, FluentDictionary<string, object>>>) ((a, v) => a.Params = v != null ? (Dictionary<string, object>) v(new FluentDictionary<string, object>()) : (Dictionary<string, object>) null));
    }

    public TDescriptor Lang(string lang) => this.Assign<string>(lang, (Action<TInterface, string>) ((a, v) => a.Lang = v));

    public TDescriptor Lang(ScriptLang lang) => this.Assign<string>(lang.GetStringValue(), (Action<TInterface, string>) ((a, v) => a.Lang = v));
  }
}
