...
// Type: Nest.ReadOnlyUrlRepository
...
namespace Nest
{
  public class ReadOnlyUrlRepository : 
    ...
    ISnapshotRepository
  {
    public ReadOnlyUrlRepository(ReadOnlyUrlRepositorySettings settings) => this.Settings = (IReadOnlyUrlRepositorySettings) settings;
