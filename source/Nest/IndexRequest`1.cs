...
namespace Nest
{
    ...
    where TDocument : class
  {
    ...
    internal static HttpMethod GetHttpMethod(IIndexRequest<TDocument> request) => request.Id?.StringOrLongValue == null && !request.RouteValues.ContainsId ? HttpMethod.POST : HttpMethod.PUT;

    protected IIndexRequest<TDocument> Self => (IIndexRequest<TDocument>) this;
    ...
    [IgnoreDataMember]
    Id IIndexRequest<TDocument>.Id => this.Self.RouteValues.Get<Id>("id");
    ...
    public Elasticsearch.Net.OpType? OpType
    {
      get => this.Q<Elasticsearch.Net.OpType?>("op_type");
      set => this.Q("op_type", (object) value);
    }
