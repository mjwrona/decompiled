...
// Type: Nest.SqlSearchStatusDescriptor
...
namespace Nest
{
  public class SqlSearchStatusDescriptor : 
    RequestDescriptorBase<SqlSearchStatusDescriptor, SqlSearchStatusRequestParameters, ISqlSearchStatusRequest>,
