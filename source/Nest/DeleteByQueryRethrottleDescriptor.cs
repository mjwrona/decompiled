...
// Type: Nest.DeleteByQueryRethrottleDescriptor
...
namespace Nest
{
  public class DeleteByQueryRethrottleDescriptor : 
    ...
    IRequest
  {
    ...
    public DeleteByQueryRethrottleDescriptor RequestsPerSecond(long? requestspersecond) => this.Qs("requests_per_second", (object) requestspersecond);
  }
}
