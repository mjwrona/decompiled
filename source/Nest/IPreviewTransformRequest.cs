...
// Type: Nest.IPreviewTransformRequest
...
namespace Nest
{
  ...
  public interface IPreviewTransformRequest : IRequest<PreviewTransformRequestParameters>, IRequest
  {
    [IgnoreDataMember]
    Id TransformId { get; }
