...
// Type: Nest.DeleteCalendarDescriptor
...
namespace Nest
{
  public class DeleteCalendarDescriptor : 
    RequestDescriptorBase<DeleteCalendarDescriptor, DeleteCalendarRequestParameters, IDeleteCalendarRequest>,
