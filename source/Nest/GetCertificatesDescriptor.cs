...
// Type: Nest.GetCertificatesDescriptor
...
namespace Nest
{
  public class GetCertificatesDescriptor : 
    RequestDescriptorBase<GetCertificatesDescriptor, GetCertificatesRequestParameters, IGetCertificatesRequest>,
