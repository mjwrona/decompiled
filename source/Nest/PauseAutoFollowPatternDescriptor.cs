...
// Type: Nest.PauseAutoFollowPatternDescriptor
...
namespace Nest
{
  public class PauseAutoFollowPatternDescriptor : 
    RequestDescriptorBase<PauseAutoFollowPatternDescriptor, PauseAutoFollowPatternRequestParameters, IPauseAutoFollowPatternRequest>,
    ...
    IRequest
  {
    ...
    public PauseAutoFollowPatternDescriptor(Name name)
      : base((Func<RouteValues, RouteValues>) (r => r.Required(nameof (name), (IUrlParameter) name)))
    {
    }

    [SerializationConstructor]
    protected PauseAutoFollowPatternDescriptor()
    {
    }
