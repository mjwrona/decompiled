...
// Type: Nest.UpdateByQueryRethrottleDescriptor
...
namespace Nest
{
  public class UpdateByQueryRethrottleDescriptor : 
    RequestDescriptorBase<UpdateByQueryRethrottleDescriptor, UpdateByQueryRethrottleRequestParameters, IUpdateByQueryRethrottleRequest>,
    ...
    IRequest
  {
    ...
    public UpdateByQueryRethrottleDescriptor RequestsPerSecond(long? requestspersecond) => this.Qs("requests_per_second", (object) requestspersecond);
  }
}
