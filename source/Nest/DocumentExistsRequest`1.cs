...
// Type: Nest.DocumentExistsRequest`1
...
namespace Nest
{
  public class DocumentExistsRequest<TDocument> : 
  ...
  {
    protected IDocumentExistsRequest<TDocument> TypedSelf => (IDocumentExistsRequest<TDocument>) this;
