...
namespace Nest
{
  public class SqlDeleteRequest : 
    PlainRequestBase<SqlDeleteRequestParameters>,
    ISqlDeleteRequest,
    IRequest<SqlDeleteRequestParameters>,
    IRequest
  {
    protected ISqlDeleteRequest Self => (ISqlDeleteRequest) this;

    internal override ApiUrls ApiUrls => ApiUrlsLookups.SqlDelete;

    public SqlDeleteRequest(Id id)
      : base((Func<RouteValues, RouteValues>) (r => r.Required(nameof (id), (IUrlParameter) id)))
    {
    }

    [SerializationConstructor]
    protected SqlDeleteRequest()
    {
    }
