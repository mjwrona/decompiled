...
// Type: Nest.RankFeatureSaturationFunctionDescriptor
...
namespace Nest
{
    ...
    IRankFeatureFunction
  {
    ...
    public RankFeatureSaturationFunctionDescriptor Pivot(float? pivot) => this.Assign<float?>(pivot, (Action<IRankFeatureSaturationFunction, float?>) ((a, v) => a.Pivot = v));
  }
}
