...
namespace Nest
{
  public class CatFielddataRequest : 
    ...
    IRequest
  {
    protected ICatFielddataRequest Self => (ICatFielddataRequest) this;
    ...
    [IgnoreDataMember]
    Fields ICatFielddataRequest.Fields => this.Self.RouteValues.Get<Fields>("fields");
