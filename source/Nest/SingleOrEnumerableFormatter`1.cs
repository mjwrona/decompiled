...
// Type: Nest.SingleOrEnumerableFormatter`1
...
namespace Nest
{
  internal class SingleOrEnumerableFormatter<T> : IJsonFormatter<IEnumerable<T>>, IJsonFormatter
  {
      ...
      IJsonFormatterResolver formatterResolver)
    {
      if (value == null)
        ...
        formatterResolver.GetFormatter<IEnumerable<T>>().Serialize(ref writer, value, formatterResolver);
    }
  }
}
