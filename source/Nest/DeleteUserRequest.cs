...
namespace Nest
{
  public class DeleteUserRequest : 
    PlainRequestBase<DeleteUserRequestParameters>,
    IDeleteUserRequest,
    IRequest<DeleteUserRequestParameters>,
    IRequest
  {
    protected IDeleteUserRequest Self => (IDeleteUserRequest) this;

    internal override ApiUrls ApiUrls => ApiUrlsLookups.SecurityDeleteUser;

    public DeleteUserRequest(Name username)
