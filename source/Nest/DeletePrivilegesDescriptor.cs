...
// Type: Nest.DeletePrivilegesDescriptor
...
namespace Nest
{
  public class DeletePrivilegesDescriptor : 
    RequestDescriptorBase<DeletePrivilegesDescriptor, DeletePrivilegesRequestParameters, IDeletePrivilegesRequest>,
    ...
    IRequest
  {
    ...
    public DeletePrivilegesDescriptor(Name application, Name name)
    ...
    protected DeletePrivilegesDescriptor()
    {
    }
    ...
    public DeletePrivilegesDescriptor Refresh(Elasticsearch.Net.Refresh? refresh) => this.Qs(nameof (refresh), (object) refresh);
  }
}
