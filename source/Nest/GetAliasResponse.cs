...
namespace Nest
{
  ...
  {
    [IgnoreDataMember]
    public IReadOnlyDictionary<IndexName, IndexAliases> Indices => this.Self.BackingDictionary;

    public override bool IsValid => base.IsValid || this.Indices.Count > 0;
  }
}
