...
// Type: Nest.ClosePointInTimeRequest
...
namespace Nest
{
  public class ClosePointInTimeRequest : 
    PlainRequestBase<ClosePointInTimeRequestParameters>,
    IClosePointInTimeRequest,
    IRequest<ClosePointInTimeRequestParameters>,
    IRequest
  {
    protected IClosePointInTimeRequest Self => (IClosePointInTimeRequest) this;
