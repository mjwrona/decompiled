...
// Type: Nest.PostVotingConfigExclusionsResponseBuilder
...
namespace Nest
{
  internal class PostVotingConfigExclusionsResponseBuilder : CustomResponseBuilderBase
  {
    public override object DeserializeResponse(
      ...
      Stream stream)
    {
      return (object) new PostVotingConfigExclusionsResponse();
    }
    ...
    {
      return Task.FromResult<object>((object) new PostVotingConfigExclusionsResponse());
    }
  }
}
