...
// Type: Nest.CreateDataStreamDescriptor
...
namespace Nest
{
  public class CreateDataStreamDescriptor : 
    RequestDescriptorBase<CreateDataStreamDescriptor, CreateDataStreamRequestParameters, ICreateDataStreamRequest>,
