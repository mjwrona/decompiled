...
// Type: Nest.ValidateDetectorRequest
...
namespace Nest
{
  public class ValidateDetectorRequest : 
    PlainRequestBase<ValidateDetectorRequestParameters>,
    IValidateDetectorRequest,
    IRequest<ValidateDetectorRequestParameters>,
    IRequest
  {
    protected IValidateDetectorRequest Self => (IValidateDetectorRequest) this;
