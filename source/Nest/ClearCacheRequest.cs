...
namespace Nest
{
  public class ClearCacheRequest : 
    ...
    IRequest
  {
    protected IClearCacheRequest Self => (IClearCacheRequest) this;
    ...
    {
      get => this.Q<bool?>("fielddata");
      set => this.Q("fielddata", (object) value);
    }
    ...
    public bool? Query
    {
      get => this.Q<bool?>("query");
      set => this.Q("query", (object) value);
    }

    public bool? Request
    {
      get => this.Q<bool?>("request");
      set => this.Q("request", (object) value);
    }
  }
}
