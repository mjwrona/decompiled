...
// Type: Nest.SourceExistsRequest`1
...
namespace Nest
{
  public class SourceExistsRequest<TDocument> : 
    SourceExistsRequest,
  ...
  {
    protected ISourceExistsRequest<TDocument> TypedSelf => (ISourceExistsRequest<TDocument>) this;
