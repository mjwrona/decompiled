...
// Type: Microsoft.TeamFoundation.Work.WebApi.CapacityContractBase
...
{
  public abstract class CapacityContractBase : TeamSettingsDataContractBase
  {
    [DataMember]
    public IEnumerable<Activity> Activities { get; set; }

    [DataMember]
    public IEnumerable<DateRange> DaysOff { get; set; }
  }
}
