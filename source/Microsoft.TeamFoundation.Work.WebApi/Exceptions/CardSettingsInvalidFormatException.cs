...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.CardSettingsInvalidFormatException
...
{
  [Serializable]
  public class CardSettingsInvalidFormatException : VssServiceException
  {
    public CardSettingsInvalidFormatException()
      : base(AgileResources.CardSettingsInvalidFormatException)
    {
    }

    public CardSettingsInvalidFormatException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
