...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.ScaledAgileInvalidPermissionException
...
{
  [Serializable]
  public class ScaledAgileInvalidPermissionException : VssServiceException
  {
    public ScaledAgileInvalidPermissionException(string message)
      : base(message)
    {
    }

    public ScaledAgileInvalidPermissionException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
