...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.ScaledAgileViewDefinitionInvalidException
...
{
  [Serializable]
  public class ScaledAgileViewDefinitionInvalidException : VssServiceException
  {
    public ScaledAgileViewDefinitionInvalidException()
    {
    }
    ...
    public ScaledAgileViewDefinitionInvalidException(string message)
      : base(message)
    {
    }
  }
