...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.DuplicateTeamFieldValuesException
...
{
  [Serializable]
  public class DuplicateTeamFieldValuesException : ArgumentException
  {
    public DuplicateTeamFieldValuesException(string duplicateValues, string paramName)
      : base(string.Format(AgileResources.TeamFieldValuesContainsDuplicate, (object) duplicateValues), paramName)
    {
    }
  }
}
