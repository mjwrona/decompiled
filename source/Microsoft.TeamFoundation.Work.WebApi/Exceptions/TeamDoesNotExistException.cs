...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.TeamDoesNotExistException
...
{
  [Serializable]
  public class TeamDoesNotExistException : VssServiceException
  {
    ...
    public TeamDoesNotExistException()
      : base(AgileResources.TeamDoesNotExistException)
    {
    }

    public TeamDoesNotExistException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
