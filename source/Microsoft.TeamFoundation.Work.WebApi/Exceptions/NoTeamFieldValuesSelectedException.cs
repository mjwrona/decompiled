...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.NoTeamFieldValuesSelectedException
...
{
  [Serializable]
  public class NoTeamFieldValuesSelectedException : ArgumentException
  {
    public NoTeamFieldValuesSelectedException(string message, string paramName)
