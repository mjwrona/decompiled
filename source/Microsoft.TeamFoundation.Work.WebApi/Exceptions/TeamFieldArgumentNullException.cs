...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.TeamFieldArgumentNullException
...
{
  [Serializable]
  public class TeamFieldArgumentNullException : ArgumentException
  {
    public TeamFieldArgumentNullException(string message)
      : base(message)
    {
    }
  }
