...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.InvalidTeamSettingsIterationException
...
{
  [Serializable]
  public class InvalidTeamSettingsIterationException : ArgumentException
  {
    public InvalidTeamSettingsIterationException(string message)
      : base(message)
    {
    }
  }
