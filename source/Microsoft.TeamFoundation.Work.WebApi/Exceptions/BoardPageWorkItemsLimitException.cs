...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.BoardPageWorkItemsLimitException
...
{
  [Serializable]
  public class BoardPageWorkItemsLimitException : ArgumentException
  {
    public BoardPageWorkItemsLimitException(int size)
      : base(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, AgileResources.BoardPageWorkItemsLimitException, (object) size))
    {
    }
  }
}
