...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.CardSettingsMaxAdditionalFieldsExceededException
...
{
  [Serializable]
  public class CardSettingsMaxAdditionalFieldsExceededException : VssServiceException
  {
    public CardSettingsMaxAdditionalFieldsExceededException()
      : base(AgileResources.CardSettingsMaxAdditionalFieldsExceededException)
    {
    }
