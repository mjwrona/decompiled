...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.PlanLimitExceededException
...
{
  [Serializable]
  public class PlanLimitExceededException : VssServiceException
  {
    public PlanLimitExceededException()
      : base(AgileResources.PlanLimitExceededException)
    {
    }

    public PlanLimitExceededException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
