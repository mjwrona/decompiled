...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.InvalidTeamSettingsForUpdateException
...
{
  [Serializable]
  public class InvalidTeamSettingsForUpdateException : ArgumentException
  {
    public InvalidTeamSettingsForUpdateException(string message)
      : base(message)
    {
    }
  }
