...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.NoDefaultTeamFieldValueException
...
{
  [Serializable]
  public class NoDefaultTeamFieldValueException : ArgumentException
  {
    public NoDefaultTeamFieldValueException(string message, string paramName)
