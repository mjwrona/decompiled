...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.SetBoardCardRulesInvalidArgumentException
...
{
  [Serializable]
  public class SetBoardCardRulesInvalidArgumentException : ArgumentException
  {
    public SetBoardCardRulesInvalidArgumentException(
      string message,
      string paramName,
    ...
    public SetBoardCardRulesInvalidArgumentException(string message, Exception innerException)
