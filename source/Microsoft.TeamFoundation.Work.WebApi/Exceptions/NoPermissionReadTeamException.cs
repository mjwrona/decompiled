...
// Type: Microsoft.TeamFoundation.Work.WebApi.Exceptions.NoPermissionReadTeamException
...
{
  [Serializable]
  public class NoPermissionReadTeamException : VssServiceException
  {
    public NoPermissionReadTeamException()
      : base(string.Format(AgileResources.NoPermissionReadTeamException))
    {
    }

    public NoPermissionReadTeamException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
