...
// Type: Microsoft.TeamFoundation.Work.WebApi.TimelineTeamStatusCode
...
namespace Microsoft.TeamFoundation.Work.WebApi
{
  ...
  {
    [EnumMember] OK,
    [EnumMember] DoesntExistOrAccessDenied,
    [EnumMember] MaxTeamsExceeded,
    [EnumMember] MaxTeamFieldsExceeded,
    [EnumMember] BacklogInError,
    [EnumMember] MissingTeamFieldValue,
    [EnumMember] NoIterationsExist,
  }
}
