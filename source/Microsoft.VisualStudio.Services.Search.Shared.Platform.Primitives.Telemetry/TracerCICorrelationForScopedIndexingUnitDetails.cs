...
// Type: Microsoft.VisualStudio.Services.Search.Shared.Platform.Primitives.Telemetry.TracerCICorrelationForScopedIndexingUnitDetails
...
namespace Microsoft.VisualStudio.Services.Search.Shared.Platform.Primitives.Telemetry
{
  ...
  public class TracerCICorrelationForScopedIndexingUnitDetails : 
    TracerCICorrelationForRepositoryDetails
  {
    public TracerIndexingUnitData ScopedIndexingUnitData { get; }

    public TracerCICorrelationForScopedIndexingUnitDetails(
      ...
      : base(correlationId, currentContext, accountData, collectionData, projectData, repositoryData)
    {
      this.ScopedIndexingUnitData = scopedIndexingUnitData;
    }
    ...
    public override IDictionary<string, object> GetAllCorrelationDetails()
    {
      ...
      correlationDetails.Add("ScopedIndexingUnitId", (object) this.ScopedIndexingUnitData.Id);
