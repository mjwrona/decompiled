...
// Type: Microsoft.VisualStudio.Services.Tcm.ResultsMetaData5_1_3Controller
...
namespace Microsoft.VisualStudio.Services.Tcm
{
  ...
  [VersionedApiControllerCustomName(Area = "testresults", ResourceName = "ResultMetaData", ResourceVersion = 3)]
  public class ResultsMetaData5_1_3Controller : TcmControllerBase
  {
    private ResultsHelper m_resultsHelper;

    [HttpPost]
    [ClientLocationId("B72FF4C0-4341-4213-BA27-F517CF341C95")]
    [ClientExample("Post_testresultmetadata_6_0.json", "Get test result metadata", null, null)]
    public List<TestResultMetaData> QueryTestResultsMetaData(
      [FromBody] List<string> testCaseReferenceIds,
      ResultMetaDataDetails detailsToInclude = ResultMetaDataDetails.None)
    {
      return this.ResultsHelper.GetTestResultsMetaData(this.ProjectInfo, testCaseReferenceIds, detailsToInclude);
    }

    [HttpPatch]
    [ClientLocationId("B72FF4C0-4341-4213-BA27-F517CF341C95")]
    [ClientExample("Patch_testresultsmetadata_6_0.json", "Update test result metadata", null, null)]
