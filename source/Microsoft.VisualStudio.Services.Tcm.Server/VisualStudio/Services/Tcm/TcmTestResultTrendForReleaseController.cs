...
// Type: Microsoft.VisualStudio.Services.Tcm.TcmTestResultTrendForReleaseController
...
namespace Microsoft.VisualStudio.Services.Tcm
{
  ...
  [VersionedApiControllerCustomName(Area = "testresults", ResourceName = "ResultTrendByRelease", ResourceVersion = 1)]
  public class TcmTestResultTrendForReleaseController : TcmControllerBase
  {
    private ITestReportsHelper _testReportsHelper;

    [HttpPost]
    [ClientLocationId("107F23C3-359A-460A-A70C-63EE739F9F9A")]
