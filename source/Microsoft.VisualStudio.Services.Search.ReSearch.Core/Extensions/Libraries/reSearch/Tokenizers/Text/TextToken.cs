...
// Type: Microsoft.VisualStudio.Services.Search.Extensions.Libraries.reSearch.Tokenizers.Text.TextToken
...
namespace Microsoft.VisualStudio.Services.Search.Extensions.Libraries.reSearch.Tokenizers.Text
{
  ...
  {
    public uint CharacterOffset { get; set; }

    public uint TokenOffset { get; set; }
