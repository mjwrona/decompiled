...
// Type: Microsoft.VisualStudio.Services.Search.WebApi.Legacy.Contracts.WorkItem.WorkItemResults
...
{
  [DataContract]
  public class WorkItemResults : SearchSecuredObject
  {
    [DataMember(Name = "count")]
    public int Count { get; set; }

    [DataMember(Name = "values")]
    public IEnumerable<WorkItemResult> Values { get; set; }
      ...
      string token)
    {
      ...
      IEnumerable<WorkItemResult> values = this.Values;
      this.Values = values != null ? (IEnumerable<WorkItemResult>) values.Select<WorkItemResult, WorkItemResult>((Func<WorkItemResult, WorkItemResult>) (i =>
      {
