...
// Type: Microsoft.VisualStudio.Services.Search.WebApi.FailedFile
...
namespace Microsoft.VisualStudio.Services.Search.WebApi
{
  ...
  {
    public FailedFile(string filePath, int retryCount)
    {
      this.FilePath = filePath;
      this.RetryCount = retryCount.ToString((IFormatProvider) CultureInfo.CurrentCulture);
    }
