...
// Type: Microsoft.VisualStudio.Services.Search.Index.CustomTenantAliasInfo
...
{
  public class CustomTenantAliasInfo
  {
    public CustomTenantAliasInfo() => this.Indices = (IDictionary<string, CustomTenantIndexInfo>) new Dictionary<string, CustomTenantIndexInfo>();

    public string Name { get; set; }

    public IDictionary<string, CustomTenantIndexInfo> Indices { get; set; }
  }
}
