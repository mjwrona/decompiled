...
// Type: Microsoft.VisualStudio.Services.SecurityRoles.ISecurityRoleScopeRequestContextMapper
...
{
  public interface ISecurityRoleScopeRequestContextMapper
  {
    IVssRequestContext GetRequestContext(IVssRequestContext requestContext);
  }
}
