...
// Type: Microsoft.VisualStudio.Services.SecurityRoles.ScopeNotFoundException
...
{
  [Serializable]
  public class ScopeNotFoundException : VssServiceException
  {
    public ScopeNotFoundException(string scopeId)
      : base(SecurityRolesResources.ScopeNotFoundException((object) scopeId))
    {
    }
    ...
    public ScopeNotFoundException(string message, Exception innerException, int errorNumber)
      : base(message, innerException)
    {
    }
  }
