...
// Type: Microsoft.TeamFoundation.Server.WebAccess.Presentation.AuthenticationRedirectViewModel
...
{
  public class AuthenticationRedirectViewModel
  {
    public string RedirectUrl { get; set; }

    public bool IsUsingOAuth { get; set; }

    public string OAuthInitiationUrl { get; set; }
  }
}
