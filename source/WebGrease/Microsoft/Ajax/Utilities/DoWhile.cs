...
// Type: Microsoft.Ajax.Utilities.DoWhile
...
namespace Microsoft.Ajax.Utilities
{
  public sealed class DoWhile : IterationStatement
  {
    ...
    public override IEnumerable<AstNode> Children => AstNode.EnumerateNonNullNodes((AstNode) this.Body, this.Condition);
    ...
    internal override bool EncloseBlock(EncloseBlockType type) => type == EncloseBlockType.SingleDoWhile;
  }
}
