...
// Type: WebGrease.Css.ImageAssemblyAnalysis.ImageAssemblyScanOutput
...
namespace WebGrease.Css.ImageAssemblyAnalysis
{
  ...
  {
    internal ImageAssemblyScanOutput() => this.ImageReferencesToAssemble = (IList<InputImage>) new List<InputImage>();
