...
// Type: WebGrease.Css.Ast.Selectors.FunctionalPseudoNode
...
namespace WebGrease.Css.Ast.Selectors
{
  public sealed class FunctionalPseudoNode : AstNode
  {
    ...
    public override AstNode Accept(NodeVisitor nodeVisitor) => nodeVisitor.VisitFunctionalPseudoNode(this);
  }
}
