...
// Type: WebGrease.Css.Ast.Selectors.UniversalSelectorNode
...
namespace WebGrease.Css.Ast.Selectors
{
  public sealed class UniversalSelectorNode : AstNode
  {
    ...
    public override AstNode Accept(NodeVisitor nodeVisitor) => nodeVisitor.VisitUniversalSelectorNode(this);
  }
}
