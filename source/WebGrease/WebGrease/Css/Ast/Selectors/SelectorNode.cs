...
// Type: WebGrease.Css.Ast.Selectors.SelectorNode
...
namespace WebGrease.Css.Ast.Selectors
{
  public sealed class SelectorNode : AstNode
  {
    public SelectorNode(
      ...
      ReadOnlyCollection<CombinatorSimpleSelectorSequenceNode> combinatorSimpleSelectorSequenceNodes)
    {
    ...
    public override AstNode Accept(NodeVisitor nodeVisitor) => nodeVisitor.VisitSelectorNode(this);
  }
}
