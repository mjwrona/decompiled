...
// Type: WebGrease.Css.Ast.StyleSheetRuleOrCommentNode
...
namespace WebGrease.Css.Ast
{
  public class StyleSheetRuleOrCommentNode : StyleSheetRuleNode
  {
    ...
    public override AstNode Accept(NodeVisitor nodeVisitor) => this.IsCommentNode ? (AstNode) new StyleSheetRuleOrCommentNode((ImportantCommentNode) this.ImportantCommentNode.Accept(nodeVisitor), true) : base.Accept(nodeVisitor);
  }
}
