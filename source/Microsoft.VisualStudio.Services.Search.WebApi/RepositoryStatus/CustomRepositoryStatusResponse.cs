...
// Type: Microsoft.VisualStudio.Services.Search.WebApi.Contracts.RepositoryStatus.CustomRepositoryStatusResponse
...
{
  [DataContract]
  public class CustomRepositoryStatusResponse : SearchSecuredV2Object
  {
    [DataMember(Name = "id")]
    ...
    [DataMember(Name = "indexedTopLevelFolders")]
    public IEnumerable<DepotInfo> IndexedTopLevelFolders { get; set; }
    ...
    public override void SetSecuredObject(Guid namespaceId, int requiredPermissions, string token)
    {
      ...
      IEnumerable<DepotInfo> indexedTopLevelFolders = this.IndexedTopLevelFolders;
      this.IndexedTopLevelFolders = indexedTopLevelFolders != null ? (IEnumerable<DepotInfo>) indexedTopLevelFolders.Select<DepotInfo, DepotInfo>((Func<DepotInfo, DepotInfo>) (i =>
      {
        i.SetSecuredObject(namespaceId, requiredPermissions, token);
        return i;
      })).ToList<DepotInfo>() : (IEnumerable<DepotInfo>) null;
    }
  }
}
