...
// Type: Microsoft.VisualStudio.Services.Search.Server.Jobs.RepositoryCodeIndexingJob
...
{
  public class RepositoryCodeIndexingJob : AbstractSearchServiceIndexingJob
  {
    protected override int TracePoint => 1080335;
