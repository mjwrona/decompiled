...
// Type: Microsoft.VisualStudio.Services.Search.Server.Jobs.Operations.Code.DeleteOrphanTfvcFilesOperation
...
{
  internal class DeleteOrphanTfvcFilesOperation : DeleteOrphanFilesOperation
  {
    public DeleteOrphanTfvcFilesOperation(
      ...
      StringBuilder resultmessage)
    {
      ...
      return contractType.IsSourceNoDedupeFileContract() || contractType.IsDedupeFileContract() ? new IndexOperations().PerformBulkDelete(executionContext, executionContext.GetIndex(), queryExpression) : (IndexOperationsResponse) null;
    }
  }
}
