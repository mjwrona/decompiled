...
// Type: Microsoft.VisualStudio.Services.ExtensionManagement.Server.Components.InstalledExtensionComponent6
...
{
  internal class InstalledExtensionComponent6 : InstalledExtensionComponent5
  {
    public override void DeleteExtensionStates(List<ExtensionState> extensionStates)
    {
      this.PrepareStoredProcedure("Extension.prc_DeleteExtensionStates");
      ...
      {
        this.Trace(10013485, TraceLevel.Info, "Deleting extension with id {0}.{1}", (object) extensionState.PublisherName, (object) extensionState.ExtensionName);
        rows.Add(new KeyValuePair<string, string>(extensionState.PublisherName, extensionState.ExtensionName));
      }
      this.BindKeyValuePairStringTable("@extensions", (IEnumerable<KeyValuePair<string, string>>) rows);
