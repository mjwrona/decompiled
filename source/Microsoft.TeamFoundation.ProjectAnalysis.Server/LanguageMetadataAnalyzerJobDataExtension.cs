...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.LanguageMetadataAnalyzerJobDataExtension
...
{
  public static class LanguageMetadataAnalyzerJobDataExtension
  {
    public static bool IsJobDataUpToDate(this LanguageMetadataAnalyzerJobData data)
    {
      if (!data.Version.HasValue)
        return false;
      int? version = data.Version;
      int num = 1;
      return version.GetValueOrDefault() == num & version.HasValue;
    }
  }
}
