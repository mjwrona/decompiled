...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.NoDefaultBranchException
...
{
  [Serializable]
  public class NoDefaultBranchException : TeamFoundationServiceException
  {
    public NoDefaultBranchException(Guid repoId)
      : base(ProjectAnalysisResources.Format("NoDefaultBranchFoundOnRepo", (object) repoId))
    {
    }
  }
}
