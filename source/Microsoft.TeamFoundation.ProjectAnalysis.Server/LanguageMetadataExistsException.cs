...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.LanguageMetadataExistsException
...
{
  [Serializable]
  public class LanguageMetadataExistsException : TeamFoundationServiceException
  {
    public LanguageMetadataExistsException(
    ...
    public LanguageMetadataExistsException()
      : base(ProjectAnalysisResources.Get("LanguageMetadataExists"))
    {
    }
  }
}
