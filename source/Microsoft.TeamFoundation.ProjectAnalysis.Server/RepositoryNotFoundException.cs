...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.RepositoryNotFoundException
...
{
  [Serializable]
  public class RepositoryNotFoundException : TeamFoundationServiceException
  {
    public RepositoryNotFoundException(Guid repoId)
      : base(ProjectAnalysisResources.Format("RepositoryNotFound", (object) repoId))
    {
    }
  }
}
