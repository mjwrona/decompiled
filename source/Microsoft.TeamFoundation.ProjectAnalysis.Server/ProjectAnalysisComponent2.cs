...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.ProjectAnalysisComponent2
...
{
  internal class ProjectAnalysisComponent2 : ProjectAnalysisComponent
  {
    protected override void BindRecordVersion(LanguageMetadataRecord record) => this.BindInt("@recordVersion", record.RecordVersion);
  }
}
