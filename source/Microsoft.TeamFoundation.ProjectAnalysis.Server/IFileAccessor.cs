...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.IFileAccessor
...
namespace Microsoft.TeamFoundation.ProjectAnalysis.Server
{
  ...
  {
    IRepositoryDescriptor RepositoryDescriptor { get; }

    IEnumerable<string> GetFilePaths();

    Stream GetContent(string filePath);

    ILanguageConfigurator GetConfigurator();
  }
}
