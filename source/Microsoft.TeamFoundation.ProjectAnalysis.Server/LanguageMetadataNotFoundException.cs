...
// Type: Microsoft.TeamFoundation.ProjectAnalysis.Server.LanguageMetadataNotFoundException
...
{
  [Serializable]
  public class LanguageMetadataNotFoundException : TeamFoundationServiceException
  {
    public LanguageMetadataNotFoundException(
    ...
    public LanguageMetadataNotFoundException()
      : base(ProjectAnalysisResources.Get("LanguageMetadataNotFound"))
    {
    }
  }
}
