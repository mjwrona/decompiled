...
// Type: Microsoft.VisualStudio.Services.Feed.Common.FeedIdentityExtensions
...
{
  public static class FeedIdentityExtensions
  {
    public static FeedIdentity GetIdentity(this FeedCore feed) => new FeedIdentity(feed.Project?.Id, feed.Id);
  }
}
