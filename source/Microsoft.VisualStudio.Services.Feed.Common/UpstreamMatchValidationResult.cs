...
// Type: Microsoft.VisualStudio.Services.Feed.Common.UpstreamMatchValidationResult
...
{
  public record UpstreamMatchValidationResult(
    UpstreamStatus Status,
    IEnumerable<UpstreamStatusDetail> StatusDetails)
  ;
}
