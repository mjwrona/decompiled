...
// Type: Microsoft.VisualStudio.Services.Feed.Common.IChangeProcessorProvider
...
{
  public interface IChangeProcessorProvider
  {
    Task<bool> ProcessChangesAsync(Changes changes);
  }
}
