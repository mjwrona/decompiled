...
// Type: Microsoft.VisualStudio.Services.Feed.Common.PackageVersionIdentity
...
{
  public class PackageVersionIdentity
  {
    public PackageVersionIdentity(string packageName, string version)
    {
