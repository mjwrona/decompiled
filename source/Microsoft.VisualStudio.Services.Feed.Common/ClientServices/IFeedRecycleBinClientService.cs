...
// Type: Microsoft.VisualStudio.Services.Feed.Common.ClientServices.IFeedRecycleBinClientService
...
{
  [DefaultServiceImplementation(typeof (FrameworkFeedRecycleBinClientService))]
  public interface IFeedRecycleBinClientService : IVssFrameworkService
  {
    Task<List<Microsoft.VisualStudio.Services.Feed.WebApi.Feed>> GetFeedsFromRecycleBinAsync(
