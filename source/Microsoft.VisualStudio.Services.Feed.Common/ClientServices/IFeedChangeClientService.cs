...
// Type: Microsoft.VisualStudio.Services.Feed.Common.ClientServices.IFeedChangeClientService
...
{
  [DefaultServiceImplementation(typeof (FrameworkFeedChangeClientService))]
  public interface IFeedChangeClientService : IVssFrameworkService
  {
    Task<FeedChangesResponse> GetFeedChangesAsync(
