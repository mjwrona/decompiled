...
// Type: Microsoft.VisualStudio.Services.Feed.Common.ClientServices.IFeedInternalClientService
...
{
  [DefaultServiceImplementation(typeof (FrameworkFeedInternalClientService))]
  public interface IFeedInternalClientService : IVssFrameworkService
  {
    Task<Microsoft.VisualStudio.Services.Feed.WebApi.Feed> GetFeedByIdForAnyScopeAsync(
