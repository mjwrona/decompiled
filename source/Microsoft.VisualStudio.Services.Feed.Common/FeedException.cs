...
// Type: Microsoft.VisualStudio.Services.Feed.Common.FeedException
...
{
  public static class FeedException
  {
    public static bool IsHostShutdownResponse(VssServiceException ex) => ex.Message.StartsWith("TF24668");
  }
}
