...
// Type: Microsoft.Azure.Pipelines.Approval.Server.DataAccess.Model.BlockedApproverType
...
{
  public class BlockedApproverType
  {
    public Guid BlockedApproverId { get; set; }
