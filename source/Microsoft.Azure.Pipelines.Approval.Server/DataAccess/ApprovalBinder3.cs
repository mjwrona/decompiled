...
// Type: Microsoft.Azure.Pipelines.Approval.Server.DataAccess.ApprovalBinder3
...
{
  internal class ApprovalBinder3 : ApprovalBinder2
  {
    ...
    protected override Microsoft.Azure.Pipelines.Approval.WebApi.Approval Bind()
    {
      string json = this.m_context.GetString((IDataReader) this.Reader, true);
      JObject jobject = json == null ? (JObject) null : JObject.Parse(json);
      return new Microsoft.Azure.Pipelines.Approval.WebApi.Approval()
      {
        ...
        Owner = (ApprovalOwner) this.m_owner.GetByte((IDataReader) this.Reader),
        Context = jobject
      };
    }
  }
