...
// Type: Microsoft.Azure.Pipelines.Approval.Server.Controllers.Approval2Controller
...
namespace Microsoft.Azure.Pipelines.Approval.Server.Controllers
{
  ...
  [VersionedApiControllerCustomName(Area = "approval", ResourceName = "approvals", ResourceVersion = 2)]
  public class Approval2Controller : ApprovalProjectApiController
  {
    [HttpGet]
    [ActionName("Query")]
    ...
    public IEnumerable<Microsoft.Azure.Pipelines.Approval.WebApi.Approval> QueryApprovals(
      ...
      [ClientParameterAsIEnumerable(typeof (string), ',')] string assignedTo = null,
      ApprovalStatus state = ApprovalStatus.All,
      int top = 250)
    {
      return this.QueryApprovalsExtended(approvalIds, expand, assignedTo, state, top);
    }
  }
}
