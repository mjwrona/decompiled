...
// Type: Microsoft.Azure.Pipelines.Approval.Server.IApprovalCompletedEventSubscriber
...
{
  [InheritedExport]
  public interface IApprovalCompletedEventSubscriber : ISubscriber, IApprovalOwner
  {
    void ProcessApprovalCompletedEvent(
      IVssRequestContext requestContext,
      ApprovalCompletedNotificationEvent approvalCompletedEvent);
  }
}
