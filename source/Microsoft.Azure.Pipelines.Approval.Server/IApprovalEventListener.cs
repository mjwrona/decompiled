...
// Type: Microsoft.Azure.Pipelines.Approval.Server.IApprovalEventListener
...
{
  [InheritedExport]
  public interface IApprovalEventListener : IApprovalOwner
  {
    void PublishNotification(IVssRequestContext requestContext, object notificationEventArgs);

    bool IsASubsriber(ApprovalOwner owner, Type subscribedType);
  }
}
