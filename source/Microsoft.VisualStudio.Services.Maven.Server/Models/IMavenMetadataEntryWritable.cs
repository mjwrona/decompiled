...
// Type: Microsoft.VisualStudio.Services.Maven.Server.Models.IMavenMetadataEntryWritable
...
{
  public interface IMavenMetadataEntryWritable : 
    IMavenMetadataEntry,
  ...
  {
    new byte[] PomBytes { get; set; }

    bool AddPackageFile(MavenPackageFileNew packageFile);
  }
}
