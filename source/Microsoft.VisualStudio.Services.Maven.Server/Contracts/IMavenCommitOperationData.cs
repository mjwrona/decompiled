...
// Type: Microsoft.VisualStudio.Services.Maven.Server.Contracts.IMavenCommitOperationData
...
{
  public interface IMavenCommitOperationData : 
    IAddOperationData,
    IPackageVersionOperationData,
    IPackageOperationData,
    ICommitOperationData
  {
    MavenPomMetadata Pom { get; }

    byte[] PomBytes { get; }

    IEnumerable<MavenPackageFileNew> Files { get; }
  }
}
