...
// Type: Microsoft.TeamFoundation.Ssh.Server.SshProcessStillRunningException
...
{
  [Serializable]
  public class SshProcessStillRunningException : TeamFoundationServiceException
  {
    public SshProcessStillRunningException()
      : base(FrameworkResources.ProcessStillRunningError())
    {
    }
  }
}
