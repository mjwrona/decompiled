...
// Type: Microsoft.TeamFoundation.Ssh.Server.ITeamFoundationSshService
...
{
  [DefaultServiceImplementation(typeof (TeamFoundationSshService))]
  public interface ITeamFoundationSshService : IVssFrameworkService
  {
    void CloseSessions();
  }
}
