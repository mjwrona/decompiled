...
// Type: Microsoft.TeamFoundation.Ssh.Server.SshServerTeardownTimeoutException
...
{
  [Serializable]
  public class SshServerTeardownTimeoutException : TeamFoundationServiceException
  {
    public SshServerTeardownTimeoutException()
      : base("The Teardown operation timed out while the SshServer was recycling or shutting down.")
    {
    }
  }
}
