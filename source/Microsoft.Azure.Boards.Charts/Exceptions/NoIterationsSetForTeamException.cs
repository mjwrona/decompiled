...
// Type: Microsoft.Azure.Boards.Charts.Exceptions.NoIterationsSetForTeamException
...
{
  [Serializable]
  public class NoIterationsSetForTeamException : TeamFoundationServiceException
  {
    public NoIterationsSetForTeamException(string message)
      : base(message)
    {
    }

    public NoIterationsSetForTeamException()
      : base(ChartsResources.NoIterationsSetForTeamMessage)
    {
    }
  }
}
