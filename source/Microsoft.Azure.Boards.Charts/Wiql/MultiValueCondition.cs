...
// Type: Microsoft.Azure.Boards.Charts.Wiql.MultiValueCondition
...
{
  public class MultiValueCondition : Condition
  {
    public MultiValueCondition() => this.Values = new Collection<object>();

    public string Field { get; set; }

    public MultiValueOperator Operator { get; set; }
