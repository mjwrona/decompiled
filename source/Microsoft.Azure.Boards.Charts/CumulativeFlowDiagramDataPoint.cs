...
// Type: Microsoft.Azure.Boards.Charts.CumulativeFlowDiagramDataPoint
...
{
  internal class CumulativeFlowDiagramDataPoint
  {
    public DateTime Date { get; set; }

    public Dictionary<string, int> StateCounts { get; set; }

    public IDictionary<Guid, int> Counts { get; set; }
  }
}
