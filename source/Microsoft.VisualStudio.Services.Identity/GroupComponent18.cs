...
// Type: Microsoft.VisualStudio.Services.Identity.GroupComponent18
...
{
  internal class GroupComponent18 : GroupComponent17
  {
      ...
      bool removeChildren)
    {
      try
      {
        ...
        this.PrepareForAuditingAction("Group.DeleteGroupMembership");
      ...
      IEnumerable<Tuple<IdentityDescriptor, Guid, bool>> updates)
    {
      try
      {
        ...
        this.PrepareForAuditingAction("Group.UpdateGroupMembership");
      ...
      IEnumerable<GroupComponent.GroupUpdate> groupUpdates)
    {
      try
      {
        ...
        this.PrepareForAuditingAction("Group.UpdateGroups");
      ...
      IEnumerable<Tuple<IdentityDescriptor, Guid, bool>> updates)
    {
      try
      {
        ...
        this.PrepareForAuditingAction("Group.UpdateIdentityMembership");
