...
// Type: Microsoft.VisualStudio.Services.Identity.GroupComponent7
...
{
  internal class GroupComponent7 : GroupComponent6
  {
      ...
      IEnumerable<GroupComponent.GroupUpdate> groupUpdates)
    {
      try
      {
        ...
        this.PrepareForAuditingAction("Group.UpdateGroup");
