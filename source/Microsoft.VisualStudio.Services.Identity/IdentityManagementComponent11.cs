...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityManagementComponent11
...
{
  internal class IdentityManagementComponent11 : IdentityManagementComponent10
  {
      ...
      bool incudeOnlyClaimsAndBindPendingTypes = false)
    {
      try
      {
        this.TraceEnter(4701800, nameof (FetchIdentityIdsBatch));
      ...
      {
        this.TraceLeave(4701809, nameof (FetchIdentityIdsBatch));
      }
    }
