...
// Type: Microsoft.VisualStudio.Services.Identity.IdentityManagementComponent3
...
{
  internal class IdentityManagementComponent3 : IdentityManagementComponent2
  {
      ...
      out List<KeyValuePair<Guid, Guid>> identitiesToTransfer)
    {
      try
      {
        this.TraceEnter(4701200, nameof (UpdateIdentities));
      ...
      {
        this.TraceLeave(4701209, nameof (UpdateIdentities));
      }
    }
  }
}
