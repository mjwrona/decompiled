...
// Type: Microsoft.TeamFoundation.TestImpact.Server.Common.InvalidDefinitionRunIdException
...
{
  public class InvalidDefinitionRunIdException : TeamFoundationServerException
  {
    public InvalidDefinitionRunIdException()
    {
    }

    public InvalidDefinitionRunIdException(string message)
      : base(message)
    {
    }
  }
