...
// Type: Microsoft.TeamFoundation.TestImpact.Server.Common.BuildsDeletedEventHandlerJobInput
...
{
  [XmlRoot("BuildsDeletedEventHandlerJobInput")]
  [Serializable]
  public class BuildsDeletedEventHandlerJobInput
  {
    [XmlAttribute("ProjectId")]
    public string ProjectId { get; set; }

    [XmlAttribute("BuildIds")]
