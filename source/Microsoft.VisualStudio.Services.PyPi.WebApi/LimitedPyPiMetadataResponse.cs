...
// Type: Microsoft.VisualStudio.Services.PyPi.WebApi.Types.LimitedPyPiMetadataResponse
...
{
  [DataContract]
  public class LimitedPyPiMetadataResponse
  {
    [DataMember]
    public List<RawLimitedPyPiMetadata> LimitedPyPiMetadataList { get; set; }
  }
}
