...
{
  internal class Document : Resource, IDynamicMetaObjectProvider
  {
    ...
    private class DocumentDynamicMetaObject : DynamicMetaObject
    {
      ...
      public override DynamicMetaObject BindGetMember(GetMemberBinder binder)
      {
        ...
        return new DynamicMetaObject((Expression) Expression.Call((Expression) Expression.Convert(this.Expression, this.LimitType), typeof (Document).GetMethod(name, BindingFlags.Instance | BindingFlags.NonPublic), expressionArray), BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType));
      }
        ...
        DynamicMetaObject value)
      {
        ...
        return new DynamicMetaObject((Expression) Expression.Call((Expression) Expression.Convert(this.Expression, this.LimitType), typeof (Document).GetMethod(name, BindingFlags.Instance | BindingFlags.NonPublic), expressionArray), typeRestriction);
      }

      public override DynamicMetaObject BindConvert(ConvertBinder binder) => new DynamicMetaObject((Expression) Expression.Call((Expression) Expression.Convert(this.Expression, this.LimitType), typeof (Document).GetMethod("AsType", BindingFlags.Instance | BindingFlags.NonPublic).MakeGenericMethod(binder.Type)), BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType));
