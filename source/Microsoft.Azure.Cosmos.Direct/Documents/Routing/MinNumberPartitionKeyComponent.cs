...
// Type: Microsoft.Azure.Documents.Routing.MinNumberPartitionKeyComponent
...
namespace Microsoft.Azure.Documents.Routing
{
  internal sealed class MinNumberPartitionKeyComponent : IPartitionKeyComponent
  {
    ...
    public object ToObject() => (object) MinNumber.Value;

    public void WriteForBinaryEncoding(BinaryWriter binaryWriter) => binaryWriter.Write((byte) 4);
  }
}
