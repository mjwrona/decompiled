  ...
  internal static class Helpers
  {
    ...
    public static string GetDateHeader(RequestNameValueCollection requestHeaders)
    {
      if (requestHeaders == null)
        return string.Empty;
      string str = requestHeaders.XDate;
      if (string.IsNullOrEmpty(str))
        str = requestHeaders.HttpDate;
    ...
    {
      int result;
      return !int.TryParse(statusCode, out result) ? "Other" : Helpers.GetStatusFromStatusCodeInt(result);
    }
    ...
    internal static string GetStatusFromStatusCodeInt(int statusCodeInt)
    {
      ...
      switch (statusCodeInt)
      {
        ...
        default:
          ...
          return statusCodeInt == 503 ? "ServiceBusyError" : "Other";
      }
    }
  }
}
