  ...
  internal sealed class QueryResult : IDynamicMetaObjectProvider
  {
    ...
    private object Convert(Type type)
    {
      ...
      else if (type == typeof (Snapshot))
      {
        ...
        snapshot.propertyBag = this.jObject as JObject;
        obj = (object) snapshot;
      }
      else
    ...
    private class DocumentDynamicMetaObject : DynamicMetaObject
    {
      ...
      public override DynamicMetaObject BindGetMember(GetMemberBinder binder)
      {
        ...
        return new DynamicMetaObject((Expression) Expression.Call((Expression) Expression.Convert(this.Expression, this.LimitType), typeof (QueryResult).GetMethod(name, BindingFlags.Instance | BindingFlags.NonPublic), expressionArray), BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType));
      }
        ...
        DynamicMetaObject value)
      {
        ...
        return new DynamicMetaObject((Expression) Expression.Call((Expression) Expression.Convert(this.Expression, this.LimitType), typeof (QueryResult).GetMethod(name, BindingFlags.Instance | BindingFlags.NonPublic), expressionArray), typeRestriction);
      }

      public override DynamicMetaObject BindConvert(ConvertBinder binder) => new DynamicMetaObject((Expression) Expression.Call((Expression) Expression.Convert(this.Expression, this.LimitType), typeof (QueryResult).GetMethod("AsType", BindingFlags.Instance | BindingFlags.NonPublic).MakeGenericMethod(binder.Type)), BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType));
