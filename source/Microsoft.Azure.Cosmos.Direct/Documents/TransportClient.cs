...
namespace Microsoft.Azure.Documents
{
  internal abstract class TransportClient : IDisposable
  {
    ...
    internal Task<StoreResponse> ListSystemDocumentsAsync(
      Uri physicalAddress,
      DocumentServiceRequest request)
    {
      return this.InvokeStoreAsync(physicalAddress, ResourceOperation.ReadSystemDocumentFeed, request);
    }

    internal Task<StoreResponse> GetSystemDocumentAsync(
      Uri physicalAddress,
      DocumentServiceRequest request)
    {
      return this.InvokeStoreAsync(physicalAddress, ResourceOperation.ReadSystemDocument, request);
    }

    internal Task<StoreResponse> CreateSystemDocumentAsync(
      Uri physicalAddress,
      DocumentServiceRequest request)
    {
      return this.InvokeStoreAsync(physicalAddress, ResourceOperation.CreateSystemDocument, request);
    }

    internal Task<StoreResponse> ReplaceSystemDocumentAsync(
      Uri physicalAddress,
      DocumentServiceRequest request)
    {
      return this.InvokeStoreAsync(physicalAddress, ResourceOperation.ReplaceSystemDocument, request);
    }

    internal Task<StoreResponse> DeleteSystemDocumentAsync(
      Uri physicalAddress,
      DocumentServiceRequest request)
    {
      return this.InvokeStoreAsync(physicalAddress, ResourceOperation.DeleteSystemDocument, request);
    }
    ...
    public Task<StoreResponse> CompleteUserTransaction(
      Uri physicalAddress,
      DocumentServiceRequest request)
    {
      return this.InvokeStoreAsync(physicalAddress, ResourceOperation.CompleteUserTransaction, request);
    }
      ...
      if (storeResponse.Status >= 300 && storeResponse.Status != 304 && (request == null || !request.IsValidStatusCodeForExceptionlessRetry(storeResponse.Status, storeResponse.SubStatusCode)))
      {
        ...
        switch ((StatusCodes) storeResponse.Status)
        {
          ...
          case StatusCodes.Gone:
            ...
            string errorResponse1 = TransportClient.GetErrorResponse(storeResponse, RMResources.Gone, out responseHeaders8);
            uint exceptionSubStatus1 = TransportClient.GetExceptionSubStatus(responseHeaders8, errorResponse1, physicalAddress);
            switch (exceptionSubStatus1)
            {
              case 1000:
                documentClientException = (DocumentClientException) new InvalidPartitionException(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, RMResources.ExceptionMessage, (object) errorResponse1), responseHeaders8, physicalAddress);
                break;
              case 1002:
                documentClientException = (DocumentClientException) new PartitionKeyRangeGoneException(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, RMResources.ExceptionMessage, (object) errorResponse1), responseHeaders8, physicalAddress);
                break;
              case 1007:
                documentClientException = (DocumentClientException) new PartitionKeyRangeIsSplittingException(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, RMResources.ExceptionMessage, (object) errorResponse1), responseHeaders8, physicalAddress);
                break;
              case 1008:
                documentClientException = (DocumentClientException) new PartitionIsMigratingException(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, RMResources.ExceptionMessage, (object) errorResponse1), responseHeaders8, physicalAddress);
                break;
              default:
                documentClientException = (DocumentClientException) new GoneException(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, RMResources.ExceptionMessage, (object) RMResources.Gone), responseHeaders8, exceptionSubStatus1 == 0U ? new SubStatusCodes?(SubStatusCodes.ServerGenerated410) : new SubStatusCodes?(), physicalAddress);
                break;
            }
            break;
          ...
          case StatusCodes.ServiceUnavailable:
            ...
            string errorResponse2 = TransportClient.GetErrorResponse(storeResponse, RMResources.ServiceUnavailable, out responseHeaders15);
            uint exceptionSubStatus2 = TransportClient.GetExceptionSubStatus(responseHeaders15, errorResponse2, physicalAddress);
            documentClientException = (DocumentClientException) ServiceUnavailableException.Create(responseHeaders15, exceptionSubStatus2 == 0U ? new SubStatusCodes?(SubStatusCodes.ServerGenerated503) : new SubStatusCodes?(), physicalAddress);
            break;
          default:
        ...
        documentClientException.TransportRequestStats = storeResponse.TransportRequestStats;
    ...
    internal virtual Task OpenConnectionAsync(Uri physicalAddress) => throw new NotImplementedException();
    ...
    protected static uint GetExceptionSubStatus(
      ...
      Uri physicalAddress)
    {
      ...
      if (responseHeaders == null)
        return 0;
      string s = responseHeaders.Get("x-ms-substatus");
      if (!string.IsNullOrEmpty(s) && !uint.TryParse(s, NumberStyles.Integer, (IFormatProvider) CultureInfo.InvariantCulture, out result))
        throw new BadRequestException(string.Format((IFormatProvider) CultureInfo.CurrentUICulture, RMResources.ExceptionMessage, string.IsNullOrEmpty(errorMessage) ? (object) RMResources.BadRequest : (object) errorMessage), responseHeaders, physicalAddress);
      return result;
    }
  }
}
