...
namespace Microsoft.Azure.Documents
{
  ...
  internal sealed class ConsistencyReader
  {
      ...
      IAuthorizationTokenProvider authorizationTokenProvider)
    {
      ...
      this.storeReader = new StoreReader(transportClient, addressSelector, (IAddressEnumerator) new AddressEnumerator(), sessionContainer);
      ...
      CancellationToken cancellationToken = default (CancellationToken))
    {
      ...
      switch (desiredReadMode)
      {
        ...
        case ReadMode.BoundedStaleness:
          ...
          return this.quorumReader.ReadStrongAsync(entity, readQuorumValue, desiredReadMode);
        case ReadMode.Any:
          return targetConsistencyLevel == ConsistencyLevel.Session ? BackoffRetryUtility<StoreResponse>.ExecuteAsync((Func<Task<StoreResponse>>) (() => this.ReadSessionAsync(entity, desiredReadMode)), (IRetryPolicy) new SessionTokenMismatchRetryPolicy(), cancellationToken) : this.ReadAnyAsync(entity, desiredReadMode);
        default:
    ...
    private async Task<StoreResponse> ReadAnyAsync(DocumentServiceRequest entity, ReadMode readMode)
    {
      ...
      return storeResultList.Count != 0 ? storeResultList[0].ToResponse() : throw new GoneException(RMResources.Gone, SubStatusCodes.Server_NoValidStoreResponse);
    }
