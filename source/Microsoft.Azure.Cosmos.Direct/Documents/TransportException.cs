      ...
      get
      {
        ...
        switch (baseException)
        {
          case SocketException socketException:
            str = string.Format((IFormatProvider) CultureInfo.InvariantCulture, "socket error {0} [0x{1:X8}]", (object) socketException.SocketErrorCode, (object) (int) socketException.SocketErrorCode);
            break;
          case Win32Exception win32Exception:
            str = string.Format((IFormatProvider) CultureInfo.InvariantCulture, "Windows error 0x{0:X8}", (object) win32Exception.NativeErrorCode);
            break;
          default:
            str = string.Format((IFormatProvider) CultureInfo.InvariantCulture, "HRESULT 0x{0:X8}", (object) baseException.HResult);
            break;
        }
        return string.Format((IFormatProvider) CultureInfo.InvariantCulture, "{0} (Time: {1:o}, activity ID: {2}, error code: {3} [0x{4:X4}], base error: {5}, URI: {6}, connection: {7}, payload sent: {8})", (object) base.Message, (object) this.Timestamp, (object) this.ActivityId, (object) this.ErrorCode, (object) (int) this.ErrorCode, (object) str, (object) this.RequestUri, (object) this.Source, (object) this.UserRequestSent);
      }
    }
