...
// Type: Microsoft.TeamFoundation.Server.WebAccess.TfsCommon.GlobalDialog
...
{
  [DataContract]
  public class GlobalDialog : GlobalMessage
  {
    [DataMember(EmitDefaultValue = false)]
    public IList<IDictionary<string, object>> ButtonProps { get; set; }

    [DataMember(EmitDefaultValue = false)]
    public IDictionary<string, object> CloseButtonProps { get; set; }
