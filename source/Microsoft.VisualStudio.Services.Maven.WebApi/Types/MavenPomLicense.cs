...
// Type: Microsoft.VisualStudio.Services.Maven.WebApi.Types.MavenPomLicense
...
{
  [DataContract]
  public class MavenPomLicense : MavenPomOrganization
  {
    [DataMember(EmitDefaultValue = false, Name = "distribution")]
