...
// Type: Microsoft.Azure.Devops.Teams.Service.TeamNotFoundException
...
{
  public class TeamNotFoundException : ArgumentException
  {
    public TeamNotFoundException(string teamId)
      : base(Resources.TeamNotFound((object) teamId))
    {
    }
  }
}
