...
// Type: Microsoft.Azure.Devops.Teams.Service.DefaultTeamNotFoundException
...
{
  public class DefaultTeamNotFoundException : ArgumentException
  {
    public DefaultTeamNotFoundException(string projectId)
      : base(Resources.DefaultTeamNotFound((object) projectId))
    {
    }
  }
}
