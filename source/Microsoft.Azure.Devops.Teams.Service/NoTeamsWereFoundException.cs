...
// Type: Microsoft.Azure.Devops.Teams.Service.NoTeamsWereFoundException
...
{
  public class NoTeamsWereFoundException : ArgumentException
  {
    public NoTeamsWereFoundException(string projectId)
      : base(Resources.NoTeamsFoundForProject((object) projectId))
    {
    }
  }
}
