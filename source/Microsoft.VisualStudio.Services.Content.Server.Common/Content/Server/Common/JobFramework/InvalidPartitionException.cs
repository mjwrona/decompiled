...
// Type: Microsoft.VisualStudio.Services.Content.Server.Common.JobFramework.InvalidPartitionException
...
namespace Microsoft.VisualStudio.Services.Content.Server.Common.JobFramework
{
  ...
  {
    public InvalidPartitionException(string message, Exception ex)
      : base(message, ex)
    {
    }
