...
// Type: Microsoft.TeamFoundation.Server.WebAccess.WorkItemTracking.Common.ProcessSettings
...
{
  [DataContract]
  public class ProcessSettings : BaseWorkItemFormLayoutUserSettingsSecuredObject
  {
    public ProcessSettings() => this.WorkItemTypeSettings = (IList<Microsoft.TeamFoundation.Server.WebAccess.WorkItemTracking.Common.WorkItemTypeSettings>) new List<Microsoft.TeamFoundation.Server.WebAccess.WorkItemTracking.Common.WorkItemTypeSettings>();
