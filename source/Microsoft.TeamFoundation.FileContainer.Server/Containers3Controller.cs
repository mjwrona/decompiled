...
// Type: Microsoft.TeamFoundation.Framework.Server.Containers3Controller
...
{
  [VersionedApiControllerCustomName(Area = "Container", ResourceName = "Containers", ResourceVersion = 3)]
  public class Containers3Controller : ContainersController
  {
  }
}
