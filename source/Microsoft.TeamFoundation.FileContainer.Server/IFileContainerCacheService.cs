...
// Type: Microsoft.TeamFoundation.Framework.Server.IFileContainerCacheService
...
{
  [DefaultServiceImplementation(typeof (FileContainerCacheService))]
  internal interface IFileContainerCacheService : IVssFrameworkService
  {
    bool TryGetValue(
    ...
    void Remove(IVssRequestContext requestContext, long containerId);
  }
}
