...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.AzureRoleAssignmentPermission
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  public class AzureRoleAssignmentPermission : AzurePermission
  {
    ...
    public AzureRoleAssignmentPermission()
      : base("Microsoft.RoleAssignment")
    {
    }
  }
}
