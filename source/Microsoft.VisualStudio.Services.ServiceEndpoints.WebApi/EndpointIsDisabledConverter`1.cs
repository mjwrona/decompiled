...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.EndpointIsDisabledConverter`1
...
{
  internal class EndpointIsDisabledConverter<T> : EndpointIsReadyConverter<T>
  {
