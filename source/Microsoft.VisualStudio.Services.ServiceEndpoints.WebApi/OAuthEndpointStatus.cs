...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.OAuthEndpointStatus
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  {
    public OAuthEndpointStatus()
    {
    }

    public OAuthEndpointStatus(string state, string statusMessage)
    {
      this.State = state;
