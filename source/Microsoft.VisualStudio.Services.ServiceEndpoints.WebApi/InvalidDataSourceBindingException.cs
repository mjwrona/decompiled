...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.InvalidDataSourceBindingException
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  [ExceptionMapping("3.0", "5.0", "InvalidDataSourceBindingException", "Microsoft.TeamFoundation.DistributedTask.WebApi.InvalidDataSourceBindingException, Microsoft.TeamFoundation.DistributedTask.WebApi, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class InvalidDataSourceBindingException : ServiceEndpointExceptionType
  {
    public InvalidDataSourceBindingException(string message)
      : base(message)
    {
    }

    public InvalidDataSourceBindingException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected InvalidDataSourceBindingException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
