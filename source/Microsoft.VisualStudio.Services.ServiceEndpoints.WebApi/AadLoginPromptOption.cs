...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.AadLoginPromptOption
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  public enum AadLoginPromptOption
  {
    [EnumMember] NoOption,
    [EnumMember] Login,
    [EnumMember] SelectAccount,
    [EnumMember] FreshLogin,
    [EnumMember] FreshLoginWithMfa,
  }
}
