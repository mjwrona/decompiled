...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.InvalidEndpointResponseException
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  [ExceptionMapping("3.0", "5.0", "InvalidEndpointResponseException", "Microsoft.TeamFoundation.DistributedTask.WebApi.InvalidEndpointResponseException, Microsoft.TeamFoundation.DistributedTask.WebApi, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class InvalidEndpointResponseException : ServiceEndpointExceptionType
  {
    public InvalidEndpointResponseException(string message)
      : base(message)
    {
    }

    public InvalidEndpointResponseException(string message, Exception ex)
      : base(message, ex)
    {
    }

    protected InvalidEndpointResponseException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
