...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.AzureSpnOperationStatus
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  {
    public AzureSpnOperationStatus(string state, string statusMessage, string severity = null)
    {
      this.State = state;
