...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.InvalidServiceEndpointRequestException
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  [ExceptionMapping("3.0", "5.0", "InvalidServiceEndpointRequestException", "Microsoft.TeamFoundation.DistributedTask.WebApi.InvalidServiceEndpointRequestException, Microsoft.TeamFoundation.DistributedTask.WebApi, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class InvalidServiceEndpointRequestException : ServiceEndpointExceptionType
  {
    public InvalidServiceEndpointRequestException(string message)
      : base(message)
    {
    }

    public InvalidServiceEndpointRequestException(string message, Exception ex)
      : base(message, ex)
    {
    }

    protected InvalidServiceEndpointRequestException(
