...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.DataSourceNotFoundException
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  [ExceptionMapping("3.0", "5.0", "DataSourceNotFoundException", "Microsoft.TeamFoundation.DistributedTask.WebApi.DataSourceNotFoundException, Microsoft.TeamFoundation.DistributedTask.WebApi, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
  [Serializable]
  public class DataSourceNotFoundException : ServiceEndpointExceptionType
  {
    ...
    public DataSourceNotFoundException(string message, Exception innerException)
      : base(message, innerException)
    {
    }

    protected DataSourceNotFoundException(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
  }
