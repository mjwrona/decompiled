...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.RefreshAuthenticationParameters
...
namespace Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi
{
  ...
  {
    [DataMember]
    public short TokenValidityInMinutes { get; set; }

    [DataMember]
    public Guid EndpointId { get; set; }

    [DataMember]
    public IEnumerable<int> Scope { get; set; }
  }
}
