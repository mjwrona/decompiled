...
// Type: Microsoft.VisualStudio.Services.ServiceEndpoints.WebApi.DataSourceBinding
...
{
  public class DataSourceBinding : DataSourceBindingBase
  {
    ...
    private DataSourceBinding(DataSourceBinding inputDefinitionToClone)
      : base((DataSourceBindingBase) inputDefinitionToClone)
    {
    }
