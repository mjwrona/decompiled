...
// Type: Microsoft.VisualStudio.Services.Notifications.WebApi.BatchNotificationOperation
...
namespace Microsoft.VisualStudio.Services.Notifications.WebApi
{
  ...
  public class BatchNotificationOperation
  {
    ...
    [DataMember(EmitDefaultValue = false)]
    public List<NotificationQueryCondition> NotificationQueryConditions { get; set; }
  }
}
