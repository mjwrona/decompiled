...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.Yaml.ObjectTemplating.Events.OnMappingStartEventArgs
...
{
  internal sealed class OnMappingStartEventArgs : TemplateEventArgs
  {
    private readonly MappingToken m_mapping;
    private ReadOnlyMappingToken m_readOnlyMapping;

    internal OnMappingStartEventArgs(TemplateContext context, MappingToken mapping)
      : base(context)
    {
