...
// Type: Microsoft.TeamFoundation.DistributedTask.Pipelines.Yaml.ObjectTemplating.Events.OnSequenceStartEventArgs
...
{
  internal sealed class OnSequenceStartEventArgs : TemplateEventArgs
  {
    private readonly SequenceToken m_sequence;
    private ReadOnlySequenceToken m_readOnlySequence;

    internal OnSequenceStartEventArgs(TemplateContext context, SequenceToken sequence)
      : base(context)
    {
