...
// Type: Microsoft.VisualStudio.Services.Artifact.WebApi.ContentTypeNotSpecifiedException
...
{
  [Serializable]
  public class ContentTypeNotSpecifiedException : VssServiceException
  {
    public ContentTypeNotSpecifiedException(string message, Exception ex)
      : base(message, ex)
    {
    }

    public ContentTypeNotSpecifiedException(string message)
