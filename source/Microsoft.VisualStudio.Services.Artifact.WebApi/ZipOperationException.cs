...
// Type: Microsoft.VisualStudio.Services.Artifact.WebApi.ZipOperationException
...
{
  [Serializable]
  public class ZipOperationException : VssServiceException
  {
    public ZipOperationException(string message, Exception ex)
      : base(message, ex)
    {
    }
