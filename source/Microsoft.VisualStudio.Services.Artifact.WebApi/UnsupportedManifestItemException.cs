...
// Type: Microsoft.VisualStudio.Services.Artifact.WebApi.UnsupportedManifestItemException
...
{
  [Serializable]
  public class UnsupportedManifestItemException : VssServiceException
  {
    public UnsupportedManifestItemException(string message)
      : base(message)
    {
    }
  }
