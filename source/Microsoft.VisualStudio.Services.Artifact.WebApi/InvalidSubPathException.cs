...
// Type: Microsoft.VisualStudio.Services.Artifact.WebApi.InvalidSubPathException
...
{
  [Serializable]
  public class InvalidSubPathException : VssServiceException
  {
    public InvalidSubPathException(string message)
      : base(message)
    {
    }
  }
