...
// Type: Microsoft.VisualStudio.Services.Artifact.WebApi.ContentRangeNotAcceptedException
...
{
  [Serializable]
  public class ContentRangeNotAcceptedException : VssServiceException
  {
    public ContentRangeNotAcceptedException(string message, Exception ex)
      : base(message, ex)
    {
    }

    public ContentRangeNotAcceptedException(string message)
