...
// Type: Microsoft.VisualStudio.Services.Artifact.WebApi.InvalidContentFormatException
...
{
  [Serializable]
  public class InvalidContentFormatException : VssServiceException
  {
    public InvalidContentFormatException(string message, Exception ex)
      : base(message, ex)
    {
    }
