...
// Type: Microsoft.TeamFoundation.VersionControl.Server.GetOperationColumns15b
...
{
  internal class GetOperationColumns15b : GetOperationColumns6
  {
    protected SqlColumnBinder propertyDataspaceId = new SqlColumnBinder("PropertyDataspaceId");

    public GetOperationColumns15b(VersionControlSqlResourceComponent component)
      : base(component)
    {
    }
    ...
    protected override GetOperation Bind()
    {
      ...
      getOperation.ItemDataspaceId = this.GetDataspaceIdentifier(this.propertyDataspaceId.GetInt32((IDataReader) this.Reader, 0));
