...
// Type: Microsoft.TeamFoundation.VersionControl.Server.QueryItemsColumns15b
...
{
  internal class QueryItemsColumns15b : QueryItemsColumns3
  {
    protected SqlColumnBinder propertyDataspaceId = new SqlColumnBinder("PropertyDataspaceId");

    public QueryItemsColumns15b(VersionControlSqlResourceComponent component)
      : base(component)
    {
    }
