...
// Type: Microsoft.TeamFoundation.VersionControl.Server.VersionedItemComponent25
...
{
  internal class VersionedItemComponent25 : VersionedItemComponent24
  {
      ...
      bool isWildCard)
    {
      ...
      this.BindBoolean("@forceIndexHint", !isWildCard);
