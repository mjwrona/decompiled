...
// Type: Microsoft.TeamFoundation.VersionControl.Server.ServerItemLocalVersionUpdateColumns
...
{
  internal class ServerItemLocalVersionUpdateColumns : 
    VersionControlObjectBinder<ServerItemLocalVersionUpdate>
  {
    ...
    public ServerItemLocalVersionUpdateColumns()
    {
    }

    public ServerItemLocalVersionUpdateColumns(VersionControlSqlResourceComponent component)
      : base(component)
    {
    }
    ...
    protected override ServerItemLocalVersionUpdate Bind()
    {
      ...
      localVersionUpdate.SourceItemPathPair = this.GetPreDataspaceItemPathPair(this.sourceServerItem.GetServerItem(this.Reader, false));
