...
// Type: Microsoft.VisualStudio.ExternalProviders.GitHub.WebApi.DeclaredGraphQLTypeInfo
...
{
  internal class DeclaredGraphQLTypeInfo : GraphQLTypeInfo
  {
    public IReadOnlyList<DistinctGraphQLTypeInfo> Implementations { get; set; }
  }
}
