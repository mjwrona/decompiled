...
// Type: Microsoft.VisualStudio.ExternalProviders.GitHub.WebApi.GraphQLTypeInfo
...
{
  internal abstract class GraphQLTypeInfo
  {
    public Type Type { get; set; }

    public IReadOnlyList<PropertyInfo> ScalarProperties { get; set; }

    public IReadOnlyList<PropertyInfo> ObjectProperties { get; set; }
  }
}
