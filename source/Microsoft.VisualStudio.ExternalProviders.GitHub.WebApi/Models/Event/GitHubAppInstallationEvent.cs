...
// Type: Microsoft.VisualStudio.ExternalProviders.GitHub.WebApi.Models.Event.GitHubAppInstallationEvent
...
{
  [DataContract]
  public class GitHubAppInstallationEvent
  {
    [DataMember]
    public GitHubAppInstallationAction Action { get; set; }
