...
// Type: Microsoft.VisualStudio.ExternalProviders.GitHub.WebApi.Models.Event.GitHubRepositoryAction
...
{
  [DataContract]
  public enum GitHubRepositoryAction
  {
    [EnumMember] Created,
    [EnumMember] Deleted,
    [EnumMember] Archived,
    [EnumMember] Unarchived,
    [EnumMember] Edited,
    [EnumMember] Renamed,
    [EnumMember] Transferred,
    [EnumMember] Publicized,
    [EnumMember] Privatized,
  }
}
