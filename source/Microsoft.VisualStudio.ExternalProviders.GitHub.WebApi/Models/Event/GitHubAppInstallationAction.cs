...
// Type: Microsoft.VisualStudio.ExternalProviders.GitHub.WebApi.Models.Event.GitHubAppInstallationAction
...
{
  [DataContract]
  public enum GitHubAppInstallationAction
  {
    [EnumMember] Created,
    [EnumMember] Deleted,
    [EnumMember(Value = "new_permissions_accepted")] NewPermissionsAccepted,
  }
}
