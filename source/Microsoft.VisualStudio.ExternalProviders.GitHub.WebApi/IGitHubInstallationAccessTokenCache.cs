...
// Type: Microsoft.VisualStudio.ExternalProviders.GitHub.WebApi.IGitHubInstallationAccessTokenCache
...
{
  public interface IGitHubInstallationAccessTokenCache
  {
    bool TryGetToken(GitHubAppType app, string key, out GitHubData.InstallationAccessToken token);

    void AddOrUpdate(GitHubAppType app, string key, GitHubData.InstallationAccessToken token);

    void Remove(GitHubAppType app, string key);
  }
}
