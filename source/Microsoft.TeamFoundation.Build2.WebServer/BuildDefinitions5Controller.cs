...
// Type: Microsoft.TeamFoundation.Build2.WebServer.BuildDefinitions5Controller
...
namespace Microsoft.TeamFoundation.Build2.WebServer
{
  ...
  public class BuildDefinitions5Controller : BuildApiController
  {
    protected const int DefaultTop = 10000;

    [HttpPost]
    public Microsoft.TeamFoundation.Build.WebApi.BuildDefinition CreateDefinition(
      ...
      [FromUri] int? definitionToCloneRevision = null)
    {
      ...
      Microsoft.TeamFoundation.Build2.Server.BuildDefinition serverBuildDefinition = definition.ToBuildServerBuildDefinition();
      this.FixIncomingDefinition(serverBuildDefinition, false);
      if (serverBuildDefinition != null && serverBuildDefinition.Process != null)
        serverBuildDefinition.Process.Version = 3;
      ...
      return buildDefinition.ToWebApiBuildDefinition(this.TfsRequestContext, this.GetApiResourceVersion().ApiVersion);
    }

    [HttpGet]
    [PublicProjectRequestRestrictions]
    public virtual Microsoft.TeamFoundation.Build.WebApi.BuildDefinition GetDefinition(
      int definitionId,
      int? revision = null,
      ...
      bool includeLatestBuilds = false)
    {
      ...
      return definition.ToWebApiBuildDefinition(this.TfsRequestContext, this.GetApiResourceVersion().ApiVersion);
    }
    ...
    [PublicProjectRequestRestrictions]
    public virtual HttpResponseMessage GetDefinitions(
      string name = "*",
      ...
      string yamlFilename = null)
    {
      ...
      if (!string.IsNullOrEmpty(yamlFilename))
      {
        if (!includeAllProperties)
          throw new InvalidDefinitionQueryException(Resources.YamlFilenameRequiresIncludeAllPropertiese());
        if (processType.HasValue)
        {
          int? nullable3 = processType;
          int num = 2;
          if (!(nullable3.GetValueOrDefault() == num & nullable3.HasValue))
            throw new InvalidDefinitionQueryException(Resources.YamlFilenameRequiresYamlProcessType());
        }
        processType = new int?(2);
      }
      ...
      else
      {
        ...
        int? processType2 = processType;
        list = definitionService.GetDefinitions(tfsRequestContext, projectId, name2, queryOrder: (Microsoft.TeamFoundation.Build2.Server.DefinitionQueryOrder) queryOrder2, count: count, minLastModifiedTime: minLastModifiedTime, maxLastModifiedTime: maxLastModifiedTime, lastDefinitionName: lastDefinitionName, minMetricsTime: minMetricsTime2, path: path2, builtAfter: builtAfter2, notBuiltAfter: notBuiltAfter2, options: (DefinitionQueryOptions) options, includeLatestBuilds: num4 != 0, taskIdFilter: taskIdFilter2, processType: processType2).ToList<Microsoft.TeamFoundation.Build2.Server.BuildDefinition>();
      }
      if (!string.IsNullOrEmpty(yamlFilename))
        list = list.Where<Microsoft.TeamFoundation.Build2.Server.BuildDefinition>((Func<Microsoft.TeamFoundation.Build2.Server.BuildDefinition, bool>) (d => string.Equals(((Microsoft.TeamFoundation.Build2.Server.YamlProcess) d.Process).YamlFilename, yamlFilename, StringComparison.Ordinal))).ToList<Microsoft.TeamFoundation.Build2.Server.BuildDefinition>();
      IdentityMap identityMap = new IdentityMap(this.TfsRequestContext.GetService<IdentityService>());
      HttpResponseMessage responseMessage = includeAllProperties ? this.Request.CreateResponse<List<Microsoft.TeamFoundation.Build.WebApi.BuildDefinition>>(HttpStatusCode.OK, list.Take<Microsoft.TeamFoundation.Build2.Server.BuildDefinition>(top).Select<Microsoft.TeamFoundation.Build2.Server.BuildDefinition, Microsoft.TeamFoundation.Build.WebApi.BuildDefinition>((Func<Microsoft.TeamFoundation.Build2.Server.BuildDefinition, Microsoft.TeamFoundation.Build.WebApi.BuildDefinition>) (d =>
      {
        this.FixOutgoingDefinition(d);
        return d.ToWebApiBuildDefinition(this.TfsRequestContext, this.GetApiResourceVersion().ApiVersion, identityMap);
      })).ToList<Microsoft.TeamFoundation.Build.WebApi.BuildDefinition>()) : this.Request.CreateResponse<List<BuildDefinitionReference>>(HttpStatusCode.OK, list.Take<Microsoft.TeamFoundation.Build2.Server.BuildDefinition>(top).Select<Microsoft.TeamFoundation.Build2.Server.BuildDefinition, BuildDefinitionReference>((Func<Microsoft.TeamFoundation.Build2.Server.BuildDefinition, BuildDefinitionReference>) (d =>
      {
        this.FixOutgoingDefinition(d);
        return d.ToBuildDefinitionReference(this.TfsRequestContext, this.GetApiResourceVersion().ApiVersion, identityMap);
    ...
    [HttpPut]
    public Microsoft.TeamFoundation.Build.WebApi.BuildDefinition UpdateDefinition(
      int definitionId,
      [FromBody] Microsoft.TeamFoundation.Build.WebApi.BuildDefinition definition,
    ...
    [HttpPatch]
    public virtual Microsoft.TeamFoundation.Build.WebApi.BuildDefinition RestoreDefinition(
      int definitionId,
      bool deleted)
    {
      if (deleted)
        throw new ArgumentOutOfRangeException(nameof (deleted), Resources.UseDeleteVerbToDeleteDefinition());
      Microsoft.TeamFoundation.Build2.Server.BuildDefinition buildDefinition = this.DefinitionService.RestoreDefinition(this.TfsRequestContext, this.ProjectId, definitionId);
    ...
    protected void ValidateDefinition(Microsoft.TeamFoundation.Build.WebApi.BuildDefinition definition)
    {
      ArgumentUtility.CheckForNull<Microsoft.TeamFoundation.Build.WebApi.BuildDefinition>(definition, nameof (definition));
      ...
      if (!System.Enum.IsDefined(typeof (Microsoft.TeamFoundation.Build.WebApi.BuildAuthorizationScope), (object) definition.JobAuthorizationScope))
        throw new ArgumentOutOfRangeException("JobAuthorizationScope");
      if (definition.Process != null && definition.Process is Microsoft.TeamFoundation.Build.WebApi.DesignerProcess)
      {
        foreach (Microsoft.TeamFoundation.Build.WebApi.Phase phase in ((Microsoft.TeamFoundation.Build.WebApi.DesignerProcess) definition.Process).Phases)
        {
          if (phase != null && !System.Enum.IsDefined(typeof (Microsoft.TeamFoundation.Build.WebApi.BuildAuthorizationScope), (object) phase.JobAuthorizationScope))
            throw new ArgumentOutOfRangeException("JobAuthorizationScope");
        }
      }
      ...
      definition.CheckSupportedBuildOptions(this.TfsRequestContext, this.GetApiResourceVersion());
    }
