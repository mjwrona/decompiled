...
<%--Dialog template--%>
<script id="add_generic_connections_dialog" type="text/html">
    <div class="add_generic_connections_dialog services_dialog">
...
<script id="generic-connected-service-details" type="text/html">
    <div class="generic-connected-service-details">
        <!-- ko if: name() -->
        <div class="group">
