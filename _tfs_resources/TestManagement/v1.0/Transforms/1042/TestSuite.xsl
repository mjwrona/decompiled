    ...
    <xsl:for-each select="planAndSuites">
      <div id="exported-data">
        ...
        <xsl:for-each select="testPlan">
          <div class="heading">
              테스트 계획 <xsl:call-template name="url-generator">
                  <xsl:with-param name="label">
                      테스트 계획: <xsl:value-of select="@title"/> 
                  </xsl:with-param>
        ...
        <xsl:for-each select="testSuites">
          <xsl:for-each select="testSuite">
            ...
            <div class="heading">
              테스트 도구 모음 <xsl:call-template name="url-generator">
                <xsl:with-param name="label">
                    테스트 도구 모음: <xsl:value-of select="@title"/>
                </xsl:with-param>
              </xsl:call-template>: <xsl:value-of select="@title"/>
            </div>
                    ...
                    <tr>
                      ...
                      <td>
                          <xsl:call-template name="url-generator">
                              <xsl:with-param name="label">
                                  요구 사항: <xsl:value-of select="@title"/>
                              </xsl:with-param>
                          </xsl:call-template>: <xsl:value-of select="@title"/>
                      </td>
                    </tr>
            ...
            <xsl:for-each select="testCases">
              ...
              <div class="tab">
                테스트 사례 (<xsl:value-of select="@count"/>)
                <hr/>
              </div>

              <xsl:for-each select="testCase">
                <div class="test-case-heading heading">
                  테스트 사례 <xsl:call-template name="url-generator">
                    <xsl:with-param name="label">
                        테스트 사례: <xsl:value-of select="@title"/>
                       </xsl:with-param>
                    </xsl:call-template>: <xsl:value-of select="@title"/>
                </div>
                ...
                <xsl:for-each select="parameters">
                  ...
                  <xsl:for-each select="sharedParameterDataSet">
                    <div class="sub-tab">
                      공유 매개 변수 <xsl:call-template name="url-generator">
                          <xsl:with-param name="label">
                            공유 매개 변수: <xsl:value-of select="@title"/>
                          </xsl:with-param>
                ...
                <xsl:comment>최신 테스트 결과</xsl:comment>
