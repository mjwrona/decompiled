      ...
      <div id="exported-data">
        ...
        <xsl:for-each select="testPlan">
          <div class="heading" _locID="TestPlan">
              Test plan <xsl:call-template name="url-generator">
                  <xsl:with-param name="label">
                      Test plan: <xsl:value-of select="@title"/> 
                  </xsl:with-param>
          ...
          <xsl:for-each select="configurations">
            ...
            <div class ="sub-tab" _locID="ConfigurationsInThisTestPlan">
            ...
            <xsl:for-each select="additionalConfiguration">
              <div class ="sub-tab" _locID="AdditionalConfigurations">
                ADDITIONAL CONFIGURATIONS REFERENCED BY CHILD SUITES
              </div>
              <table class="table-style">
                <tr>
                  <th width="5%" _locID="Id">Id</th>
              ...
              <tr>
                <td>
                  <xsl:for-each select="manualRuns">
                    <div class ="sub-tab" _locID="ManualRuns">
                      MANUAL RUNS
                    </div>
                ...
                <td>
                  <xsl:for-each select="automatedRuns">
                    <div class ="sub-tab" _locID="AutomatedRuns">
                      AUTOMATED RUNS
                    </div>
                   <xsl:apply-templates select = "properties"/>
                  </xsl:for-each>
              ...
              <tr>
                <td>
                  <xsl:for-each select="builds">
                    <div class="sub-tab" _locID="Build">
                      BUILD
                    </div>
                    <xsl:apply-templates select = "properties"/>
                  </xsl:for-each>
        ...
        <xsl:for-each select="testSuites">
          <xsl:for-each select="testSuite">
            ...
            <div class="heading" _locID="TestSuite">
              Test suite <xsl:call-template name="url-generator">
                <xsl:with-param name="label">
                    Test suite: <xsl:value-of select="@title"/>
                </xsl:with-param>
              </xsl:call-template>: <xsl:value-of select="@title"/>
            </div>
              ...
              <div>
                ...
                <table class="body-text">
                  <xsl:for-each select="requirement">
                    <tr>
                      <td class="property-name" _locID="Requirement">
                        Requirement:
                      </td>
                      <td>
                          <xsl:call-template name="url-generator">
                              <xsl:with-param name="label">
                                  Requirement: <xsl:value-of select="@title"/>
                              </xsl:with-param>
                          </xsl:call-template>: <xsl:value-of select="@title"/>
                      </td>
                    </tr>
                  ...
                  <xsl:for-each select="configurations">
                    <tr>
                      <td class="property-name" _locID="Configurations">
                        Configurations:
                      </td>
                      <td>
            ...
            <xsl:for-each select="testCases">
              ...
              <div class="tab" _locID="TestCases">
                Test cases&#160;(<xsl:value-of select="@count"/>)
                <hr/>
              </div>
                ...
                <xsl:for-each select="parameters">
                  ...
                  <xsl:for-each select="sharedParameterDataSet">
                    <div class ="sub-tab" _locID="SharedParameter">
                      Shared parameter <xsl:call-template name="url-generator">
                          <xsl:with-param name="label">
                            Shared parameter : <xsl:value-of select="@title"/>
                          </xsl:with-param>
