<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <table>
      ...
      <tr>
        <xsl:choose>
            <xsl:when test="@owner != @cmtr">
                <td>Возвращено от имени:</td>
            </xsl:when>
            <xsl:when test="@owner = @cmtr">
                <td>Кем возвращено:</td>
            </xsl:when>
        </xsl:choose>
        <td class="PropValue">
      ...
      <tr>
        ...
        <!-- Optional policy override comment -->
         ...
         <tr>
         <td>Причина переопределения политики:</td>
        <td class="PropValue">
    ...
    <table class="WithBorder">
        <tr>
            ...
            <td class="ColHeading">Изменение типа</td>
        </tr>
